...
public class SidePropagation extends VisibilityPropagation {
    ...
    public float f11828b = 3.0f;

    /* renamed from: c  reason: collision with root package name */
    public int f11829c = 80;
    ...
    public long c(ViewGroup viewGroup, Transition transition, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        int f11 = f(transitionValues3);
        int g11 = g(transitionValues3);
        int[] iArr = new int[2];
        ...
        return (long) Math.round((((float) (duration * ((long) i11))) / this.f11828b) * h11);
    }
    ...
    public final int h(android.view.View r7, int r8, int r9, int r10, int r11, int r12, int r13, int r14, int r15) {
        /*
            ...
            int r7 = androidx.core.view.h0.F(r7)
