...
public final class Stopwatch {
    ...
    public final Ticker f11162a = Ticker.b();
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f11166a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f11166a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.test.espresso.core.internal.deps.guava.base.Stopwatch.AnonymousClass1.<clinit>():void");
        }
    }

    public static String a(TimeUnit timeUnit) {
        switch (AnonymousClass1.f11166a[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
    ...
    public static TimeUnit b(long j11) {
    ...
    public final long e() {
        return this.f11163b ? (this.f11162a.a() - this.f11165d) + this.f11164c : this.f11164c;
    }

    public Stopwatch f() {
        Preconditions.p(!this.f11163b, "This stopwatch is already running.");
        this.f11163b = true;
        this.f11165d = this.f11162a.a();
        return this;
    }
    ...
    public String toString() {
        long e11 = e();
        TimeUnit b11 = b(e11);
        String a11 = Platform.a(((double) e11) / ((double) TimeUnit.NANOSECONDS.convert(1, b11)));
        String a12 = a(b11);
        StringBuilder sb2 = new StringBuilder(String.valueOf(a11).length() + 1 + String.valueOf(a12).length());
        sb2.append(a11);
        sb2.append(" ");
        sb2.append(a12);
        return sb2.toString();
