...
abstract class Striped64 extends Number {
    ...
    public static final class Cell {
        ...
        public static final Unsafe f11299b;

        /* renamed from: c  reason: collision with root package name */
        public static final long f11300c;

        /* renamed from: a  reason: collision with root package name */
        public volatile long f11301a;

        static {
            try {
                Unsafe access$000 = Striped64.getUnsafe();
                f11299b = access$000;
                f11300c = access$000.objectFieldOffset(Cell.class.getDeclaredField("a"));
            } catch (Exception e11) {
                throw new Error(e11);
            }
        }
        ...
        public final boolean a(long j11, long j12) {
            return f11299b.compareAndSwapLong(this, f11300c, j11, j12);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0010, code lost:
        return (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new androidx.test.espresso.core.internal.deps.guava.cache.Striped64.AnonymousClass1());
     */
    ...
    public final void retryUpdate(long r17, int[] r19, boolean r20) {
        ...
        L_0x0082:
            ...
            if (r11 == 0) goto L_0x00a9
            androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell[] r8 = r1.cells     // Catch:{ all -> 0x00a5 }
            if (r8 != r9) goto L_0x00a0
            int r8 = r10 << 1
            androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell[] r8 = new androidx.test.espresso.core.internal.deps.guava.cache.Striped64.Cell[r8]     // Catch:{ all -> 0x00a5 }
            r11 = r4
        L_0x0095:
        ...
        L_0x00b6:
            ...
            boolean r10 = r16.casBusy()
            if (r10 == 0) goto L_0x00e2
            androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell[] r10 = r1.cells     // Catch:{ all -> 0x00de }
            if (r10 != r9) goto L_0x00d8
            r9 = 2
            androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell[] r9 = new androidx.test.espresso.core.internal.deps.guava.cache.Striped64.Cell[r9]     // Catch:{ all -> 0x00de }
            r10 = r7 & 1
            androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell r11 = new androidx.test.espresso.core.internal.deps.guava.cache.Striped64$Cell     // Catch:{ all -> 0x00de }
