...
public final class NavGraphViewModelLazyKt$navGraphViewModels$2 extends Lambda implements a<ViewModelProvider.Factory> {
    ...
    public NavGraphViewModelLazyKt$navGraphViewModels$2(i<NavBackStackEntry> iVar) {
        super(0);
        this.$backStackEntry$delegate = iVar;
    }

    public final ViewModelProvider.Factory invoke() {
        return g.e(this.$backStackEntry$delegate).getDefaultViewModelProviderFactory();
    }
}
