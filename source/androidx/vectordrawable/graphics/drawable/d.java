...
public class d {
    ...
    public static class a implements TypeEvaluator<f.b[]> {
        ...
        public f.b[] evaluate(float f11, f.b[] bVarArr, f.b[] bVarArr2) {
            if (f.b(bVarArr, bVarArr2)) {
                if (!f.b(this.f12005a, bVarArr)) {
                    this.f12005a = f.f(bVarArr);
                }
                for (int i11 = 0; i11 < bVarArr.length; i11++) {
                    this.f12005a[i11].d(bVarArr[i11], bVarArr2[i11], f11);
                }
                return this.f12005a;
            }
    ...
    public static Animator a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, float f11) throws XmlPullParserException, IOException {
        return b(context, resources, theme, xmlPullParser, Xml.asAttributeSet(xmlPullParser), (AnimatorSet) null, 0, f11);
    }
    ...
    public static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f11985h
            r7 = r22
            android.content.res.TypedArray r6 = s0.i.k(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = s0.i.g(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
    ...
    public static Keyframe c(Keyframe keyframe, float f11) {
    ...
    public static void d(Keyframe[] keyframeArr, float f11, int i11, int i12) {
        float f12 = f11 / ((float) ((i12 - i11) + 2));
        while (i11 <= i12) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        /*
        ...
        L_0x003c:
            ...
            t0.f$b[] r13 = t0.f.d(r12)
            t0.f$b[] r14 = t0.f.d(r11)
    ...
    public static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k11 = i.k(resources, theme, attributeSet, a.f11987j);
        int i11 = 0;
        TypedValue l11 = i.l(k11, xmlPullParser, "value", 0);
    ...
    public static Animator i(Context context, int i11) throws Resources.NotFoundException {
    ...
    public static Animator j(Context context, Resources resources, Resources.Theme theme, int i11) throws Resources.NotFoundException {
        return k(context, resources, theme, i11, 1.0f);
    }

    public static Animator k(Context context, Resources resources, Resources.Theme theme, int i11, float f11) throws Resources.NotFoundException {
        XmlResourceParser xmlResourceParser = null;
        try {
            XmlResourceParser animation = resources.getAnimation(i11);
            Animator a11 = a(context, resources, theme, animation, f11);
            if (animation != null) {
                animation.close();
            }
            return a11;
    ...
    public static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f11, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray k11 = i.k(resources, theme, attributeSet, a.f11984g);
        TypedArray k12 = i.k(resources, theme, attributeSet, a.f11988k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k11, k12, f11, xmlPullParser);
        int h11 = i.h(k11, xmlPullParser, "interpolator", 0, 0);
        if (h11 > 0) {
            valueAnimator.setInterpolator(c.b(context, h11));
        }
        k11.recycle();
        if (k12 != null) {
            k12.recycle();
    ...
    public static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i11, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe keyframe;
        TypedArray k11 = i.k(resources, theme, attributeSet, a.f11987j);
        float f11 = i.f(k11, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l11 = i.l(k11, xmlPullParser, "value", 0);
        boolean z11 = l11 != null;
        if (i11 == 4) {
            i11 = (!z11 || !h(l11.type)) ? 0 : 3;
        }
        if (z11) {
            if (i11 == 0) {
                keyframe = Keyframe.ofFloat(f11, i.f(k11, xmlPullParser, "value", 0, 0.0f));
            } else if (i11 == 1 || i11 == 3) {
                keyframe = Keyframe.ofInt(f11, i.g(k11, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i11 == 0) {
            keyframe = Keyframe.ofFloat(f11);
        } else {
            keyframe = Keyframe.ofInt(f11);
        }
        int h11 = i.h(k11, xmlPullParser, "interpolator", 1, 0);
        if (h11 > 0) {
            keyframe.setInterpolator(c.b(context, h11));
        }
        k11.recycle();
        return keyframe;
    }

    public static ObjectAnimator n(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, float f11, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r0 = 0
            r1 = r0
        L_0x0002:
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r6 = r20
            r7 = 0
            r8 = r7
        ...
        L_0x0016:
            ...
            int[] r0 = androidx.vectordrawable.graphics.drawable.a.f11986i
            r11 = r18
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = s0.i.k(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = s0.i.i(r14, r6, r0, r1)
            r0 = 4
            java.lang.String r1 = "valueType"
            int r5 = s0.i.g(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
    ...
    public static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f11, XmlPullParser xmlPullParser) {
        long g11 = (long) i.g(typedArray, xmlPullParser, IBridgeMediaLoader.COLUMN_DURATION, 1, 300);
        long g12 = (long) i.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g13 = i.g(typedArray, xmlPullParser, "valueType", 7, 4);
        if (i.j(xmlPullParser, "valueFrom") && i.j(xmlPullParser, "valueTo")) {
            ...
            if (e11 != null) {
                valueAnimator.setValues(new PropertyValuesHolder[]{e11});
            }
        }
    ...
    public static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i11, float f11, XmlPullParser xmlPullParser) {
        ObjectAnimator objectAnimator = (ObjectAnimator) valueAnimator;
        String i12 = i.i(typedArray, xmlPullParser, "pathData", 1);
        if (i12 != null) {
            String i13 = i.i(typedArray, xmlPullParser, "propertyXName", 2);
            String i14 = i.i(typedArray, xmlPullParser, "propertyYName", 3);
            if (i11 != 2) {
            }
            if (i13 == null && i14 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(f.e(i12), objectAnimator, f11 * 0.5f, i13, i14);
            return;
        }
        objectAnimator.setPropertyName(i.i(typedArray, xmlPullParser, "propertyName", 0));
    }

    public static void s(Path path, ObjectAnimator objectAnimator, float f11, String str, String str2) {
        ...
        while (true) {
            ...
            pathMeasure2.getPosTan(f12 - ((Float) arrayList.get(i12)).floatValue(), fArr3, (float[]) null);
            fArr[i11] = fArr3[0];
            fArr2[i11] = fArr3[1];
            f12 += f14;
            int i13 = i12 + 1;
