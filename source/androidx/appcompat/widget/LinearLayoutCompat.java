...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i15 = 0; i15 < virtualChildCount; i15++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i15))) {
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
                if (b11) {
                    i14 = virtualChildAt.getRight() + layoutParams.rightMargin;
                } else {
                    i14 = (virtualChildAt.getLeft() - layoutParams.leftMargin) - this.mDividerWidth;
                }
                drawVerticalDivider(canvas, i14);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 != null) {
                ...
                if (b11) {
                    i13 = virtualChildAt2.getLeft() - layoutParams2.leftMargin;
                    i12 = this.mDividerWidth;
                } else {
                    i11 = virtualChildAt2.getRight() + layoutParams2.rightMargin;
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 == null) {
                i11 = (getHeight() - getPaddingBottom()) - this.mDividerHeight;
            } else {
                i11 = virtualChildAt2.getBottom() + ((LayoutParams) virtualChildAt2.getLayoutParams()).bottomMargin;
            }
            drawHorizontalDivider(canvas, i11);
        }
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i12) {
            ...
            if (baseline != -1) {
                ...
                return i13 + ((LayoutParams) childAt.getLayoutParams()).topMargin + baseline;
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = androidx.appcompat.widget.o0.b(r24)
            ...
            int r1 = androidx.core.view.h0.F(r24)
    ...
    public void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L_0x0059:
            ...
            r1 = r11
        L_0x0075:
            int r2 = androidx.core.view.h0.F(r17)
