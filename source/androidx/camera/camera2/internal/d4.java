...
public class d4 {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f5080a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f5080a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f5080a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f5080a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.camera.camera2.internal.d4.a.<clinit>():void");
        }
    }

    public static int a(UseCaseConfigFactory.CaptureType captureType, int i11) {
        int i12 = a.f5080a[captureType.ordinal()];
        return i12 != 1 ? (i12 == 2 || i12 == 3) ? 3 : 1 : i11 == 2 ? 5 : 2;
    }

    public static int b(UseCaseConfigFactory.CaptureType captureType, int i11) {
        int i12 = a.f5080a[captureType.ordinal()];
        return i12 != 1 ? (i12 == 2 || i12 == 3) ? 3 : 1 : i11 == 2 ? 5 : 1;
    }
}
