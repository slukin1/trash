...
public class SmallDisplaySizeQuirk implements Quirk {
    ...
    public static final Map<String, Size> f5064a;
    ...
    public static boolean d() {
        return f5064a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    public Size c() {
        return f5064a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
