...
public class UnicodeCountry extends Country {
    ...
    static {
        ...
        AO = unicodeCountry9;
        UnicodeCountry unicodeCountry10 = new UnicodeCountry(16, "AQ", n0.f32118f, "Antarctica", "Antarctic");
        AQ = unicodeCountry10;
        ...
        BW = unicodeCountry35;
        UnicodeCountry unicodeCountry36 = new UnicodeCountry(TUIMessageBean.MSG_STATUS_DELETE, "BY", "BLR", "Belarus", "Belarusian");
        BY = unicodeCountry36;
        ...
        CC = unicodeCountry39;
        UnicodeCountry unicodeCountry40 = new UnicodeCountry(b.f34945b, "CD", "COD", "Congo - Kinshasa", "Congolese");
        CD = unicodeCountry40;
        ...
        CU = unicodeCountry51;
        UnicodeCountry unicodeCountry52 = new UnicodeCountry(MobileEvents.EVENTTYPE_SDKPARAMETERS, "CV", "CPV", "Cape Verde", "Cape Verdean");
        CV = unicodeCountry52;
        UnicodeCountry unicodeCountry53 = new UnicodeCountry(354, "CX", "CXR", "Christmas Island", "");
        CX = unicodeCountry53;
        UnicodeCountry unicodeCountry54 = new UnicodeCountry(TPNativePlayerInitConfig.BOOL_ENABLE_DROPFRAME_BY_REFRESHRATE, "CY", "CYP", "Cyprus", "Cypriot");
        CY = unicodeCountry54;
        ...
        ES = unicodeCountry67;
        UnicodeCountry unicodeCountry68 = new UnicodeCountry(561, "ET", DefiChainInfo.CHAIN_ETH, "Ethiopia", "Ethiopian");
        ET = unicodeCountry68;
        UnicodeCountry unicodeCountry69 = new UnicodeCountry(582, "FI", "FIN", "Finland", "Finnish");
        FI = unicodeCountry69;
        UnicodeCountry unicodeCountry70 = new UnicodeCountry(TPCodecParamers.TP_PROFILE_H264_CONSTRAINED_BASELINE, "FJ", "FJI", "Fiji", "Fijian");
        FJ = unicodeCountry70;
        ...
        GS = unicodeCountry89;
        UnicodeCountry unicodeCountry90 = new UnicodeCountry(TXLivePushConfig.DEFAULT_MIN_VIDEO_BITRATE, "GT", "GTM", "Guatemala", "Guatemalan");
        GT = unicodeCountry90;
        ...
        UnicodeCountry unicodeCountry115 = new UnicodeCountry(UGCDataReportDef.DR_DAU_EVENT_ID_RECORD_RESOLUTION_1080P, ExpandedProductParsedResult.KILOGRAM, "KGZ", "Kyrgyzstan", "Kyrgyz");
        ...
        UnicodeCountry unicodeCountry122 = new UnicodeCountry(UGCDataReportDef.DR_DAU_EVENT_ID_RECORD_RESOLUTION_BD, "KW", "KWT", "Kuwait", "Kuwaiti");
        ...
        UnicodeCountry unicodeCountry125 = new UnicodeCountry(UGCDataReportDef.DR_DAU_EVENT_ID_RECORD_VIDEO_BITRATE, "LA", "Lao", "Laos", "Lao");
        LA = unicodeCountry125;
        UnicodeCountry unicodeCountry126 = new UnicodeCountry(UGCDataReportDef.DR_DAU_EVENT_ID_RECORD_BEAUTY_WHITE, ExpandedProductParsedResult.POUND, "LBN", "Lebanon", "Lebanese");
        ...
        UnicodeCountry unicodeCountry129 = new UnicodeCountry(MTCorePrivatesApi.SDK_VERSION_CODE, "LK", "LKA", "Sri Lanka", "Sri Lankan");
        ...
        UnicodeCountry unicodeCountry132 = new UnicodeCountry(SPHINCS256Config.CRYPTO_SECRETKEYBYTES, "LT", "LTU", "Lithuania", "Lithuanian");
        ...
        UnicodeCountry unicodeCountry145 = new UnicodeCountry(TipsMessageBean.MSG_TYPE_GROUP_QUITE, "MM", "MMR", "Myanmar [Burma]", "Burmese");
        ...
        UnicodeCountry unicodeCountry155 = new UnicodeCountry(TXLiteAVCode.WARNING_INSUFFICIENT_CAPTURE_FPS, "MW", "MWI", "Malawi", "Malawian");
        MW = unicodeCountry155;
        UnicodeCountry unicodeCountry156 = new UnicodeCountry(1156, "MX", "MEX", "Mexico", "Mexican");
        MX = unicodeCountry156;
        UnicodeCountry unicodeCountry157 = new UnicodeCountry(TXLiteAVCode.WARNING_CAMERA_NOT_AUTHORIZED, "MY", "MYS", "Malaysia", "Malaysian");
        ...
        UnicodeCountry unicodeCountry174 = new UnicodeCountry(BannerConfig.SCROLL_TIME, "PF", "PYF", "French Polynesia", "French Polynesian");
        ...
        UnicodeCountry unicodeCountry218 = new UnicodeCountry(1574, "TL", SSLSocketFactoryFactory.DEFAULT_PROTOCOL, "Timor-Leste", "Timorese");
        ...
        UnicodeCountry unicodeCountry232 = new UnicodeCountry(Wots.WOTS_SIGBYTES, "UZ", "UZB", "Uzbekistan", "Uzbekistani, Uzbek");
        ...
        UnicodeCountry unicodeCountry236 = new UnicodeCountry(TPOptionalID.OPTION_ID_BEFORE_BOOL_ENABLE_IGNORE_VIDEO_STREAM_IN_COMMON_AUDIO_FORMATS, "VG", "VGB", "British Virgin Islands", "Virgin Island");
    ...
    private UnicodeCountry(int i11, String str, String str2, String str3, String str4) {
        this.code = i11;
        this.alpha2Code = str;
