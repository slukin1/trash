...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(ByteString byteString, long j11) throws IOException;

    long indexOfElement(ByteString byteString) throws IOException;

    long indexOfElement(ByteString byteString, long j11) throws IOException;

    InputStream inputStream();

    BufferedSource peek();

    boolean rangeEquals(long j11, ByteString byteString) throws IOException;

    boolean rangeEquals(long j11, ByteString byteString, int i11, int i12) throws IOException;
    ...
    ByteString readByteString(long j11) throws IOException;

    long readDecimalLong() throws IOException;

    void readFully(Buffer buffer, long j11) throws IOException;
    ...
    String readString(long j11, Charset charset) throws IOException;
