...
public class EditPagePort extends EditPage {
    ...
    private void initBody(RelativeLayout relativeLayout, float f11) {
        ...
        AnonymousClass1 r82 = new AsyncImageView(this.activity) {
            public void onImageGot(String str, Bitmap bitmap) {
                Bitmap unused = EditPagePort.this.thumb = bitmap;
                super.onImageGot(str, bitmap);
            }
        };
        this.aivThumb = r82;
        r82.setScaleToCropCenter(true);
    ...
    private void initThumb(com.mob.tools.gui.AsyncImageView r7) {
        ...
        L_0x0079:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.sharesdk.onekeyshare.themes.classic.port.EditPagePort.initThumb(com.mob.tools.gui.AsyncImageView):void");
    }
    ...
    public void onCreate() {
        super.onCreate();
        float screenHeight = ((float) ResHelper.getScreenHeight(this.activity)) / 1280.0f;
