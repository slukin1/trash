...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r5, android.os.Bundle r6, android.os.ResultReceiver r7) {
                ...
                L_0x002b:
                    p0.g.b(r6, r2, r1)     // Catch:{ BadParcelableException -> 0x00c4 }
            ...
            public void onSkipToQueueItem(long j11) {
                Callback.this.onSkipToQueueItem(j11);
            }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(e eVar) {
            ...
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((e) null);
                }
            }
        }
    ...
    public interface MediaSessionImpl {
        ...
        void setPlaybackToLocal(int i11);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j11) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j11);
            return (j11 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() {
                public void onPlaybackPositionUpdate(long j11) {
                    MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(j11), (Bundle) null);
                }
            });
        }
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        j11 = elapsedRealtime - lastPositionUpdateTime;
                        if (playbackSpeed > 0.0f && playbackSpeed != 1.0f) {
                            j11 = (long) (((float) j11) * playbackSpeed);
                        }
                    }
                    position += j11;
                }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j11) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j11);
            return (j11 & 128) != 0 ? rccTransportControlFlagsFromActions | 512 : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i11) {
                postToHandler(26, (Object) mediaDescriptionCompat, i11);
            }

            public void adjustVolume(int i11, int i12, String str) {
                MediaSessionImplBase.this.adjustVolume(i11, i12);
            }
            ...
            public long getFlags() {
                long j11;
                synchronized (MediaSessionImplBase.this.mLock) {
                    j11 = (long) MediaSessionImplBase.this.mFlags;
                }
                return j11;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                    i11 = mediaSessionImplBase.mVolumeType;
                    i12 = mediaSessionImplBase.mLocalStream;
                    VolumeProviderCompat volumeProviderCompat = mediaSessionImplBase.mVolumeProvider;
                    if (i11 != 2) {
                        streamMaxVolume = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i12);
                        streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i12);
                    } else {
                        throw null;
                    }
                }
            ...
            public void postToHandler(int i11) {
                MediaSessionImplBase.this.postToHandler(i11, 0, 0, (Object) null, (Bundle) null);
            }
            ...
            public void seekTo(long j11) throws RemoteException {
                postToHandler(18, (Object) Long.valueOf(j11));
            }
            ...
            public void setCaptioningEnabled(boolean z11) throws RemoteException {
                postToHandler(29, (Object) Boolean.valueOf(z11));
            }

            public void setRepeatMode(int i11) throws RemoteException {
                postToHandler(23, i11);
            }

            public void setShuffleMode(int i11) throws RemoteException {
                postToHandler(30, i11);
            }

            public void setShuffleModeEnabledRemoved(boolean z11) throws RemoteException {
            }

            public void setVolumeTo(int i11, int i12, String str) {
                MediaSessionImplBase.this.setVolumeTo(i11, i12);
            }

            public void skipToQueueItem(long j11) {
                postToHandler(11, (Object) Long.valueOf(j11));
            }
            ...
            public void postToHandler(int i11, int i12) {
                MediaSessionImplBase.this.postToHandler(i11, i12, 0, (Object) null, (Bundle) null);
            }

            public void postToHandler(int i11, Object obj) {
                MediaSessionImplBase.this.postToHandler(i11, 0, 0, obj, (Bundle) null);
            }

            public void postToHandler(int i11, Object obj, int i12) {
                MediaSessionImplBase.this.postToHandler(i11, i12, 0, obj, (Bundle) null);
            }

            public void postToHandler(int i11, Object obj, Bundle bundle) {
                MediaSessionImplBase.this.postToHandler(i11, 0, 0, obj, bundle);
            }
        }
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((e) null);
                    }
                }
            }
        }
        ...
        private void sendCaptioningEnabled(boolean z11) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onCaptioningEnabledChanged(z11);
        ...
        private void sendRepeatMode(int i11) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i11);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i11) {
            for (int beginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    this.mControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i11);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        public void adjustVolume(int i11, int i12) {
            if (this.mVolumeType != 2) {
                this.mAudioManager.adjustStreamVolume(this.mLocalStream, i11, i12);
            }
        }
        ...
        public int getRccStateFromState(int i11) {
            switch (i11) {
                case 0:
                    return 0;
                case 1:
        ...
        public void postToHandler(int i11, int i12, int i13, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message obtainMessage = messageHandler.obtainMessage(i11, i12, i13, obj);
        ...
        public void setCaptioningEnabled(boolean z11) {
            if (this.mCaptioningEnabled != z11) {
                this.mCaptioningEnabled = z11;
                sendCaptioningEnabled(z11);
            }
        }
        ...
        public void setPlaybackToLocal(int i11) {
            this.mLocalStream = i11;
            this.mVolumeType = 1;
            int i12 = this.mVolumeType;
            int i13 = this.mLocalStream;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(i12, i13, 2, this.mAudioManager.getStreamMaxVolume(i13), this.mAudioManager.getStreamVolume(this.mLocalStream)));
        }
        ...
        public void setRatingType(int i11) {
            this.mRatingType = i11;
        }
        ...
        public void setVolumeTo(int i11, int i12) {
            if (this.mVolumeType != 2) {
                this.mAudioManager.setStreamVolume(this.mLocalStream, i11, i12);
            }
        }
        ...
        public boolean update() {
            if (this.mIsActive) {
                boolean z11 = this.mIsMbrRegistered;
                if (!z11 && (this.mFlags & 1) != 0) {
                    registerMediaButtonEventReceiver(this.mMediaButtonReceiverIntent, this.mMediaButtonReceiverComponentName);
                    this.mIsMbrRegistered = true;
                } else if (z11 && (this.mFlags & 1) == 0) {
                    unregisterMediaButtonEventReceiver(this.mMediaButtonReceiverIntent, this.mMediaButtonReceiverComponentName);
                    this.mIsMbrRegistered = false;
                }
                boolean z12 = this.mIsRccRegistered;
                if (!z12 && (this.mFlags & 2) != 0) {
                    this.mAudioManager.registerRemoteControlClient(this.mRcc);
                    this.mIsRccRegistered = true;
                    return true;
                } else if (z12 && (this.mFlags & 2) == 0) {
                    this.mRcc.setPlaybackState(0);
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public QueueItem(MediaDescriptionCompat mediaDescriptionCompat, long j11) {
            this((Object) null, mediaDescriptionCompat, j11);
        }
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), (j11 < 0 || playbackSpeed <= j11) ? playbackSpeed < 0 ? 0 : playbackSpeed : j11, playbackStateCompat.getPlaybackSpeed(), elapsedRealtime).build();
    }
    ...
    public void setCaptioningEnabled(boolean z11) {
        this.mImpl.setCaptioningEnabled(z11);
    }
    ...
    public void setPlaybackToLocal(int i11) {
        this.mImpl.setPlaybackToLocal(i11);
    }
    ...
    public void setRatingType(int i11) {
        this.mImpl.setRatingType(i11);
    }

    public void setRepeatMode(int i11) {
        this.mImpl.setRepeatMode(i11);
    }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i11) {
            this.mResultReceiver.writeToParcel(parcel, i11);
        }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setActive(boolean z11) {
            MediaSessionCompatApi21.setActive(this.mSessionObj, z11);
        }
        ...
        public void setCaptioningEnabled(boolean z11) {
            if (this.mCaptioningEnabled != z11) {
                ...
                for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onCaptioningEnabledChanged(z11);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setFlags(int i11) {
            MediaSessionCompatApi21.setFlags(this.mSessionObj, i11);
        }
        ...
        public void setPlaybackToLocal(int i11) {
            MediaSessionCompatApi21.setPlaybackToLocal(this.mSessionObj, i11);
        }
        ...
        public void setRatingType(int i11) {
            if (Build.VERSION.SDK_INT < 22) {
                ...
                MediaSessionCompatApi22.setRatingType(this.mSessionObj, i11);
            }
        }
        ...
        public void setRepeatMode(int i11) {
            if (this.mRepeatMode != i11) {
                ...
                for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onRepeatModeChanged(i11);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i11) {
            if (this.mShuffleMode != i11) {
                ...
                for (int beginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        this.mExtraControllerCallbacks.getBroadcastItem(beginBroadcast).onShuffleModeChanged(i11);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
