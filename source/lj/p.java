...
public class p extends o implements a.C0808a {
    ...
    public void M(EdgeEnginePageActivity edgeEnginePageActivity) {
        this.F = edgeEnginePageActivity;
        synchronized (this) {
            this.I |= 1;
        }
    ...
    public final void a(int i11, View view) {
        EdgeEnginePageActivity edgeEnginePageActivity = this.F;
        if (edgeEnginePageActivity != null) {
            edgeEnginePageActivity.finish();
        }
    }
