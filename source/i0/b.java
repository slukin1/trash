...
public class b<K, V> {
    ...
    private int safeSizeOf(K k11, V v11) {
    ...
    public final V get(K r5) {
        ...
        L_0x0054:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.b.get(java.lang.Object):java.lang.Object");
    }
    ...
    public final V put(K k11, V v11) {
        ...
        synchronized (this) {
            this.putCount++;
            this.size += safeSizeOf(k11, v11);
            put = this.map.put(k11, v11);
            if (put != null) {
                this.size -= safeSizeOf(k11, put);
            }
        }
        if (put != null) {
    ...
    public final V remove(K k11) {
        ...
        synchronized (this) {
            ...
            if (remove != null) {
                this.size -= safeSizeOf(k11, remove);
            }
        }
        if (remove != null) {
            entryRemoved(false, k11, remove, (V) null);
        }
        return remove;
    }
    ...
    public final synchronized String toString() {
        ...
        int i12;
        i11 = this.hitCount;
        i12 = this.missCount + i11;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i12 != 0 ? (i11 * 100) / i12 : 0)});
    }
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0071:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: i0.b.trimToSize(int):void");
    }
}
