...
public class RxRingBuffer implements Subscription {
    ...
    static {
        int i11 = PlatformDependent.isAndroid() ? 16 : 128;
        ...
        if (property != null) {
            try {
                ...
                printStream.println("Failed to set 'rx.buffer.size' with value " + property + " => " + e11.getMessage());
            }
        }
        SIZE = i11;
    }

    private RxRingBuffer(Queue<Object> queue2, int i11) {
        this.queue = queue2;
        this.size = i11;
    }
    ...
    public void onNext(Object obj) throws MissingBackpressureException {
        ...
        synchronized (this) {
            ...
            if (queue2 != null) {
                z11 = false;
                z12 = !queue2.offer(NotificationLite.next(obj));
            }
        }
        if (z11) {
    ...
    private RxRingBuffer(boolean z11, int i11) {
        this.queue = z11 ? new SpmcArrayQueue<>(i11) : new SpscArrayQueue<>(i11);
        this.size = i11;
    }
