...
public final class BlockingOperatorMostRecent {
    ...
    public static final class MostRecentObserver<T> extends Subscriber<T> {
        ...
        public MostRecentObserver(T t11) {
            this.value = NotificationLite.next(t11);
        }
    ...
    public static <T> Iterable<T> mostRecent(final Observable<? extends T> observable, final T t11) {
        return new Iterable<T>() {
            public Iterator<T> iterator() {
                MostRecentObserver mostRecentObserver = new MostRecentObserver(t11);
