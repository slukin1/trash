...
public final class OperatorPublish<T> extends ConnectableObservable<T> {
    ...
    public static final class PublishSubscriber<T> extends Subscriber<T> {
        ...
        public boolean checkTerminated(Object obj, boolean z11) {
            int i11 = 0;
            if (obj != null) {
                if (!NotificationLite.isCompleted(obj)) {
                    ...
                    try {
                        ...
                        while (i11 < length) {
                            andSet[i11].child.onError(error);
                            i11++;
                        }
                        return true;
                    } finally {
        ...
        public void init() {
            add(Subscriptions.create(new Action0() {
                public void call() {
                    ...
                    publishSubscriber.current.compareAndSet(publishSubscriber, (Object) null);
                }
            }));
        }
            ...
            do {
                ...
                if (innerProducerArr != EMPTY && innerProducerArr != TERMINATED) {
                    ...
                    while (true) {
                        if (i12 >= length) {
                            break;
                        } else if (innerProducerArr[i12].equals(innerProducer)) {
                            i11 = i12;
                            break;
                        } else {
                            i12++;
    ...
    public static <T, R> Observable<R> create(final Observable<? extends T> observable, final Func1<? super Observable<T>, ? extends Observable<R>> func1, final boolean z11) {
        return Observable.unsafeCreate(new Observable.OnSubscribe<R>() {
            public void call(final Subscriber<? super R> subscriber) {
                final OnSubscribePublishMulticast onSubscribePublishMulticast = new OnSubscribePublishMulticast(RxRingBuffer.SIZE, z11);
                AnonymousClass1 r12 = new Subscriber<R>() {
                    public void onCompleted() {
                ...
                subscriber.add(r12);
                ((Observable) func1.call(Observable.unsafeCreate(onSubscribePublishMulticast))).unsafeSubscribe(r12);
