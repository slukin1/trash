...
public final class OperatorWindowWithTime<T> implements Observable.Operator<Observable<T>, T> {
    ...
    public final class ExactSubscriber extends Subscriber<T> {
        ...
        public boolean emitValue(T t11) {
            State<T> state2;
        ...
        public void onError(Throwable th2) {
            synchronized (this.guard) {
                if (this.emitting) {
                    this.queue = Collections.singletonList(NotificationLite.error(th2));
                    return;
                }
                this.queue = null;
                this.emitting = true;
        ...
        public void scheduleExact() {
            ...
            worker2.schedulePeriodically(r12, 0, operatorWindowWithTime.timespan, operatorWindowWithTime.unit);
        }
    }

    public final class InexactSubscriber extends Subscriber<T> {
        public final Subscriber<? super Observable<T>> child;
        public final List<CountedSerializedSubject<T>> chunks = new LinkedList();
        public boolean done;
        public final Object guard = new Object();
        public final Scheduler.Worker worker;
        ...
        public void scheduleChunk() {
            ...
            OperatorWindowWithTime operatorWindowWithTime = OperatorWindowWithTime.this;
            long j11 = operatorWindowWithTime.timeshift;
            worker2.schedulePeriodically(r12, j11, j11, operatorWindowWithTime.unit);
        }
            ...
            synchronized (this.guard) {
                if (!this.done) {
                    ...
                    try {
                        ...
                        OperatorWindowWithTime operatorWindowWithTime = OperatorWindowWithTime.this;
                        worker2.schedule(r22, operatorWindowWithTime.timespan, operatorWindowWithTime.unit);
                    } catch (Throwable th2) {
                        onError(th2);
                    }
                }
    ...
    public static final class State<T> {
        public static final State<Object> EMPTY = new State<>((Observer) null, (Observable) null, 0);
        public final Observer<T> consumer;
        public final int count;
        public final Observable<T> producer;

        public State(Observer<T> observer, Observable<T> observable, int i11) {
    ...
    public OperatorWindowWithTime(long j11, long j12, TimeUnit timeUnit, int i11, Scheduler scheduler2) {
        this.timespan = j11;
        this.timeshift = j12;
        this.unit = timeUnit;
        this.size = i11;
