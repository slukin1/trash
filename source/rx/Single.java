...
public class Single<T> {
    ...
    public Single(OnSubscribe<T> onSubscribe2) {
    ...
    public static <T> Single<T> error(final Throwable th2) {
        return create(new OnSubscribe<T>() {
            public void call(SingleSubscriber<? super T> singleSubscriber) {
                singleSubscriber.onError(th2);
            }
    ...
    public static <T> Single<T> from(Future<? extends T> future) {
        return create(new SingleFromFuture(future, 0, (TimeUnit) null));
    }
    ...
    public static <T> Single<? extends T>[] iterableToArray(Iterable<? extends Single<? extends T>> iterable) {
        ...
        for (Single<? extends T> single : iterable) {
            if (i11 == singleArr.length) {
                Single<? extends T>[] singleArr2 = new Single[((i11 >> 2) + i11)];
                System.arraycopy(singleArr, 0, singleArr2, 0, i11);
                singleArr = singleArr2;
            }
            singleArr[i11] = single;
            i11++;
        }
        if (singleArr.length == i11) {
            return singleArr;
        }
        Single<? extends T>[] singleArr3 = new Single[i11];
        System.arraycopy(singleArr, 0, singleArr3, 0, i11);
        return singleArr3;
    }

    public static <T> Single<T> just(T t11) {
        return ScalarSynchronousSingle.create(t11);
    }
    ...
    public static <T> Single<T> merge(Single<? extends Single<? extends T>> single) {
        ...
        return create(new OnSubscribe<T>(single) {
            public final /* synthetic */ Single val$source;
            ...
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                AnonymousClass1 r02 = new SingleSubscriber<Single<? extends T>>() {
    ...
    public final Single<T> delay(long j11, TimeUnit timeUnit, Scheduler scheduler) {
        return create(new SingleDelay(this.onSubscribe, j11, timeUnit, scheduler));
    }
        ...
        if (action1 != null) {
            return create(new SingleDoOnEvent(this, new Action1<T>() {
                public void call(T t11) {
                    action1.call(Notification.createOnNext(t11));
                }
    ...
    public final Observable<T> mergeWith(Single<? extends T> single) {
        return merge(this, (Single) single);
    }
        ...
        return create(new OnSubscribe<T>() {
            public void call(final SingleSubscriber<? super T> singleSubscriber) {
                ...
                createWorker.schedule(new Action0() {
                    public void call() {
                        AnonymousClass1 r02 = new SingleSubscriber<T>() {
                            public void onError(Throwable th2) {
                                try {
                                    singleSubscriber.onError(th2);
                                } finally {
    ...
    public final Single<T> timeout(long j11, TimeUnit timeUnit) {
        return timeout(j11, timeUnit, (Single) null, Schedulers.computation());
    }
    ...
    public static <T> Single<T> from(Future<? extends T> future, long j11, TimeUnit timeUnit) {
        Objects.requireNonNull(timeUnit, "unit is null");
        return create(new SingleFromFuture(future, j11, timeUnit));
    }

    public static <T> Observable<T> mergeDelayError(Observable<? extends Single<? extends T>> observable, int i11) {
        return observable.flatMapSingle(UtilityFunctions.identity(), true, i11);
    }

    private Subscription unsafeSubscribe(Subscriber<? super T> subscriber, boolean z11) {
        if (z11) {
            try {
                subscriber.onStart();
            } catch (Throwable th2) {
    ...
    public static <T, Resource> Single<T> using(Func0<Resource> func0, Func1<? super Resource, ? extends Single<? extends T>> func1, Action1<? super Resource> action1, boolean z11) {
        ...
        return create(new SingleOnSubscribeUsing(func0, func1, action1, z11));
    }
    ...
    public final Single<T> retry(long j11) {
        return toObservable().retry(j11).toSingle();
    }
    ...
    public final Single<T> timeout(long j11, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout(j11, timeUnit, (Single) null, scheduler);
    }

    @Deprecated
    public Single(Observable.OnSubscribe<T> onSubscribe2) {
    ...
    public final Single<T> timeout(long j11, TimeUnit timeUnit, Single<? extends T> single) {
        return timeout(j11, timeUnit, single, Schedulers.computation());
    }
    ...
    public final Single<T> timeout(long j11, TimeUnit timeUnit, Single<? extends T> single, Scheduler scheduler) {
        if (single == null) {
        ...
        return create(new SingleTimeout(this.onSubscribe, j11, timeUnit, scheduler, single.onSubscribe));
    }
    ...
    public static <T> Observable<T> merge(Observable<? extends Single<? extends T>> observable, int i11) {
        return observable.flatMapSingle(UtilityFunctions.identity(), false, i11);
    }
