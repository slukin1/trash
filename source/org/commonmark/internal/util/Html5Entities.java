...
public class Html5Entities {
    ...
    public static final Map<String, String> f59754a = b();

    /* renamed from: b  reason: collision with root package name */
    public static final Pattern f59755b = Pattern.compile("^&#[Xx]?");

    public static String a(String str) {
        Matcher matcher = f59755b.matcher(str);
        if (matcher.find()) {
            try {
            ...
            String str2 = f59754a.get(str.substring(1, str.length() - 1));
    ...
    public static java.util.Map<java.lang.String, java.lang.String> b() {
        ...
        L_0x0056:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.commonmark.internal.util.Html5Entities.b():java.util.Map");
    }
}
