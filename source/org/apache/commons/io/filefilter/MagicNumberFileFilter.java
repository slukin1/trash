...
public class MagicNumberFileFilter extends AbstractFileFilter implements Serializable {
    ...
    public String toString() {
        return super.toString() + "(" + new String(this.magicNumbers, Charset.defaultCharset()) + Constants.ACCEPT_TIME_SEPARATOR_SP + this.byteOffset + ")";
    }
    ...
    public MagicNumberFileFilter(String str, long j11) {
        if (str == null) {
    ...
    public MagicNumberFileFilter(byte[] bArr, long j11) {
        if (bArr == null) {
            throw new IllegalArgumentException("The magic number cannot be null");
