...
public class XmlPullParserFactory {
    ...
    public static final Class referenceContextClass = XmlPullParserFactory.class;
    ...
    public XmlPullParser newPullParser() throws XmlPullParserException {
        ...
        if (vector == null) {
            ...
            int i11 = 0;
            while (i11 < this.parserClasses.size()) {
                Class cls = (Class) this.parserClasses.elementAt(i11);
                try {
                    ...
                    stringBuffer3.append(l.f34627b);
    ...
    public XmlSerializer newSerializer() throws XmlPullParserException {
        ...
        if (vector == null) {
            ...
            StringBuffer stringBuffer2 = new StringBuffer();
            int i11 = 0;
            while (i11 < this.serializerClasses.size()) {
                Class cls = (Class) this.serializerClasses.elementAt(i11);
                try {
    ...
    public void setFeature(String str, boolean z11) throws XmlPullParserException {
        this.features.put(str, new Boolean(z11));
    }

    public void setNamespaceAware(boolean z11) {
        this.features.put(XmlPullParser.FEATURE_PROCESS_NAMESPACES, new Boolean(z11));
    }

    public void setValidating(boolean z11) {
        this.features.put(XmlPullParser.FEATURE_VALIDATION, new Boolean(z11));
    }
