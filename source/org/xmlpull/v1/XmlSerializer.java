...
public interface XmlSerializer {
    ...
    String getPrefix(String str, boolean z11) throws IllegalArgumentException;
    ...
    void setFeature(String str, boolean z11) throws IllegalArgumentException, IllegalStateException;
    ...
    XmlSerializer text(char[] cArr, int i11, int i12) throws IOException, IllegalArgumentException, IllegalStateException;
}
