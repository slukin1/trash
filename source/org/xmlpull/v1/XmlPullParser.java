...
public interface XmlPullParser {
    ...
    public static final String[] TYPES = {"START_DOCUMENT", "END_DOCUMENT", "START_TAG", "END_TAG", "TEXT", "CDSECT", "ENTITY_REF", "IGNORABLE_WHITESPACE", "PROCESSING_INSTRUCTION", ZopimCommentActivity.EXTRA_COMMENT, "DOCDECL"};
    ...
    int getNamespaceCount(int i11) throws XmlPullParserException;
    ...
    boolean isAttributeDefault(int i11);
    ...
    void require(int i11, String str, String str2) throws XmlPullParserException, IOException;
