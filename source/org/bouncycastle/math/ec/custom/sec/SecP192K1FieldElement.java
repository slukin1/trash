...
public class SecP192K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP192K1FieldElement(BigInteger bigInteger) {
        ...
        this.f59419x = SecP192K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP192K1Field.add(this.f59419x, ((SecP192K1FieldElement) eCFieldElement).f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat192.create();
        SecP192K1Field.addOne(this.f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.inv(((SecP192K1FieldElement) eCFieldElement).f59419x, create);
        SecP192K1Field.multiply(create, this.f59419x, create);
        return new SecP192K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat192.eq(this.f59419x, ((SecP192K1FieldElement) obj).f59419x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f59419x, 0, 6);
    }

    public ECFieldElement invert() {
        int[] create = Nat192.create();
        SecP192K1Field.inv(this.f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat192.isOne(this.f59419x);
    }

    public boolean isZero() {
        return Nat192.isZero(this.f59419x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.multiply(this.f59419x, ((SecP192K1FieldElement) eCFieldElement).f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat192.create();
        SecP192K1Field.negate(this.f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f59419x;
    ...
    public ECFieldElement square() {
        int[] create = Nat192.create();
        SecP192K1Field.square(this.f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat192.create();
        SecP192K1Field.subtract(this.f59419x, ((SecP192K1FieldElement) eCFieldElement).f59419x, create);
        return new SecP192K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat192.getBit(this.f59419x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat192.toBigInteger(this.f59419x);
    }
}
