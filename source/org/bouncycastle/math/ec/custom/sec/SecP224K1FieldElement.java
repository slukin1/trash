...
public class SecP224K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP224K1FieldElement(BigInteger bigInteger) {
        ...
        this.f59423x = SecP224K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP224K1Field.add(this.f59423x, ((SecP224K1FieldElement) eCFieldElement).f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224K1Field.addOne(this.f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.inv(((SecP224K1FieldElement) eCFieldElement).f59423x, create);
        SecP224K1Field.multiply(create, this.f59423x, create);
        return new SecP224K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat224.eq(this.f59423x, ((SecP224K1FieldElement) obj).f59423x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f59423x, 0, 7);
    }

    public ECFieldElement invert() {
        int[] create = Nat224.create();
        SecP224K1Field.inv(this.f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat224.isOne(this.f59423x);
    }

    public boolean isZero() {
        return Nat224.isZero(this.f59423x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.multiply(this.f59423x, ((SecP224K1FieldElement) eCFieldElement).f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224K1Field.negate(this.f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f59423x;
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224K1Field.square(this.f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224K1Field.subtract(this.f59423x, ((SecP224K1FieldElement) eCFieldElement).f59423x, create);
        return new SecP224K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat224.getBit(this.f59423x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f59423x);
    }
}
