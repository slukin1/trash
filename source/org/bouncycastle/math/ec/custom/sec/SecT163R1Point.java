...
public class SecT163R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElement8 = this.f59403y;
        ECFieldElement eCFieldElement9 = this.f59404zs[0];
    ...
    public ECPoint twice() {
        ...
        if (!isOne) {
            a11 = a11.multiply(square);
        }
        ECFieldElement add = eCFieldElement2.square().add(multiply).add(a11);
        if (add.isZero()) {
