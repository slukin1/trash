...
public class SecT193R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT193R1Curve() {
        super(193, 15, 0, 0);
        this.f59387a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01")));
        this.f59388b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814")));
