...
public class SecT239K1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT239K1Curve() {
        super(TwitterApiConstants.Errors.GUEST_AUTH_ERROR_CODE, ISO781611.SMT_DO_DS, 0, 0);
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawXCoord()).f59439x, 0, jArr, i13);
            int i15 = i13 + 4;
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawYCoord()).f59439x, 0, jArr, i15);
            i13 = i15 + 4;
        }
