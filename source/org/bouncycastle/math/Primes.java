...
public abstract class Primes {
                        ...
                        if (!(intValue5 % 89 == 0 || intValue5 % 97 == 0 || intValue5 % 101 == 0 || intValue5 % 103 == 0)) {
                            ...
                            if (!(intValue6 % 107 == 0 || intValue6 % 109 == 0 || intValue6 % 113 == 0 || intValue6 % 127 == 0)) {
                                ...
                                if (!(intValue7 % 131 == 0 || intValue7 % 137 == 0 || intValue7 % 139 == 0 || intValue7 % 149 == 0)) {
                                    ...
                                    if (!(intValue8 % 151 == 0 || intValue8 % 157 == 0 || intValue8 % 163 == 0 || intValue8 % TPPixelFormat.TP_PIX_FMT_MEDIACODEC == 0)) {
    ...
    private static STOutput implSTRandomPrime(Digest digest, int i11, byte[] bArr) {
        ...
        if (i12 < 33) {
            ...
            do {
                ...
                inc(bArr2, 1);
                i14++;
                long extract32 = ((long) (((extract32(bArr3) ^ extract32(bArr4)) & (-1 >>> (32 - i12))) | (1 << (i12 - 1)) | 1)) & 4294967295L;
                if (isPrime32(extract32)) {
                    return new STOutput(BigInteger.valueOf(extract32), bArr2, i14);
                }
            } while (i14 <= i12 * 4);
            throw new IllegalStateException("Too many iterations in Shawe-Taylor Random_Prime Routine");
        }
        STOutput implSTRandomPrime = implSTRandomPrime(digest2, (i12 + 3) / 2, bArr2);
        ...
        int i15 = i12 - 1;
        int i16 = (i15 / (digestSize * 8)) + 1;
        BigInteger hashGen = hashGen(digest2, primeSeed, i16);
        BigInteger bigInteger = ONE;
        BigInteger bit = hashGen.mod(bigInteger.shiftLeft(i15)).setBit(i15);
        ...
        int i17 = primeGenCounter;
        int i18 = 0;
        while (true) {
            if (add.bitLength() > i12) {
                BigInteger bigInteger2 = ONE;
                shiftLeft2 = bigInteger2.shiftLeft(i15).subtract(bigInteger2).divide(shiftLeft).add(bigInteger2).shiftLeft(i13);
                add = shiftLeft2.multiply(prime).add(bigInteger2);
            }
            i17 += i13;
            if (!implHasAnySmallFactors(add)) {
                BigInteger add2 = shiftLeft2.add(BigInteger.valueOf((long) i18));
                BigInteger modPow = hashGen(digest2, primeSeed, i16).mod(add.subtract(THREE)).add(TWO).modPow(add2, add);
                BigInteger bigInteger3 = ONE;
                if (add.gcd(modPow.subtract(bigInteger3)).equals(bigInteger3) && modPow.modPow(prime, add).equals(bigInteger3)) {
                    return new STOutput(add, primeSeed, i17);
                }
                obj = null;
                shiftLeft2 = add2;
                i18 = 0;
    ...
    private static boolean isPrime32(long j11) {
        if ((j11 >>> 32) == 0) {
            int i11 = (j11 > 5 ? 1 : (j11 == 5 ? 0 : -1));
            if (i11 <= 0) {
                return j11 == 2 || j11 == 3 || i11 == 0;
            }
            if ((1 & j11) == 0 || j11 % 3 == 0 || j11 % 5 == 0) {
                return false;
            }
