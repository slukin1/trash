...
class ECUtils {
    ...
    public static X962Parameters getDomainParametersFromName(ECParameterSpec eCParameterSpec, boolean z11) {
        if (eCParameterSpec instanceof ECNamedCurveSpec) {
            ...
            return new X962Parameters(new X9ECParameters(convertCurve, new X9ECPoint(EC5Util.convertPoint(convertCurve, eCParameterSpec.getGenerator()), z11), eCParameterSpec.getOrder(), BigInteger.valueOf((long) eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed()));
        }
    }
