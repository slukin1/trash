...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private CRL doGenerateCRL(InputStream inputStream, boolean z11) throws CRLException {
        ...
        try {
            ...
            if (aSN1Set == null) {
                ...
                inputStream.reset();
                return read != 48 ? readPEMCRL(inputStream, z11) : readDERCRL(new ASN1InputStream(inputStream, true));
    ...
    private Certificate doGenerateCertificate(InputStream inputStream, boolean z11) throws CertificateException {
        ...
        try {
            ...
            if (aSN1Set == null) {
                ...
                inputStream.reset();
                return read != 48 ? readPEMCertificate(inputStream, z11) : readDERCertificate(new ASN1InputStream(inputStream));
    ...
    private Certificate readPEMCertificate(InputStream inputStream, boolean z11) throws IOException, CertificateParsingException {
