...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0013, code lost:
        r11 = null;
        r10 = r12.f59337c.getEncoded(org.bouncycastle.asn1.ASN1Encoding.DER);
     */
    ...
    private org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal getInternalCertificate() {
        ...
        L_0x0009:
            monitor-exit(r0)     // Catch:{ all -> 0x0040 }
            r0 = 0
            org.bouncycastle.asn1.x509.Certificate r1 = r12.f59337c     // Catch:{ IOException -> 0x0016 }
        ...
        L_0x001e:
            ...
            org.bouncycastle.asn1.x509.Certificate r5 = r12.f59337c
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            if (!this.hashValueSet || !x509CertificateObject.hashValueSet) {
                if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f59337c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f59337c.getSignature())) {
                    return false;
                }
