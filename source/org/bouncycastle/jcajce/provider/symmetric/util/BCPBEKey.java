...
public class BCPBEKey implements PBEKey, Destroyable {
    ...
    public byte[] getEncoded() {
        ...
        int i11 = this.type;
        return i11 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(this.password) : i11 == 5 ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(this.password) : PBEParametersGenerator.PKCS5PasswordToBytes(this.password);
    }
