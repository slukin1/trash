...
import com.sumsub.sns.internal.core.data.source.applicant.remote.utils.b;
...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    public class CertId {
        ...
        public byte[] f59338id;

        public CertId(PublicKey publicKey) {
            this.f59338id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Arrays.areEqual(this.f59338id, ((CertId) obj).f59338id);
        }

        public int hashCode() {
            return Arrays.hashCode(this.f59338id);
        }
    }
    ...
    private Cipher createCipher(int i11, char[] cArr, AlgorithmIdentifier algorithmIdentifier) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, NoSuchProviderException {
        SecretKey secretKey;
        ...
        createCipher.init(i11, secretKey, algorithmParameterSpec);
        return createCipher;
    }
    ...
    private void doStore(OutputStream outputStream, char[] cArr, boolean z11) throws IOException {
        ...
        ContentInfo contentInfo2 = new ContentInfo(aSN1ObjectIdentifier9, new BEROctetString(new AuthenticatedSafe(new ContentInfo[]{new ContentInfo(aSN1ObjectIdentifier9, bEROctetString), new ContentInfo(PKCSObjectIdentifiers.encryptedData, new EncryptedData(aSN1ObjectIdentifier9, algorithmIdentifier, new BEROctetString(cryptData)).toASN1Primitive())}).getEncoded(z11 ? ASN1Encoding.DER : str6)));
        byte[] bArr3 = new byte[this.saltLength];
        this.random.nextBytes(bArr3);
        try {
            new Pfx(contentInfo2, new MacData(new DigestInfo(this.macAlgorithm, calculatePbeMac(this.macAlgorithm.getAlgorithm(), bArr3, this.itCount, cArr, false, ((ASN1OctetString) contentInfo2.getContent()).getOctets())), bArr3, this.itCount)).encodeTo(outputStream2, z11 ? ASN1Encoding.DER : str6);
        } catch (Exception e15) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v6, resolved type: org.bouncycastle.asn1.ASN1OctetString} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v7, resolved type: org.bouncycastle.asn1.ASN1OctetString} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v7, resolved type: org.bouncycastle.asn1.ASN1OctetString} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v24, resolved type: org.bouncycastle.asn1.ASN1OctetString} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v13, resolved type: org.bouncycastle.asn1.ASN1Primitive} */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v28, resolved type: org.bouncycastle.asn1.ASN1Primitive} */
    ...
    public void engineLoad(java.io.InputStream r23, char[] r24) throws java.io.IOException {
        ...
        L_0x0009:
            ...
            r2 = 48
            if (r0 != r2) goto L_0x061b
            r1.reset()
            org.bouncycastle.asn1.ASN1InputStream r0 = new org.bouncycastle.asn1.ASN1InputStream
            r0.<init>((java.io.InputStream) r1)
            org.bouncycastle.asn1.ASN1Primitive r0 = r0.readObject()     // Catch:{ Exception -> 0x0610 }
            org.bouncycastle.asn1.pkcs.Pfx r0 = org.bouncycastle.asn1.pkcs.Pfx.getInstance(r0)     // Catch:{ Exception -> 0x0610 }
        ...
        L_0x01d1:
            ...
            org.bouncycastle.asn1.ASN1BMPString r7 = (org.bouncycastle.asn1.ASN1BMPString) r7
        ...
        L_0x03df:
            ...
            org.bouncycastle.asn1.ASN1BMPString r5 = (org.bouncycastle.asn1.ASN1BMPString) r5
        ...
        L_0x04ab:
            ...
            java.io.ByteArrayInputStream r3 = new java.io.ByteArrayInputStream     // Catch:{ Exception -> 0x05e9 }
            org.bouncycastle.asn1.ASN1Encodable r2 = r2.getCertValue()     // Catch:{ Exception -> 0x05e9 }
            org.bouncycastle.asn1.ASN1OctetString r2 = (org.bouncycastle.asn1.ASN1OctetString) r2     // Catch:{ Exception -> 0x05e9 }
            byte[] r2 = r2.getOctets()     // Catch:{ Exception -> 0x05e9 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x05e9 }
            java.security.cert.CertificateFactory r2 = r8.certFact     // Catch:{ Exception -> 0x05e9 }
            java.security.cert.Certificate r2 = r2.generateCertificate(r3)     // Catch:{ Exception -> 0x05e9 }
        ...
        L_0x04f0:
            ...
            r10 = r5
            org.bouncycastle.asn1.ASN1OctetString r10 = (org.bouncycastle.asn1.ASN1OctetString) r10
            byte[] r10 = r10.getOctets()
            java.lang.String r10 = org.bouncycastle.util.encoders.Hex.toHexString(r10)
            org.bouncycastle.jcajce.provider.keystore.pkcs12.PKCS12KeyStoreSpi$IgnoresCaseHashtable r1 = r8.keys
            java.util.Hashtable r1 = r1.keys
            ...
            goto L_0x0583
        L_0x0555:
            org.bouncycastle.asn1.ASN1Primitive r1 = r13.toASN1Primitive()
            boolean r1 = r1.equals((org.bouncycastle.asn1.ASN1Primitive) r5)
        ...
        L_0x0569:
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = org.bouncycastle.asn1.pkcs.PKCSObjectIdentifiers.pkcs_9_at_friendlyName
            boolean r1 = r7.equals((org.bouncycastle.asn1.ASN1Primitive) r1)
        ...
        L_0x058d:
            ...
            org.bouncycastle.jcajce.provider.keystore.pkcs12.PKCS12KeyStoreSpi$CertId r1 = new org.bouncycastle.jcajce.provider.keystore.pkcs12.PKCS12KeyStoreSpi$CertId
            java.security.PublicKey r5 = r2.getPublicKey()
            r1.<init>((java.security.PublicKey) r5)
            r0.put(r1, r2)
            ...
            org.bouncycastle.asn1.x509.SubjectKeyIdentifier r1 = r8.createSubjectKeyId(r1)
            ...
            r1.put(r0, r2)
            org.bouncycastle.jcajce.provider.keystore.pkcs12.PKCS12KeyStoreSpi$IgnoresCaseHashtable r1 = r8.keys
            java.lang.Object r2 = r1.remove(r14)
            r1.put(r0, r2)
            goto L_0x05e4
        L_0x05c9:
            if (r4 == 0) goto L_0x05dd
            java.lang.String r0 = new java.lang.String
            byte[] r1 = r4.getOctets()
            byte[] r1 = org.bouncycastle.util.encoders.Hex.encode(r1)
            r0.<init>(r1)
            java.util.Hashtable r1 = r8.keyCerts
            r1.put(r0, r2)
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        } else if (!z11 || certificateArr != null) {
            if (this.keys.get(str) != null) {
