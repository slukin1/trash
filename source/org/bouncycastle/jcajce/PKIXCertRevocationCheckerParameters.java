...
public class PKIXCertRevocationCheckerParameters {
    ...
    public PKIXCertRevocationCheckerParameters(PKIXExtendedParameters pKIXExtendedParameters, Date date, CertPath certPath2, int i11, X509Certificate x509Certificate, PublicKey publicKey) {
