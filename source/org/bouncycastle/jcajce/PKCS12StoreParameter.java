...
public class PKCS12StoreParameter implements KeyStore.LoadStoreParameter {
    ...
    public PKCS12StoreParameter(OutputStream outputStream, KeyStore.ProtectionParameter protectionParameter2, boolean z11) {
    ...
    public PKCS12StoreParameter(OutputStream outputStream, char[] cArr, boolean z11) {
        this(outputStream, (KeyStore.ProtectionParameter) new KeyStore.PasswordProtection(cArr), z11);
    }
