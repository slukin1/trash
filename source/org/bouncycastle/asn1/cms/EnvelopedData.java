...
public class EnvelopedData extends ASN1Object {
    ...
    private EnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        int i12 = i11 + 1;
        this.encryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(i11));
        if (aSN1Sequence.size() > i12) {
            this.unprotectedAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i12), false);
        }
    }
    ...
    public static EnvelopedData getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
