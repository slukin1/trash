...
public class KEKIdentifier extends ASN1Object {
    ...
    private KEKIdentifier(ASN1Sequence aSN1Sequence) {
        ...
        if (size != 1) {
            if (size == 2) {
                boolean z11 = aSN1Sequence.getObjectAt(1) instanceof ASN1GeneralizedTime;
    ...
    public static KEKIdentifier getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
