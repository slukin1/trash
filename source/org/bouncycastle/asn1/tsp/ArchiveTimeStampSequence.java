...
public class ArchiveTimeStampSequence extends ASN1Object {
    ...
    public ArchiveTimeStampSequence append(ArchiveTimeStampChain archiveTimeStampChain) {
        ...
        for (int i11 = 0; i11 != this.archiveTimeStampChains.size(); i11++) {
            aSN1EncodableVector.add(this.archiveTimeStampChains.getObjectAt(i11));
        }
    ...
    public ArchiveTimeStampChain[] getArchiveTimeStampChains() {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            archiveTimeStampChainArr[i11] = ArchiveTimeStampChain.getInstance(this.archiveTimeStampChains.getObjectAt(i11));
        }
