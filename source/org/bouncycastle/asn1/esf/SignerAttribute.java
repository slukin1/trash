    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (true) {
            ...
            if (objArr[i11] instanceof Attribute[]) {
                aSN1EncodableVector.add(new DERTaggedObject(0, new DERSequence((ASN1Encodable[]) (Attribute[]) this.values[i11])));
            } else {
                aSN1EncodableVector.add(new DERTaggedObject(1, (AttributeCertificate) objArr[i11]));
            }
            i11++;
        }
    }
