...
public class RevocationValues extends ASN1Object {
    ...
    public CertificateList[] getCrlVals() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            certificateListArr[i11] = CertificateList.getInstance(this.crlVals.getObjectAt(i11));
        }
    ...
    public BasicOCSPResponse[] getOcspVals() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            basicOCSPResponseArr[i11] = BasicOCSPResponse.getInstance(this.ocspVals.getObjectAt(i11));
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (otherRevVals2 != null) {
            aSN1EncodableVector.add(new DERTaggedObject(true, 2, (ASN1Encodable) otherRevVals2.toASN1Primitive()));
        }
