...
public class X509Name extends ASN1Object {
    ...
    public X509Name(Vector vector, Hashtable hashtable, X509NameEntryConverter x509NameEntryConverter) {
        ...
        if (vector != null) {
            for (int i12 = 0; i12 != vector.size(); i12++) {
                this.ordering.addElement(vector.elementAt(i12));
    ...
    public X509Name(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            int i11 = 0;
            while (true) {
                if (i11 < instance.size()) {
                    ASN1Sequence instance2 = ASN1Sequence.getInstance(instance.getObjectAt(i11).toASN1Primitive());
                    if (instance2.size() == 2) {
    ...
    private void appendValue(StringBuffer stringBuffer, Hashtable hashtable, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        while (i11 < length2 && stringBuffer.charAt(i11) == ' ') {
        ...
        while (true) {
            length2--;
            if (length2 > i11 && stringBuffer.charAt(length2) == ' ') {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            while (i12 != i13) {
                ...
                String str = (String) this.values.elementAt(i12);
                int i14 = 0;
                while (true) {
                    if (i14 >= size) {
                        z11 = false;
                        break;
                    } else if (!zArr[i14] && aSN1ObjectIdentifier.equals((ASN1Primitive) (ASN1ObjectIdentifier) instance.ordering.elementAt(i14)) && equivalentStrings(str, (String) instance.values.elementAt(i14))) {
                        zArr[i14] = true;
                        z11 = true;
                        break;
                    } else {
    ...
    public boolean equals(Object obj, boolean z11) {
        ...
        try {
            ...
            for (int i11 = 0; i11 < size; i11++) {
                if (!((ASN1ObjectIdentifier) this.ordering.elementAt(i11)).equals((ASN1Primitive) (ASN1ObjectIdentifier) instance.ordering.elementAt(i11)) || !equivalentStrings((String) this.values.elementAt(i11), (String) instance.values.elementAt(i11))) {
                    return false;
                }
            }
            return true;
