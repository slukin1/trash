...
public class BiometricData extends ASN1Object {
    ...
    public BiometricData(TypeOfBiometricData typeOfBiometricData2, AlgorithmIdentifier algorithmIdentifier, ASN1OctetString aSN1OctetString, ASN1IA5String aSN1IA5String) {
        this.typeOfBiometricData = typeOfBiometricData2;
        this.hashAlgorithm = algorithmIdentifier;
        this.biometricDataHash = aSN1OctetString;
