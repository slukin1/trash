...
public interface ICAOObjectIdentifiers {
    ...
    static {
        ...
        id_icao_aaProtocolObject = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        ASN1ObjectIdentifier branch3 = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
