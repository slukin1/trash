...
public class CsrAttrs extends ASN1Object {
    ...
    private CsrAttrs(ASN1Sequence aSN1Sequence) {
        ...
        for (int i11 = 0; i11 != aSN1Sequence.size(); i11++) {
            this.attrOrOIDs[i11] = AttrOrOID.getInstance(aSN1Sequence.getObjectAt(i11));
        }
    }
    ...
    public static CsrAttrs getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
