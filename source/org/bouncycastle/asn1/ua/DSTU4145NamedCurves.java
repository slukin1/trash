...
public class DSTU4145NamedCurves {
    ...
    public static final String oidBase = (UAObjectIdentifiers.dstu4145le.getId() + ".2.");
    public static final ASN1ObjectIdentifier[] oids = new ASN1ObjectIdentifier[10];
    ...
    static {
        ...
        while (true) {
            ...
            if (i12 >= eCDomainParametersArr.length) {
                break;
            }
            eCDomainParametersArr[i12] = new ECDomainParameters(f2mArr[i12], eCPointArr[i12], bigIntegerArr[i12], bigIntegerArr3[i12]);
            i12++;
        }
        while (true) {
