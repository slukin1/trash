...
public class DVCSCertInfo extends ASN1Object {
    ...
    private DVCSCertInfo(ASN1Sequence aSN1Sequence) {
        ...
        int i12 = i11 + 1;
        this.messageImprint = DigestInfo.getInstance(aSN1Sequence.getObjectAt(i11));
        int i13 = i12 + 1;
        this.serialNumber = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(i12));
        int i14 = i13 + 1;
        this.responseTime = DVCSTime.getInstance(aSN1Sequence.getObjectAt(i13));
        while (i14 < aSN1Sequence.size()) {
            int i15 = i14 + 1;
            ASN1Encodable objectAt2 = aSN1Sequence.getObjectAt(i14);
    ...
    public static DVCSCertInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
