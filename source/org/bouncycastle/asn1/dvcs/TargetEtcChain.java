...
public class TargetEtcChain extends ASN1Object {
    ...
    public static TargetEtcChain[] arrayFromSequence(ASN1Sequence aSN1Sequence) {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            targetEtcChainArr[i11] = getInstance(aSN1Sequence.getObjectAt(i11));
        }
    ...
    public static TargetEtcChain getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z11) {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (pathProcInput2 != null) {
            aSN1EncodableVector.add(new DERTaggedObject(false, 0, (ASN1Encodable) pathProcInput2));
        }
