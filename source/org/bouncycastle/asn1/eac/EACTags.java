...
public class EACTags {
    ...
    public static int decodeTag(int i11) {
        int i12 = 0;
        boolean z11 = false;
    ...
    public static int encodeTag(ASN1ApplicationSpecific aSN1ApplicationSpecific) {
        int i11 = aSN1ApplicationSpecific.isConstructed() ? 96 : 64;
        int applicationTag = aSN1ApplicationSpecific.getApplicationTag();
        if (applicationTag <= 31) {
            return i11 | applicationTag;
        }
        int i12 = i11 | 31;
        while (true) {
            int i13 = (i12 << 8) | (applicationTag & 127);
            applicationTag >>= 7;
            if (applicationTag <= 0) {
                return i13;
            }
    ...
    public static int getTag(int i11) {
        return decodeTag(i11);
    }

    public static int getTagNo(int i11) {
