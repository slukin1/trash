...
public interface MiscObjectIdentifiers {
    ...
    static {
        ...
        netscapeRenewalURL = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        netscapeCApolicyURL = aSN1ObjectIdentifier.branch("8");
        netscapeSSLServerName = aSN1ObjectIdentifier.branch("12");
        netscapeCertComment = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = new ASN1ObjectIdentifier("2.16.840.1.113733.1");
        verisign = aSN1ObjectIdentifier2;
        verisignCzagExtension = aSN1ObjectIdentifier2.branch(ae.AFInAppEventType);
