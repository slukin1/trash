...
public class IDEACBCPar extends ASN1Object {
    ...
    public ASN1OctetString f59051iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f59051iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f59051iv = new DEROctetString(Arrays.clone(bArr));
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f59051iv;
