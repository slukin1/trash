...
public class ScryptParams extends ASN1Object {
    ...
    public ScryptParams(byte[] bArr, int i11, int i12, int i13) {
        this(bArr, BigInteger.valueOf((long) i11), BigInteger.valueOf((long) i12), BigInteger.valueOf((long) i13), (BigInteger) null);
    }

    public ScryptParams(byte[] bArr, int i11, int i12, int i13, int i14) {
        this(bArr, BigInteger.valueOf((long) i11), BigInteger.valueOf((long) i12), BigInteger.valueOf((long) i13), BigInteger.valueOf((long) i14));
    }
