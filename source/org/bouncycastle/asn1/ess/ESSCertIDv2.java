...
public class ESSCertIDv2 extends ASN1Object {
    ...
    private ESSCertIDv2(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() <= 3) {
            ...
            int i12 = i11 + 1;
            this.certHash = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i11).toASN1Primitive()).getOctets();
            if (aSN1Sequence.size() > i12) {
                this.issuerSerial = IssuerSerial.getInstance(aSN1Sequence.getObjectAt(i12));
                return;
            }
            return;
        }
