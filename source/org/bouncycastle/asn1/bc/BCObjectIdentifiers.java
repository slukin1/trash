...
public interface BCObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier f59034bc;
    ...
    static {
        ...
        xmss_SHA256 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        xmss_SHA512 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        xmss_SHAKE128 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        xmss_mt_SHA256 = branch13.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        xmss_mt_SHA512 = branch13.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        ASN1ObjectIdentifier branch16 = branch13.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        qTESLA_Rnd1_p_III = branch18.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        qTESLA_p_I = branch18.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        qTESLA_p_III = branch18.branch("12");
        ASN1ObjectIdentifier branch19 = branch6.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        ...
        ASN1ObjectIdentifier branch22 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        bc_kem = branch22;
        ...
        mceliece6688128_r3 = branch23.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        mceliece6688128f_r3 = branch23.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        mceliece6960119_r3 = branch23.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        mceliece6960119f_r3 = branch23.branch("8");
        mceliece8192128_r3 = branch23.branch("9");
        mceliece8192128f_r3 = branch23.branch(CouponReturn.TYPE_EXPERIENCE);
        ...
        frodokem43088r3 = branch24.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        frodokem43088shaker3 = branch24.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        ...
        saberkem192r3 = branch25.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        firesaberkem192r3 = branch25.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        lightsaberkem256r3 = branch25.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
