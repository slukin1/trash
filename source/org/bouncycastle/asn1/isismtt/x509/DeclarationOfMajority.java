...
public class DeclarationOfMajority extends ASN1Object implements ASN1Choice {
    ...
    public DeclarationOfMajority(int i11) {
        this.declaration = new DERTaggedObject(false, 0, (ASN1Encodable) new ASN1Integer((long) i11));
    }
    ...
    public DeclarationOfMajority(boolean z11, String str) {
        if (str.length() > 2) {
