...
public interface ISISMTTObjectIdentifiers {
    ...
    static {
        ...
        id_isismtt_at_declarationOfMajority = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_isismtt_at_iCCSN = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_isismtt_at_PKReference = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_isismtt_at_restriction = branch2.branch("8");
        id_isismtt_at_retrieveIfAllowed = branch2.branch("9");
        id_isismtt_at_requestedCertificate = branch2.branch(CouponReturn.TYPE_EXPERIENCE);
        id_isismtt_at_namingAuthorities = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_isismtt_at_certInDirSince = branch2.branch("12");
        id_isismtt_at_certHash = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
