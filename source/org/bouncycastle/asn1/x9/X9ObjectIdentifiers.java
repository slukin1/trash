...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        c2tnb191v1 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        c2tnb191v2 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        c2tnb191v3 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        c2onb191v4 = branch7.branch("8");
        c2onb191v5 = branch7.branch("9");
        c2pnb208w1 = branch7.branch(CouponReturn.TYPE_EXPERIENCE);
        c2tnb239v1 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        c2tnb239v2 = branch7.branch("12");
        c2tnb239v3 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        c2onb239v4 = branch7.branch("14");
        c2onb239v5 = branch7.branch("15");
        c2pnb272w1 = branch7.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
        ...
        prime239v2 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        prime239v3 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        prime256v1 = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        mqvSinglePass_sha1kdf_scheme = aSN1ObjectIdentifier2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
        ...
        dhHybrid2 = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        dhHybridOneFlow = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        mqv2 = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
