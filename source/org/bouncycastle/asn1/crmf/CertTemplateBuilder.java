...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int i11, boolean z11, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z11, i11, aSN1Encodable));
        }
    }
    ...
    public CertTemplateBuilder setVersion(int i11) {
        this.version = new ASN1Integer((long) i11);
        return this;
    }
}
