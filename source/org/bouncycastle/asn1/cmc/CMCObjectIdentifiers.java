...
public interface CMCObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_cmc = branch;
        ...
        id_cmc_transactionId = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_cmc_senderNonce = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_cmc_recipientNonce = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        id_cmc_decryptedPOP = branch.branch(CouponReturn.TYPE_EXPERIENCE);
        id_cmc_lraPOPWitness = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_cmc_getCert = branch.branch("15");
        id_cmc_getCRL = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
