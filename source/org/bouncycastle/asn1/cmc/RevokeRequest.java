...
public class RevokeRequest extends ASN1Object {
    ...
    private RevokeRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > i11 && (aSN1Sequence.getObjectAt(i11).toASN1Primitive() instanceof ASN1OctetString)) {
            this.passphrase = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i11));
            i11++;
        }
        if (aSN1Sequence.size() > i11 && (aSN1Sequence.getObjectAt(i11).toASN1Primitive() instanceof ASN1UTF8String)) {
            this.comment = ASN1UTF8String.getInstance(aSN1Sequence.getObjectAt(i11));
        }
    }
