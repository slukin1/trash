...
public interface PKCSObjectIdentifiers {
    ...
    static {
        ...
        sha1WithRSAEncryption = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        srsaOAEPEncryptionSET = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_RSAES_OAEP = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_mgf1 = aSN1ObjectIdentifier.branch("8");
        id_pSpecified = aSN1ObjectIdentifier.branch("9");
        id_RSASSA_PSS = aSN1ObjectIdentifier.branch(CouponReturn.TYPE_EXPERIENCE);
        sha256WithRSAEncryption = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        sha384WithRSAEncryption = aSN1ObjectIdentifier.branch("12");
        sha512WithRSAEncryption = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        sha224WithRSAEncryption = aSN1ObjectIdentifier.branch("14");
        sha512_224WithRSAEncryption = aSN1ObjectIdentifier.branch("15");
        sha512_256WithRSAEncryption = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
        String str = BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN;
        ...
        pbeWithMD5AndRC2_CBC = aSN1ObjectIdentifier3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        pbeWithSHA1AndDES_CBC = aSN1ObjectIdentifier3.branch(CouponReturn.TYPE_EXPERIENCE);
        pbeWithSHA1AndRC2_CBC = aSN1ObjectIdentifier3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_PBKDF2 = aSN1ObjectIdentifier3.branch("12");
        id_PBES2 = aSN1ObjectIdentifier3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        ...
        des_EDE3_CBC = aSN1ObjectIdentifier4.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        md5 = aSN1ObjectIdentifier5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_hmacWithSHA1 = aSN1ObjectIdentifier5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP).intern();
        id_hmacWithSHA224 = aSN1ObjectIdentifier5.branch("8").intern();
        id_hmacWithSHA256 = aSN1ObjectIdentifier5.branch("9").intern();
        id_hmacWithSHA384 = aSN1ObjectIdentifier5.branch(CouponReturn.TYPE_EXPERIENCE).intern();
        id_hmacWithSHA512 = aSN1ObjectIdentifier5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP).intern();
        id_hmacWithSHA512_224 = aSN1ObjectIdentifier5.branch("12").intern();
        id_hmacWithSHA512_256 = aSN1ObjectIdentifier5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT).intern();
        ...
        pkcs_9_at_signingTime = aSN1ObjectIdentifier6.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC).intern();
        pkcs_9_at_counterSignature = aSN1ObjectIdentifier6.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL).intern();
        pkcs_9_at_challengePassword = aSN1ObjectIdentifier6.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP).intern();
        ...
        pkcs_9_at_signingDescription = aSN1ObjectIdentifier6.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT).intern();
        ...
        id_cti_ets_proofOfApproval = aSN1ObjectIdentifier8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_cti_ets_proofOfCreation = aSN1ObjectIdentifier8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        ...
        id_aa_msgSigDigest = aSN1ObjectIdentifier9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_aa_contentReference = aSN1ObjectIdentifier9.branch(CouponReturn.TYPE_EXPERIENCE);
        id_aa_encrypKeyPref = aSN1ObjectIdentifier9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_aa_signingCertificate = aSN1ObjectIdentifier9.branch("12");
        id_aa_signingCertificateV2 = aSN1ObjectIdentifier9.branch("47");
        id_aa_contentIdentifier = aSN1ObjectIdentifier9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        secretBag = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        safeContentsBag = branch8.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        ...
        pbeWithSHAAnd128BitRC2_CBC = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        pbeWithSHAAnd40BitRC2_CBC = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        pbewithSHAAnd40BitRC2_CBC = branch9.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
    }
}
