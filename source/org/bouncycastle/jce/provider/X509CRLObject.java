...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f59366c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (this.f59366c.getSignatureAlgorithm().equals(this.f59366c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f59366c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f59366c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f59366c.equals(x509CRLObject.f59366c);
        }
        return false;
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f59366c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f59366c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f59366c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f59366c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f59366c.getNextUpdate() != null) {
            return this.f59366c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f59366c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f59366c.getSignature().getOctets();
    }

    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f59366c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f59366c.getThisUpdate().getDate();
    }

    public int getVersion() {
        return this.f59366c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f59366c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f59366c.getIssuer();
