...
class RFC3280CertPathUtilities {
    ...
    private static void checkCRL(PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, DistributionPoint distributionPoint, PKIXExtendedParameters pKIXExtendedParameters, Date date, Date date2, X509Certificate x509Certificate, X509Certificate x509Certificate2, PublicKey publicKey, CertStatus certStatus, ReasonsMask reasonsMask, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException, RecoverableCertPathValidatorException {
        ...
        if (date2.getTime() <= date.getTime()) {
            Iterator it3 = CertPathValidatorUtilities.getCompleteCRLs(pKIXCertRevocationCheckerParameters, distributionPoint2, x509Certificate3, pKIXExtendedParameters2, date3).iterator();
            boolean z11 = false;
            e = null;
    ...
    public static PKIXPolicyNode prepareCertB(CertPath certPath, int i11, List[] listArr, PKIXPolicyNode pKIXPolicyNode, int i12) throws CertPathValidatorException {
        boolean z11;
        CertPath certPath2 = certPath;
        int i13 = i11;
        List[] listArr2 = listArr;
        List<? extends Certificate> certificates = certPath.getCertificates();
        X509Certificate x509Certificate = (X509Certificate) certificates.get(i13);
        int size = certificates.size() - i13;
        try {
            ...
            boolean z12 = false;
            for (int i14 = 0; i14 < instance.size(); i14++) {
                ASN1Sequence aSN1Sequence = (ASN1Sequence) instance.getObjectAt(i14);
                        ...
                        while (true) {
                            ...
                            if ("2.5.29.32.0".equals(pKIXPolicyNode4.getValidPolicy())) {
                                ...
                                try {
                                        ...
                                        try {
                                            ...
                                            if ("2.5.29.32.0".equals(instance2.getPolicyIdentifier().getId())) {
                                                try {
                                                    ...
                                                    throw new ExtCertPathValidatorException("Policy qualifier info set could not be decoded.", e11, certPath2, i13);
                                                }
                                            }
                                        } catch (Exception e12) {
                                            throw new CertPathValidatorException("Policy information could not be decoded.", e12, certPath2, i13);
                                        }
                                    }
                                    Set set2 = set;
                                    boolean contains = x509Certificate.getCriticalExtensionOIDs() != null ? x509Certificate.getCriticalExtensionOIDs().contains(CERTIFICATE_POLICIES) : z12;
                                    ...
                                    throw new ExtCertPathValidatorException("Certificate policies extension could not be decoded.", e13, certPath2, i13);
                                }
                            }
                        }
                    }
                    ...
                    while (it4.hasNext()) {
                        ...
                        if (pKIXPolicyNode8.getValidPolicy().equals(str)) {
                            ...
                            for (int i15 = size - 1; i15 >= 0; i15--) {
                                List list = listArr2[i15];
                                PKIXPolicyNode pKIXPolicyNode9 = pKIXPolicyNode2;
                                for (int i16 = 0; i16 < list.size(); i16++) {
                                    PKIXPolicyNode pKIXPolicyNode10 = (PKIXPolicyNode) list.get(i16);
            ...
            throw new ExtCertPathValidatorException("Policy mappings extension could not be decoded.", e14, certPath2, i13);
        }
    }

    public static void prepareNextCertA(CertPath certPath, int i11) throws CertPathValidatorException {
        try {
            ASN1Sequence instance = ASN1Sequence.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i11), POLICY_MAPPINGS));
            if (instance != null) {
                int i12 = 0;
                while (i12 < instance.size()) {
                    try {
                        ASN1Sequence instance2 = ASN1Sequence.getInstance(instance.getObjectAt(i12));
                        ...
                        if ("2.5.29.32.0".equals(instance3.getId())) {
                            throw new CertPathValidatorException("IssuerDomainPolicy is anyPolicy", (Throwable) null, certPath, i11);
                        } else if (!"2.5.29.32.0".equals(instance4.getId())) {
                            i12++;
                        } else {
                            throw new CertPathValidatorException("SubjectDomainPolicy is anyPolicy", (Throwable) null, certPath, i11);
                        }
                    } catch (Exception e11) {
    ...
    public static void prepareNextCertG(CertPath certPath, int i11, PKIXNameConstraintValidator pKIXNameConstraintValidator) throws CertPathValidatorException {
        try {
            ASN1Sequence instance = ASN1Sequence.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i11), NAME_CONSTRAINTS));
            ...
            if (instance2 != null) {
                ...
                if (excludedSubtrees != null) {
                    int i12 = 0;
                    while (i12 != excludedSubtrees.length) {
                        try {
    ...
    public static int prepareNextCertI1(CertPath certPath, int i11, int i12) throws CertPathValidatorException {
        try {
            ASN1Sequence instance = ASN1Sequence.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i11), POLICY_CONSTRAINTS));
            if (instance != null) {
    ...
    public static int prepareNextCertI2(CertPath certPath, int i11, int i12) throws CertPathValidatorException {
        try {
            ASN1Sequence instance = ASN1Sequence.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i11), POLICY_CONSTRAINTS));
            if (instance != null) {
                Enumeration objects = instance.getObjects();
    ...
    public static void prepareNextCertK(CertPath certPath, int i11) throws CertPathValidatorException {
        try {
            BasicConstraints instance = BasicConstraints.getInstance(CertPathValidatorUtilities.getExtensionValue((X509Certificate) certPath.getCertificates().get(i11), BASIC_CONSTRAINTS));
            if (instance == null) {
                throw new CertPathValidatorException("Intermediate certificate lacks BasicConstraints", (Throwable) null, certPath, i11);
            } else if (!instance.isCA()) {
                throw new CertPathValidatorException("Not a CA certificate", (Throwable) null, certPath, i11);
            }
        } catch (Exception e11) {
    ...
    public static int prepareNextCertL(CertPath certPath, int i11, int i12) throws CertPathValidatorException {
        ...
        throw new ExtCertPathValidatorException("Max path length not greater than zero", (Throwable) null, certPath, i11);
    }
    ...
    public static void prepareNextCertN(CertPath certPath, int i11) throws CertPathValidatorException {
        ...
        if (keyUsage.length <= 5 || !keyUsage[5]) {
            throw new ExtCertPathValidatorException("Issuer certificate keyusage extension is critical and does not permit key signing.", (Throwable) null, certPath, i11);
        }
    }
    ...
    public static void prepareNextCertO(CertPath certPath, int i11, Set set, List list) throws CertPathValidatorException {
        ...
        if (!set.isEmpty()) {
            throw new ExtCertPathValidatorException("Certificate has unsupported critical extension: " + set, (Throwable) null, certPath, i11);
        }
    }
                ...
                if (instance.getDistributionPoint() != null) {
                    ...
                    if (distributionPoint.getDistributionPoint() != null) {
                        ...
                        if (distributionPoint3.getType() == 1) {
                            ...
                            for (int i11 = 0; i11 < generalNameArr2.length; i11++) {
                                Enumeration objects2 = ASN1Sequence.getInstance(generalNameArr2[i11].getName().toASN1Primitive()).getObjects();
                                ASN1EncodableVector aSN1EncodableVector2 = new ASN1EncodableVector();
                                while (objects2.hasMoreElements()) {
                                    aSN1EncodableVector2.add((ASN1Encodable) objects2.nextElement());
                                }
                                aSN1EncodableVector2.add(distributionPoint3.getName());
                                generalNameArr2[i11] = new GeneralName(X500Name.getInstance(new DERSequence(aSN1EncodableVector2)));
                            }
                        }
                        if (generalNameArr2 != null) {
                            int i12 = 0;
                            while (true) {
                                if (i12 >= generalNameArr2.length) {
                                    break;
                                } else if (arrayList.contains(generalNameArr2[i12])) {
                                    z11 = true;
                                    break;
                                } else {
                                    i12++;
    ...
    public static void processCertA(CertPath certPath, PKIXExtendedParameters pKIXExtendedParameters, Date date, PKIXCertRevocationChecker pKIXCertRevocationChecker, int i11, PublicKey publicKey, boolean z11, X500Name x500Name, X509Certificate x509Certificate) throws CertPathValidatorException {
        CertPath certPath2 = certPath;
        PKIXCertRevocationChecker pKIXCertRevocationChecker2 = pKIXCertRevocationChecker;
        int i12 = i11;
        X500Name x500Name2 = x500Name;
        X509Certificate x509Certificate2 = (X509Certificate) certPath.getCertificates().get(i12);
        if (!z11) {
            try {
                CertPathValidatorUtilities.verifyX509Certificate(x509Certificate2, publicKey, pKIXExtendedParameters.getSigProvider());
            } catch (GeneralSecurityException e11) {
                throw new ExtCertPathValidatorException("Could not validate certificate signature.", e11, certPath, i12);
            }
        } else {
        ...
        try {
            Date date2 = date;
            Date validCertDateFromValidityModel = CertPathValidatorUtilities.getValidCertDateFromValidityModel(date, pKIXExtendedParameters.getValidityModel(), certPath, i12);
            try {
                x509Certificate2.checkValidity(validCertDateFromValidityModel);
                if (pKIXCertRevocationChecker2 != null) {
                    pKIXCertRevocationChecker2.initialize(new PKIXCertRevocationCheckerParameters(pKIXExtendedParameters, validCertDateFromValidityModel, certPath, i11, x509Certificate, publicKey));
                ...
                if (!issuerPrincipal.equals(x500Name2)) {
                    throw new ExtCertPathValidatorException("IssuerName(" + issuerPrincipal + ") does not match SubjectName(" + x500Name2 + ") of signing certificate.", (Throwable) null, certPath, i12);
                }
            } catch (CertificateExpiredException e12) {
                CertificateExpiredException certificateExpiredException = e12;
                throw new ExtCertPathValidatorException("Could not validate certificate: " + certificateExpiredException.getMessage(), certificateExpiredException, certPath, i12);
            } catch (CertificateNotYetValidException e13) {
                CertificateNotYetValidException certificateNotYetValidException = e13;
                throw new ExtCertPathValidatorException("Could not validate certificate: " + certificateNotYetValidException.getMessage(), certificateNotYetValidException, certPath, i12);
            }
        } catch (AnnotatedException e14) {
            throw new ExtCertPathValidatorException("Could not validate time of certificate.", e14, certPath, i12);
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        int i13 = 0;
                        int i14 = 0;
                        while (i14 != rDNs.length) {
                            GeneralName generalName = new GeneralName(1, ((ASN1String) rDNs[i14].getFirst().getValue()).getString());
                            try {
        ...
        try {
            ...
            while (objects.hasMoreElements()) {
                ...
                if (!"2.5.29.32.0".equals(policyIdentifier.getId())) {
                    try {
                        ...
                        if (!CertPathValidatorUtilities.processCertD1i(i14, listArr2, policyIdentifier, qualifierSet)) {
                            CertPathValidatorUtilities.processCertD1ii(i14, listArr2, policyIdentifier, qualifierSet);
                        }
                    } catch (CertPathValidatorException e11) {
                        throw new ExtCertPathValidatorException("Policy qualifier info set could not be build.", e11, certPath2, i13);
                    }
                }
            }
                        ...
                        for (int i15 = 0; i15 < list.size(); i15++) {
                            ...
                            for (Object next2 : pKIXPolicyNode2.getExpectedPolicies()) {
                                ...
                                if (!z12) {
                                    ...
                                    PKIXPolicyNode pKIXPolicyNode4 = new PKIXPolicyNode(new ArrayList(), i14, hashSet3, pKIXPolicyNode2, qualifierSet2, str, false);
                                    pKIXPolicyNode2.addChild(pKIXPolicyNode3);
                                    listArr2[i14].add(pKIXPolicyNode3);
                                }
                            }
                        }
                    }
            ...
            for (int i16 = i14 - 1; i16 >= 0; i16--) {
                ...
                for (int i17 = 0; i17 < list2.size(); i17++) {
                    PKIXPolicyNode pKIXPolicyNode6 = (PKIXPolicyNode) list2.get(i17);
            ...
            if (criticalExtensionOIDs != null) {
                ...
                List list3 = listArr2[i14];
                for (int i18 = 0; i18 < list3.size(); i18++) {
                    ((PKIXPolicyNode) list3.get(i18)).setCritical(contains);
                }
            }
            return pKIXPolicyNode5;
        } catch (AnnotatedException e12) {
            throw new ExtCertPathValidatorException("Could not read certificate policies extension from certificate.", e12, certPath2, i13);
        }
    }
    ...
    public static void processCertF(CertPath certPath, int i11, PKIXPolicyNode pKIXPolicyNode, int i12) throws CertPathValidatorException {
        if (i12 <= 0 && pKIXPolicyNode == null) {
            throw new ExtCertPathValidatorException("No valid policy tree found when one expected.", (Throwable) null, certPath, i11);
        }
    }
        ...
        if (pKIXPolicyNode != null) {
            if (!CertPathValidatorUtilities.isAnyPolicy(set)) {
                ...
                if (!set2.isEmpty()) {
                    ...
                    throw new ExtCertPathValidatorException("Explicit policy requested but none available.", (Throwable) null, certPath, i11);
                }
            }
            return pKIXPolicyNode;
        } else if (!pKIXExtendedParameters.isExplicitPolicyRequired()) {
