...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f59365c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f59365c.equals(((X509CRLEntryObject) obj).f59365c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f59365c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f59365c.getRevocationDate().getDate();
    }

    public BigInteger getSerialNumber() {
        return this.f59365c.getUserCertificate().getValue();
    }

    public boolean hasExtensions() {
        return this.f59365c.getExtensions() != null;
    }
