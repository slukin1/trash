...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String[] DIGESTS = {"GOST3411", "Keccak", "MD2", "MD4", FileTool.HASH_TYPE_MD5, FileTool.HASH_TYPE_SHA1, "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool", "Blake2b", "Blake2s", "DSTU7564", "Haraka", "Blake3"};
    ...
    private static final String[] SYMMETRIC_CIPHERS = {b.f40261d, "ARC4", "ARIA", "Blowfish", "Camellia", "CAST5", "CAST6", "ChaCha", "DES", "DESede", "GOST28147", "Grainv1", "Grain128", "HC128", "HC256", "IDEA", "Noekeon", "RC2", "RC5", "RC6", "Rijndael", "Salsa20", "SEED", "Serpent", "Shacal2", "Skipjack", "SM4", "TEA", "Twofish", "Threefish", "VMPC", "VMPCKSA3", "XTEA", "XSalsa20", "OpenSSLPBKDF", "DSTU7624", "GOST3412_2015", "Zuc"};
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int i11 = 0; i11 != strArr.length; i11++) {
            Class loadClass = ClassUtil.loadClass(BouncyCastleProvider.class, str + strArr[i11] + "$Mappings");
            if (loadClass != null) {
                try {
