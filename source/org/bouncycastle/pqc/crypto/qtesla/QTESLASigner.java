...
public class QTESLASigner implements MessageSigner {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (z11) {
            ...
            this.publicKey = null;
            i11 = this.privateKey.getSecurityCategory();
        } else {
            ...
            i11 = qTESLAPublicKeyParameters.getSecurityCategory();
        }
        QTESLASecurityCategory.validate(i11);
    }
    ...
    public boolean verifySignature(byte[] bArr, byte[] bArr2) {
        ...
        if (securityCategory == 5) {
            i11 = QTesla1p.verifying(bArr, bArr2, 0, bArr2.length, this.publicKey.getPublicData());
        } else if (securityCategory == 6) {
            i11 = QTesla3p.verifying(bArr, bArr2, 0, bArr2.length, this.publicKey.getPublicData());
        } else {
