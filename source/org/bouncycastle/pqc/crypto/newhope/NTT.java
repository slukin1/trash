...
class NTT {
    ...
    public static void core(short[] sArr, short[] sArr2) {
        for (int i11 = 0; i11 < 10; i11 += 2) {
            ...
            for (int i13 = 0; i13 < i12; i13++) {
                ...
                int i15 = i13;
                while (i15 < 1023) {
                    short s11 = sArr[i15] & Constants.PROTOCOL_NONE;
                    int i16 = i15 + i12;
                    short s12 = sArr[i16] & Constants.PROTOCOL_NONE;
                    int i17 = i14 + 1;
                    short s13 = sArr2[i14];
                    sArr[i15] = (short) (s11 + s12);
                    sArr[i16] = Reduce.montgomery(s13 * ((s11 + 36867) - s12));
                    i15 += i12 * 2;
                    i14 = i17;
                }
            }
            ...
            for (int i19 = 0; i19 < i18; i19++) {
                ...
                int i22 = i19;
                while (i22 < 1023) {
                    short s14 = sArr[i22] & Constants.PROTOCOL_NONE;
                    int i23 = i22 + i18;
                    short s15 = sArr[i23] & Constants.PROTOCOL_NONE;
                    int i24 = i21 + 1;
                    short s16 = sArr2[i21];
                    sArr[i22] = Reduce.barrett((short) (s14 + s15));
                    sArr[i23] = Reduce.montgomery(s16 * ((s14 + 36867) - s15));
                    i22 += i18 * 2;
                    i21 = i24;
                }
            }
    ...
    public static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int i11 = 0; i11 < 1024; i11++) {
            sArr[i11] = Reduce.montgomery((sArr[i11] & Constants.PROTOCOL_NONE) * (65535 & sArr2[i11]));
        }
    }
}
