...
public class GF2Field {
    ...
    public static short multElem(short s11, short s12) {
        ...
        short[] sArr = exps;
        short[] sArr2 = logs;
        return sArr[(sArr2[s11] + sArr2[s12]) % 255];
    }
}
