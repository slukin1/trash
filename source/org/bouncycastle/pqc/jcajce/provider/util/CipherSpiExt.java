...
public abstract class CipherSpiExt extends CipherSpi {
    ...
    public abstract int doFinal(byte[] bArr, int i11, int i12, byte[] bArr2, int i13) throws ShortBufferException, IllegalBlockSizeException, BadPaddingException;
    ...
    public abstract byte[] doFinal(byte[] bArr, int i11, int i12) throws IllegalBlockSizeException, BadPaddingException;
