...
public class RainbowPublicKey extends ASN1Object {
    ...
    public RainbowPublicKey(int i11, short[][] sArr, short[][] sArr2, short[] sArr3) {
        ...
        this.docLength = new ASN1Integer((long) i11);
    ...
    private RainbowPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        for (int i11 = 0; i11 < instance.size(); i11++) {
            this.coeffQuadratic[i11] = ASN1OctetString.getInstance(instance.getObjectAt(i11)).getOctets();
        }
        ...
        for (int i12 = 0; i12 < aSN1Sequence2.size(); i12++) {
            this.coeffSingular[i12] = ASN1OctetString.getInstance(aSN1Sequence2.getObjectAt(i12)).getOctets();
        }
