...
public class GOST28147Engine implements BlockCipher {
    ...
    private void GOST28147Func(int[] iArr, byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        if (this.forEncryption) {
            ...
            while (i15 > 0) {
                i15--;
                int GOST28147_mainStep = i13 ^ GOST28147_mainStep(i14, iArr[i15]);
                i13 = i14;
                i14 = GOST28147_mainStep;
            }
        } else {
            int i19 = 0;
            while (i19 < 8) {
                i19++;
                int i21 = bytesToint;
                bytesToint = bytesToint2 ^ GOST28147_mainStep(bytesToint, iArr[i19]);
                bytesToint2 = i21;
            }
            i13 = bytesToint2;
            i14 = bytesToint;
            ...
            while (i22 < 3) {
                ...
                while (i23 >= 0 && (i22 != 2 || i23 != 0)) {
                    i23--;
                    int GOST28147_mainStep2 = i13 ^ GOST28147_mainStep(i14, iArr[i23]);
                    i13 = i14;
                    i14 = GOST28147_mainStep2;
                }
                i22++;
            }
        }
        intTobytes(i14, bArr2, i12);
        intTobytes(GOST28147_mainStep(i14, iArr[0]) ^ i13, bArr2, i12 + 4);
    }
