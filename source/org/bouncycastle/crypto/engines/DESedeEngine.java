    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        if (iArr == null) {
            ...
            if (this.forEncryption) {
                byte[] bArr4 = bArr3;
                desFunc(iArr, bArr, i11, bArr4, 0);
                byte[] bArr5 = bArr3;
                desFunc(this.workingKey2, bArr5, 0, bArr4, 0);
                desFunc(this.workingKey3, bArr5, 0, bArr2, i12);
            } else {
                byte[] bArr6 = bArr3;
                desFunc(this.workingKey3, bArr, i11, bArr6, 0);
                byte[] bArr7 = bArr3;
                desFunc(this.workingKey2, bArr7, 0, bArr6, 0);
                desFunc(this.workingKey1, bArr7, 0, bArr2, i12);
            }
            return 8;
        } else {
