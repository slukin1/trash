...
public class MD5Digest extends GeneralDigest implements EncodableDigest {
    ...
    public int doFinal(byte[] bArr, int i11) {
        finish();
        unpackWord(this.H1, bArr, i11);
        unpackWord(this.H2, bArr, i11 + 4);
        unpackWord(this.H3, bArr, i11 + 8);
        unpackWord(this.H4, bArr, i11 + 12);
        reset();
        return 16;
    }

    public String getAlgorithmName() {
        return FileTool.HASH_TYPE_MD5;
    }
    ...
    public byte[] getEncodedState() {
        ...
        for (int i11 = 0; i11 != this.xOff; i11++) {
            Pack.intToBigEndian(this.X[i11], bArr, (i11 * 4) + 36);
        }
        return bArr;
    }
    ...
    public void processBlock() {
        ...
        int i13 = this.H3;
        int i14 = this.H4;
        int rotateLeft = rotateLeft(((i11 + F(i12, i13, i14)) + this.X[0]) - 680876936, 7) + i12;
        int rotateLeft2 = rotateLeft(((i14 + F(rotateLeft, i12, i13)) + this.X[1]) - 389564586, 12) + rotateLeft;
        int rotateLeft3 = rotateLeft(i13 + F(rotateLeft2, rotateLeft, i12) + this.X[2] + 606105819, 17) + rotateLeft2;
        int rotateLeft4 = rotateLeft(((i12 + F(rotateLeft3, rotateLeft2, rotateLeft)) + this.X[3]) - 1044525330, 22) + rotateLeft3;
