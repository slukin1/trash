...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int FF4 = FF4(i11, i12, i13, i14, this.X[5], 8);
        int FF42 = FF4(i14, FF4, i12, i13, this.X[14], 9);
        int FF43 = FF4(i13, FF42, FF4, i12, this.X[7], 9);
        int FF44 = FF4(i12, FF43, FF42, FF4, this.X[0], 11);
