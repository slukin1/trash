...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    private void unpackWord(int i11, byte[] bArr, int i12) {
        bArr[i12] = (byte) i11;
    ...
    public int doFinal(byte[] bArr, int i11) {
        finish();
        unpackWord(this.H0, bArr, i11);
        unpackWord(this.H1, bArr, i11 + 4);
        unpackWord(this.H2, bArr, i11 + 8);
        unpackWord(this.H3, bArr, i11 + 12);
        unpackWord(this.H4, bArr, i11 + 16);
        unpackWord(this.H5, bArr, i11 + 20);
        unpackWord(this.H6, bArr, i11 + 24);
        unpackWord(this.H7, bArr, i11 + 28);
        unpackWord(this.H8, bArr, i11 + 32);
        unpackWord(this.H9, bArr, i11 + 36);
        reset();
        return 40;
    }
    ...
    public void processBlock() {
        ...
        int i19 = this.H8;
        int i21 = this.H9;
        int RL = RL(i11 + f1(i12, i13, i14) + this.X[0], 11) + i15;
        int RL2 = RL(i13, 10);
        int RL3 = RL(i15 + f1(RL, i12, RL2) + this.X[1], 14) + i14;
        int RL4 = RL(i12, 10);
        int RL5 = RL(i14 + f1(RL3, RL, RL4) + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i16 + f5(i17, i18, i19) + this.X[5] + 1352829926, 8) + i21;
        int RL34 = RL(i18, 10);
        int RL35 = RL(i21 + f5(RL33, i17, RL34) + this.X[14] + 1352829926, 9) + i19;
        int RL36 = RL(i17, 10);
        int RL37 = RL(i19 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
    ...
    public void processWord(byte[] bArr, int i11) {
        ...
        int i13 = i12 + 1;
        this.xOff = i13;
        iArr[i12] = ((bArr[i11 + 3] & 255) << Ascii.CAN) | (bArr[i11] & 255) | ((bArr[i11 + 1] & 255) << 8) | ((bArr[i11 + 2] & 255) << 16);
        if (i13 == 16) {
            processBlock();
        }
    }
