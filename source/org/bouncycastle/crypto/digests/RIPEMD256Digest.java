...
public class RIPEMD256Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int i17 = this.H6;
        int i18 = this.H7;
        int F1 = F1(i11, i12, i13, i14, this.X[0], 11);
        int F12 = F1(i14, F1, i12, i13, this.X[1], 14);
        int F13 = F1(i13, F12, F1, i12, this.X[2], 15);
        int F14 = F1(i12, F13, F12, F1, this.X[3], 12);
        ...
        int FF4 = FF4(i15, i16, i17, i18, this.X[5], 8);
        int FF42 = FF4(i18, FF4, i16, i17, this.X[14], 9);
        int FF43 = FF4(i17, FF42, FF4, i16, this.X[7], 9);
        int FF44 = FF4(i16, FF43, FF42, FF4, this.X[0], 11);
