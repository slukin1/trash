...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    private void addTo(byte[] bArr, byte[] bArr2) {
        ...
        for (int i11 = 1; i11 <= bArr2.length; i11++) {
            int i12 = (bArr[bArr.length - i11] & 255) + (bArr2[bArr2.length - i11] & 255) + b11;
            b11 = i12 > 255 ? (byte) 1 : 0;
            bArr[bArr.length - i11] = (byte) i12;
        }
        for (int length = bArr2.length + 1; length <= bArr.length; length++) {
            int i13 = (bArr[bArr.length - length] & 255) + b11;
            b11 = i13 > 255 ? (byte) 1 : 0;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z11) {
        ...
        if (length > 262144) {
            ...
            addTo(this._V, new byte[]{(byte) ((int) (j11 >> 24)), (byte) ((int) (j11 >> 16)), (byte) ((int) (j11 >> 8)), (byte) ((int) j11)});
            this._reseedCounter++;
