...
public final class CryptoServicesRegistrar {
    ...
    public static <T> T getSizedProperty(Property property, int i11) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (i12 != lookupProperty.length) {
                T t11 = (DHParameters) lookupProperty[i12];
                if (t11.getP().bitLength() == i11) {
                    return t11;
                }
                i12++;
            }
            ...
            while (i12 != lookupProperty.length) {
                T t12 = (DSAParameters) lookupProperty[i12];
                if (t12.getP().bitLength() == i11) {
                    return t12;
                }
                i12++;
            }
