...
public class DESExample {
    ...
    private BufferedInputStream f59190in;
    private byte[] key;
    ...
    public DESExample(java.lang.String r7, java.lang.String r8, java.lang.String r9, boolean r10) {
        /*
            ...
            r6.f59190in = r3     // Catch:{ FileNotFoundException -> 0x0020 }
            goto L_0x003c
        L_0x0020:
    ...
    private void performDecrypt(byte[] bArr) {
        ...
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(this.f59190in));
        byte[] bArr2 = null;
        while (true) {
            try {
    ...
    private void performEncrypt(byte[] bArr) {
        ...
        while (true) {
            try {
                int read = this.f59190in.read(bArr2, 0, 47);
                if (read > 0) {
