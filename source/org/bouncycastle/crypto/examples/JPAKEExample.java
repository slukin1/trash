...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        BigInteger p11 = jPAKEPrimeOrderGroup.getP();
        BigInteger q11 = jPAKEPrimeOrderGroup.getQ();
        BigInteger g11 = jPAKEPrimeOrderGroup.getG();
        System.out.println("********* Initialization **********");
        System.out.println("Public parameters for the cyclic group:");
        PrintStream printStream = System.out;
        printStream.println("p (" + p11.bitLength() + " bits): " + p11.toString(16));
        PrintStream printStream2 = System.out;
        printStream2.println("q (" + q11.bitLength() + " bits): " + q11.toString(16));
        PrintStream printStream3 = System.out;
        printStream3.println("g (" + p11.bitLength() + " bits): " + g11.toString(16));
        PrintStream printStream4 = System.out;
        StringBuilder sb2 = new StringBuilder();
        sb2.append("p mod q = ");
        sb2.append(p11.mod(q11).toString(16));
        printStream4.println(sb2.toString());
        PrintStream printStream5 = System.out;
        printStream5.println("g^{q} mod p = " + g11.modPow(q11, p11).toString(16));
        System.out.println("");
        PrintStream printStream6 = System.out;
        printStream6.println("(Secret passwords used by Alice and Bob: \"" + MTCoreConstants.Register.KEY_PASSWORD + "\" and \"" + MTCoreConstants.Register.KEY_PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup2 = jPAKEPrimeOrderGroup;
        SHA256Digest sHA256Digest2 = sHA256Digest;
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", MTCoreConstants.Register.KEY_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", MTCoreConstants.Register.KEY_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
