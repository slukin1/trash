...
public class ChaCha20Poly1305 implements AEADCipher {
    ...
    private long incrementCount(long j11, int i11, long j12) {
        long j13 = (long) i11;
        ...
        if (i11 >= 0) {
            ...
            if (i13 == 3) {
                ...
                if (i11 <= bArr.length - i12) {
                    if (i14 > 0) {
                        processData(this.buf, 0, i14, bArr, i11);
                        this.poly1305.update(bArr, i11, this.bufPos);
                    }
                    finishData(4);
                    System.arraycopy(this.mac, 0, bArr, i11 + this.bufPos, 16);
                } else {
                    throw new OutputLengthException("Output buffer too short");
                }
            } else if (i13 == 7) {
                ...
                if (i15 >= 16) {
                    ...
                    if (i11 <= bArr.length - i12) {
                        if (i12 > 0) {
                            this.poly1305.update(this.buf, 0, i12);
                            processData(this.buf, 0, i12, bArr, i11);
                        }
                        finishData(8);
    ...
    public int getOutputSize(int i11) {
        int max = Math.max(0, i11) + this.bufPos;
        int i12 = this.state;
    ...
    public void processAADBytes(byte[] bArr, int i11, int i12) {
        ...
        if (i11 < 0) {
            ...
            checkAAD();
            if (i12 > 0) {
                this.aadCount = incrementCount(this.aadCount, i12, -1);
