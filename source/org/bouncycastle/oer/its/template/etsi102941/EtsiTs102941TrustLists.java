...
public class EtsiTs102941TrustLists {
    ...
    static {
        ...
        EaEntry = typeName7;
        OERDefinition.Builder builder5 = builder3;
        ...
        OERDefinition.Builder builder6 = builder2;
        ...
        OERDefinition.Builder typeName14 = OERDefinition.seq(builder6.label("version"), builder5.label("nextUpdate"), OERDefinition.bool().label("isFullCtl"), OERDefinition.integer(0, 255).label("ctlSequence"), typeName13.label("ctlCommands"), OERDefinition.extension(new Object[0])).typeName("CtlFormat");
