...
public class EccP384CurvePoint extends EccCurvePoint implements ASN1Choice {
    ...
    public EccP384CurvePoint(int i11, ASN1Encodable aSN1Encodable) {
        this.choice = i11;
    ...
    private EccP384CurvePoint(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo != 0) {
            if (tagNo == 1) {
                ...
                if (tagNo == 4) {
                    aSN1Encodable = ASN1Sequence.getInstance(aSN1TaggedObject.getObject());
                } else {
    ...
    public byte[] getEncodedPoint() {
        ...
        if (i11 != 0) {
            if (i11 == 2) {
                ...
                return Arrays.concatenate(new byte[]{4}, ASN1OctetString.getInstance(instance.getObjectAt(0)).getOctets(), ASN1OctetString.getInstance(instance.getObjectAt(1)).getOctets());
            } else {
