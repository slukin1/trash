...
public abstract class DateTimeFieldType implements Serializable {
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MILLIS_OF_DAY_TYPE = new StandardDateTimeFieldType("millisOfDay", (byte) 22, DurationFieldType.millis(), DurationFieldType.days());
    public static final byte MILLIS_OF_SECOND = 23;
    /* access modifiers changed from: private */
    public static final DateTimeFieldType MILLIS_OF_SECOND_TYPE = new StandardDateTimeFieldType("millisOfSecond", (byte) 23, DurationFieldType.millis(), DurationFieldType.seconds());
    ...
    /* access modifiers changed from: private */
    public static final DateTimeFieldType SECOND_OF_MINUTE_TYPE = new StandardDateTimeFieldType("secondOfMinute", (byte) 21, DurationFieldType.seconds(), DurationFieldType.minutes());
    ...
    public static class StandardDateTimeFieldType extends DateTimeFieldType {
        ...
        public StandardDateTimeFieldType(String str, byte b11, DurationFieldType durationFieldType, DurationFieldType durationFieldType2) {
            super(str);
            this.iOrdinal = b11;
        ...
        public DateTimeField getField(Chronology chronology) {
            ...
            switch (this.iOrdinal) {
                case 1:
                    return c11.era();
                case 2:
                    return c11.yearOfEra();
                case 3:
                    return c11.centuryOfEra();
                case 4:
                    return c11.yearOfCentury();
                case 5:
                    return c11.year();
                case 6:
                    return c11.dayOfYear();
                case 7:
                    return c11.monthOfYear();
                case 8:
                    return c11.dayOfMonth();
                case 9:
                    return c11.weekyearOfCentury();
                case 10:
                    return c11.weekyear();
                case 11:
                    return c11.weekOfWeekyear();
                case 12:
                    return c11.dayOfWeek();
                case 13:
                    return c11.halfdayOfDay();
                case 14:
                    return c11.hourOfHalfday();
                case 15:
                    return c11.clockhourOfHalfday();
                case 16:
                    return c11.clockhourOfDay();
                case 17:
                    return c11.hourOfDay();
                case 18:
                    return c11.minuteOfDay();
                case 19:
                    return c11.minuteOfHour();
                case 20:
                    return c11.secondOfDay();
                case 21:
                    return c11.secondOfMinute();
                case 22:
                    return c11.millisOfDay();
                case 23:
                    return c11.millisOfSecond();
                default:
