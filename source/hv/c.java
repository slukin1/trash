...
import com.huobi.woodpecker.kalle.secure.Encryption;
...
public class c implements a {
    ...
    public c(Context context) {
        this.f22803b = d.a(context, "huobi_wp_cache_store");
    }
    ...
    public Cache get(String str) {
        String b11 = this.f22803b.b(d(str), "");
