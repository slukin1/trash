...
public class PlatformChannel {
    ...
    public static class AppSwitcherDescription {
        ...
        public AppSwitcherDescription(int i11, String str) {
            this.color = i11;
            this.label = str;
        }
    }
    ...
    public SystemUiMode decodeSystemUiMode(String str) throws JSONException, NoSuchFieldException {
        int i11 = AnonymousClass2.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$SystemUiMode[SystemUiMode.fromValue(str).ordinal()];
        if (i11 == 1) {
    ...
    public List<SystemUiOverlay> decodeSystemUiOverlays(JSONArray jSONArray) throws JSONException, NoSuchFieldException {
        ...
        for (int i11 = 0; i11 < jSONArray.length(); i11++) {
            int i12 = AnonymousClass2.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$SystemUiOverlay[SystemUiOverlay.fromValue(jSONArray.getString(i11)).ordinal()];
            if (i12 == 1) {
