...
public class PathProviderPlugin implements FlutterPlugin, Messages.PathProviderApi {
    ...
    private void setup(BinaryMessenger binaryMessenger, Context context2) {
        try {
            h.p(binaryMessenger, this);
        } catch (Exception e11) {
            Log.e(TAG, "Received exception while setting up PathProviderPlugin", e11);
        }
    ...
    public void onDetachedFromEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        h.p(flutterPluginBinding.getBinaryMessenger(), (Messages.PathProviderApi) null);
    }
}
