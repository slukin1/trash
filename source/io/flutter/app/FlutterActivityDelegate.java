...
public final class FlutterActivityDelegate implements FlutterActivityEvents, FlutterView.Provider, PluginRegistry {
    ...
    public boolean onActivityResult(int i11, int i12, Intent intent) {
        return this.flutterView.getPluginRegistry().onActivityResult(i11, i12, intent);
    }
    ...
    public boolean onRequestPermissionsResult(int i11, String[] strArr, int[] iArr) {
        return this.flutterView.getPluginRegistry().onRequestPermissionsResult(i11, strArr, iArr);
    }
