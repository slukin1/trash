...
final class ObservableMergeWithMaybe$MergeWithObserver<T> extends AtomicInteger implements k<T>, b {
    ...
    public static final class OtherObserver<T> extends AtomicReference<b> implements f<T> {
    ...
    public ObservableMergeWithMaybe$MergeWithObserver(k<? super T> kVar) {
