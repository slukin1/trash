...
final class ObservableConcatMap$ConcatMapDelayErrorObserver<T, R> extends AtomicInteger implements k<T>, b {
    ...
    public static final class DelayErrorInnerObserver<R> extends AtomicReference<b> implements k<R> {
        ...
        public DelayErrorInnerObserver(k<? super R> kVar, ObservableConcatMap$ConcatMapDelayErrorObserver<?, R> observableConcatMap$ConcatMapDelayErrorObserver) {
    ...
    public ObservableConcatMap$ConcatMapDelayErrorObserver(k<? super R> kVar, h<? super T, ? extends j<? extends R>> hVar, int i11, boolean z11) {
        this.downstream = kVar;
        this.mapper = hVar;
        this.bufferSize = i11;
        this.tillTheEnd = z11;
