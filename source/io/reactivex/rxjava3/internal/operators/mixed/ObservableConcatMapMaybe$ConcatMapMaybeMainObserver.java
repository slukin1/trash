...
final class ObservableConcatMapMaybe$ConcatMapMaybeMainObserver<T, R> extends AtomicInteger implements k<T>, b {
    ...
    public static final class ConcatMapMaybeObserver<R> extends AtomicReference<b> implements f<R> {
    ...
    public ObservableConcatMapMaybe$ConcatMapMaybeMainObserver(k<? super R> kVar, h<? super T, ? extends g<? extends R>> hVar, int i11, ErrorMode errorMode2) {
