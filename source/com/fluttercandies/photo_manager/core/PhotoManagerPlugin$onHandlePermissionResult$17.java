...
public final class PhotoManagerPlugin$onHandlePermissionResult$17 extends Lambda implements a<Unit> {
    ...
    public PhotoManagerPlugin$onHandlePermissionResult$17(MethodCall methodCall, PhotoManagerPlugin photoManagerPlugin, e eVar) {
        super(0);
    ...
    public final void invoke() {
        try {
            ...
            b y11 = this.this$0.f65026g.y(str, str2, str3, str4);
            if (y11 == null) {
                this.$resultHandler.h((Object) null);
                return;
            }
            this.$resultHandler.h(com.fluttercandies.photo_manager.core.utils.b.f65118a.c(y11));
        } catch (Exception e11) {
            z4.a.c("save video error", e11);
            this.$resultHandler.h((Object) null);
        }
    }
}
