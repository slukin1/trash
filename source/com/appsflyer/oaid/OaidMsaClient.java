...
class OaidMsaClient {
    public static OaidClient.Info fetchMsa(Context context, final Logger logger, long j11, TimeUnit timeUnit) {
        String str;
        try {
            ...
            String str2 = (String) linkedBlockingQueue.poll(j11, timeUnit);
