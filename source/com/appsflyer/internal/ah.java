...
final class ah extends aw<String> {
    ...
    public java.lang.String AFKeystoreWrapper() {
        /*
            ...
            android.content.Context r2 = r9.values     // Catch:{ all -> 0x0044 }
            ...
            java.lang.String r4 = r9.valueOf     // Catch:{ all -> 0x0044 }
        ...
        L_0x004c:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.ah.AFKeystoreWrapper():java.lang.String");
    }
    ...
    public final /* synthetic */ Object AFInAppEventType() {
        new Thread(this.AFInAppEventParameterName).start();
        return (String) super.AFInAppEventType();
    }
}
