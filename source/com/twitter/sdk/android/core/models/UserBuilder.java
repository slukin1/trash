...
public class UserBuilder {
    ...
    public UserBuilder setDefaultProfile(boolean z11) {
        this.defaultProfile = z11;
        return this;
    }

    public UserBuilder setDefaultProfileImage(boolean z11) {
        this.defaultProfileImage = z11;
        return this;
    }
    ...
    public UserBuilder setFavouritesCount(int i11) {
        this.favouritesCount = i11;
        return this;
    }

    public UserBuilder setFollowRequestSent(boolean z11) {
        this.followRequestSent = z11;
        return this;
    }

    public UserBuilder setFollowersCount(int i11) {
        this.followersCount = i11;
        return this;
    }

    public UserBuilder setFriendsCount(int i11) {
        this.friendsCount = i11;
        return this;
    }

    public UserBuilder setGeoEnabled(boolean z11) {
        this.geoEnabled = z11;
        return this;
    }

    public UserBuilder setId(long j11) {
        this.f51202id = j11;
        return this;
    }
    ...
    public UserBuilder setIsTranslator(boolean z11) {
        this.isTranslator = z11;
        return this;
    }
    ...
    public UserBuilder setListedCount(int i11) {
        this.listedCount = i11;
        return this;
    }
    ...
    public UserBuilder setProfileBackgroundTile(boolean z11) {
        this.profileBackgroundTile = z11;
        return this;
    }
    ...
    public UserBuilder setProfileUseBackgroundImage(boolean z11) {
        this.profileUseBackgroundImage = z11;
        return this;
    }

    public UserBuilder setProtectedUser(boolean z11) {
        this.protectedUser = z11;
        return this;
    }
    ...
    public UserBuilder setShowAllInlineMedia(boolean z11) {
    ...
    public UserBuilder setStatusesCount(int i11) {
    ...
    public UserBuilder setUtcOffset(int i11) {
        this.utcOffset = i11;
        return this;
    }

    public UserBuilder setVerified(boolean z11) {
        this.verified = z11;
        return this;
    }
