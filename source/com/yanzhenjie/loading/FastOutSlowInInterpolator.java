...
public class FastOutSlowInInterpolator implements Interpolator {
    ...
    public float getInterpolation(float f11) {
        ...
        float f12 = this.f52627a;
        return fArr[min] + (((f11 - (((float) min) * f12)) / f12) * (fArr[min + 1] - fArr[min]));
    }
}
