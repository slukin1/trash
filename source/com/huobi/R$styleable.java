...
public final class R$styleable {
    ...
    public static final int[] AirdropView = {R.attr.topicType};
    public static final int AirdropView_topicType = 0;
    ...
    public static final int[] AutoScaleTextView = {R.attr.autoScaleMinTextSize};
    public static final int AutoScaleTextView_autoScaleMinTextSize = 0;
    ...
    public static final int[] AvatarView = {R.attr.account, R.attr.attentionType, R.attr.avatarPath, R.attr.avatarType, R.attr.colorPalette, R.attr.hasLive, R.attr.liveId, R.attr.outlineColor, R.attr.outlineSize, R.attr.textColor, R.attr.uidUnique, R.attr.viewSize};
    public static final int AvatarView_account = 0;
    public static final int AvatarView_attentionType = 1;
    public static final int AvatarView_avatarPath = 2;
    public static final int AvatarView_avatarType = 3;
    public static final int AvatarView_colorPalette = 4;
    public static final int AvatarView_hasLive = 5;
    public static final int AvatarView_liveId = 6;
    public static final int AvatarView_outlineColor = 7;
    public static final int AvatarView_outlineSize = 8;
    public static final int AvatarView_textColor = 9;
    public static final int AvatarView_uidUnique = 10;
    public static final int AvatarView_viewSize = 11;
    ...
    public static final int[] CircleProgress = {R.attr.circleBgColor, R.attr.isShowAnim, R.attr.ringBgColor, R.attr.ringColor, R.attr.ringDiameter, R.attr.ringWidth, R.attr.speed};
    public static final int CircleProgress_circleBgColor = 0;
    public static final int CircleProgress_isShowAnim = 1;
    public static final int CircleProgress_ringBgColor = 2;
    public static final int CircleProgress_ringColor = 3;
    public static final int CircleProgress_ringDiameter = 4;
    public static final int CircleProgress_ringWidth = 5;
    public static final int CircleProgress_speed = 6;
    ...
    public static final int[] CommonToolbar = {R.attr.backgroundColor, R.attr.leftIcon, R.attr.leftIconFilterColor, R.attr.leftIconVisible, R.attr.leftText, R.attr.leftTextColor, R.attr.leftTextSize, R.attr.leftTextVisible, R.attr.rightIcon, R.attr.rightIcon2, R.attr.rightIcon2Visible, R.attr.rightIconFilterColor, R.attr.rightIconVisible, R.attr.rightText, R.attr.rightTextColor, R.attr.rightTextSize, R.attr.rightTextVisible, R.attr.title, R.attr.titleColor, R.attr.titleSize, R.attr.titleVisible};
    public static final int CommonToolbar_backgroundColor = 0;
    public static final int CommonToolbar_leftIcon = 1;
    public static final int CommonToolbar_leftIconFilterColor = 2;
    public static final int CommonToolbar_leftIconVisible = 3;
    public static final int CommonToolbar_leftText = 4;
    public static final int CommonToolbar_leftTextColor = 5;
    public static final int CommonToolbar_leftTextSize = 6;
    public static final int CommonToolbar_leftTextVisible = 7;
    public static final int CommonToolbar_rightIcon = 8;
    public static final int CommonToolbar_rightIcon2 = 9;
    public static final int CommonToolbar_rightIcon2Visible = 10;
    public static final int CommonToolbar_rightIconFilterColor = 11;
    public static final int CommonToolbar_rightIconVisible = 12;
    public static final int CommonToolbar_rightText = 13;
    public static final int CommonToolbar_rightTextColor = 14;
    public static final int CommonToolbar_rightTextSize = 15;
    public static final int CommonToolbar_rightTextVisible = 16;
    public static final int CommonToolbar_title = 17;
    public static final int CommonToolbar_titleColor = 18;
    public static final int CommonToolbar_titleSize = 19;
    public static final int CommonToolbar_titleVisible = 20;
    ...
    public static final int[] CustomWidthSwitch = {R.attr.custom_width};
    ...
    public static final int[] DividerView = {R.attr.dashGap, R.attr.dashLength, R.attr.dashThickness, R.attr.dividerLineColor, R.attr.dividerOrientation};
    ...
    public static final int DividerView_dividerLineColor = 3;
    ...
    public static final int[] FloatLayout = {16842927, 16843091, R.attr.childHorizontalSpacing, R.attr.childVerticalSpacing, R.attr.maxNumber};
    public static final int FloatLayout_android_gravity = 0;
    public static final int FloatLayout_android_maxLines = 1;
    public static final int FloatLayout_childHorizontalSpacing = 2;
    public static final int FloatLayout_childVerticalSpacing = 3;
    public static final int FloatLayout_maxNumber = 4;
    ...
    public static final int[] FollowView = {R.attr.followType};
    public static final int FollowView_followType = 0;
    ...
    public static final int[] GridTradeInputView = {R.attr.grid_trade_input_hint, R.attr.grid_trade_input_text, R.attr.grid_trade_input_title, R.attr.grid_trade_input_unit};
    public static final int GridTradeInputView_grid_trade_input_hint = 0;
    public static final int GridTradeInputView_grid_trade_input_text = 1;
    public static final int GridTradeInputView_grid_trade_input_title = 2;
    public static final int GridTradeInputView_grid_trade_input_unit = 3;
    ...
    public static final int[] HotCoinChartView = {R.attr.pointList, R.attr.xList, R.attr.xTextHeight, R.attr.xTextWidth};
    public static final int HotCoinChartView_pointList = 0;
    public static final int HotCoinChartView_xList = 1;
    public static final int HotCoinChartView_xTextHeight = 2;
    public static final int HotCoinChartView_xTextWidth = 3;
    ...
    public static final int[] JumioFaceAnimation = {R.attr.jumio_face_animation_customization, R.attr.jumio_face_animation_foreground};
    ...
    public static final int[] LiteTradingView = {R.attr.enableHighlight, R.attr.enableInstantPrice, R.attr.strokeWidth};
    public static final int LiteTradingView_enableHighlight = 0;
    public static final int LiteTradingView_enableInstantPrice = 1;
    public static final int LiteTradingView_strokeWidth = 2;
    ...
    public static final int[] MarqueeTextViewStyle = {R.attr.setAnimDuration, R.attr.setDirection, R.attr.setGravity, R.attr.setInterval, R.attr.setLineHeight, R.attr.setMaxLines, R.attr.setSingleLine, R.attr.setTextColor, R.attr.setTextSize, R.attr.setTypeface};
    public static final int MarqueeTextViewStyle_setAnimDuration = 0;
    public static final int MarqueeTextViewStyle_setDirection = 1;
    public static final int MarqueeTextViewStyle_setGravity = 2;
    public static final int MarqueeTextViewStyle_setInterval = 3;
    public static final int MarqueeTextViewStyle_setLineHeight = 4;
    public static final int MarqueeTextViewStyle_setMaxLines = 5;
    public static final int MarqueeTextViewStyle_setSingleLine = 6;
    public static final int MarqueeTextViewStyle_setTextColor = 7;
    public static final int MarqueeTextViewStyle_setTextSize = 8;
    public static final int MarqueeTextViewStyle_setTypeface = 9;
    ...
    public static final int[] NftHexagonView = {R.attr.nftSize, R.attr.normalSize, R.attr.roundRadius};
    public static final int NftHexagonView_nftSize = 0;
    public static final int NftHexagonView_normalSize = 1;
    public static final int NftHexagonView_roundRadius = 2;
    ...
    public static final int[] RoundCornerImageView = {R.attr.corner_radius, R.attr.left_bottom_corner_radius, R.attr.left_bottom_radius, R.attr.left_top_corner_radius, R.attr.left_top_radius, R.attr.right_bottom_corner_radius, R.attr.right_bottom_radius, R.attr.right_top_corner_radius, R.attr.right_top_radius};
    ...
    public static final int[] SNSApplicantDataBoolFieldView = {R.attr.sns_applicantDataBoolFieldLayout, R.attr.sns_applicantDataBoolFieldViewStyle};
    ...
    public static final int[] SNSApplicantDataFieldView = {R.attr.sns_applicantDataFieldLayout, R.attr.sns_applicantDataFieldViewStyle};
    ...
    public static final int[] SNSApplicantDataFileFieldView = {R.attr.sns_applicantDataFileFieldLayout, R.attr.sns_applicantDataFileFieldViewStyle};
    ...
    public static final int[] SNSApplicantDataMutilselectFieldView = {R.attr.sns_applicantDataMutilselectFieldViewLayout, R.attr.sns_applicantDataMutilselectFieldViewStyle};
    ...
    public static final int[] SNSApplicantDataPhoneFieldView = {R.attr.sns_applicantDataPhoneFieldLayout, R.attr.sns_applicantDataPhoneFieldViewStyle};
    ...
    public static final int[] SNSApplicantDataRadioGroupView = {R.attr.sns_applicantDataRadioGroupLayout, R.attr.sns_applicantDataRadioGroupViewStyle};
    ...
    public static final int[] SNSApplicantDataSectionView = {R.attr.sns_applicantDataSectionLayout, R.attr.sns_applicantDataSectionViewStyle};
    ...
    public static final int[] SNSApplicantDataTextAreaFieldView = {R.attr.sns_applicantDataTextAreaFieldLayout, R.attr.sns_applicantDataTextAreaFieldViewStyle};
    ...
    public static final int[] SNSAutoCompleteTextView = {16842964, R.attr.sns_AutoCompleteTextViewStyle};
    ...
    public static final int[] SNSBackgroundConstraintLayout = {16842964, R.attr.sns_BackgroundConstraintLayoutStyle};
    ...
    public static final int[] SNSBackgroundView = {16842964, R.attr.sns_BackgroundViewStyle, R.attr.sns_CameraBackgroundViewStyle};
    ...
    public static final int[] SNSBottomSheetHandleView = {R.attr.sns_BottomSheetHandleStyle};
    public static final int SNSBottomSheetHandleView_sns_BottomSheetHandleStyle = 0;
    public static final int[] SNSBottomSheetView = {16842964, R.attr.backgroundColor, R.attr.sns_BottomSheetViewStyle};
    ...
    public static final int[] SNSCardRadioButton = {R.attr.sns_cardRadioButtonBackgroundColor, R.attr.sns_cardRadioButtonCornerRadius, R.attr.sns_cardRadioButtonStrokeColor, R.attr.sns_cardRadioButtonStrokeWidth, R.attr.sns_cardRadioButtonViewStyle};
    ...
    public static final int[] SNSCheckGroup = {16843049, 16843561, R.attr.sns_CheckGroupStyle, R.attr.sns_checkBackgroundColor};
    ...
    public static final int[] SNSCountrySelectorView = {R.attr.sns_CountrySelectorViewStyle};
    public static final int SNSCountrySelectorView_sns_CountrySelectorViewStyle = 0;
    public static final int[] SNSDateInputLayout = {R.attr.sns_DateInputLayoutStyle};
    public static final int SNSDateInputLayout_sns_DateInputLayoutStyle = 0;
    public static final int[] SNSDateTimeInputLayout = {R.attr.sns_DateTimeInputLayoutStyle};
    public static final int SNSDateTimeInputLayout_sns_DateTimeInputLayoutStyle = 0;
    public static final int[] SNSDotsProgressView = {R.attr.sns_DotsProgressViewStyle, R.attr.sns_dotsProgressDotBackgroundColor, R.attr.sns_dotsProgressDotCompleteColor, R.attr.sns_dotsProgressMinGap};
    ...
    public static final int[] SNSFileItemView = {16842904, R.attr.background, R.attr.boxBackgroundColor, R.attr.boxStrokeColor, R.attr.boxStrokeWidth, R.attr.previewCornerRadius, R.attr.sns_endIconTint, R.attr.sns_fileItemViewLayout, R.attr.sns_fileItemViewStyle, R.attr.sns_startIconTint};
    ...
    public static final int[] SNSFlagView = {R.attr.shapeAppearanceOverlay, R.attr.sns_FlagViewStyle, R.attr.strokeColor, R.attr.strokeWidth};
    ...
    public static final int[] SNSFlaggedInputLayout = {R.attr.sns_FlaggedInputLayoutStyle, R.attr.sns_flagMarginEnd, R.attr.sns_flagMarginStart};
    ...
    public static final int[] SNSFrameView = {R.attr.sns_FrameDrawable, R.attr.sns_FrameFillColor, R.attr.sns_FramePaddingBottom, R.attr.sns_FramePaddingLeft, R.attr.sns_FramePaddingRight, R.attr.sns_FramePaddingTop, R.attr.sns_FrameViewStyle};
    public static final int[] SNSFrameViewWithBackground = {R.attr.snsFrameViewWithBackgroundStyle, R.attr.sns_frameBackgroundColor, R.attr.sns_stateFrameColor, R.attr.sns_stateFrameRadius, R.attr.sns_stateFrameWidth};
    ...
    public static final int[] SNSImageButton = {16842964, 16843041, 16843883, R.attr.sns_ImageButtonStyle};
    ...
    public static final int[] SNSImageView = {16843041, 16843883, R.attr.sns_ImageViewStyle};
    ...
    public static final int[] SNSIntroItemView = {R.attr.sns_IntroItemViewStyle, R.attr.sns_introLivenessItemViewStyle};
    ...
    public static final int[] SNSListItemView = {R.attr.sns_ListItemViewStyle};
    public static final int SNSListItemView_sns_ListItemViewStyle = 0;
    public static final int[] SNSLivenessFaceView = {16842965, 16842966, 16842967, 16842968, 16842969, R.attr.sns_ProofaceCompleteOverlayColor, R.attr.sns_ProofaceMarkerActiveColor, R.attr.sns_ProofaceMarkerInActiveColor, R.attr.sns_ProofaceMarkerPadding, R.attr.sns_ProofaceMarkerSize, R.attr.sns_ProofaceMarkerStroke, R.attr.sns_ProofaceOverlayColor, R.attr.sns_ProofaceRecognizingAnimationSpeed, R.attr.sns_ProofaceRecognizingColor, R.attr.sns_ProofaceRecognizingStroke, R.attr.sns_ProofaceViewStyle};
    ...
    public static final int[] SNSModeratorCommentView = {R.attr.sns_ModeratorCommentViewStyle};
    public static final int SNSModeratorCommentView_sns_ModeratorCommentViewStyle = 0;
    public static final int[] SNSPinView = {16843056, 16843090, R.attr.boxBackgroundColor, R.attr.boxStrokeColor, R.attr.boxStrokeWidth, R.attr.shapeAppearance, R.attr.sns_cursorDrawable, R.attr.sns_itemPadding, R.attr.sns_itemSpacing, R.attr.sns_pinViewStyle};
    ...
    public static final int[] SNSProgressView = {R.attr.shapeAppearance, R.attr.sns_ProgressViewStyle, R.attr.sns_dimColor, R.attr.sns_progressBackgroundColor, R.attr.sns_progressViewLayout};
    ...
    public static final int[] SNSRadioGroup = {16843049, 16843561, R.attr.sns_RadioGroupStyle, R.attr.sns_radioBackgroundColor};
    ...
    public static final int[] SNSRotationZoomableImageView = {R.attr.sns_RotationZoomableImageViewStyle, R.attr.sns_zoomEnabled};
    ...
    public static final int[] SNSSegmentedToggleView = {16842804, R.attr.boxBackgroundColor, R.attr.boxStrokeColor, R.attr.boxStrokeWidth, R.attr.sns_SNSSegmentedToggleViewStyle, R.attr.sns_itemBackgroundColor, R.attr.sns_itemPadding, R.attr.sns_textColor};
    ...
    public static final int[] SNSSelectorItemView = {R.attr.sns_SelectorItemViewStyle};
    public static final int SNSSelectorItemView_sns_SelectorItemViewStyle = 0;
    public static final int[] SNSStepView = {R.attr.elevation, R.attr.sns_StepViewStyle, R.attr.sns_iconEnd, R.attr.sns_iconStart, R.attr.sns_stepBackgroundColor, R.attr.sns_stepIconTintColor, R.attr.sns_stepStrokeColor, R.attr.sns_stepStrokeWidth, R.attr.sns_stepSubtitleTextColor, R.attr.sns_stepTitleTextColor, R.attr.sns_stepViewLayout, R.attr.sns_subtitle, R.attr.sns_title};
    ...
    public static final int[] SNSSupportItemView = {R.attr.sns_SupportItemViewStyle};
    public static final int SNSSupportItemView_sns_SupportItemViewStyle = 0;
    public static final int[] SNSTextButton = {16842804, 16842904, 16842927, 16842964, 16842966, 16842968, 16843072, R.attr.backgroundTint, R.attr.rippleColor, R.attr.sns_TextButtonStyle};
    ...
    public static final int[] SNSTextInputEditText = {R.attr.sns_TextInputEditTextStyle};
    public static final int SNSTextInputEditText_sns_TextInputEditTextStyle = 0;
    public static final int[] SNSTextInputLayout = {R.attr.sns_TextInputLayoutStyle, R.attr.sns_editorBackgroundColor};
    ...
    public static final int[] SNSTextView = {16842804, 16842927, 16842964, 16843121, 16843666, R.attr.sns_BodyTextViewStyle, R.attr.sns_CaptionTextViewStyle, R.attr.sns_H1TextViewStyle, R.attr.sns_H2TextViewStyle, R.attr.sns_RecorderTextViewStyle, R.attr.sns_Subtitle1TextViewStyle, R.attr.sns_Subtitle2PrimaryTextViewStyle, R.attr.sns_Subtitle2TextViewStyle, R.attr.sns_textColor};
    ...
    public static final int[] SNSToolbarView = {R.attr.sns_ToolbarViewStyle, R.attr.sns_iconClose, R.attr.sns_toolbarIconTint, R.attr.sns_toolbarViewLayout};
    ...
    public static final int[] SNSVideoIdentDocumentView = {R.attr.sns_VideoIdentDocumentViewStyle, R.attr.sns_stepStrokeWidthActivated, R.attr.sns_stepStrokeWidthDefault};
    ...
    public static final int[] SNSVideoIdentLanguageItemView = {R.attr.sns_VideoIdentLanguageItemViewStyle};
    public static final int SNSVideoIdentLanguageItemView_sns_VideoIdentLanguageItemViewStyle = 0;
    public static final int[] SNSVideoSelfiePhraseView = {R.attr.sns_VideoSelfiePhraseViewStyle};
    public static final int SNSVideoSelfiePhraseView_sns_VideoSelfiePhraseViewStyle = 0;
    public static final int[] SNSWarningView = {R.attr.sns_WarningViewStyle};
    ...
    public static final int[] ShadowLayout = {R.attr.shadow_path_coordinatex1, R.attr.shadow_path_coordinatex2, R.attr.shadow_path_coordinatey1, R.attr.shadow_path_coordinatey2, R.attr.shadow_path_endright_y_rate, R.attr.shadow_path_startleft_y_rate, R.attr.sl_shadow_angle, R.attr.sl_shadow_color, R.attr.sl_shadow_distance, R.attr.sl_shadow_model, R.attr.sl_shadow_offsetdx, R.attr.sl_shadow_offsetdy, R.attr.sl_shadow_radius, R.attr.sl_shadow_rectroundradius, R.attr.sl_shadow_zoomdy, R.attr.sl_shadowed, R.attr.z_depth, R.attr.z_depth_animDuration, R.attr.z_depth_clipcanvas, R.attr.z_depth_doAnim, R.attr.z_depth_padding, R.attr.z_depth_paddingBottom, R.attr.z_depth_paddingLeft, R.attr.z_depth_paddingRight, R.attr.z_depth_paddingTop, R.attr.z_depth_shape};
    public static final int ShadowLayout_shadow_path_coordinatex1 = 0;
    public static final int ShadowLayout_shadow_path_coordinatex2 = 1;
    public static final int ShadowLayout_shadow_path_coordinatey1 = 2;
    public static final int ShadowLayout_shadow_path_coordinatey2 = 3;
    public static final int ShadowLayout_shadow_path_endright_y_rate = 4;
    public static final int ShadowLayout_shadow_path_startleft_y_rate = 5;
    public static final int ShadowLayout_sl_shadow_angle = 6;
    public static final int ShadowLayout_sl_shadow_color = 7;
    public static final int ShadowLayout_sl_shadow_distance = 8;
    public static final int ShadowLayout_sl_shadow_model = 9;
    public static final int ShadowLayout_sl_shadow_offsetdx = 10;
    public static final int ShadowLayout_sl_shadow_offsetdy = 11;
    public static final int ShadowLayout_sl_shadow_radius = 12;
    public static final int ShadowLayout_sl_shadow_rectroundradius = 13;
    public static final int ShadowLayout_sl_shadow_zoomdy = 14;
    public static final int ShadowLayout_sl_shadowed = 15;
    public static final int ShadowLayout_z_depth = 16;
    public static final int ShadowLayout_z_depth_animDuration = 17;
    public static final int ShadowLayout_z_depth_clipcanvas = 18;
    public static final int ShadowLayout_z_depth_doAnim = 19;
    public static final int ShadowLayout_z_depth_padding = 20;
    public static final int ShadowLayout_z_depth_paddingBottom = 21;
    public static final int ShadowLayout_z_depth_paddingLeft = 22;
    public static final int ShadowLayout_z_depth_paddingRight = 23;
    public static final int ShadowLayout_z_depth_paddingTop = 24;
    public static final int ShadowLayout_z_depth_shape = 25;
    ...
    public static final int[] SwitchCustomWidth = {R.attr.custom_width};
    ...
    public static final int[] SynthesizedImageView = {R.attr.default_image, R.attr.image_background, R.attr.image_gap, R.attr.image_size, R.attr.synthesized_default_image, R.attr.synthesized_image_bg, R.attr.synthesized_image_gap, R.attr.synthesized_image_size};
    ...
    public static final int[] TitleBarLayout = {R.attr.title_bar_can_return, R.attr.title_bar_middle_title};
    ...
    public static final int[] UserLogoView = {16842996, 16842997, R.attr.badgeAlign, R.attr.badgeLogo, R.attr.badgeLogoBackground, R.attr.badgeLogoHeight, R.attr.badgeLogoMargin, R.attr.badgeLogoPadding, R.attr.badgeLogoWidth, R.attr.decoraScale, R.attr.decoraSrc, R.attr.decoraVisiable, R.attr.defaultLogo, R.attr.logoBackground, R.attr.logoHeight, R.attr.logoPadding, R.attr.logoWidth};
    public static final int UserLogoView_android_layout_height = 1;
    public static final int UserLogoView_android_layout_width = 0;
    public static final int UserLogoView_badgeAlign = 2;
    public static final int UserLogoView_badgeLogo = 3;
    public static final int UserLogoView_badgeLogoBackground = 4;
    public static final int UserLogoView_badgeLogoHeight = 5;
    public static final int UserLogoView_badgeLogoMargin = 6;
    public static final int UserLogoView_badgeLogoPadding = 7;
    public static final int UserLogoView_badgeLogoWidth = 8;
    public static final int UserLogoView_decoraScale = 9;
    public static final int UserLogoView_decoraSrc = 10;
    public static final int UserLogoView_decoraVisiable = 11;
    public static final int UserLogoView_defaultLogo = 12;
    public static final int UserLogoView_logoBackground = 13;
    public static final int UserLogoView_logoHeight = 14;
    public static final int UserLogoView_logoPadding = 15;
    public static final int UserLogoView_logoWidth = 16;
    ...
    public static final int[] VersionSwitchCardView = {R.attr.desc, R.attr.rawRes, R.attr.selected, R.attr.tag, R.attr.title};
    public static final int VersionSwitchCardView_desc = 0;
    public static final int VersionSwitchCardView_rawRes = 1;
    public static final int VersionSwitchCardView_selected = 2;
    public static final int VersionSwitchCardView_tag = 3;
    public static final int VersionSwitchCardView_title = 4;
    ...
    public static final int[] WidgetView = {R.attr.anchor};
    ...
    public static final int[] communityThemeAttr = {R.attr.authMarkBgDrawable, R.attr.authMarkTextColor, R.attr.commentIconTextColor, R.attr.communityDetailDisclaimerBgColor, R.attr.communityDetailDisclaimerTextColor, R.attr.communityEmptyHintTextColor, R.attr.communityEmptyIcon, R.attr.communityFirstItemBgOnTopicDetail, R.attr.communityFromBgDrawable, R.attr.communityFromIconTextColor, R.attr.communityHotTopicTagflowListBg, R.attr.communityListTopDefaultSortBtnIcon, R.attr.communityListTopNewCountTipsColor, R.attr.communityListTopSortBtnTextColor, R.attr.communityListTopTimeSortBtnIcon, R.attr.communityMenuItemBgNormal, R.attr.communityMenuItemBgSelected, R.attr.communityMenuItemTextColor, R.attr.communityMenuItemUnCheckTextColor, R.attr.communityMenuPanelBg, R.attr.communityMomentCommentDialogInputBgColor, R.attr.communityMomentContentCopyBgColor, R.attr.communityMomentFromItemBgColor, R.attr.communityMomentListNoMoreDataTipsTextColor, R.attr.communityMomentMainPageBgColor, R.attr.communityMomentMainPageTitleColor, R.attr.communityMomentMainPageTopLineColor, R.attr.communityMomentMoreListTitleColorNormal, R.attr.communityMomentMoreListTitleColorSelected, R.attr.communityMomentRedPacketBtnBgDrawable, R.attr.communityMomentRedPacketBtnBgGrayDrawable, R.attr.communityMomentRedPacketBtnTextColor, R.attr.communityMomentRedPacketBtnTextGrayColor, R.attr.communityNetUnableIcon, R.attr.communityNetUnableRetryBackground, R.attr.communityNetUnableRetryTextColor, R.attr.communityOtherItemBgOnTopicDetail, R.attr.contentExpandTextColor, R.attr.contentTextColor, R.attr.errorDefIconMomentCommentEmpty, R.attr.errorDefIconMomentEmpty, R.attr.errorDefIconMomentForwordEmpty, R.attr.errorDefIconMomentPariseEmpty, R.attr.errorDefIconNoNetworkResId, R.attr.errorDefTipsMomentEmptyTextColor, R.attr.groupChatArrowColor, R.attr.groupChatBgDrawable, R.attr.groupChatLabelColor, R.attr.groupChatMessageTextColor, R.attr.hotTopicTagFlowBg, R.attr.hotTopicTagFlowNameTextColor, R.attr.hotTopicTagIvToggleSrc, R.attr.listDividingLineColor, R.attr.menuDialogItemBgColor, R.attr.menuDialogItemLineColor, R.attr.menuDialogItemTitleColor, R.attr.momentDetailMoreListItemContentColor, R.attr.momentDetailMoreListItemLineColor, R.attr.momentDetailMoreListItemTitleColor, R.attr.postTimeTextColor, R.attr.postTypeTextColor, R.attr.praiseIconTextColor, R.attr.rootBgColor, R.attr.shareContentBgDrawable, R.attr.shareContentSubTitleTextColor, R.attr.shareContentTitleTextColor, R.attr.shareIconTextColor, R.attr.topicDetailCtlLayoutContentScrim, R.attr.topicDetailListBackground, R.attr.topicDetailRootViewBg, R.attr.topicDetailSmartRefreshFooterAccentColor, R.attr.topicDetailSmartRefreshFooterDividerColor, R.attr.topicDetailToolbarLeftIconColor, R.attr.topicDetailToolbarTitleColor, R.attr.topicDetailToolbarleftIconFilterColor, R.attr.topicDetailctbToolbarLineColor, R.attr.usernameTextColor};
    public static final int communityThemeAttr_authMarkBgDrawable = 0;
    public static final int communityThemeAttr_authMarkTextColor = 1;
    public static final int communityThemeAttr_commentIconTextColor = 2;
    public static final int communityThemeAttr_communityDetailDisclaimerBgColor = 3;
    public static final int communityThemeAttr_communityDetailDisclaimerTextColor = 4;
    public static final int communityThemeAttr_communityEmptyHintTextColor = 5;
    public static final int communityThemeAttr_communityEmptyIcon = 6;
    public static final int communityThemeAttr_communityFirstItemBgOnTopicDetail = 7;
    public static final int communityThemeAttr_communityFromBgDrawable = 8;
    public static final int communityThemeAttr_communityFromIconTextColor = 9;
    public static final int communityThemeAttr_communityHotTopicTagflowListBg = 10;
    public static final int communityThemeAttr_communityListTopDefaultSortBtnIcon = 11;
    public static final int communityThemeAttr_communityListTopNewCountTipsColor = 12;
    public static final int communityThemeAttr_communityListTopSortBtnTextColor = 13;
    public static final int communityThemeAttr_communityListTopTimeSortBtnIcon = 14;
    public static final int communityThemeAttr_communityMenuItemBgNormal = 15;
    public static final int communityThemeAttr_communityMenuItemBgSelected = 16;
    public static final int communityThemeAttr_communityMenuItemTextColor = 17;
    public static final int communityThemeAttr_communityMenuItemUnCheckTextColor = 18;
    public static final int communityThemeAttr_communityMenuPanelBg = 19;
    public static final int communityThemeAttr_communityMomentCommentDialogInputBgColor = 20;
    public static final int communityThemeAttr_communityMomentContentCopyBgColor = 21;
    public static final int communityThemeAttr_communityMomentFromItemBgColor = 22;
    public static final int communityThemeAttr_communityMomentListNoMoreDataTipsTextColor = 23;
    public static final int communityThemeAttr_communityMomentMainPageBgColor = 24;
    public static final int communityThemeAttr_communityMomentMainPageTitleColor = 25;
    public static final int communityThemeAttr_communityMomentMainPageTopLineColor = 26;
    public static final int communityThemeAttr_communityMomentMoreListTitleColorNormal = 27;
    public static final int communityThemeAttr_communityMomentMoreListTitleColorSelected = 28;
    public static final int communityThemeAttr_communityMomentRedPacketBtnBgDrawable = 29;
    public static final int communityThemeAttr_communityMomentRedPacketBtnBgGrayDrawable = 30;
    public static final int communityThemeAttr_communityMomentRedPacketBtnTextColor = 31;
    public static final int communityThemeAttr_communityMomentRedPacketBtnTextGrayColor = 32;
    public static final int communityThemeAttr_communityNetUnableIcon = 33;
    public static final int communityThemeAttr_communityNetUnableRetryBackground = 34;
    public static final int communityThemeAttr_communityNetUnableRetryTextColor = 35;
    public static final int communityThemeAttr_communityOtherItemBgOnTopicDetail = 36;
    public static final int communityThemeAttr_contentExpandTextColor = 37;
    public static final int communityThemeAttr_contentTextColor = 38;
    public static final int communityThemeAttr_errorDefIconMomentCommentEmpty = 39;
    public static final int communityThemeAttr_errorDefIconMomentEmpty = 40;
    public static final int communityThemeAttr_errorDefIconMomentForwordEmpty = 41;
    public static final int communityThemeAttr_errorDefIconMomentPariseEmpty = 42;
    public static final int communityThemeAttr_errorDefIconNoNetworkResId = 43;
    public static final int communityThemeAttr_errorDefTipsMomentEmptyTextColor = 44;
    public static final int communityThemeAttr_groupChatArrowColor = 45;
    public static final int communityThemeAttr_groupChatBgDrawable = 46;
    public static final int communityThemeAttr_groupChatLabelColor = 47;
    public static final int communityThemeAttr_groupChatMessageTextColor = 48;
    public static final int communityThemeAttr_hotTopicTagFlowBg = 49;
    public static final int communityThemeAttr_hotTopicTagFlowNameTextColor = 50;
    public static final int communityThemeAttr_hotTopicTagIvToggleSrc = 51;
    public static final int communityThemeAttr_listDividingLineColor = 52;
    public static final int communityThemeAttr_menuDialogItemBgColor = 53;
    public static final int communityThemeAttr_menuDialogItemLineColor = 54;
    public static final int communityThemeAttr_menuDialogItemTitleColor = 55;
    public static final int communityThemeAttr_momentDetailMoreListItemContentColor = 56;
    public static final int communityThemeAttr_momentDetailMoreListItemLineColor = 57;
    public static final int communityThemeAttr_momentDetailMoreListItemTitleColor = 58;
    public static final int communityThemeAttr_postTimeTextColor = 59;
    public static final int communityThemeAttr_postTypeTextColor = 60;
    public static final int communityThemeAttr_praiseIconTextColor = 61;
    public static final int communityThemeAttr_rootBgColor = 62;
    public static final int communityThemeAttr_shareContentBgDrawable = 63;
    public static final int communityThemeAttr_shareContentSubTitleTextColor = 64;
    public static final int communityThemeAttr_shareContentTitleTextColor = 65;
    public static final int communityThemeAttr_shareIconTextColor = 66;
    public static final int communityThemeAttr_topicDetailCtlLayoutContentScrim = 67;
    public static final int communityThemeAttr_topicDetailListBackground = 68;
    public static final int communityThemeAttr_topicDetailRootViewBg = 69;
    public static final int communityThemeAttr_topicDetailSmartRefreshFooterAccentColor = 70;
    public static final int communityThemeAttr_topicDetailSmartRefreshFooterDividerColor = 71;
    public static final int communityThemeAttr_topicDetailToolbarLeftIconColor = 72;
    public static final int communityThemeAttr_topicDetailToolbarTitleColor = 73;
    public static final int communityThemeAttr_topicDetailToolbarleftIconFilterColor = 74;
    public static final int communityThemeAttr_topicDetailctbToolbarLineColor = 75;
    public static final int communityThemeAttr_usernameTextColor = 76;
    public static final int[] core_round_rect_image_style = {R.attr.round_radius};
    ...
    public static final int[] iproov = {R.attr.iproov_closeButton_colorTint, R.attr.iproov_customization, R.attr.iproov_filterBackgroundColor, R.attr.iproov_filterForegroundColor, R.attr.iproov_genuinePresenceAssurance_notReadyOvalStrokeColor, R.attr.iproov_genuinePresenceAssurance_readyOvalStrokeColor, R.attr.iproov_livenessAssurance_completedOvalStrokeColor, R.attr.iproov_livenessAssurance_ovalStrokeColor, R.attr.iproov_promptBackgroundColor, R.attr.iproov_promptRoundedCorners, R.attr.iproov_promptTextColor, R.attr.iproov_surroundColor, R.attr.iproov_titleTextColor};
    ...
    public static final int[] f40923jumio = {R.attr.jumio_background, R.attr.jumio_bubble_background, R.attr.jumio_bubble_background_selected, R.attr.jumio_bubble_foreground, R.attr.jumio_circle_item_background, R.attr.jumio_circle_item_foreground, R.attr.jumio_confirmation_image_background, R.attr.jumio_confirmation_image_background_border, R.attr.jumio_error_circle_gradient_end, R.attr.jumio_error_circle_gradient_start, R.attr.jumio_error_circle_plain, R.attr.jumio_indicator_active, R.attr.jumio_indicator_default, R.attr.jumio_loading_circle_gradient_end, R.attr.jumio_loading_circle_gradient_start, R.attr.jumio_loading_circle_icon, R.attr.jumio_loading_circle_plain, R.attr.jumio_navigation_icon, R.attr.jumio_navigation_icon_dark, R.attr.jumio_overlay_customization, R.attr.jumio_primary_button_background, R.attr.jumio_primary_button_background_disabled, R.attr.jumio_primary_button_background_pressed, R.attr.jumio_primary_button_foreground, R.attr.jumio_primary_button_foreground_disabled, R.attr.jumio_primary_button_foreground_pressed, R.attr.jumio_scanBackground, R.attr.jumio_scanOverlay, R.attr.jumio_scanOverlayFill, R.attr.jumio_scanOverlayTransparent, R.attr.jumio_scanOverlay_livenessStroke, R.attr.jumio_scanOverlay_livenessStrokeAnimation, R.attr.jumio_scanOverlay_livenessStrokeAnimationCompleted, R.attr.jumio_scanview_animation_background, R.attr.jumio_scanview_bubble_background, R.attr.jumio_scanview_bubble_foreground, R.attr.jumio_scanview_foreground, R.attr.jumio_scanview_shutter, R.attr.jumio_scanview_shutter_dark, R.attr.jumio_scanview_shutter_dark_pressed, R.attr.jumio_scanview_shutter_pressed, R.attr.jumio_search_bubble_background, R.attr.jumio_search_bubble_foreground, R.attr.jumio_secondary_button_background, R.attr.jumio_secondary_button_background_disabled, R.attr.jumio_secondary_button_background_pressed, R.attr.jumio_secondary_button_foreground, R.attr.jumio_selection_icon_foreground, R.attr.jumio_start_item_checkmark, R.attr.jumio_switch_thumb_off, R.attr.jumio_switch_track_off, R.attr.jumio_switch_track_on, R.attr.jumio_text_foreground};
