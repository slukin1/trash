...
public class SmartRefreshHeader extends RelativeLayout implements g {
    ...
    public SpinnerStyle f80256c = SpinnerStyle.Scale;

    /* renamed from: d  reason: collision with root package name */
    public Integer f80257d;

    /* renamed from: e  reason: collision with root package name */
    public int f80258e;

    /* renamed from: f  reason: collision with root package name */
    public int f80259f = 500;

    /* renamed from: g  reason: collision with root package name */
    public boolean f80260g = true;

    /* renamed from: h  reason: collision with root package name */
    public float f80261h = 2.5f;

    /* renamed from: i  reason: collision with root package name */
    public LottieAnimationView f80262i;

    /* renamed from: j  reason: collision with root package name */
    public TextView f80263j;
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f80264a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.huobi.page.SmartRefreshHeader.a.<clinit>():void");
        }
    }
    ...
    public final void a(Context context, AttributeSet attributeSet) {
        ...
        this.f80262i = safeLottieView;
        safeLottieView.setRepeatCount(-1);
        this.f80262i.setAnimation(R$raw.refresh_header);
        linearLayout.addView(this.f80262i, new RelativeLayout.LayoutParams(densityUtil.a(48.0f), densityUtil.a((float) (getArrowViewHeightDp() - 8))));
        TextView textView = new TextView(getContext());
        this.f80263j = textView;
        textView.setTextSize(1, 12.0f);
        this.f80263j.setTextColor(context.getResources().getColor(R$color.baseColorMajorTheme100));
        this.f80263j.setText("HTX.com");
        linearLayout.addView(this.f80263j, new RelativeLayout.LayoutParams(-2, -2));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(13);
        addView(linearLayout, layoutParams);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.ClassicsHeader);
        this.f80259f = obtainStyledAttributes.getInt(R$styleable.ClassicsHeader_srlFinishDuration, this.f80259f);
        this.f80260g = obtainStyledAttributes.getBoolean(R$styleable.ClassicsHeader_srlEnableLastTime, this.f80260g);
        this.f80256c = SpinnerStyle.values()[obtainStyledAttributes.getInt(R$styleable.ClassicsHeader_srlClassicsSpinnerStyle, this.f80256c.ordinal())];
    ...
    public SmartRefreshHeader d(int i11) {
        ...
        this.f80257d = valueOf;
        this.f80258e = valueOf.intValue();
        i iVar = this.f80255b;
        if (iVar != null) {
            iVar.c(this.f80257d.intValue());
        }
        return this;
    }
    ...
    public void onPulling(float f11, int i11, int i12, int i13) {
        if (f11 >= 1.0f) {
            this.f80262i.setScaleX(1.0f);
            this.f80262i.setScaleY(1.0f);
            this.f80262i.setAlpha(1.0f);
            return;
        }
        this.f80262i.setScaleX(f11);
        this.f80262i.setScaleY(f11);
        this.f80262i.setAlpha(f11);
    }
    ...
    public void onStateChanged(j jVar, RefreshState refreshState, RefreshState refreshState2) {
        int i11 = a.f80264a[refreshState2.ordinal()];
        if (i11 == 1) {
            this.f80262i.pauseAnimation();
        } else if (i11 == 2) {
            this.f80262i.playAnimation();
        }
    }

    @Deprecated
    public void setPrimaryColors(int... iArr) {
        if (iArr.length > 0 && !(getBackground() instanceof BitmapDrawable) && this.f80257d == null) {
            d(iArr[0]);
            this.f80257d = null;
        }
    }
    ...
    public void setTextColor(int i11) {
        TextView textView = this.f80263j;
        if (textView != null) {
