...
import com.huobi.finance.viewhandler.ContractItemViewAdapter;

public class ContractAccountInfo extends BaseAssetInfo {
    ...
    private int isDebit;
    private boolean isNewAssetData;
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof ContractAccountInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String availableWithdraw3 = contractAccountInfo.getAvailableWithdraw();
        ...
        String leverRate3 = contractAccountInfo.getLeverRate();
        if (leverRate2 != null ? !leverRate2.equals(leverRate3) : leverRate3 != null) {
            return false;
        }
        String adjustFactor2 = getAdjustFactor();
        String adjustFactor3 = contractAccountInfo.getAdjustFactor();
        if (adjustFactor2 != null ? adjustFactor2.equals(adjustFactor3) : adjustFactor3 == null) {
            return getIsDebit() == contractAccountInfo.getIsDebit() && isNewAssetData() == contractAccountInfo.isNewAssetData();
        }
        return false;
    }
    ...
    public String getViewHandlerName() {
        return ContractItemViewAdapter.class.getName();
    }
    ...
    public int hashCode() {
        ...
        String marginStatic2 = getMarginStatic();
        int hashCode4 = (hashCode3 * 59) + (marginStatic2 == null ? 43 : marginStatic2.hashCode());
        String marginPosition2 = getMarginPosition();
        ...
        if (adjustFactor2 != null) {
            i11 = adjustFactor2.hashCode();
        }
        return ((((i12 + i11) * 59) + getIsDebit()) * 59) + (isNewAssetData() ? 79 : 97);
    }

    public boolean isNewAssetData() {
        return this.isNewAssetData;
    }
    ...
    public void setNewAssetData(boolean z11) {
        this.isNewAssetData = z11;
    }
    ...
    public String toString() {
        return "ContractAccountInfo(symbol=" + getSymbol() + ", marginBalance=" + getMarginBalance() + ", marginStatic=" + getMarginStatic() + ", marginPosition=" + getMarginPosition() + ", marginFrozen=" + getMarginFrozen() + ", marginAvailable=" + getMarginAvailable() + ", profitReal=" + getProfitReal() + ", profitUnreal=" + getProfitUnreal() + ", riskRate=" + getRiskRate() + ", liquidationPrice=" + getLiquidationPrice() + ", availableWithdraw=" + getAvailableWithdraw() + ", leverRate=" + getLeverRate() + ", adjustFactor=" + getAdjustFactor() + ", isDebit=" + getIsDebit() + ", isNewAssetData=" + isNewAssetData() + ")";
    }
}
