...
public class AssetCoinPOwnTabChildFragment extends BaseAssetChildTabFragment {
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("coinPOwnAssetList", new d(this));
        }
    }
    ...
    public void onResume() {
        ...
        a aVar = this.f42574e;
        if (!(aVar == null || aVar.a() == null)) {
            this.f42574e.a().I("assetThirdTypeEvent('7',false)");
        }
        BaseModuleConfig.a().w("app_assets_futures_CoinP_mv_exposure", (HashMap) null);
    }
