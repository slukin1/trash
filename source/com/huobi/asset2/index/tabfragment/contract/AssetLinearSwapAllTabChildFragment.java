...
public class AssetLinearSwapAllTabChildFragment extends BaseAssetChildTabFragment {
    ...
    public String e9() {
        return i.d().e() ? "asset_tab_contract_u_unity_item_2.xml" : "asset_tab_contract_u_item.xml";
    }
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("usdtMAllAssetList", new f(this));
        }
    }
    ...
    public void onResume() {
        ...
        a aVar = this.f42574e;
        if (!(aVar == null || aVar.a() == null)) {
            this.f42574e.a().I("assetThirdTypeEvent('4',true)");
        }
    ...
    public View ve(Context context) {
        ...
        if (i.d().e()) {
            ...
            jSONObject.put("listTitleLeft", (Object) getResources().getString(R$string.n_market_collecation_tab_name));
            jSONObject.put("listTitleCenter", (Object) getResources().getString(R$string.n_balance_contract_secured_assets_ratio));
            jSONObject.put("listTitleRight", (Object) getResources().getString(R$string.n_asset_right_appraisement));
        }
    ...
    public String wa() {
        return i.d().e() ? "asset_tab_contract_u_unity_expand_item_2.xml" : "asset_tab_contract_u_expand_item.xml";
    }
}
