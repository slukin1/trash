...
public class AssetMarginPartChildFragment extends BaseAssetChildTabFragment {
    ...
    public String Ah() {
        return "shortLevelDataListError";
    }
    ...
    public String e9() {
        return "asset_tab_margin_short_item.xml";
    }
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("shortLevelDataList", new b(this));
        }
    }

    public void onResume() {
        super.onResume();
        BaseModuleConfig.a().w("app_assets_margin_lsolated_exposure", (HashMap) null);
    }
    ...
    public View ve(Context context) {
        ...
        linearLayout.addView(this.f42574e.a().E("asset_tab_margin_part_header_layout.xml", getContext(), false, (JSONObject) null));
        ...
        jSONObject.put("listTitleCenter", (Object) "");
        jSONObject.put("listTitleRight", (Object) getResources().getString(R$string.n_balance_equivalent));
    ...
    public String wa() {
        return "asset_tab_margin_short_expand_item.xml";
    }
}
