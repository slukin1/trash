...
public class PrimeOrderBeanViewHandler implements c {
    ...
    public void c(Context context, PrimeOrderBean primeOrderBean) {
        ...
        if (!NetworkStatus.c(j.c())) {
            ...
            o.C().u(primeOrderBean.getId()).delay(1, TimeUnit.SECONDS).compose(RxJavaHelper.t(gVar)).subscribe(new a(gVar));
        }
    }
    ...
    public void handleView(v9.c cVar, int i11, PrimeOrderBean primeOrderBean, ViewGroup viewGroup) {
        ...
        textView6.setText("0");
        textView3.setOnClickListener(new wt.a(this, primeOrderBean, textView3));
        ViewUtil.m(b11, false);
        PrimeInfo G = o.C().G();
        ViewUtil.m(textView3, G == null || primeOrderBean.getSymbol() == null || !primeOrderBean.getSymbol().equalsIgnoreCase(G.getSymbolCode()) || !o.C().X() || o.C().d0());
    }
