...
import com.huobi.tradenew.prime.dialog.PrimeLuckyDialog;
...
public class PrimeLiteLayout extends PrimeLayout implements BaseDialogFragment.c {
    ...
    public void T(ViewGroup viewGroup, PrimeResult primeResult) {
        ...
        if (primeResult == null || TextUtils.isEmpty(primeResult.getOrderId())) {
            this.f83050z.add(new b(getResources().getString(R.string.prime_order_id_status_cancel_unorder)));
        } else {
            ...
            this.f83050z.add(new d(orderId, str, primeResult.isFinished()));
        }
    ...
    public final void a0() {
        ...
        sb2.append(K != null ? K.getQuotaAmount() : "--");
        sb2.append(" ");
    ...
    public final void c0() {
        ...
        if (this.O) {
            if (this.K) {
                ...
                ViewGroup viewGroup = this.f83027c;
                if (viewGroup != null) {
                    try {
        ...
        } else if (this.f83027c != null && (loadingView = this.M) != null) {
            loadingView.d();
            this.f83027c.removeView(this.M);
        }
    }
