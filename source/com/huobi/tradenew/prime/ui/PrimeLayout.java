...
public class PrimeLayout extends FrameLayout implements it.a {
    ...
    public DecimalFormat f83026b;

    /* renamed from: c  reason: collision with root package name */
    public ViewGroup f83027c;

    /* renamed from: d  reason: collision with root package name */
    public EasyRecyclerView<s9.a> f83028d;

    /* renamed from: e  reason: collision with root package name */
    public PrimeCountDownLayout f83029e;

    /* renamed from: f  reason: collision with root package name */
    public ImageView f83030f;

    /* renamed from: g  reason: collision with root package name */
    public TextView f83031g;

    /* renamed from: h  reason: collision with root package name */
    public TextView f83032h;

    /* renamed from: i  reason: collision with root package name */
    public TextView f83033i;

    /* renamed from: j  reason: collision with root package name */
    public TextView f83034j;

    /* renamed from: k  reason: collision with root package name */
    public TextView f83035k;

    /* renamed from: l  reason: collision with root package name */
    public TextView f83036l;

    /* renamed from: m  reason: collision with root package name */
    public TextView f83037m;

    /* renamed from: n  reason: collision with root package name */
    public TextView f83038n;

    /* renamed from: o  reason: collision with root package name */
    public TextView f83039o;

    /* renamed from: p  reason: collision with root package name */
    public TextView f83040p;
    ...
    public TextView f83043s;

    /* renamed from: t  reason: collision with root package name */
    public LoadingView f83044t;

    /* renamed from: u  reason: collision with root package name */
    public TextView f83045u;

    /* renamed from: v  reason: collision with root package name */
    public TextView f83046v;

    /* renamed from: w  reason: collision with root package name */
    public TextView f83047w;

    /* renamed from: x  reason: collision with root package name */
    public TextView f83048x;

    /* renamed from: y  reason: collision with root package name */
    public TextView f83049y;

    /* renamed from: z  reason: collision with root package name */
    public final List<s9.a> f83050z;
    ...
    public /* synthetic */ void A(View view) {
        if (this.f83042r.getVisibility() != 0) {
            SensorsDataAutoTrackHelper.trackViewOnClick(view);
            return;
        }
        this.f83042r.setVisibility(4);
        this.f83044t.setVisibility(0);
        this.f83044t.c();
        this.A.g();
        E();
        this.H = false;
    ...
    public /* synthetic */ void B(View view) {
        PrimeResult K2 = o.C().K();
        if (K2 == null) {
            SensorsDataAutoTrackHelper.trackViewOnClick(view);
            return;
        }
        List<PrimeBidResultDetail> detail = K2.getDetail();
        if (detail != null && !detail.isEmpty()) {
            ...
            this.J.uh(K2.getWinRate(), arrayList);
            a aVar = this.A;
    ...
    private void J() {
        LoadingView loadingView = this.f83044t;
        if (loadingView != null) {
            loadingView.d();
            this.f83044t.setVisibility(8);
        }
        View view = this.f83042r;
        if (view != null) {
    ...
    private void N() {
        PrimeResult K2 = o.C().K();
        ViewUtil.m(this.f83049y, r.x().F0() && o.C().X() && K2 != null && K2.isFinished() && K2.getDetail() != null && !K2.getDetail().isEmpty());
    }

    private void Q(PrimeResult primeResult) {
        String str;
        this.f83050z.clear();
        if (primeResult == null || TextUtils.isEmpty(primeResult.getOrderId())) {
            this.f83050z.add(new b(getResources().getString(R.string.prime_order_id_status_cancel_unorder_lucky)));
        } else {
            ...
            if (bidIds != null && !bidIds.isEmpty()) {
                for (int i11 = 0; i11 < bidIds.size(); i11++) {
                    ...
                    if (o.C().d0() || !primeResult.isFinished()) {
                        str = o.C().d0() ? getResources().getString(R.string.prime_trade_order_status_trading) : getResources().getString(R.string.prime_trade_order_status_ordering);
                    } else if (z12) {
            ...
            if (!o.C().d0() && primeResult.isFinished() && arrayList.isEmpty()) {
                this.f83050z.add(new e(getResources().getString(R.string.prime_lucky_item_title_thanks)));
            }
            this.f83050z.addAll(arrayList);
            this.f83050z.addAll(arrayList2);
        }
        N();
        this.f83028d.setData(this.f83050z);
    }
    ...
    private DecimalFormat getAmountDecFormat() {
        if (this.f83026b == null) {
            this.f83026b = new DecimalFormat("#,###");
            DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols(Locale.US);
            decimalFormatSymbols.setDecimalSeparator(',');
            this.f83026b.setDecimalFormatSymbols(decimalFormatSymbols);
        }
        return this.f83026b;
    }

    private void k() {
        this.f83029e.setCountDownCallback(this);
        findViewById(R.id.id_prime_login_btn).setOnClickListener(new vt.b(this));
        findViewById(R.id.id_prime_see_detail_btn).setOnClickListener(new g(this));
        findViewById(R.id.id_prime_project_report).setOnClickListener(new vt.a(this));
        findViewById(R.id.id_prime_project_rule).setOnClickListener(new f(this));
        findViewById(R.id.id_prime_close_up_btn).setOnClickListener(new vt.e(this));
        findViewById(R.id.linear_refresh).setOnClickListener(new d(this));
        TextView textView = this.f83049y;
        if (textView != null) {
    ...
    private void n() {
        this.f83029e.setValid(false);
        this.f83031g.setText(String.format(Locale.US, getResources().getString(R.string.prime_round_desc), new Object[]{getBaseCurrencyUpper(), Constants.ACCEPT_TIME_SEPARATOR_SERVER, Constants.ACCEPT_TIME_SEPARATOR_SERVER}));
        this.f83031g.setTextColor(j.b(R.color.prime));
        this.f83035k.setText("--");
        ViewUtil.m(findViewById(R.id.id_prime_stop_price_layout), true);
        this.f83036l.setText("--");
    ...
    private void r(Context context) {
        ...
        this.f83044t = (LoadingView) findViewById(R.id.loading_refresh);
        this.f83042r = findViewById(R.id.linear_refresh);
        this.f83043s = (TextView) findViewById(R.id.text_refresh);
        this.f83041q = findViewById(R.id.relative_refresh);
        this.f83031g = (TextView) findViewById(R.id.id_prime_round_desc);
        this.f83028d = (EasyRecyclerView) findViewById(R.id.id_prime_list_recyclerView);
        this.f83029e = (PrimeCountDownLayout) findViewById(R.id.id_prime_count_down_view);
        this.f83032h = (TextView) findViewById(R.id.id_prime_limit_amount);
        this.f83035k = (TextView) findViewById(R.id.id_prime_this_amount);
        this.f83033i = (TextView) findViewById(R.id.id_prime_this_amount_title);
        this.f83034j = (TextView) findViewById(R.id.id_prime_this_stop_price_title);
        this.f83036l = (TextView) findViewById(R.id.id_prime_this_stop_price);
        this.f83037m = (TextView) findViewById(R.id.id_prime_start_time);
        this.f83038n = (TextView) findViewById(R.id.id_prime_list_layout_title);
        this.f83039o = (TextView) findViewById(R.id.id_prime_price_rate);
        this.f83040p = (TextView) findViewById(R.id.id_prime_count_down_title);
        this.f83045u = (TextView) findViewById(R.id.id_prime_tips_order_finish_desc);
        this.f83046v = (TextView) findViewById(R.id.id_prime_see_detail_btn);
        this.f83047w = (TextView) findViewById(R.id.id_prime_tips_tv_waiting);
        this.f83048x = (TextView) findViewById(R.id.id_prime_tips_order_finish_title);
        this.f83030f = (ImageView) findViewById(R.id.id_prime_round_logo_text_img);
        this.f83049y = (TextView) findViewById(R.id.id_prime_lucky_order_rule_tv);
        this.f83044t.setLottieAnimationRes(getRefreshJsonId());
        F();
        this.f83030f.setImageResource(getLogoImgResId());
    }
    ...
    public void E() {
        T(this.f83027c, o.C().K());
        if (r.x().F0()) {
            o.C().y();
        } else if (l()) {
            this.f83050z.clear();
            this.f83050z.add(new b(getResources().getString(R.string.prime_order_id_status_please_login)));
            this.f83028d.setData(this.f83050z);
        }
    }
    ...
    public void F() {
        ...
        this.f83043s.setText(spannableStringBuilder);
    }
    ...
    public boolean G(android.view.ViewGroup r9, com.hbg.lib.data.symbol.PrimeInfo r10, java.lang.String r11, java.lang.String r12, java.lang.String r13, boolean r14) {
        ...
        L_0x007d:
            ...
            return r9
        L_0x0085:
            com.huobi.trade.prime.ui.PrimeCountDownLayout r9 = r8.f83029e
            r9.setValid(r0)
        ...
        L_0x00a1:
            ...
            goto L_0x011a
        L_0x00c1:
            android.widget.TextView r14 = r8.f83031g
            ...
            int r5 = bh.j.b(r5)
            r14.setTextColor(r5)
            android.widget.TextView r14 = r8.f83040p
            com.hbg.lib.common.utils.ViewUtil.m(r14, r0)
            com.huobi.trade.prime.ui.PrimeCountDownLayout r14 = r8.f83029e
            com.hbg.lib.common.utils.ViewUtil.m(r14, r0)
            ...
            android.widget.TextView r5 = r8.f83035k
            r5.setText(r14)
        ...
        L_0x011a:
            android.view.View r14 = r8.f83041q
            r5 = 8
        ...
        L_0x012e:
            ...
            android.widget.TextView r14 = r8.f83035k
            r14.setText(r10)
        ...
        L_0x01dc:
            ...
            r8.W(r11)
            r8.R()
            android.widget.TextView r10 = r8.f83031g
        ...
        L_0x0227:
            r8.M(r12)
            com.hbg.lib.widgets.adapter.recyclerview.EasyRecyclerView<s9.a> r10 = r8.f83028d
            java.util.List<s9.a> r11 = r8.f83050z
            r8.L(r10, r11, r9)
            r8.S()
            r8.E()
            r8.N()
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huobi.tradenew.prime.ui.PrimeLayout.G(android.view.ViewGroup, com.hbg.lib.data.symbol.PrimeInfo, java.lang.String, java.lang.String, java.lang.String, boolean):boolean");
    }
    ...
    public void M(String str) {
        if (o.C().X()) {
            this.f83038n.setText(getResources().getString(R.string.prime_my_order_id));
            return;
        }
        this.f83038n.setText(String.format(Locale.US, getResources().getString(R.string.prime_list_layout_title_text), new Object[]{str}));
    }

    public void O() {
        PrimeAveragePosition primeAveragePosition = this.G;
        if (primeAveragePosition == null) {
            this.f83032h.setText(getResources().getString(R.string.prime_trade_limit_amount_detail_tip));
        } else if (!primeAveragePosition.isQualify()) {
            this.f83032h.setText(getResources().getString(R.string.prime_trade_limit_amount_trade_tip));
        } else if (o()) {
    ...
    public void P() {
        PrimeResult K2 = o.C().K();
        if (K2 == null || TextUtils.isEmpty(K2.getOrderId()) || o.C().X()) {
            ViewUtil.m(findViewById(R.id.id_prime_tips_layout_waiting), false);
            ViewUtil.m(findViewById(R.id.id_prime_tips_layout_order_finish), false);
        } else if (!K2.isFinished()) {
            ViewUtil.m(findViewById(R.id.id_prime_tips_layout_waiting), true);
            this.f83047w.setText(getWaitingText());
            ViewUtil.m(findViewById(R.id.id_prime_tips_layout_order_finish), false);
        } else {
            ViewUtil.m(findViewById(R.id.id_prime_tips_layout_waiting), false);
            ...
            this.f83045u.setText(String.format(locale, string, new Object[]{K2.getQuotaAmount() + " " + getBaseCurrencyUpper()}));
            this.f83048x.setText(String.format(locale, getResources().getString(R.string.prime_please_order_finish_tips_title), new Object[]{String.valueOf(this.F.getTotalRounds())}));
        }
    }
    ...
    public void R() {
        ...
        if (status == 1 || status == 2) {
            ...
            if (divide.compareTo(BigDecimal.ZERO) > 0) {
                this.f83039o.setTextColor(ContextCompat.getColor(getContext(), w.h()));
                str = "+";
            } else {
                if (divide.compareTo(BigDecimal.ZERO) < 0) {
                    this.f83039o.setTextColor(ContextCompat.getColor(getContext(), w.d()));
                } else {
                    this.f83039o.setTextColor(ContextCompat.getColor(getContext(), R.color.color_flat));
                }
                str = "";
            }
            this.f83039o.setText(str + divide.toPlainString() + "%");
        }
    }

    public void T(ViewGroup viewGroup, PrimeResult primeResult) {
        this.f83027c = viewGroup;
        if (o.C().X()) {
            Q(primeResult);
        }
        S();
    ...
    public void U() {
        ...
        if (status == 1 || status == 2) {
            ...
            if ("btcht".equalsIgnoreCase(this.F.getSymbolCode())) {
                this.f83037m.setText(String.format(locale, getResources().getString(R.string.prime_start_trade_time2), new Object[]{format}));
                return;
            }
            this.f83037m.setText(String.format(locale, getResources().getString(getStartTitleResId()), new Object[]{format, str.toUpperCase(locale)}));
        }
    }
    ...
    public void V() {
        ...
        if (status == 1 || status == 2) {
            if (s()) {
                this.f83033i.setText(getResources().getString(R.string.prime_this_cycle_amount));
            } else {
                this.f83033i.setText(getResources().getString(R.string.prime_this_amount));
            }
        } else if (status == 3) {
            if (s()) {
                this.f83033i.setText(getResources().getString(R.string.prime_this_cycle_amount));
            } else {
                this.f83033i.setText(getResources().getString(R.string.prime_this_amount_total));
            }
        }
    }
    ...
    public void W(String str) {
        ...
        if (z11) {
            ...
            if (s()) {
                this.f83034j.setText(getResources().getString(R.string.prime_this_cycle_price));
                currentPrice = this.F.getRounds().get(0).getRoundIssuePrice();
            } else {
                this.f83034j.setText(getResources().getString(R.string.current_round_price));
            }
            this.f83036l.setText(currentPrice + " " + str);
            return;
        }
    ...
    public void c(int i11) {
        if (getVisibility() == 0) {
            G((ViewGroup) null, o.C().G(), this.B, this.C, this.D, true);
        }
    }
    ...
    public boolean u() {
        PrimeResult K2;
        if (!o.C().X() && (K2 = o.C().K()) != null && !TextUtils.isEmpty(K2.getOrderId())) {
            return false;
        }
        return true;
    }
