...
public class TradeSymbolChangeDialogFragment extends BaseListPopupDialog<TradeSymbolChangeItem> {
    ...
    public TradeType f83226b;

    /* renamed from: c  reason: collision with root package name */
    public String f83227c;

    /* renamed from: d  reason: collision with root package name */
    public String f83228d;

    /* renamed from: e  reason: collision with root package name */
    public View.OnClickListener f83229e = new a();
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String d11 = i2.a().d(TradeSymbolChangeDialogFragment.this.f83226b);
            i2.a().h(TradeSymbolChangeDialogFragment.this.f83226b, tradeSymbolChangeItem.d());
            ...
            symbolChangeEvent.j(TradeSymbolChangeDialogFragment.this.f83226b);
    ...
    public List<TradeSymbolChangeItem> getDataList() {
        ...
        if (!TextUtils.isEmpty(this.f83227c) && (Z = a1.v().Z(this.f83226b)) != null && !Z.isEmpty()) {
            for (SymbolBean next : Z) {
                if (next.isCanTrade() && this.f83227c.equalsIgnoreCase(next.getBaseCurrency())) {
                    TradeSymbolChangeItem tradeSymbolChangeItem = new TradeSymbolChangeItem();
                    if (next.getSymbol().equals(this.f83228d)) {
                        tradeSymbolChangeItem.h(true);
                    }
                    tradeSymbolChangeItem.i(next.getSymbol());
                    tradeSymbolChangeItem.j(next.getSymbolName());
                    tradeSymbolChangeItem.g(this.f83229e);
