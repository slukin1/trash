...
public class HeavyBubblePopup extends PopupWindow {
    ...
    public HeavyBubblePopup(boolean z11, View view, int i11) {
        super(i11, -2);
        Context context2;
        if (z11) {
    ...
    private View onCreateView() {
        View inflate = LayoutInflater.from(this.context).inflate(R$layout.view_bubble_guide, (ViewGroup) null);
        ...
        ((ConstraintLayout) inflate.findViewById(R$id.vg_bubble_card)).setBackground(this.target.getResources().getDrawable(R$drawable.bubble_guide_shadow));
    ...
    public void setArrowCenterHorizontal(int i11) {
        ...
        marginLayoutParams.setMarginStart((((rect.left + rect.right) / 2) - (PixelUtils.a(16.0f) / 2)) + i11);
    ...
    public void setArrowOrientation(int i11) {
        if (i11 == 1) {
            this.viewArrow.animate().rotation(90.0f);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.viewArrow.getLayoutParams();
            layoutParams.gravity = 5;
            layoutParams.rightMargin = BaseApplication.b().getResources().getDimensionPixelSize(R$dimen.dimen_17);
            this.viewArrow.setLayoutParams(layoutParams);
        } else if (i11 == 2) {
            this.viewArrow.animate().rotation(180.0f);
            ...
            this.viewArrow.animate().rotation(270.0f);
    ...
    public void setNegListener(View.OnClickListener onClickListener) {
        this.tvNegative.setOnClickListener(new l0(this, onClickListener));
    }
    ...
    public void setPosListener(View.OnClickListener onClickListener) {
        this.tvPositive.setOnClickListener(new m0(this, onClickListener));
    }

    public void setPosListenerNoDismiss(View.OnClickListener onClickListener) {
        this.tvPositive.setOnClickListener(new k0(onClickListener));
    }
