...
public class SimpleFooterAdapter<T extends IndexPartEntity> extends IndexPartFooterAdapter<T> {
    private IndexPartAdapter<T> mAdapter;

    public SimpleFooterAdapter(IndexPartAdapter<T> indexPartAdapter, String str, String str2, List<T> list) {
        super(str, str2, list);
