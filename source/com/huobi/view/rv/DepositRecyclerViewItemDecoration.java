...
public class DepositRecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    private Drawable mDividerDrawable;
    private int mDividerSize;
    private int mSecondDividerSize;
    private Drawable mSecondDrawable;

    public DepositRecyclerViewItemDecoration(Context context, int i11, int i12, int i13, int i14) {
