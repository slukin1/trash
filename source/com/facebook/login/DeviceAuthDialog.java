...
public class DeviceAuthDialog extends DialogFragment {
                ...
                if (!DeviceAuthDialog.this.completed.get()) {
                    ...
                    if (error != null) {
                        ...
                        try {
                            ...
                            DeviceAuthDialog.this.onError(new FacebookException((Throwable) e11));
                        }
                    }
                }
            }
    ...
    public void onSuccess(String str, Long l11, Long l12) {
        ...
        final Date date2 = l11.longValue() != 0 ? new Date(new Date().getTime() + (l11.longValue() * 1000)) : null;
        if (l12.longValue() != 0) {
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        bundle.putString("access_token", Validate.hasAppID() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + Validate.hasClientToken());
            ...
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.isBeingDestroyed) {
                    ...
                    try {
                        ...
                        requestState.setInterval(jSONObject.getLong(MTPushConstants.Geofence.KEY_INTERVAL));
