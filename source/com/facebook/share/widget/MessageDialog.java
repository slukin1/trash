...
public final class MessageDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public MessageDialog(Activity activity, int i11) {
        super(activity, i11);
        this.shouldFailOnDataError = false;
        ShareInternalUtility.registerStaticShareCallback(i11);
    }

    public MessageDialog(Fragment fragment, int i11) {
        this(new FragmentWrapper(fragment), i11);
    }

    public MessageDialog(android.app.Fragment fragment, int i11) {
        this(new FragmentWrapper(fragment), i11);
    }

    private MessageDialog(FragmentWrapper fragmentWrapper, int i11) {
