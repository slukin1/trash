...
public class VideoUploader {
    ...
    public static class FinishUploadWorkItem extends UploadWorkItemBase {
        public static final Set<Integer> transientErrorCodes = new HashSet<Integer>() {
            {
                add(1363011);
            }
        };
        ...
        public void enqueueRetry(int i11) {
            VideoUploader.enqueueUploadFinish(this.uploadContext, i11);
        }
    ...
    public static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        public void enqueueRetry(int i11) {
            VideoUploader.enqueueUploadStart(this.uploadContext, i11);
        }
    ...
    public static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        public void enqueueRetry(int i11) {
            VideoUploader.enqueueUploadChunk(this.uploadContext, this.chunkStart, this.chunkEnd, i11);
        }
    ...
    public static class UploadContext {
        ...
        private UploadContext(ShareVideoContent shareVideoContent, String str, FacebookCallback<Sharer.Result> facebookCallback) {
            ...
            if (!Utility.isNullOrEmpty(shareVideoContent.getPeopleIds())) {
                this.params.putString(InnerShareParams.TAGS, TextUtils.join(", ", shareVideoContent.getPeopleIds()));
            }
    ...
    public static abstract class UploadWorkItemBase implements Runnable {
        ...
        public UploadWorkItemBase(UploadContext uploadContext2, int i11) {
        ...
        public abstract void enqueueRetry(int i11);
            ...
            if (executeAndWait != null) {
                ...
                if (error != null) {
                    ...
                    try {
                        ...
                        endUploadWithFailure(new FacebookException(VideoUploader.ERROR_BAD_SERVER_RESPONSE, (Throwable) e11));
                    }
                } else {
                    handleError(new FacebookException(VideoUploader.ERROR_BAD_SERVER_RESPONSE));
                }
        ...
        public void run() {
            if (!this.uploadContext.isCanceled) {
                try {
                    ...
                    endUploadWithFailure(e11);
                } catch (Exception e12) {
                    endUploadWithFailure(new FacebookException(VideoUploader.ERROR_UPLOAD, (Throwable) e12));
                }
            } else {
    ...
    /* access modifiers changed from: private */
    public static void enqueueUploadChunk(UploadContext uploadContext, String str, String str2, int i11) {
        enqueueRequest(uploadContext, new TransferChunkWorkItem(uploadContext, str, str2, i11));
    }

    /* access modifiers changed from: private */
    public static void enqueueUploadFinish(UploadContext uploadContext, int i11) {
        enqueueRequest(uploadContext, new FinishUploadWorkItem(uploadContext, i11));
    }

    /* access modifiers changed from: private */
    public static void enqueueUploadStart(UploadContext uploadContext, int i11) {
        enqueueRequest(uploadContext, new StartUploadWorkItem(uploadContext, i11));
    }
