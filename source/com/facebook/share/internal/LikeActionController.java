...
public class LikeActionController {
    ...
    public static void createControllerForObjectIdAndType(String str, LikeView.ObjectType objectType2, CreationCallback creationCallback) {
        ...
        handler.post(new Runnable(deserializeFromDiskSynchronously) {
            public final /* synthetic */ LikeActionController val$controllerToRefresh;
    ...
    private static com.facebook.share.internal.LikeActionController deserializeFromDiskSynchronously(java.lang.String r5) {
        /*
            ...
            boolean r2 = com.facebook.internal.Utility.isNullOrEmpty((java.lang.String) r1)     // Catch:{ IOException -> 0x001c }
    ...
    private static LikeActionController deserializeFromJson(String str) {
        try {
            ...
            Log.e(TAG, "Unable to deserialize controller from JSON", e11);
            return null;
        }
    }
        ...
        return new ResultProcessor((FacebookCallback) null) {
            ...
            public void onSuccess(AppCall appCall, Bundle bundle) {
                ...
                if (bundle != null && bundle.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY)) {
                    boolean z11 = bundle.getBoolean(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY);
                    ...
                    LikeActionController.this.updateState(z11, str2, str, str4, str3, str6);
                }
            }
        };
    }
    ...
    @Deprecated
    public static boolean handleOnActivityResult(final int i11, final int i12, final Intent intent) {
        ...
        getControllerForObjectId(objectIdForPendingController, LikeView.ObjectType.UNKNOWN, new CreationCallback() {
            public void onComplete(LikeActionController likeActionController, FacebookException facebookException) {
                if (facebookException == null) {
                    likeActionController.onActivityResult(i11, i12, intent);
                } else {
    ...
    public void onActivityResult(int i11, int i12, Intent intent) {
        ShareInternalUtility.handleActivityResult(i11, i12, intent, getResultProcessor(this.facebookDialogAnalyticsBundle));
        clearState();
    }
            ...
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(CallbackManagerImpl.RequestCodeOffset.Like.toRequestCode(), new CallbackManagerImpl.Callback() {
                    public boolean onActivityResult(int i11, Intent intent) {
                        return LikeActionController.handleOnActivityResult(CallbackManagerImpl.RequestCodeOffset.Like.toRequestCode(), i11, intent);
                    }
                });
                isInitialized = true;
            }
    ...
    public void publishAgainIfNeeded(Bundle bundle) {
        ...
        if (z11 != this.isObjectLikedOnServer && !publishLikeOrUnlikeAsync(z11, bundle)) {
            publishDidError(!this.isObjectLiked);
        }
    }

    /* access modifiers changed from: private */
    public void publishDidError(boolean z11) {
        updateLikeState(z11);
        Bundle bundle = new Bundle();
    ...
    private boolean publishLikeOrUnlikeAsync(boolean z11, Bundle bundle) {
        if (canUseOGPublish()) {
            if (z11) {
            ...
            likeStatusClient.setCompletedListener(new PlatformServiceClient.CompletedListener() {
                public void completed(Bundle bundle) {
                    ...
                    if (bundle != null && bundle.containsKey(ShareConstants.EXTRA_OBJECT_IS_LIKED)) {
                        boolean z11 = bundle.getBoolean(ShareConstants.EXTRA_OBJECT_IS_LIKED);
                        ...
                        LikeActionController.this.updateState(z11, str6, str7, str8, str9, str5);
                    }
                }
            });
        }
    ...
    public static void serializeToDiskSynchronously(String str, String str2) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to serialize controller to disk", e11);
    ...
    private static String serializeToJson(LikeActionController likeActionController) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to serialize controller to JSON", e11);
            return null;
        }
    }
    ...
    private void updateLikeState(boolean z11) {
        updateState(z11, this.likeCountStringWithLike, this.likeCountStringWithoutLike, this.socialSentenceWithLike, this.socialSentenceWithoutLike, this.unlikeToken);
    }

    /* access modifiers changed from: private */
    public void updateState(boolean z11, String str, String str2, String str3, String str4, String str5) {
    ...
    public void toggleLike(Activity activity, FragmentWrapper fragmentWrapper, Bundle bundle) {
        ...
        if (canUseOGPublish()) {
            ...
            } else if (!publishLikeOrUnlikeAsync(z11, bundle)) {
                updateLikeState(!z11);
