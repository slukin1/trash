...
final class LegacyTokenHelper {
    ...
    private void deserializeKey(String str, Bundle bundle) throws JSONException {
        ...
        if (string.equals(TYPE_BOOLEAN_ARRAY)) {
            ...
            while (i11 < length3) {
                sArr[i11] = (short) jSONArray3.getInt(i11);
                i11++;
            }
            ...
            while (i11 < length4) {
                iArr[i11] = jSONArray4.getInt(i11);
                i11++;
            }
            ...
            while (i11 < length7) {
                dArr[i11] = jSONArray7.getDouble(i11);
                i11++;
            }
            ...
            for (int i12 = 0; i12 < length8; i12++) {
                String string3 = jSONArray8.getString(i12);
                if (string3 != null && string3.length() == 1) {
                    cArr[i12] = string3.charAt(0);
                }
            }
            ...
            while (i11 < length9) {
                Object obj = jSONArray9.get(i11);
                arrayList.add(i11, obj == JSONObject.NULL ? null : (String) obj);
                i11++;
            }
    ...
    public static void putExpirationMilliseconds(Bundle bundle, long j11) {
        Validate.notNull(bundle, "bundle");
        bundle.putLong(EXPIRATION_DATE_KEY, j11);
    }
    ...
    public static void putLastRefreshMilliseconds(Bundle bundle, long j11) {
        Validate.notNull(bundle, "bundle");
        bundle.putLong(LAST_REFRESH_DATE_KEY, j11);
    }
    ...
    public Bundle load() {
        ...
        for (String next : this.cache.getAll().keySet()) {
            try {
                ...
                String str = TAG;
                Logger.log(loggingBehavior, 5, str, "Error reading cached value for key: '" + next + "' -- " + e11);
                return null;
            }
        }
        return bundle;
    ...
    public void save(Bundle bundle) {
        ...
        for (String str : bundle.keySet()) {
            try {
                ...
                LoggingBehavior loggingBehavior = LoggingBehavior.CACHE;
                String str2 = TAG;
                Logger.log(loggingBehavior, 5, str2, "Error processing value for key: '" + str + "' -- " + e11);
                return;
            }
        }
        edit.apply();
