...
public final class FetchedAppSettingsManager {
    ...
    public static JSONObject getAppSettingsQueryResponse(String str) {
        ...
        bundle.putString("fields", TextUtils.join(Constants.ACCEPT_TIME_SEPARATOR_SP, new ArrayList(Arrays.asList(APP_SETTING_FIELDS))));
        ...
        if (Utility.isNullOrEmpty(applicationId)) {
            ...
            FacebookSdk.getExecutor().execute(new Runnable() {
                public void run() {
                    ...
                    if (access$100 != null) {
                        FetchedAppSettings unused = FetchedAppSettingsManager.parseAppSettingsFromJSON(applicationId, access$100);
    ...
    public static FetchedAppSettings parseAppSettingsFromJSON(String str, JSONObject jSONObject) {
        ...
        FetchedAppSettings fetchedAppSettings3 = new FetchedAppSettings(jSONObject2.optBoolean(APP_SETTING_SUPPORTS_IMPLICIT_SDK_LOGGING, false), jSONObject2.optString(APP_SETTING_NUX_CONTENT, ""), jSONObject2.optBoolean(APP_SETTING_NUX_ENABLED, false), jSONObject2.optInt(APP_SETTING_APP_EVENTS_SESSION_TIMEOUT, com.facebook.appevents.internal.Constants.getDefaultAppEventsSessionTimeoutInSeconds()), SmartLoginOption.parseOptions(jSONObject2.optLong(APP_SETTING_SMART_LOGIN_OPTIONS)), parseDialogConfigurations(jSONObject2.optJSONObject(APP_SETTING_DIALOG_CONFIGS)), z11, facebookRequestErrorClassification2, jSONObject2.optString(SMART_LOGIN_BOOKMARK_ICON_URL), jSONObject2.optString(SMART_LOGIN_MENU_ICON_URL), z12, z13, optJSONArray2, jSONObject2.optString(SDK_UPDATE_MESSAGE), z14, jSONObject2.optString(APP_SETTING_APP_EVENTS_AAM_RULE), jSONObject2.optString(SUGGESTED_EVENTS_SETTING), jSONObject2.optString(APP_SETTING_RESTRICTIVE_EVENT_FILTER_FIELD));
    ...
    private static Map<String, Map<String, FetchedAppSettings.DialogFeatureConfig>> parseDialogConfigurations(JSONObject jSONObject) {
        ...
        if (!(jSONObject == null || (optJSONArray = jSONObject.optJSONArray("data")) == null)) {
            for (int i11 = 0; i11 < optJSONArray.length(); i11++) {
                FetchedAppSettings.DialogFeatureConfig parseDialogConfig = FetchedAppSettings.DialogFeatureConfig.parseDialogConfig(optJSONArray.optJSONObject(i11));
    ...
    public static synchronized void pollCallbacks() {
        /*
            ...
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicReference<com.facebook.internal.FetchedAppSettingsManager$FetchAppSettingState> r1 = loadingState     // Catch:{ all -> 0x006d }
            java.lang.Object r1 = r1.get()     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$FetchAppSettingState r1 = (com.facebook.internal.FetchedAppSettingsManager.FetchAppSettingState) r1     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$FetchAppSettingState r2 = com.facebook.internal.FetchedAppSettingsManager.FetchAppSettingState.NOT_LOADED     // Catch:{ all -> 0x006d }
            boolean r2 = r2.equals(r1)     // Catch:{ all -> 0x006d }
            if (r2 != 0) goto L_0x006b
            com.facebook.internal.FetchedAppSettingsManager$FetchAppSettingState r2 = com.facebook.internal.FetchedAppSettingsManager.FetchAppSettingState.LOADING     // Catch:{ all -> 0x006d }
            boolean r2 = r2.equals(r1)     // Catch:{ all -> 0x006d }
            if (r2 == 0) goto L_0x001c
            goto L_0x006b
        L_0x001c:
            java.lang.String r2 = com.facebook.FacebookSdk.getApplicationId()     // Catch:{ all -> 0x006d }
            java.util.Map<java.lang.String, com.facebook.internal.FetchedAppSettings> r3 = fetchedAppSettings     // Catch:{ all -> 0x006d }
            java.lang.Object r2 = r3.get(r2)     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettings r2 = (com.facebook.internal.FetchedAppSettings) r2     // Catch:{ all -> 0x006d }
            ...
            com.facebook.internal.FetchedAppSettingsManager$FetchAppSettingState r4 = com.facebook.internal.FetchedAppSettingsManager.FetchAppSettingState.ERROR     // Catch:{ all -> 0x006d }
            boolean r1 = r4.equals(r1)     // Catch:{ all -> 0x006d }
            if (r1 == 0) goto L_0x0052
        L_0x0039:
            java.util.concurrent.ConcurrentLinkedQueue<com.facebook.internal.FetchedAppSettingsManager$FetchedAppSettingsCallback> r1 = fetchedAppSettingsCallbacks     // Catch:{ all -> 0x006d }
            boolean r2 = r1.isEmpty()     // Catch:{ all -> 0x006d }
            if (r2 != 0) goto L_0x0050
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$FetchedAppSettingsCallback r1 = (com.facebook.internal.FetchedAppSettingsManager.FetchedAppSettingsCallback) r1     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$2 r2 = new com.facebook.internal.FetchedAppSettingsManager$2     // Catch:{ all -> 0x006d }
        ...
        L_0x0052:
            ...
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$FetchedAppSettingsCallback r1 = (com.facebook.internal.FetchedAppSettingsManager.FetchedAppSettingsCallback) r1     // Catch:{ all -> 0x006d }
            com.facebook.internal.FetchedAppSettingsManager$3 r4 = new com.facebook.internal.FetchedAppSettingsManager$3     // Catch:{ all -> 0x006d }
    ...
    public static FetchedAppSettings queryAppSettings(String str, boolean z11) {
        if (!z11) {
    ...
    public static void setIsUnityInit(boolean z11) {
        isUnityInit = z11;
        JSONArray jSONArray = unityEventBindings;
        if (jSONArray != null && z11) {
