...
public class ImageRequest {
    ...
    public static class Builder {
        ...
        public Builder setAllowCachedRedirects(boolean z11) {
    ...
    public static Uri getProfilePictureUri(String str, int i11, int i12) {
    ...
    public static Uri getProfilePictureUri(String str, int i11, int i12, String str2) {
