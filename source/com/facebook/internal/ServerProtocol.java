...
public final class ServerProtocol {
    ...
    public static Bundle getQueryParamsForPlatformActivityIntentWebFallback(String str, int i11, Bundle bundle) {
        ...
        try {
            ...
            String str2 = TAG;
            Logger.log(loggingBehavior, 6, str2, "Error creating Url -- " + e11);
            return null;
        }
    }
}
