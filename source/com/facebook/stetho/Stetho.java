...
public class Stetho {
    ...
    public static final class DefaultInspectorModulesBuilder {
        ...
        public DefaultInspectorModulesBuilder excludeSqliteDatabaseDriver(boolean z11) {
            this.mExcludeSqliteDatabaseDriver = z11;
            return this;
        }
        ...
        public Iterable<ChromeDevtoolsDomain> finish() {
            ...
            if (Build.VERSION.SDK_INT >= 11) {
                ...
                if (!z11 && !this.mExcludeSqliteDatabaseDriver) {
    ...
    public static abstract class Initializer {
        ...
        public final void start() {
            new ServerManager(new LocalSocketServer(FlutterActivityLaunchConfigs.DEFAULT_DART_ENTRYPOINT, AddressNameHelper.createCustomAddress("_devtools_remote"), new LazySocketHandler(new RealSocketHandlerFactory()))).start();
        }
    }
    ...
    public static class PluginBuilder<T> {
        ...
        public void provide(String str, T t11) {
            throwIfFinished();
            this.mPlugins.add(t11);
            this.mProvidedNames.add(str);
        }

        public void provideIfDesired(String str, T t11) {
            throwIfFinished();
