...
public class Page implements ChromeDevtoolsDomain {
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.f65007id = 1;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        Iterator<String> it2 = SharedPreferencesHelper.getSharedPreferenceTags(this.mContext).iterator();
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree("1", (String) null, "Stetho", it2.hasNext() ? it2.next() : "");
        ...
        while (it2.hasNext()) {
            ...
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(sb3, "1", "Child #" + sb3, it2.next()));
            i11 = i12;
        }
