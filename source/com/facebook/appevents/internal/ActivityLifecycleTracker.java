...
public class ActivityLifecycleTracker {
    ...
    public static /* synthetic */ int access$108() {
        int i11 = activityReferences;
        activityReferences = i11 + 1;
        return i11;
    }
        ...
        singleThreadExecutor.execute(new Runnable() {
            public void run() {
                ...
                if (ActivityLifecycleTracker.foregroundActivityCount.get() <= 0) {
                    ...
                    synchronized (ActivityLifecycleTracker.currentFutureLock) {
                        ScheduledFuture unused2 = ActivityLifecycleTracker.currentFuture = ActivityLifecycleTracker.singleThreadExecutor.schedule(r02, (long) ActivityLifecycleTracker.getSessionTimeoutInSeconds(), TimeUnit.SECONDS);
                    }
                }
                long access$1100 = ActivityLifecycleTracker.currentActivityAppearTime;
                long j11 = 0;
                if (access$1100 > 0) {
                    j11 = (currentTimeMillis - access$1100) / 1000;
                }
                AutomaticAnalyticsLogger.logActivityTimeSpentEvent(activityName, j11);
