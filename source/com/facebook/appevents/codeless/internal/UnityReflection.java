...
public class UnityReflection {
    ...
    public static void sendMessage(String str, String str2, String str3) {
        ...
        try {
            ...
            unityPlayer.getMethod(UNITY_SEND_MESSAGE_METHOD, new Class[]{cls, cls, cls}).invoke(unityPlayer, new Object[]{str, str2, str3});
        } catch (Exception e11) {
            Log.e(TAG, "Failed to send message to Unity", e11);
        }
    }
}
