...
public class NotificationParams {
    ...
    public JSONArray getJSONArray(String str) {
        ...
        try {
            ...
            Log.w(TAG, "Malformed JSON for key " + userFriendlyKey(str) + l.f34627b + string + ", falling back to default");
            return null;
        }
    }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        try {
            ...
            Log.w(TAG, "Missing format argument for " + userFriendlyKey(str2) + l.f34627b + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e11);
            return null;
        }
    }
