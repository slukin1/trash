...
final class AutoValue_PersistedInstallationEntry extends PersistedInstallationEntry {
    ...
    public static final class Builder extends PersistedInstallationEntry.Builder {
        ...
        public PersistedInstallationEntry.Builder setExpiresInSecs(long j11) {
            this.expiresInSecs = Long.valueOf(j11);
            return this;
        }
        ...
        public PersistedInstallationEntry.Builder setTokenCreationEpochInSecs(long j11) {
            this.tokenCreationEpochInSecs = Long.valueOf(j11);
            return this;
        }
    ...
    public int hashCode() {
        ...
        long j11 = this.expiresInSecs;
        long j12 = this.tokenCreationEpochInSecs;
        int i12 = (((((hashCode2 ^ hashCode3) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)))) * 1000003) ^ ((int) (j12 ^ (j12 >>> 32)))) * 1000003;
        String str4 = this.fisError;
        if (str4 != null) {
            i11 = str4.hashCode();
        }
    ...
    private AutoValue_PersistedInstallationEntry(String str, PersistedInstallation.RegistrationStatus registrationStatus2, String str2, String str3, long j11, long j12, String str4) {
        this.firebaseInstallationId = str;
        this.registrationStatus = registrationStatus2;
        this.authToken = str2;
        this.refreshToken = str3;
        this.expiresInSecs = j11;
        this.tokenCreationEpochInSecs = j12;
        this.fisError = str4;
    }
}
