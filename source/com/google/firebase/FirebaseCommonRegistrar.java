...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, d.f67083a));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, e.f67084a));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, f.f67090a));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, c.f66961a));
