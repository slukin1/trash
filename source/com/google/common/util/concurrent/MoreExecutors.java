...
public final class MoreExecutors {
    ...
    public static final class DirectExecutorService extends AbstractListeningExecutorService {
        ...
        public boolean isTerminated() {
            boolean z11;
            synchronized (this.lock) {
                z11 = this.shutdown && this.runningTasks == 0;
            }
            return z11;
        }
    ...
    public static final class ScheduledListeningDecorator extends ListeningDecorator implements ListeningScheduledExecutorService {
        ...
        public static final class ListenableScheduledTask<V> extends ForwardingListenableFuture.SimpleForwardingListenableFuture<V> implements ListenableScheduledFuture<V> {
            ...
            public boolean cancel(boolean z11) {
                ...
                if (cancel) {
                    this.scheduledDelegate.cancel(z11);
                }
                return cancel;
            }
        ...
        public ListenableScheduledFuture<?> scheduleAtFixedRate(Runnable runnable, long j11, long j12, TimeUnit timeUnit) {
            ...
            return new ListenableScheduledTask(neverSuccessfulListenableFutureTask, this.delegate.scheduleAtFixedRate(neverSuccessfulListenableFutureTask, j11, j12, timeUnit));
        }

        public ListenableScheduledFuture<?> scheduleWithFixedDelay(Runnable runnable, long j11, long j12, TimeUnit timeUnit) {
            NeverSuccessfulListenableFutureTask neverSuccessfulListenableFutureTask = new NeverSuccessfulListenableFutureTask(runnable);
            return new ListenableScheduledTask(neverSuccessfulListenableFutureTask, this.delegate.scheduleWithFixedDelay(neverSuccessfulListenableFutureTask, j11, j12, timeUnit));
        }

        public ListenableScheduledFuture<?> schedule(Runnable runnable, long j11, TimeUnit timeUnit) {
            TrustedListenableFutureTask create = TrustedListenableFutureTask.create(runnable, null);
            return new ListenableScheduledTask(create, this.delegate.schedule(create, j11, timeUnit));
        }
    ...
    public static void addDelayedShutdownHook(ExecutorService executorService, long j11, TimeUnit timeUnit) {
        new Application().addDelayedShutdownHook(executorService, j11, timeUnit);
    }
    ...
    public static ExecutorService getExitingExecutorService(ThreadPoolExecutor threadPoolExecutor, long j11, TimeUnit timeUnit) {
        return new Application().getExitingExecutorService(threadPoolExecutor, j11, timeUnit);
    }
    ...
    public static ScheduledExecutorService getExitingScheduledExecutorService(ScheduledThreadPoolExecutor scheduledThreadPoolExecutor, long j11, TimeUnit timeUnit) {
        return new Application().getExitingScheduledExecutorService(scheduledThreadPoolExecutor, j11, timeUnit);
    }
    ...
    public static ThreadFactory platformThreadFactory() {
        ...
        try {
            ...
            throw Throwables.propagate(e14.getCause());
        }
    }
    ...
    public static class Application {
        public final void addDelayedShutdownHook(ExecutorService executorService, long j11, TimeUnit timeUnit) {
            ...
            addShutdownHook(MoreExecutors.newThread("DelayedShutdownHook-for-" + executorService, new Runnable() {
                public void run() {
                    try {
                        ...
                        executorService2.awaitTermination(j12, timeUnit2);
                    } catch (InterruptedException unused) {
                    }
                }
            }));
        ...
        public final ExecutorService getExitingExecutorService(ThreadPoolExecutor threadPoolExecutor, long j11, TimeUnit timeUnit) {
            MoreExecutors.useDaemonThreadFactory(threadPoolExecutor);
            ExecutorService unconfigurableExecutorService = Executors.unconfigurableExecutorService(threadPoolExecutor);
            addDelayedShutdownHook(threadPoolExecutor, j11, timeUnit);
            return unconfigurableExecutorService;
        }

        public final ScheduledExecutorService getExitingScheduledExecutorService(ScheduledThreadPoolExecutor scheduledThreadPoolExecutor, long j11, TimeUnit timeUnit) {
            MoreExecutors.useDaemonThreadFactory(scheduledThreadPoolExecutor);
            ScheduledExecutorService unconfigurableScheduledExecutorService = Executors.unconfigurableScheduledExecutorService(scheduledThreadPoolExecutor);
            addDelayedShutdownHook(scheduledThreadPoolExecutor, j11, timeUnit);
