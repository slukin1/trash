...
public abstract class AbstractService implements Service {
    ...
    public static final class StateSnapshot {
        ...
        public Throwable failureCause() {
            ...
            Preconditions.checkState(state2 == Service.State.FAILED, "failureCause() is only valid if the service has failed, service is %s", (Object) state2);
            return this.failure;
        }

        public StateSnapshot(Service.State state2, boolean z11, Throwable th2) {
            boolean z12 = false;
            ...
            Preconditions.checkArgument(!((state2 == Service.State.FAILED ? true : z12) ^ (th2 != null)), "A failure cause should be set if and only if the state is failed.  Got %s and %s instead.", (Object) state2, (Object) th2);
            this.state = state2;
