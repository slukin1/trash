...
abstract class AggregateFuture<InputT, OutputT> extends AbstractFuture.TrustedFuture<OutputT> {
    ...
    public abstract class RunningState extends AggregateFutureState implements Runnable {
        ...
        public RunningState(ImmutableCollection<? extends ListenableFuture<? extends InputT>> immutableCollection, boolean z11, boolean z12) {
        ...
        /* access modifiers changed from: private */
        public void handleOneInputDone(int i11, Future<? extends InputT> future) {
            ...
            try {
                ...
                if (this.allMustSucceed) {
                    ...
                    if (this.collectsValues) {
                        collectOneValue(this.allMustSucceed, i11, done);
                    }
                } else if (this.collectsValues && !future.isCancelled()) {
                    collectOneValue(this.allMustSucceed, i11, Futures.getDone(future));
                }
            ...
            if (this.futures.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    ...
                    listenableFuture.addListener(new Runnable() {
                        public void run() {
                            try {
                                RunningState.this.handleOneInputDone(i11, listenableFuture);
                            } finally {
                ...
                while (it3.hasNext()) {
                    ((ListenableFuture) it3.next()).addListener(this, MoreExecutors.directExecutor());
                }
            }
        }
        ...
        private void processCompleted() {
            if (this.collectsValues && (!this.allMustSucceed)) {
                ...
                UnmodifiableIterator<? extends ListenableFuture<? extends InputT>> it2 = this.futures.iterator();
                while (it2.hasNext()) {
                    handleOneInputDone(i11, (ListenableFuture) it2.next());
                    i11++;
                }
            }
            handleAllCompleted();
        ...
        public abstract void collectOneValue(boolean z11, int i11, InputT inputt);
    ...
    public final void releaseResources() {
        ...
        if (runningState2 != null) {
            ...
            if (isCancelled() && (access$000 != null)) {
                UnmodifiableIterator it2 = access$000.iterator();
                while (it2.hasNext()) {
