...
public final class MediaType {
    ...
    public static final MediaType JSON_UTF_8 = createConstantUtf8("application", MTPushConstants.Analysis.KEY_JSON);
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.on("; ").withKeyValueSeparator(ContainerUtils.KEY_VALUE_DELIMITER);
    public static final MediaType PDF = createConstant("application", "pdf");
    public static final MediaType PLAIN_TEXT_UTF_8 = createConstantUtf8("text", ChainInfo.CHAIN_TYPE_PLAIN);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb2.append("; ");
            PARAMETER_JOINER.appendTo(sb2, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new Function<String, String>() {
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            UnmodifiableIterator it2 = this.parameters.get((Object) CHARSET_ATTRIBUTE).iterator();
    ...
    public static final class Tokenizer {
        ...
        public String consumeToken(CharMatcher charMatcher) {
            ...
            Preconditions.checkState(this.position != i11);
        ...
        public String consumeTokenIfPresent(CharMatcher charMatcher) {
            Preconditions.checkState(hasMore());
            int i11 = this.position;
            this.position = charMatcher.negate().indexIn(this.input, i11);
            return hasMore() ? this.input.substring(i11, this.position) : this.input.substring(i11);
        }

        public boolean hasMore() {
            int i11 = this.position;
            return i11 >= 0 && i11 < this.input.length();
        }
        ...
        public char consumeCharacter(char c11) {
            Preconditions.checkState(hasMore());
            Preconditions.checkState(previewChar() == c11);
            this.position++;
            return c11;
        }
    }
