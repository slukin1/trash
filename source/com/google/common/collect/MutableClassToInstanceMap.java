...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    public static <B, T extends B> T cast(Class<T> cls, B b11) {
        return Primitives.wrap(cls).cast(b11);
    }
    ...
    public static <B> Map.Entry<Class<? extends B>, B> checkedEntry(final Map.Entry<Class<? extends B>, B> entry) {
        return new ForwardingMapEntry<Class<? extends B>, B>() {
            public B setValue(B b11) {
                return super.setValue(MutableClassToInstanceMap.cast((Class) getKey(), b11));
            }
    ...
    public B put(Class<? extends B> cls, B b11) {
        return super.put(cls, cast(cls, b11));
    }
}
