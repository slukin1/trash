...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        ...
        public Builder setEnumvalue(int i11, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i11, (EnumValue) builder.build());
            return this;
        }

        public Builder setOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i11, (Option) builder.build());
            return this;
        }
        ...
        public Builder addEnumvalue(int i11, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i11, (EnumValue) builder.build());
            return this;
        }

        public Builder addOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i11, (Option) builder.build());
            return this;
        }
    }
