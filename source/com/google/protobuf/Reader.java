...
interface Reader {
    ...
    <T> void mergeGroupField(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
