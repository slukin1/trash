...
abstract class EventStoreConfig {
    public static final EventStoreConfig DEFAULT = builder().setMaxStorageSizeInBytes(MAX_DB_STORAGE_SIZE_IN_BYTES).setLoadBatchSize(200).setCriticalSectionEnterTimeoutMs(10000).setEventCleanUpAge(604800000).setMaxBlobByteSizePerRow(MAX_BLOB_BYTE_SIZE_PER_ROW).build();
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setCriticalSectionEnterTimeoutMs(int i11);

        public abstract Builder setEventCleanUpAge(long j11);

        public abstract Builder setLoadBatchSize(int i11);

        public abstract Builder setMaxBlobByteSizePerRow(int i11);

        public abstract Builder setMaxStorageSizeInBytes(long j11);
    }
