...
final class AutoValue_EventInternal extends EventInternal {
    ...
    public static final class Builder extends EventInternal.Builder {
        ...
        public EventInternal.Builder setEventMillis(long j11) {
            this.eventMillis = Long.valueOf(j11);
            return this;
        }
        ...
        public EventInternal.Builder setUptimeMillis(long j11) {
            this.uptimeMillis = Long.valueOf(j11);
            return this;
        }
    }
    ...
    public int hashCode() {
        ...
        long j11 = this.eventMillis;
        long j12 = this.uptimeMillis;
        return ((((((((hashCode ^ hashCode2) * 1000003) ^ this.encodedPayload.hashCode()) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)))) * 1000003) ^ ((int) (j12 ^ (j12 >>> 32)))) * 1000003) ^ this.autoMetadata.hashCode();
    }
    ...
    private AutoValue_EventInternal(String str, Integer num, EncodedPayload encodedPayload2, long j11, long j12, Map<String, String> map) {
        this.transportName = str;
        this.code = num;
        this.encodedPayload = encodedPayload2;
        this.eventMillis = j11;
