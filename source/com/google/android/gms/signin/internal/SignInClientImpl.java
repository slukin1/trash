...
public class SignInClientImpl extends GmsClient<zaf> implements zae {
    ...
    public SignInClientImpl(Context context, Looper looper, boolean z11, ClientSettings clientSettings, Bundle bundle, GoogleApiClient.ConnectionCallbacks connectionCallbacks, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public final void zac(IAccountAccessor iAccountAccessor, boolean z11) {
        try {
