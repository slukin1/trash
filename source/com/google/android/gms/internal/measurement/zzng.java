...
class zzng extends AbstractMap {
    ...
    public /* synthetic */ zzng(int i11, zznf zznf) {
        this.zza = i11;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i11 <= size) {
            int i12 = (i11 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzna) this.zzb.get(i12)).zza());
            if (compareTo2 < 0) {
                size = i12 - 1;
    ...
    public final Object zzl(int i11) {
        zzn();
        Object value = ((zzna) this.zzb.remove(i11)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i11 = 0; i11 < zzb2; i11++) {
            if (!zzg(i11).equals(zzng.zzg(i11))) {
                return false;
            }
        }
        if (zzb2 != size) {
    ...
    public final int hashCode() {
        ...
        for (int i12 = 0; i12 < zzb2; i12++) {
            i11 += ((zzna) this.zzb.get(i12)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i12 = this.zza;
        if (size == i12) {
            zzna zzna = (zzna) this.zzb.remove(i12 - 1);
            zzm().put(zzna.zza(), zzna.getValue());
        }
        this.zzb.add(i11, new zzna(this, comparable, obj));
        return null;
    }
