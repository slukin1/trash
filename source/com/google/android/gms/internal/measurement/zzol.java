...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzb = zza2.zzd("measurement.app_uninstalled_additional_ad_id_cache_time", Period.MIN60_MILLS);
        zzc = zza2.zzd("measurement.max_bundles_per_iteration", 100);
        zzd = zza2.zzd("measurement.config.cache_time", Period.DAY_MILLS);
        ...
        zzj = zza2.zzd("measurement.store.max_stored_events_per_app", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
        ...
        zzp = zza2.zzd("measurement.monitoring.sample_period_millis", Period.DAY_MILLS);
        zzq = zza2.zzd("measurement.upload.realtime_upload_interval", 10000);
        zzr = zza2.zzd("measurement.upload.refresh_blacklisted_config_interval", Period.WEEK_MILLS);
        zzs = zza2.zzd("measurement.config.cache_time.service", Period.MIN60_MILLS);
        zzt = zza2.zzd("measurement.service_client.idle_disconnect_millis", 5000);
        zzu = zza2.zze("measurement.log_tag.service", "FA-SVC");
        zzv = zza2.zzd("measurement.upload.stale_data_deletion_interval", Period.DAY_MILLS);
        zzw = zza2.zzd("measurement.sdk.attribution.cache.ttl", Period.WEEK_MILLS);
        ...
        zzA = zza2.zzd("measurement.upload.interval", Period.MIN60_MILLS);
        ...
        zzG = zza2.zzd("measurement.upload.max_events_per_day", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
        ...
        zzM = zza2.zzd("measurement.upload.retry_time", Period.MIN30_MILLS);
        zzN = zza2.zze("measurement.upload.url", "https://app-measurement.com/a");
        zzO = zza2.zzd("measurement.upload.window_interval", Period.MIN60_MILLS);
    }
