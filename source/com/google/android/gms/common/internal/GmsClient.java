...
public abstract class GmsClient<T extends IInterface> extends BaseGmsClient<T> implements Api.Client, zaj {
    ...
    @KeepForSdk
    @VisibleForTesting
    public GmsClient(Context context, Handler handler, int i11, ClientSettings clientSettings) {
        super(context, handler, GmsClientSupervisor.getInstance(context), GoogleApiAvailability.getInstance(), i11, (BaseGmsClient.BaseConnectionCallbacks) null, (BaseGmsClient.BaseOnConnectionFailedListener) null);
    ...
    @KeepForSdk
    public GmsClient(Context context, Looper looper, int i11, ClientSettings clientSettings) {
        this(context, looper, GmsClientSupervisor.getInstance(context), GoogleApiAvailability.getInstance(), i11, clientSettings, (ConnectionCallbacks) null, (OnConnectionFailedListener) null);
    }
