...
public final class zzt {
    ...
    public static /* bridge */ /* synthetic */ void zzm(zzt zzt, zzj zzj2) {
    ...
    public static /* bridge */ /* synthetic */ void zzn(zzt zzt) {
        zzt.zzc.zzd("linkToDeath", new Object[0]);
        try {
            zzt.zzn.asBinder().linkToDeath(zzt.zzk, 0);
        } catch (RemoteException e11) {
            zzt.zzc.zzc(e11, "linkToDeath failed", new Object[0]);
        }
    }

    public static /* bridge */ /* synthetic */ void zzo(zzt zzt) {
