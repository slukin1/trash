...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
    ...
    public static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser xmlPullParser) throws ParserException {
            ...
            if (intValue == 2) {
                builder.setContainerMimeType("video/mp4").setWidth(parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH)).setHeight(parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT)).setInitializationData(buildCodecSpecificData(xmlPullParser.getAttributeValue((String) null, KEY_CODEC_PRIVATE_DATA)));
            } else if (intValue == 1) {
    ...
    public static class SmoothStreamingMediaParser extends ElementParser {
        ...
        public Object build() {
            ...
            if (this.protectionElement != null) {
                ...
                DrmInitData drmInitData = new DrmInitData(new DrmInitData.SchemeData(protectionElement2.uuid, "video/mp4", protectionElement2.data));
