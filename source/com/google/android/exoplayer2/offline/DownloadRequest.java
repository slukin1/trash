...
public final class DownloadRequest implements Parcelable {
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f65951id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List list;
        Assertions.checkArgument(this.f65951id.equals(downloadRequest.f65951id));
        ...
        return new DownloadRequest(this.f65951id, downloadRequest.uri, downloadRequest.mimeType, list, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public final int hashCode() {
        int hashCode = ((this.f65951id.hashCode() * 31 * 31) + this.uri.hashCode()) * 31;
        ...
        return ((hashCode2 + i11) * 31) + Arrays.hashCode(this.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f65951id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).setDrmKeySetId(this.keySetId).build();
    }

    public String toString() {
        String str = this.mimeType;
        String str2 = this.f65951id;
    ...
    public void writeToParcel(Parcel parcel, int i11) {
        parcel.writeString(this.f65951id);
    ...
    public DownloadRequest(Parcel parcel) {
        this.f65951id = (String) Util.castNonNull(parcel.readString());
