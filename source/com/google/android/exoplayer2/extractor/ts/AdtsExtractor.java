...
public final class AdtsExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = c.f65905a;
    ...
    private SeekMap getConstantBitrateSeekMap(long j11) {
        return new ConstantBitrateSeekMap(j11, this.firstFramePosition, getBitrateFromFrameSize(this.averageFrameSize, this.reader.getSampleDurationUs()), this.averageFrameSize);
    }
    ...
    private void maybeOutputSeekMap(long j11, boolean z11, boolean z12) {
        if (!this.hasOutputSeekMap) {
            boolean z13 = z11 && this.averageFrameSize > 0;
            if (!z13 || this.reader.getSampleDurationUs() != -9223372036854775807L || z12) {
                if (!z13 || this.reader.getSampleDurationUs() == -9223372036854775807L) {
                    this.extractorOutput.seekMap(new SeekMap.Unseekable(-9223372036854775807L));
                } else {
                    this.extractorOutput.seekMap(getConstantBitrateSeekMap(j11));
                }
