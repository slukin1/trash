...
public final class PsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = d.f65906a;
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if ((i11 != 0) && !this.durationReader.isDurationReadFinished()) {
        ...
        long peekPosition = i11 != 0 ? length - extractorInput.getPeekPosition() : -1;
    ...
    public void seek(long j11, long j12) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == -9223372036854775807L) || !(this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == j12)) {
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        if (442 != (((bArr[0] & 255) << Ascii.CAN) | ((bArr[1] & 255) << 16) | ((bArr[2] & 255) << 8) | (bArr[3] & 255)) || (bArr[4] & 196) != 68 || (bArr[6] & 4) != 4 || (bArr[8] & 4) != 4 || (bArr[9] & 1) != 1 || (bArr[12] & 3) != 3) {
            return false;
        }
