...
final class SimpleCacheSpan extends CacheSpan {
    ...
    private SimpleCacheSpan(String str, long j11, long j12, long j13, File file) {
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j11, CachedContentIndex cachedContentIndex) {
        return createCacheEntry(file, j11, -9223372036854775807L, cachedContentIndex);
    }

    public static SimpleCacheSpan createHole(String str, long j11, long j12) {
        return new SimpleCacheSpan(str, j11, j12, -9223372036854775807L, (File) null);
    }

    public static SimpleCacheSpan createLookup(String str, long j11) {
        return new SimpleCacheSpan(str, j11, -1, -9223372036854775807L, (File) null);
    }
    ...
    public static SimpleCacheSpan createCacheEntry(File file, long j11, long j12, CachedContentIndex cachedContentIndex) {
        ...
        return new SimpleCacheSpan(keyForId, Long.parseLong((String) Assertions.checkNotNull(matcher.group(2))), length, j12 == -9223372036854775807L ? Long.parseLong((String) Assertions.checkNotNull(matcher.group(3))) : j12, file2);
    }
}
