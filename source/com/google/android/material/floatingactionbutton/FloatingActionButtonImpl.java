...
class FloatingActionButtonImpl {
    ...
    public abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            floatingActionButtonImpl.updateShapeElevation((float) ((int) (f11 + ((this.shadowSizeEnd - f11) * valueAnimator.getAnimatedFraction()))));
        }
    }
    ...
    private void calculateImageMatrixFromScale(float f11, Matrix matrix) {
        matrix.reset();
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f11, float f12, float f13) {
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        ...
        return (MotionSpec) h.g(this.defaultHideMotionSpec);
    }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        ...
        return (MotionSpec) h.g(this.defaultShowMotionSpec);
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return h0.a0(this.view) && !this.view.isInEditMode();
    }
    ...
    public MaterialShapeDrawable createShapeDrawable() {
        return new MaterialShapeDrawable((ShapeAppearanceModel) h.g(this.shapeAppearance));
    }
    ...
    public void hide(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z11) {
        if (!isOrWillBeHidden()) {
    ...
    public void initializeBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i11) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{(Drawable) h.g(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    public void onPaddingUpdated(Rect rect) {
        h.h(this.contentBackground, "Didn't initialize content background");
        if (shouldAddPadding()) {
    ...
    public void show(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z11) {
        if (!isOrWillBeShown()) {
            Animator animator = this.currentAnimator;
            if (animator != null) {
                animator.cancel();
