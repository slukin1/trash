...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private ColorStateList createDefaultColorStateList(int i11) {
        ...
        return new ColorStateList(new int[][]{iArr, CHECKED_STATE_SET, FrameLayout.EMPTY_STATE_SET}, new int[]{a11.getColorForState(iArr, defaultColor), i12, defaultColor});
    }

    private final Drawable createDefaultItemBackground(d0 d0Var) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), d0Var.n(R.styleable.NavigationView_itemShapeAppearance, 0), d0Var.n(R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), d0Var, R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable(materialShapeDrawable, d0Var.f(R.styleable.NavigationView_itemShapeInsetStart, 0), d0Var.f(R.styleable.NavigationView_itemShapeInsetTop, 0), d0Var.f(R.styleable.NavigationView_itemShapeInsetEnd, 0), d0Var.f(R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private boolean hasShapeAppearance(d0 d0Var) {
        return d0Var.s(R.styleable.NavigationView_itemShapeAppearance) || d0Var.s(R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private void setupInsetScrimsListener() {
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
            public void onGlobalLayout() {
                ...
                boolean z11 = true;
                boolean z12 = NavigationView.this.tmpLocation[1] == 0;
                NavigationView.this.presenter.setBehindStatusBar(z12);
                NavigationView.this.setDrawTopInsetForeground(z12);
                Activity activity = ContextUtils.getActivity(NavigationView.this.getContext());
                if (activity != null && Build.VERSION.SDK_INT >= 21) {
                    boolean z13 = activity.findViewById(16908290).getHeight() == NavigationView.this.getHeight();
                    boolean z14 = Color.alpha(activity.getWindow().getNavigationBarColor()) != 0;
                    NavigationView navigationView2 = NavigationView.this;
                    if (!z13 || !z14) {
                        z11 = false;
                    }
                    navigationView2.setDrawBottomInsetForeground(z11);
                }
            }
        };
    ...
    public void setCheckedItem(int i11) {
        ...
        if (findItem != null) {
            this.presenter.setCheckedItem((g) findItem);
        }
    }
    ...
    public NavigationView(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            r3 = r13
            r4 = r6
            androidx.appcompat.widget.d0 r0 = com.google.android.material.internal.ThemeEnforcement.obtainTintedStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r1 = com.google.android.material.R.styleable.NavigationView_android_background
            boolean r2 = r0.s(r1)
            if (r2 == 0) goto L_0x003c
            android.graphics.drawable.Drawable r1 = r0.g(r1)
            androidx.core.view.h0.B0(r10, r1)
        L_0x003c:
        ...
        L_0x0082:
            ...
            android.content.res.ColorStateList r12 = r0.c(r12)
            goto L_0x00a7
        L_0x00a0:
        ...
        L_0x00c7:
            ...
            android.content.res.ColorStateList r3 = r0.c(r4)
        L_0x00d4:
        ...
        L_0x012c:
            ...
            androidx.appcompat.view.menu.j r11 = r11.getMenuView(r10)
