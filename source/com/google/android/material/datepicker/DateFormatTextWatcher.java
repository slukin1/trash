...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    private Runnable createRangeErrorCallback(final long j11) {
        return new Runnable() {
            public void run() {
                DateFormatTextWatcher.this.textInputLayout.setError(String.format(DateFormatTextWatcher.this.outOfRange, new Object[]{DateStrings.getDateString(j11)}));
                DateFormatTextWatcher.this.onInvalidDate();
            }
        };
    }
    ...
    public abstract void onValidDate(Long l11);
