...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void initHeaderToggle(Context context) {
        ...
        h0.x0(this.headerToggleButton, (AccessibilityDelegateCompat) null);
    ...
    public static boolean readMaterialCalendarStyleBoolean(Context context, int i11) {
    ...
    public void startPickerFragment() {
        ...
        q11.t(R.id.mtrl_calendar_frame, this.pickerFragment);
        q11.l();
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background.setElevation(h0.z(dialog.getWindow().getDecorView()));
        return dialog;
    }
    ...
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            long j11 = this.calendarConstraints.getStart().timeInMillis;
            long j12 = this.calendarConstraints.getEnd().timeInMillis;
            ...
            if (j11 <= thisMonthInUtcMilliseconds && thisMonthInUtcMilliseconds <= j12) {
                j11 = thisMonthInUtcMilliseconds;
            }
            return Month.create(j11);
        }
        ...
        public Builder<S> setTheme(int i11) {
            this.overrideThemeResId = i11;
            return this;
        }

        public Builder<S> setTitleText(int i11) {
