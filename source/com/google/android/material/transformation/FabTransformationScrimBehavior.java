...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(View view, boolean z11, boolean z12, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimator;
        MotionTiming motionTiming = z11 ? this.expandTiming : this.collapseTiming;
        if (z11) {
            if (!z12) {
                view.setAlpha(0.0f);
            }
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, final View view2, final boolean z11, boolean z12) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z11, z12, arrayList, new ArrayList());
