...
public class TextAppearance {
    ...
    private boolean shouldLoadFontSynchronously(Context context) {
        ...
        if ((i11 != 0 ? ResourcesCompat.c(context, i11) : null) != null) {
            return true;
        }
        return false;
    }
    ...
    public Typeface getFont(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface h11 = ResourcesCompat.h(context, this.fontFamilyResourceId);
                this.font = h11;
                if (h11 != null) {
                    this.font = Typeface.create(h11, this.textStyle);
                }
            } catch (Resources.NotFoundException | UnsupportedOperationException unused) {
            } catch (Exception e11) {
                Log.d(TAG, "Error loading font " + this.fontFamily, e11);
            }
        }
        createFallbackFont();
    ...
    public void getFontAsync(Context context, final TextAppearanceFontCallback textAppearanceFontCallback) {
        ...
        try {
            ResourcesCompat.j(context, i11, new ResourcesCompat.FontCallback() {
