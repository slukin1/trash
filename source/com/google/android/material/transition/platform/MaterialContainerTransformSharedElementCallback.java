...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public static void removeWindowBackground(Window window) {
        window.getDecorView().getBackground().mutate().setColorFilter(a.a(0, BlendModeCompat.CLEAR));
    }
    ...
    public void onSharedElementEnd(List<String> list, List<View> list2, List<View> list3) {
        if (!list2.isEmpty()) {
            ...
            if (list2.get(0).getTag(i11) instanceof View) {
                list2.get(0).setTag(i11, (Object) null);
            }
        }
    ...
    public void setSharedElementReenterTransitionEnabled(boolean z11) {
        this.sharedElementReenterTransitionEnabled = z11;
    }

    public void setTransparentWindowBackgroundEnabled(boolean z11) {
        this.transparentWindowBackgroundEnabled = z11;
    }
}
