...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(Context context2, AttributeSet attributeSet, int i11, int i12) {
    ...
    private float calculatePointerOffset() {
        ...
        if (((this.displayFrame.right - getBounds().right) - this.locationOnScreenX) - this.layoutMargin < 0) {
            i11 = ((this.displayFrame.right - getBounds().right) - this.locationOnScreenX) - this.layoutMargin;
        } else if (((this.displayFrame.left - getBounds().left) - this.locationOnScreenX) + this.layoutMargin <= 0) {
            return 0.0f;
        } else {
            i11 = ((this.displayFrame.left - getBounds().left) - this.locationOnScreenX) + this.layoutMargin;
        }
        return (float) i11;
    }
    ...
    public static TooltipDrawable createFromAttributes(Context context2, AttributeSet attributeSet, int i11, int i12) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context2, attributeSet, i11, i12);
        tooltipDrawable.loadFromAttributes(attributeSet, i11, i12);
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i11, int i12) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i11, i12, new int[0]);
        ...
        setFillColor(ColorStateList.valueOf(obtainStyledAttributes.getColor(R.styleable.Tooltip_backgroundTint, MaterialColors.layer(c.j(MaterialColors.getColor(this.context, 16842801, TooltipDrawable.class.getCanonicalName()), 229), c.j(MaterialColors.getColor(this.context, R.attr.colorOnBackground, TooltipDrawable.class.getCanonicalName()), 153)))));
    ...
    public void setRevealFraction(float f11) {
        this.tooltipPivotY = 1.2f;
        this.tooltipScaleX = f11;
        this.tooltipScaleY = f11;
        this.labelOpacity = AnimationUtils.lerp(0.0f, 1.0f, 0.19f, 1.0f, f11);
        invalidateSelf();
    }
