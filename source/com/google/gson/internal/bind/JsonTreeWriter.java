...
public final class JsonTreeWriter extends JsonWriter {
    private static final JsonPrimitive SENTINEL_CLOSED = new JsonPrimitive(PointsPack.STATE_CLOSED);
    ...
    public JsonWriter value(boolean z11) throws IOException {
        put(new JsonPrimitive(Boolean.valueOf(z11)));
        return this;
    }
    ...
    public JsonWriter value(double d11) throws IOException {
        if (isLenient() || (!Double.isNaN(d11) && !Double.isInfinite(d11))) {
            put(new JsonPrimitive((Number) Double.valueOf(d11)));
            return this;
        }
    ...
    public JsonWriter value(long j11) throws IOException {
        put(new JsonPrimitive((Number) Long.valueOf(j11)));
        return this;
    }
