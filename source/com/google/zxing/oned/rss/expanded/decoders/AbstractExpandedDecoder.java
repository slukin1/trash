...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case 56:
                return new AI013x0x1xDecoder(bitArray, "310", BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
            case 57:
                return new AI013x0x1xDecoder(bitArray, "320", BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
            case 58:
                return new AI013x0x1xDecoder(bitArray, "310", BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
            case 59:
                return new AI013x0x1xDecoder(bitArray, "320", BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
            case 60:
