...
public enum CharacterSetECI {
    ...
    ASCII((String) new int[]{27, DoubleMath.MAX_FACTORIAL}, (int) new String[]{C.ASCII_NAME}),
    Big5(28),
    ...
    private CharacterSetECI(int i11) {
        this(r3, r4, new int[]{i11}, new String[0]);
    }
    ...
    private CharacterSetECI(int i11, String... strArr) {
