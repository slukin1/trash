...
public final class Version {
    ...
    public static final class ECBlocks {
        ...
        public ECBlocks(int i11, ECB... ecbArr) {
            this.ecCodewordsPerBlock = i11;
    ...
    private Version(int i11, int[] iArr, ECBlocks... eCBlocksArr) {
    ...
    public static Version decodeVersionInformation(int i11) {
        ...
        while (true) {
            ...
            if (i12 < iArr.length) {
                ...
                int numBitsDiffering = FormatInformation.numBitsDiffering(i11, i15);
                if (numBitsDiffering < i13) {
                    i14 = i12 + 7;
                    i13 = numBitsDiffering;
                }
                i12++;
            } else if (i13 <= 3) {
                return getVersionForNumber(i14);
            } else {
                return null;
            }
        }
    ...
    public static Version getProvisionalVersionForDimension(int i11) throws FormatException {
        if (i11 % 4 == 1) {
            try {
                return getVersionForNumber((i11 - 17) / 4);
    ...
    public static Version getVersionForNumber(int i11) {
        if (i11 > 0 && i11 <= 40) {
            return VERSIONS[i11 - 1];
        }
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        int i11 = dimensionForVersion - 8;
        bitMatrix.setRegion(i11, 0, 8, 9);
        bitMatrix.setRegion(0, i11, 9, 8);
        int length = this.alignmentPatternCenters.length;
        for (int i12 = 0; i12 < length; i12++) {
            int i13 = this.alignmentPatternCenters[i12] - 2;
            for (int i14 = 0; i14 < length; i14++) {
                if (!((i12 == 0 && (i14 == 0 || i14 == length - 1)) || (i12 == length - 1 && i14 == 0))) {
                    bitMatrix.setRegion(this.alignmentPatternCenters[i14] - 2, i13, 5, 5);
                }
            }
        }
        int i15 = dimensionForVersion - 17;
        bitMatrix.setRegion(6, 9, 1, i15);
        bitMatrix.setRegion(9, 6, i15, 1);
        if (this.versionNumber > 6) {
            int i16 = dimensionForVersion - 11;
            bitMatrix.setRegion(i16, 0, 3, 6);
            bitMatrix.setRegion(0, i16, 6, 3);
        }
        return bitMatrix;
    }
