...
public class DeliveryHeader extends View implements g {
    ...
    public RefreshState f29485h;

    /* renamed from: i  reason: collision with root package name */
    public PathsDrawable f29486i;

    /* renamed from: j  reason: collision with root package name */
    public PathsDrawable f29487j;

    /* renamed from: k  reason: collision with root package name */
    public PathsDrawable f29488k;
    ...
    public final void a(int i11) {
        this.f29480c += DensityUtil.b(9.0f);
        this.f29481d += DensityUtil.b(5.0f);
        this.f29482e += DensityUtil.b(12.0f);
        int width = this.f29486i.getBounds().width();
        int i12 = i11 + width;
        if (this.f29480c > i12) {
            this.f29480c = -width;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.save();
        int sin = (int) (((double) (this.f29483f / 13)) * Math.sin((double) this.f29484g));
        RefreshState refreshState = this.f29485h;
        RefreshState refreshState2 = RefreshState.Refreshing;
        if (refreshState == refreshState2 || refreshState == RefreshState.RefreshFinish) {
            this.f29486i.getBounds().offsetTo(this.f29480c, this.f29483f / 3);
            this.f29486i.draw(canvas);
            this.f29486i.getBounds().offsetTo(this.f29481d, this.f29483f / 2);
            this.f29486i.draw(canvas);
            this.f29486i.getBounds().offsetTo(this.f29482e, (this.f29483f * 2) / 3);
            this.f29486i.draw(canvas);
            canvas.rotate(((float) Math.sin((double) (this.f29484g / 2.0f))) * 5.0f, (float) (width / 2), (float) ((this.f29483f / 2) - this.f29487j.f()));
            a(width);
        }
        int i11 = this.f29483f;
        int i12 = (height - (i11 / 2)) + sin;
        int i13 = width / 2;
        this.f29488k.getBounds().offsetTo(i13 - (this.f29488k.n() / 2), ((((i11 / 2) - this.f29488k.f()) + i12) - Math.min((this.f29483f / 2) - this.f29488k.f(), DensityUtil.b(this.f29484g * 100.0f))) - (this.f29488k.f() / 4));
        this.f29488k.draw(canvas);
        RefreshState refreshState3 = this.f29485h;
        if (refreshState3 == refreshState2 || refreshState3 == RefreshState.RefreshFinish) {
            Rect bounds = this.f29487j.getBounds();
            int i14 = this.f29483f;
            this.f29487j.getBounds().offsetTo(i13 - (bounds.width() / 2), ((i12 - i14) + Math.min(i14, DensityUtil.b(this.f29484g * 100.0f))) - bounds.height());
            this.f29487j.draw(canvas);
        }
    ...
    public void onPulling(float f11, int i11, int i12, int i13) {
        if (this.f29485h != RefreshState.Refreshing) {
            this.f29488k.e().setAlpha((int) ((1.0f - Math.max(0.0f, f11 - 1.0f)) * 255.0f));
        }
    }
    ...
    public void onStartAnimator(j jVar, int i11, int i12) {
        this.f29485h = RefreshState.Refreshing;
        this.f29488k.e().setAlpha(255);
        invalidate();
    }

    public void onStateChanged(j jVar, RefreshState refreshState, RefreshState refreshState2) {
        this.f29485h = refreshState2;
        if (refreshState2 == RefreshState.None) {
            this.f29484g = 0.0f;
            int i11 = -this.f29486i.getBounds().width();
            this.f29482e = i11;
            this.f29481d = i11;
            this.f29480c = i11;
        }
    ...
    public void setPrimaryColors(int... iArr) {
        if (iArr.length > 0) {
            ...
            if (iArr.length > 1) {
                this.f29486i.h(iArr[1]);
            }
        }
    }

    public DeliveryHeader(Context context, AttributeSet attributeSet, int i11) {
