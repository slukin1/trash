...
public class BallView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        } else if (i11 == 2 && (bitmap = this.bitmap1) != null) {
    ...
    public void setPositionEnd(float f11, float f12) {
        setStatus(2);
        this.currentX = f11;
        this.currentY = f12;
    }

    public void setPositionFinish(float f11, float f12) {
        setStatus(1);
        this.currentX = f11;
        this.currentY = f12;
    }
