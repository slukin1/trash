...
public class TPAudioAttributes {
    ...
    public static final HashMap<Integer, String> mMapContentTypeToString;
    ...
    /* access modifiers changed from: private */
    public static final HashMap<Integer, String> mMapUsageToString;
    /* access modifiers changed from: private */
    ...
    public static class Builder {
        ...
        public Builder addFlags(int i11) {
            this.mFlags = (i11 & 273) | this.mFlags;
            return this;
        }

        public TPAudioAttributes build() {
            TPAudioAttributes tPAudioAttributes = new TPAudioAttributes();
            int unused = tPAudioAttributes.mContentType = this.mContentType;
            int unused2 = tPAudioAttributes.mUsage = this.mUsage;
            int unused3 = tPAudioAttributes.mFlags = this.mFlags;
            return tPAudioAttributes;
        }

        public Builder setContentType(@TPAudioAttributeContentType int i11) {
            if (!TPAudioAttributes.mMapContentTypeToString.containsKey(Integer.valueOf(i11))) {
                i11 = 0;
            }
        ...
        public Builder setLegacyStreamType(@TPAudioAttributeStreamType int i11) {
            HashMap<Integer, Integer> hashMap = mMapStreamTypeToContentType;
            if (hashMap.containsKey(Integer.valueOf(i11))) {
                this.mContentType = hashMap.get(Integer.valueOf(i11)).intValue();
            } else {
                this.mContentType = 0;
            }
            HashMap<Integer, Integer> hashMap2 = mMapStreamTypeToUsage;
            if (hashMap2.containsKey(Integer.valueOf(i11))) {
                this.mUsage = hashMap2.get(Integer.valueOf(i11)).intValue();
            } else {
                this.mUsage = 0;
            }
            return this;
        ...
        public Builder setUsage(@TPAudioAttributeUsage int i11) {
            if (!TPAudioAttributes.mMapUsageToString.containsKey(Integer.valueOf(i11))) {
                i11 = 0;
            }
            this.mUsage = i11;
            return this;
    ...
    private static int contentTypeToAndroidMediaContentType(@TPAudioAttributeContentType int i11) {
    ...
    public static String contentTypeToString(@TPAudioAttributeContentType int i11) {
        HashMap<Integer, String> hashMap = mMapContentTypeToString;
        return hashMap.containsKey(Integer.valueOf(i11)) ? hashMap.get(Integer.valueOf(i11)) : "unknown content type".concat(String.valueOf(i11));
    }

    private static int flagsToAndroidMediaFlags(int i11) {
        int i12 = (i11 & 1) != 0 ? 1 : 0;
        if ((i11 & 16) != 0) {
            i12 |= 16;
        }
        return (i11 & 256) != 0 ? i12 | 256 : i12;
    }

    public static int usageToAndroidMediaStreamType(@TPAudioAttributeUsage int i11) {
    ...
    private static int usageToAndroidMediaUsage(@TPAudioAttributeUsage int i11) {
    ...
    public static String usageToString(@TPAudioAttributeUsage int i11) {
        HashMap<Integer, String> hashMap = mMapUsageToString;
        return hashMap.containsKey(Integer.valueOf(i11)) ? hashMap.get(Integer.valueOf(i11)) : "unknown usage ".concat(String.valueOf(i11));
    }
