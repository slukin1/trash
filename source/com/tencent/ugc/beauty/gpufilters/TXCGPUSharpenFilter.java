...
public class TXCGPUSharpenFilter extends TXCGPUImageFilter {
    ...
    public void onInit(GLTexturePool gLTexturePool) {
        ...
        this.mSharpnessLocation = GLES20.glGetUniformLocation(getProgramId(), "sharpness");
        this.mImageWidthFactorLocation = GLES20.glGetUniformLocation(getProgramId(), "imageWidthFactor");
        this.mImageHeightFactorLocation = GLES20.glGetUniformLocation(getProgramId(), "imageHeightFactor");
        setSharpness(this.mSharpness);
    }

    public void onOutputSizeChanged(int i11, int i12) {
        super.onOutputSizeChanged(i11, i12);
        setFloatOnDraw(this.mImageWidthFactorLocation, 1.0f / ((float) i11));
        setFloatOnDraw(this.mImageHeightFactorLocation, 1.0f / ((float) i12));
    }

    public void setSharpness(float f11) {
        this.mSharpness = f11;
        setFloatOnDraw(this.mSharpnessLocation, f11);
        LiteavLog.d(TAG, "set Sharpness ".concat(String.valueOf(f11)));
    }

    public TXCGPUSharpenFilter(float f11) {
