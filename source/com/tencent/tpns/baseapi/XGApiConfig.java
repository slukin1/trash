...
public class XGApiConfig {
    ...
    public static String getDebugMQTTServer(Context context) {
        if (Util.isNullOrEmptyString(f49741a)) {
            f49741a = PushPreferences.getString(context, "debug_server", "");
        }
        return f49741a;
    }
    ...
    public static void setDebugMQTTServer(Context context, String str) {
        if (!Util.isNullOrEmptyString(str) && !f49741a.equals(str)) {
            f49741a = str;
