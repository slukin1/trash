...
public class V2TIMFriendApplicationResult implements Serializable {
    ...
    public void setFriendApplicationResult(FriendApplicationResult friendApplicationResult2) {
        this.v2TIMFriendApplicationList.clear();
        for (FriendApplication friendApplication : friendApplicationResult2.getFriendApplicationList()) {
        ...
        this.friendApplicationResult = friendApplicationResult2;
    }
}
