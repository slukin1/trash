...
public abstract class V2TIMSignalingManager {
    ...
    public abstract String invite(String str, String str2, boolean z11, V2TIMOfflinePushInfo v2TIMOfflinePushInfo, int i11, V2TIMCallback v2TIMCallback);

    public abstract String inviteInGroup(String str, List<String> list, String str2, boolean z11, int i11, V2TIMCallback v2TIMCallback);
