...
public class V2TIMTopicInfo implements Serializable {
    ...
    public List<V2TIMGroupAtInfo> getGroupAtInfoList() {
        ...
        for (ConversationAtInfo conversationGroupAtInfo : this.topicInfo.getConversation().getConversationAtInfoList()) {
    ...
    public void setAllMute(boolean z11) {
        this.topicInfo.getGroupInfo().setAllShutUp(z11);
