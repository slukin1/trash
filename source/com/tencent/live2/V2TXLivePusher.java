...
public abstract class V2TXLivePusher {
    public abstract int enableAudioProcessObserver(boolean z11, V2TXLiveDef.V2TXLiveAudioFrameObserverFormat v2TXLiveAudioFrameObserverFormat);

    public abstract int enableCustomAudioCapture(boolean z11);

    public abstract int enableCustomVideoCapture(boolean z11);

    public abstract int enableCustomVideoProcess(boolean z11, V2TXLiveDef.V2TXLivePixelFormat v2TXLivePixelFormat, V2TXLiveDef.V2TXLiveBufferType v2TXLiveBufferType);
    ...
    public abstract int sendSeiMessage(int i11, byte[] bArr);

    public abstract int setAudioQuality(V2TXLiveDef.V2TXLiveAudioQuality v2TXLiveAudioQuality);

    public abstract int setEncoderMirror(boolean z11);
    ...
    public abstract int setWatermark(Bitmap bitmap, float f11, float f12, float f13);

    public abstract void showDebugView(boolean z11);

    public abstract int snapshot();

    public abstract int startCamera(boolean z11);
