...
public abstract class ResourceReader implements ResourceIds {
        ...
        try {
            for (Field field : cls.getFields()) {
                if (Modifier.isStatic(field.getModifiers()) && field.getType() == Integer.TYPE) {
                    ...
                    int i11 = field.getInt((Object) null);
                    if (str != null) {
                        name = str + ":" + name;
                    }
            ...
            SALog.i(TAG, "Can't read built-in id names from " + cls.getName(), e11);
        }
    }
    ...
    public String nameForId(int i11) {
        return this.mIdToIdName.get(i11);
    }
}
