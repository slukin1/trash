...
public class SensorsDataEncrypt {
    ...
    private SecreteKey readAppKey() {
        ...
        SALog.i(TAG, "readAppKey [key = " + str3 + " ,v = " + i11 + " ,symmetricEncryptType = " + str + " ,asymmetricEncryptType = " + str2 + "]");
        return new SecreteKey(str3, i11, str, str2);
    }
    ...
    private SecreteKey readLocalKey() throws JSONException {
        ...
        if (!TextUtils.isEmpty(string)) {
            ...
            i11 = jSONObject.optInt("version", 0);
        ...
        SALog.i(TAG, "readLocalKey [key = " + str3 + " ,v = " + i11 + " ,symmetricEncryptType = " + str2 + " ,asymmetricEncryptType = " + str + "]");
        return new SecreteKey(str3, i11, str2, str);
    }
