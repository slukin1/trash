...
public class NetworkUtils {
    ...
    public static boolean compareMainDomain(String str, String str2) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2) || !str2.contains(InstructionFileId.DOT)) {
            return false;
        }
        return str.substring(str.indexOf(InstructionFileId.DOT) + 1).equals(str2.substring(str2.indexOf(InstructionFileId.DOT) + 1));
    }

    public static String getHost(String str) {
        if (!TextUtils.isEmpty(str)) {
            return (str.startsWith(DomainTool.DOMAIN_PREFIX_HTTP) || str.startsWith(DomainTool.DOMAIN_PREFIX)) ? Uri.parse(str).getHost() : "";
        }
        return "";
    }
    ...
    public static String getRequestUrl(String str, String str2) {
        ...
        try {
            return new URI(parse.getScheme(), parse.getUserInfo(), parse.getHost(), parse.getPort(), (String) null, (String) null, (String) null) + "/" + str2;
    ...
    public static boolean isShouldFlush(String str, int i11) {
        return (toNetworkType(str) & i11) != 0;
    }
    ...
    public static String networkType(Context context) {
        try {
            ...
            String mobileNetworkType = mobileNetworkType(context, (TelephonyManager) context.getSystemService(PlaceFields.PHONE), connectivityManager);
