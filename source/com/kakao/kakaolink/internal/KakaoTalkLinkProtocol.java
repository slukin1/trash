...
public final class KakaoTalkLinkProtocol {
    ...
    public static final String f25031a = Charset.forName("UTF-8").name();
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.kakao.kakaolink.internal.KakaoTalkLinkProtocol.a.<clinit>():void");
        }
    }
    ...
    public static String b() {
        ...
        int i11 = a.f25032a[d11.a().ordinal()];
        if (i11 == 1) {
            return "alpha-sharer.devel.kakao.com";
        }
        if (i11 != 2) {
            return i11 != 3 ? "sharer.kakao.com" : "beta-sharer.kakao.com";
        }
