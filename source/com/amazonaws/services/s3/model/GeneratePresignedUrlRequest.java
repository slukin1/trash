...
public class GeneratePresignedUrlRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public void setZeroByteContent(boolean z11) {
        this.zeroByteContent = z11;
    }
    ...
    public GeneratePresignedUrlRequest withZeroByteContent(boolean z11) {
        setZeroByteContent(z11);
        return this;
    }
