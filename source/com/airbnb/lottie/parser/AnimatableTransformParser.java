...
public class AnimatableTransformParser {
    ...
    private static final JsonReader.Options NAMES = JsonReader.Options.of("a", TtmlNode.TAG_P, s.f70071a, "rz", "r", "o", "so", "eo", "sk", "sa");
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader2.selectName(NAMES)) {
                ...
                case 5:
                    ...
                    continue;
                case 6:
                    animatableFloatValue4 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z12);
                    continue;
                case 7:
                    animatableFloatValue5 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z12);
                    continue;
                case 8:
                    animatableFloatValue2 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z12);
                    continue;
                case 9:
                    animatableFloatValue3 = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z12);
                    continue;
                default:
                    boolean z17 = z12;
                    jsonReader.skipName();
            ...
            AnimatableFloatValue parseFloat = AnimatableValueParser.parseFloat(jsonReader2, lottieComposition2, z12);
