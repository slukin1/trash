...
public class LinearSwapContractInfo implements Serializable {
    ...
    private String pair;
    @SerializedName("precision_list")
    private List<Map<String, String>> precisionList;
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof LinearSwapContractInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LinearSwapContractInfo)) {
            return false;
        }
        LinearSwapContractInfo linearSwapContractInfo = (LinearSwapContractInfo) obj;
        if (!linearSwapContractInfo.canEqual(this)) {
            return false;
        }
        String symbol2 = getSymbol();
        String symbol3 = linearSwapContractInfo.getSymbol();
        if (symbol2 != null ? !symbol2.equals(symbol3) : symbol3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = linearSwapContractInfo.getContractCode();
        if (contractCode2 != null ? !contractCode2.equals(contractCode3) : contractCode3 != null) {
            return false;
        }
        String contractType2 = getContractType();
        String contractType3 = linearSwapContractInfo.getContractType();
        if (contractType2 != null ? !contractType2.equals(contractType3) : contractType3 != null) {
            return false;
        }
        String contractFace2 = getContractFace();
        String contractFace3 = linearSwapContractInfo.getContractFace();
        if (contractFace2 != null ? !contractFace2.equals(contractFace3) : contractFace3 != null) {
            return false;
        }
        String priceTick2 = getPriceTick();
        String priceTick3 = linearSwapContractInfo.getPriceTick();
        if (priceTick2 != null ? !priceTick2.equals(priceTick3) : priceTick3 != null) {
            return false;
        }
        String deliveryDate2 = getDeliveryDate();
        String deliveryDate3 = linearSwapContractInfo.getDeliveryDate();
        if (deliveryDate2 != null ? !deliveryDate2.equals(deliveryDate3) : deliveryDate3 != null) {
            return false;
        }
        if (getDeliveryTime() != linearSwapContractInfo.getDeliveryTime()) {
            return false;
        }
        Long settlementTime2 = getSettlementTime();
        Long settlementTime3 = linearSwapContractInfo.getSettlementTime();
        if (settlementTime2 != null ? !settlementTime2.equals(settlementTime3) : settlementTime3 != null) {
            return false;
        }
        String createDate2 = getCreateDate();
        String createDate3 = linearSwapContractInfo.getCreateDate();
        if (createDate2 != null ? !createDate2.equals(createDate3) : createDate3 != null) {
            return false;
        }
        if (getContractStatus() != linearSwapContractInfo.getContractStatus() || getAmountPrecision() != linearSwapContractInfo.getAmountPrecision() || getFeeAmountPrecision() != linearSwapContractInfo.getFeeAmountPrecision() || getOtherAmountPrecision() != linearSwapContractInfo.getOtherAmountPrecision() || getPricePrecision() != linearSwapContractInfo.getPricePrecision()) {
            return false;
        }
        String limitOpen2 = getLimitOpen();
        String limitOpen3 = linearSwapContractInfo.getLimitOpen();
        if (limitOpen2 != null ? !limitOpen2.equals(limitOpen3) : limitOpen3 != null) {
            return false;
        }
        String limitClose2 = getLimitClose();
        String limitClose3 = linearSwapContractInfo.getLimitClose();
        if (limitClose2 != null ? !limitClose2.equals(limitClose3) : limitClose3 != null) {
            return false;
        }
        String marketOpen2 = getMarketOpen();
        String marketOpen3 = linearSwapContractInfo.getMarketOpen();
        if (marketOpen2 != null ? !marketOpen2.equals(marketOpen3) : marketOpen3 != null) {
            return false;
        }
        String marketClose2 = getMarketClose();
        String marketClose3 = linearSwapContractInfo.getMarketClose();
        if (marketClose2 != null ? !marketClose2.equals(marketClose3) : marketClose3 != null) {
            return false;
        }
        String contractShortType2 = getContractShortType();
        String contractShortType3 = linearSwapContractInfo.getContractShortType();
        ...
        String activityTitle3 = linearSwapContractInfo.getActivityTitle();
        if (activityTitle2 != null ? !activityTitle2.equals(activityTitle3) : activityTitle3 != null) {
            return false;
        }
        String activityId2 = getActivityId();
        String activityId3 = linearSwapContractInfo.getActivityId();
        if (activityId2 != null ? !activityId2.equals(activityId3) : activityId3 != null) {
            return false;
        }
        String activityUrl2 = getActivityUrl();
        String activityUrl3 = linearSwapContractInfo.getActivityUrl();
        if (activityUrl2 != null ? !activityUrl2.equals(activityUrl3) : activityUrl3 != null) {
            return false;
        }
        String supportMarginMode2 = getSupportMarginMode();
        String supportMarginMode3 = linearSwapContractInfo.getSupportMarginMode();
        if (supportMarginMode2 != null ? !supportMarginMode2.equals(supportMarginMode3) : supportMarginMode3 != null) {
            return false;
        }
        String businessType2 = getBusinessType();
        String businessType3 = linearSwapContractInfo.getBusinessType();
        if (businessType2 != null ? !businessType2.equals(businessType3) : businessType3 != null) {
            return false;
        }
        String pair2 = getPair();
        String pair3 = linearSwapContractInfo.getPair();
        if (pair2 != null ? !pair2.equals(pair3) : pair3 != null) {
            return false;
        }
        String tradePartition2 = getTradePartition();
        String tradePartition3 = linearSwapContractInfo.getTradePartition();
        if (tradePartition2 != null ? !tradePartition2.equals(tradePartition3) : tradePartition3 != null) {
            return false;
        }
        List<Map<String, String>> precisionList2 = getPrecisionList();
        List<Map<String, String>> precisionList3 = linearSwapContractInfo.getPrecisionList();
        if (precisionList2 != null ? !precisionList2.equals(precisionList3) : precisionList3 != null) {
            return false;
        }
        List<CurrencyAdjust> adjust2 = getAdjust();
        List<CurrencyAdjust> adjust3 = linearSwapContractInfo.getAdjust();
        if (adjust2 != null ? adjust2.equals(adjust3) : adjust3 == null) {
            return isNotSupportTrade() == linearSwapContractInfo.isNotSupportTrade();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String supportMarginMode2 = getSupportMarginMode();
        int hashCode17 = (hashCode16 * 59) + (supportMarginMode2 == null ? 43 : supportMarginMode2.hashCode());
        String businessType2 = getBusinessType();
        int hashCode18 = (hashCode17 * 59) + (businessType2 == null ? 43 : businessType2.hashCode());
        String pair2 = getPair();
        int hashCode19 = (hashCode18 * 59) + (pair2 == null ? 43 : pair2.hashCode());
        String tradePartition2 = getTradePartition();
        int hashCode20 = (hashCode19 * 59) + (tradePartition2 == null ? 43 : tradePartition2.hashCode());
        List<Map<String, String>> precisionList2 = getPrecisionList();
        int hashCode21 = (hashCode20 * 59) + (precisionList2 == null ? 43 : precisionList2.hashCode());
        List<CurrencyAdjust> adjust2 = getAdjust();
        int i13 = hashCode21 * 59;
        if (adjust2 != null) {
