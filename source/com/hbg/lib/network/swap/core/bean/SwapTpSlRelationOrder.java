...
public class SwapTpSlRelationOrder implements Serializable {
    ...
    public List<SwapTpSlOrder> tpSlOrderInfo;
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapTpSlRelationOrder;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SwapTpSlRelationOrder)) {
            return false;
        }
        SwapTpSlRelationOrder swapTpSlRelationOrder = (SwapTpSlRelationOrder) obj;
        if (!swapTpSlRelationOrder.canEqual(this)) {
            return false;
        }
        String symbol2 = getSymbol();
        String symbol3 = swapTpSlRelationOrder.getSymbol();
        if (symbol2 != null ? !symbol2.equals(symbol3) : symbol3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = swapTpSlRelationOrder.getContractCode();
        if (contractCode2 != null ? !contractCode2.equals(contractCode3) : contractCode3 != null) {
            return false;
        }
        if (getVolume() != swapTpSlRelationOrder.getVolume()) {
            return false;
        }
        String price2 = getPrice();
        String price3 = swapTpSlRelationOrder.getPrice();
        if (price2 != null ? !price2.equals(price3) : price3 != null) {
            return false;
        }
        String orderPriceType2 = getOrderPriceType();
        String orderPriceType3 = swapTpSlRelationOrder.getOrderPriceType();
        if (orderPriceType2 != null ? !orderPriceType2.equals(orderPriceType3) : orderPriceType3 != null) {
            return false;
        }
        String direction2 = getDirection();
        String direction3 = swapTpSlRelationOrder.getDirection();
        if (direction2 != null ? !direction2.equals(direction3) : direction3 != null) {
            return false;
        }
        String offset2 = getOffset();
        String offset3 = swapTpSlRelationOrder.getOffset();
        if (offset2 != null ? !offset2.equals(offset3) : offset3 != null) {
            return false;
        }
        String leverRate2 = getLeverRate();
        String leverRate3 = swapTpSlRelationOrder.getLeverRate();
        if (leverRate2 != null ? !leverRate2.equals(leverRate3) : leverRate3 != null) {
            return false;
        }
        if (getOrderId() != swapTpSlRelationOrder.getOrderId()) {
            return false;
        }
        String orderIdStr2 = getOrderIdStr();
        String orderIdStr3 = swapTpSlRelationOrder.getOrderIdStr();
        if (orderIdStr2 != null ? !orderIdStr2.equals(orderIdStr3) : orderIdStr3 != null) {
            return false;
        }
        if (getClientOrderId() != swapTpSlRelationOrder.getClientOrderId() || getCreatedAt() != swapTpSlRelationOrder.getCreatedAt()) {
            return false;
        }
        String tradeVolume2 = getTradeVolume();
        String tradeVolume3 = swapTpSlRelationOrder.getTradeVolume();
        if (tradeVolume2 != null ? !tradeVolume2.equals(tradeVolume3) : tradeVolume3 != null) {
            return false;
        }
        String tradeTurnover2 = getTradeTurnover();
        String tradeTurnover3 = swapTpSlRelationOrder.getTradeTurnover();
        if (tradeTurnover2 != null ? !tradeTurnover2.equals(tradeTurnover3) : tradeTurnover3 != null) {
            return false;
        }
        String fee2 = getFee();
        String fee3 = swapTpSlRelationOrder.getFee();
        if (fee2 != null ? !fee2.equals(fee3) : fee3 != null) {
            return false;
        }
        String tradeAvgPrice2 = getTradeAvgPrice();
        String tradeAvgPrice3 = swapTpSlRelationOrder.getTradeAvgPrice();
        if (tradeAvgPrice2 != null ? !tradeAvgPrice2.equals(tradeAvgPrice3) : tradeAvgPrice3 != null) {
            return false;
        }
        String marginFrozen2 = getMarginFrozen();
        String marginFrozen3 = swapTpSlRelationOrder.getMarginFrozen();
        if (marginFrozen2 != null ? !marginFrozen2.equals(marginFrozen3) : marginFrozen3 != null) {
            return false;
        }
        String profit2 = getProfit();
        String profit3 = swapTpSlRelationOrder.getProfit();
        if (profit2 != null ? !profit2.equals(profit3) : profit3 != null) {
            return false;
        }
        if (getStatus() != swapTpSlRelationOrder.getStatus() || getOrderType() != swapTpSlRelationOrder.getOrderType()) {
            return false;
        }
        String orderSource2 = getOrderSource();
        String orderSource3 = swapTpSlRelationOrder.getOrderSource();
        if (orderSource2 != null ? !orderSource2.equals(orderSource3) : orderSource3 != null) {
            return false;
        }
        String feeAsset2 = getFeeAsset();
        String feeAsset3 = swapTpSlRelationOrder.getFeeAsset();
        if (feeAsset2 != null ? !feeAsset2.equals(feeAsset3) : feeAsset3 != null) {
            return false;
        }
        if (getCanceledAt() != swapTpSlRelationOrder.getCanceledAt()) {
            return false;
        }
        List<SwapTpSlOrder> tpSlOrderInfo2 = getTpSlOrderInfo();
        List<SwapTpSlOrder> tpSlOrderInfo3 = swapTpSlRelationOrder.getTpSlOrderInfo();
    ...
    public List<SwapTpSlOrder> getTpSlOrderInfo() {
    ...
    public int hashCode() {
        ...
        String contractCode2 = getContractCode();
        int hashCode2 = ((((hashCode + 59) * 59) + (contractCode2 == null ? 43 : contractCode2.hashCode())) * 59) + getVolume();
        String price2 = getPrice();
        int hashCode3 = (hashCode2 * 59) + (price2 == null ? 43 : price2.hashCode());
        String orderPriceType2 = getOrderPriceType();
        int hashCode4 = (hashCode3 * 59) + (orderPriceType2 == null ? 43 : orderPriceType2.hashCode());
        String direction2 = getDirection();
        int hashCode5 = (hashCode4 * 59) + (direction2 == null ? 43 : direction2.hashCode());
        String offset2 = getOffset();
        int hashCode6 = (hashCode5 * 59) + (offset2 == null ? 43 : offset2.hashCode());
        String leverRate2 = getLeverRate();
        int hashCode7 = (hashCode6 * 59) + (leverRate2 == null ? 43 : leverRate2.hashCode());
        ...
        int i13 = (hashCode8 * 59) + ((int) (clientOrderId2 ^ (clientOrderId2 >>> 32)));
        long createdAt2 = getCreatedAt();
        int i14 = (i13 * 59) + ((int) (createdAt2 ^ (createdAt2 >>> 32)));
        String tradeVolume2 = getTradeVolume();
        int hashCode9 = (i14 * 59) + (tradeVolume2 == null ? 43 : tradeVolume2.hashCode());
        String tradeTurnover2 = getTradeTurnover();
        int hashCode10 = (hashCode9 * 59) + (tradeTurnover2 == null ? 43 : tradeTurnover2.hashCode());
        String fee2 = getFee();
        int hashCode11 = (hashCode10 * 59) + (fee2 == null ? 43 : fee2.hashCode());
        String tradeAvgPrice2 = getTradeAvgPrice();
        int hashCode12 = (hashCode11 * 59) + (tradeAvgPrice2 == null ? 43 : tradeAvgPrice2.hashCode());
        String marginFrozen2 = getMarginFrozen();
        int hashCode13 = (hashCode12 * 59) + (marginFrozen2 == null ? 43 : marginFrozen2.hashCode());
        String profit2 = getProfit();
        int hashCode14 = (((((hashCode13 * 59) + (profit2 == null ? 43 : profit2.hashCode())) * 59) + getStatus()) * 59) + getOrderType();
        String orderSource2 = getOrderSource();
        int hashCode15 = (hashCode14 * 59) + (orderSource2 == null ? 43 : orderSource2.hashCode());
        String feeAsset2 = getFeeAsset();
        int hashCode16 = (hashCode15 * 59) + (feeAsset2 == null ? 43 : feeAsset2.hashCode());
        long canceledAt2 = getCanceledAt();
        int i15 = (hashCode16 * 59) + ((int) (canceledAt2 ^ (canceledAt2 >>> 32)));
        List<SwapTpSlOrder> tpSlOrderInfo2 = getTpSlOrderInfo();
        int i16 = i15 * 59;
    ...
    public void setTpSlOrderInfo(List<SwapTpSlOrder> list) {
