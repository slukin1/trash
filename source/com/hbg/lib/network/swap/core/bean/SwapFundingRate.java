...
public class SwapFundingRate implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapFundingRate;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SwapFundingRate)) {
            return false;
        }
        SwapFundingRate swapFundingRate = (SwapFundingRate) obj;
        if (!swapFundingRate.canEqual(this)) {
            return false;
        }
        String fundingRate2 = getFundingRate();
        String fundingRate3 = swapFundingRate.getFundingRate();
        if (fundingRate2 != null ? !fundingRate2.equals(fundingRate3) : fundingRate3 != null) {
            return false;
        }
        String finalFundingRate2 = getFinalFundingRate();
        String finalFundingRate3 = swapFundingRate.getFinalFundingRate();
        if (finalFundingRate2 != null ? finalFundingRate2.equals(finalFundingRate3) : finalFundingRate3 == null) {
            return getFundingTime() == swapFundingRate.getFundingTime() && getNextFundingTime() == swapFundingRate.getNextFundingTime();
        }
        return false;
    }
    ...
    public String toString() {
        return "SwapFundingRate(fundingRate=" + getFundingRate() + ", finalFundingRate=" + getFinalFundingRate() + ", fundingTime=" + getFundingTime() + ", nextFundingTime=" + getNextFundingTime() + ")";
    }
}
