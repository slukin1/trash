...
public class SwapUserOrderLimitType implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapUserOrderLimitType;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SwapUserOrderLimitType)) {
            return false;
        }
        SwapUserOrderLimitType swapUserOrderLimitType = (SwapUserOrderLimitType) obj;
        if (!swapUserOrderLimitType.canEqual(this)) {
            return false;
        }
        String symbol2 = getSymbol();
        String symbol3 = swapUserOrderLimitType.getSymbol();
        if (symbol2 != null ? !symbol2.equals(symbol3) : symbol3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = swapUserOrderLimitType.getContractCode();
        if (contractCode2 != null ? !contractCode2.equals(contractCode3) : contractCode3 != null) {
            return false;
        }
        String openLimit2 = getOpenLimit();
        String openLimit3 = swapUserOrderLimitType.getOpenLimit();
        if (openLimit2 != null ? !openLimit2.equals(openLimit3) : openLimit3 != null) {
            return false;
        }
        String closeLimit2 = getCloseLimit();
        String closeLimit3 = swapUserOrderLimitType.getCloseLimit();
        if (closeLimit2 != null ? !closeLimit2.equals(closeLimit3) : closeLimit3 != null) {
            return false;
        }
        String positionLimitLong2 = getPositionLimitLong();
        String positionLimitLong3 = swapUserOrderLimitType.getPositionLimitLong();
        ...
        String positionLimitShort3 = swapUserOrderLimitType.getPositionLimitShort();
        ...
        String openOrdersLong3 = swapUserOrderLimitType.getOpenOrdersLong();
        ...
        String openOrdersShort3 = swapUserOrderLimitType.getOpenOrdersShort();
    ...
    public String toString() {
        return "SwapUserOrderLimitType(symbol=" + getSymbol() + ", contractCode=" + getContractCode() + ", openLimit=" + getOpenLimit() + ", closeLimit=" + getCloseLimit() + ", positionLimitLong=" + getPositionLimitLong() + ", positionLimitShort=" + getPositionLimitShort() + ", openOrdersLong=" + getOpenOrdersLong() + ", openOrdersShort=" + getOpenOrdersShort() + ")";
    }
}
