...
public class SwapOpenRight implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapOpenRight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SwapOpenRight)) {
            return false;
        }
        SwapOpenRight swapOpenRight = (SwapOpenRight) obj;
        if (!swapOpenRight.canEqual(this)) {
            return false;
        }
        String kycCountryCode2 = getKycCountryCode();
        String kycCountryCode3 = swapOpenRight.getKycCountryCode();
        if (kycCountryCode2 != null ? !kycCountryCode2.equals(kycCountryCode3) : kycCountryCode3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = swapOpenRight.getContractCode();
        if (contractCode2 != null ? contractCode2.equals(contractCode3) : contractCode3 == null) {
            return getRight() == swapOpenRight.getRight() && getCloseRight() == swapOpenRight.getCloseRight();
        }
        return false;
    }
    ...
    public String toString() {
        return "SwapOpenRight(kycCountryCode=" + getKycCountryCode() + ", contractCode=" + getContractCode() + ", right=" + getRight() + ", closeRight=" + getCloseRight() + ")";
    }
}
