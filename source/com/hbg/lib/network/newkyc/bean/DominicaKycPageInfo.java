...
public class DominicaKycPageInfo implements Serializable {
    ...
    private Integer bindMintState;
    private String cardApplyText;
    private String cardApplyUrl;
    private String desc;
    private boolean isShowMint;
    ...
    public static class BaseInfo implements Serializable {
        private int authCountry;
        private String birthDay;
        private String cardNumber;
        private int digitalAuthCountry;
        private String firstName;
        private String lastName;
        private String realCardNumber;
        private String realNationalityName;
        ...
        public boolean equals(Object obj) {
            ...
            if (getAuthCountry() != baseInfo.getAuthCountry() || getDigitalAuthCountry() != baseInfo.getDigitalAuthCountry()) {
                return false;
            }
            String realNationalityName2 = getRealNationalityName();
            String realNationalityName3 = baseInfo.getRealNationalityName();
            if (realNationalityName2 != null ? !realNationalityName2.equals(realNationalityName3) : realNationalityName3 != null) {
                return false;
            }
            String realCardNumber2 = getRealCardNumber();
            String realCardNumber3 = baseInfo.getRealCardNumber();
            return realCardNumber2 != null ? realCardNumber2.equals(realCardNumber3) : realCardNumber3 == null;
        }

        public int getAuthCountry() {
        ...
        public int getDigitalAuthCountry() {
            return this.digitalAuthCountry;
        }
        ...
        public String getRealNationalityName() {
            return this.realNationalityName;
        }
        ...
        public int hashCode() {
            ...
            String birthDay2 = getBirthDay();
            int hashCode5 = (((((hashCode4 * 59) + (birthDay2 == null ? 43 : birthDay2.hashCode())) * 59) + getAuthCountry()) * 59) + getDigitalAuthCountry();
            String realNationalityName2 = getRealNationalityName();
            int hashCode6 = (hashCode5 * 59) + (realNationalityName2 == null ? 43 : realNationalityName2.hashCode());
            String realCardNumber2 = getRealCardNumber();
            int i12 = hashCode6 * 59;
            if (realCardNumber2 != null) {
                i11 = realCardNumber2.hashCode();
            }
            return i12 + i11;
        }

        public void setAuthCountry(int i11) {
            this.authCountry = i11;
        }
        ...
        public void setDigitalAuthCountry(int i11) {
            this.digitalAuthCountry = i11;
        }
        ...
        public void setRealNationalityName(String str) {
            this.realNationalityName = str;
        }
        ...
        public String toString() {
            return "DominicaKycPageInfo.BaseInfo(firstName=" + getFirstName() + ", lastName=" + getLastName() + ", sexDesc=" + getSexDesc() + ", cardNumber=" + getCardNumber() + ", birthDay=" + getBirthDay() + ", authCountry=" + getAuthCountry() + ", digitalAuthCountry=" + getDigitalAuthCountry() + ", realNationalityName=" + getRealNationalityName() + ", realCardNumber=" + getRealCardNumber() + ")";
        }
    }
    ...
    public static class VerifyStatusInfo implements Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            String authUrl3 = verifyStatusInfo.getAuthUrl();
            ...
            String rejectCode2 = getRejectCode();
            String rejectCode3 = verifyStatusInfo.getRejectCode();
            if (rejectCode2 != null ? !rejectCode2.equals(rejectCode3) : rejectCode3 != null) {
                return false;
            }
            String reason2 = getReason();
            String reason3 = verifyStatusInfo.getReason();
        ...
        public int hashCode() {
            String authUrl2 = getAuthUrl();
            int i11 = 43;
            int authState2 = ((getAuthState() + 59) * 59) + (authUrl2 == null ? 43 : authUrl2.hashCode());
            String authStep2 = getAuthStep();
            int hashCode = (((authState2 * 59) + (authStep2 == null ? 43 : authStep2.hashCode())) * 59) + getAuthStepValue();
            String equityDesc2 = getEquityDesc();
            int hashCode2 = (hashCode * 59) + (equityDesc2 == null ? 43 : equityDesc2.hashCode());
            String rejectCode2 = getRejectCode();
            int hashCode3 = (hashCode2 * 59) + (rejectCode2 == null ? 43 : rejectCode2.hashCode());
            String reason2 = getReason();
            int hashCode4 = (hashCode3 * 59) + (reason2 == null ? 43 : reason2.hashCode());
            List<TextConfigInfo> textConfig2 = getTextConfig();
        ...
        public String toString() {
            return "DominicaKycPageInfo.VerifyStatusInfo(authState=" + getAuthState() + ", authUrl=" + getAuthUrl() + ", authStep=" + getAuthStep() + ", authStepValue=" + getAuthStepValue() + ", equityDesc=" + getEquityDesc() + ", rejectCode=" + getRejectCode() + ", reason=" + getReason() + ", textConfig=" + getTextConfig() + ")";
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!dominicaKycPageInfo.canEqual(this) || getUid() != dominicaKycPageInfo.getUid() || getMaxLevel() != dominicaKycPageInfo.getMaxLevel()) {
            return false;
        }
        ...
        if (stepStates2 != null ? !stepStates2.equals(stepStates3) : stepStates3 != null) {
            return false;
        }
        Integer bindMintState2 = getBindMintState();
        Integer bindMintState3 = dominicaKycPageInfo.getBindMintState();
        if (bindMintState2 != null ? !bindMintState2.equals(bindMintState3) : bindMintState3 != null) {
            return false;
        }
        if (isShowMint() != dominicaKycPageInfo.isShowMint()) {
            return false;
        }
        String mintText2 = getMintText();
        String mintText3 = dominicaKycPageInfo.getMintText();
        if (mintText2 != null ? !mintText2.equals(mintText3) : mintText3 != null) {
            return false;
        }
        String mintUrl2 = getMintUrl();
        String mintUrl3 = dominicaKycPageInfo.getMintUrl();
        return mintUrl2 != null ? mintUrl2.equals(mintUrl3) : mintUrl3 == null;
    }
    ...
    public Integer getBindMintState() {
        return this.bindMintState;
    }
    ...
    public int hashCode() {
        long uid2 = getUid();
        int maxLevel2 = ((((int) (uid2 ^ (uid2 >>> 32))) + 59) * 59) + getMaxLevel();
        String maxLevelDesc2 = getMaxLevelDesc();
        int i11 = 43;
        int hashCode = (maxLevel2 * 59) + (maxLevelDesc2 == null ? 43 : maxLevelDesc2.hashCode());
        BaseInfo baseInfo2 = getBaseInfo();
        int hashCode2 = (hashCode * 59) + (baseInfo2 == null ? 43 : baseInfo2.hashCode());
        String title2 = getTitle();
        int hashCode3 = (hashCode2 * 59) + (title2 == null ? 43 : title2.hashCode());
        String desc2 = getDesc();
        int hashCode4 = (hashCode3 * 59) + (desc2 == null ? 43 : desc2.hashCode());
        String cardApplyText2 = getCardApplyText();
        int hashCode5 = (hashCode4 * 59) + (cardApplyText2 == null ? 43 : cardApplyText2.hashCode());
        String cardApplyUrl2 = getCardApplyUrl();
        int hashCode6 = (hashCode5 * 59) + (cardApplyUrl2 == null ? 43 : cardApplyUrl2.hashCode());
        List<VerifyStatusInfo> stepStates2 = getStepStates();
        int hashCode7 = (hashCode6 * 59) + (stepStates2 == null ? 43 : stepStates2.hashCode());
        Integer bindMintState2 = getBindMintState();
        int hashCode8 = (((hashCode7 * 59) + (bindMintState2 == null ? 43 : bindMintState2.hashCode())) * 59) + (isShowMint() ? 79 : 97);
        String mintText2 = getMintText();
        int hashCode9 = (hashCode8 * 59) + (mintText2 == null ? 43 : mintText2.hashCode());
        String mintUrl2 = getMintUrl();
        int i12 = hashCode9 * 59;
        if (mintUrl2 != null) {
            i11 = mintUrl2.hashCode();
        }
        return i12 + i11;
    }

    public boolean isShowMint() {
        return this.isShowMint;
    }
    ...
    public void setBindMintState(Integer num) {
        this.bindMintState = num;
    }
    ...
    public void setMintText(String str) {
        this.mintText = str;
    }

    public void setMintUrl(String str) {
        this.mintUrl = str;
    }

    public void setShowMint(boolean z11) {
        this.isShowMint = z11;
    }
    ...
    public String toString() {
        return "DominicaKycPageInfo(uid=" + getUid() + ", maxLevel=" + getMaxLevel() + ", maxLevelDesc=" + getMaxLevelDesc() + ", baseInfo=" + getBaseInfo() + ", title=" + getTitle() + ", desc=" + getDesc() + ", cardApplyText=" + getCardApplyText() + ", cardApplyUrl=" + getCardApplyUrl() + ", stepStates=" + getStepStates() + ", bindMintState=" + getBindMintState() + ", isShowMint=" + isShowMint() + ", mintText=" + getMintText() + ", mintUrl=" + getMintUrl() + ")";
    }
}
