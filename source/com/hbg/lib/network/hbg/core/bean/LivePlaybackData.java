...
public class LivePlaybackData extends LiveSquareBaseData {
    ...
    private int f70252id;
    private String introduction;
    private int needShare;
    private int onlineNum;
    private List<LiveSpeaker> speakerList;
    ...
    public List<LiveSpeaker> getSpeakerList() {
    ...
    public void setSpeakerList(List<LiveSpeaker> list) {
