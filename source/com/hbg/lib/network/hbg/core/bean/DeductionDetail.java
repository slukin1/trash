...
public class DeductionDetail implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        String takerDeduction3 = deductionDetail.getTakerDeduction();
    ...
    public String toString() {
        return "DeductionDetail(makerFeeRate=" + getMakerFeeRate() + ", takerFeeRate=" + getTakerFeeRate() + ", makerDeduction=" + getMakerDeduction() + ", takerDeduction=" + getTakerDeduction() + ")";
    }
}
