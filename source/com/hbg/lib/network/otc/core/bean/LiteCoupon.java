...
public class LiteCoupon implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof LiteCoupon;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LiteCoupon)) {
            return false;
        }
        LiteCoupon liteCoupon = (LiteCoupon) obj;
        if (!liteCoupon.canEqual(this) || getId() != liteCoupon.getId() || getCouponId() != liteCoupon.getCouponId() || getActivityId() != liteCoupon.getActivityId()) {
            return false;
        }
        String baseCurrency2 = getBaseCurrency();
        String baseCurrency3 = liteCoupon.getBaseCurrency();
        if (baseCurrency2 != null ? !baseCurrency2.equals(baseCurrency3) : baseCurrency3 != null) {
            return false;
        }
        String quoteCurrency2 = getQuoteCurrency();
        String quoteCurrency3 = liteCoupon.getQuoteCurrency();
        if (quoteCurrency2 != null ? !quoteCurrency2.equals(quoteCurrency3) : quoteCurrency3 != null) {
            return false;
        }
        if (getType() != liteCoupon.getType() || getState() != liteCoupon.getState()) {
            return false;
        }
        String meetCondition2 = getMeetCondition();
        String meetCondition3 = liteCoupon.getMeetCondition();
        if (meetCondition2 != null ? !meetCondition2.equals(meetCondition3) : meetCondition3 != null) {
            return false;
        }
        String amount2 = getAmount();
        String amount3 = liteCoupon.getAmount();
        if (amount2 != null ? !amount2.equals(amount3) : amount3 != null) {
            return false;
        }
        if (getBeginTime() != liteCoupon.getBeginTime() || getEndTime() != liteCoupon.getEndTime()) {
            return false;
        }
        String ceiling2 = getCeiling();
        String ceiling3 = liteCoupon.getCeiling();
        if (ceiling2 != null ? !ceiling2.equals(ceiling3) : ceiling3 != null) {
            return false;
        }
        String quoteSign2 = getQuoteSign();
        String quoteSign3 = liteCoupon.getQuoteSign();
        if (quoteSign2 != null ? !quoteSign2.equals(quoteSign3) : quoteSign3 != null) {
            return false;
        }
        String rules2 = getRules();
        String rules3 = liteCoupon.getRules();
        if (rules2 != null ? !rules2.equals(rules3) : rules3 != null) {
            return false;
        }
        if (getSysTime() != liteCoupon.getSysTime()) {
            return false;
        }
        String businessType2 = getBusinessType();
        String businessType3 = liteCoupon.getBusinessType();
        if (businessType2 != null ? !businessType2.equals(businessType3) : businessType3 != null) {
            return false;
        }
        String title2 = getTitle();
        String title3 = liteCoupon.getTitle();
        if (title2 != null ? !title2.equals(title3) : title3 != null) {
            return false;
        }
        if (Double.compare(getUsedHP(), liteCoupon.getUsedHP()) != 0 || isSelected() != liteCoupon.isSelected() || isEnable() != liteCoupon.isEnable() || isShowSelected() != liteCoupon.isShowSelected() || getUseConditions() != liteCoupon.getUseConditions() || getSavingsEffectDays() != liteCoupon.getSavingsEffectDays()) {
            return false;
        }
        String url2 = getUrl();
        String url3 = liteCoupon.getUrl();
    ...
    public String toString() {
        return "LiteCoupon(id=" + getId() + ", couponId=" + getCouponId() + ", activityId=" + getActivityId() + ", baseCurrency=" + getBaseCurrency() + ", quoteCurrency=" + getQuoteCurrency() + ", type=" + getType() + ", state=" + getState() + ", meetCondition=" + getMeetCondition() + ", amount=" + getAmount() + ", beginTime=" + getBeginTime() + ", endTime=" + getEndTime() + ", ceiling=" + getCeiling() + ", quoteSign=" + getQuoteSign() + ", rules=" + getRules() + ", sysTime=" + getSysTime() + ", businessType=" + getBusinessType() + ", title=" + getTitle() + ", usedHP=" + getUsedHP() + ", isSelected=" + isSelected() + ", isEnable=" + isEnable() + ", isShowSelected=" + isShowSelected() + ", useConditions=" + getUseConditions() + ", savingsEffectDays=" + getSavingsEffectDays() + ", url=" + getUrl() + ")";
    }
}
