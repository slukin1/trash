...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public static final SparseIntArray f16932a = new SparseIntArray(0);
    ...
    public f b(b bVar, View view, int i11) {
        if (f16932a.get(i11) <= 0 || view.getTag() != null) {
            return null;
        }
    ...
    public f c(b bVar, View[] viewArr, int i11) {
        if (viewArr == null || viewArr.length == 0 || f16932a.get(i11) <= 0 || viewArr[0].getTag() != null) {
            return null;
        }
        throw new RuntimeException("view must have a tag");
    }
