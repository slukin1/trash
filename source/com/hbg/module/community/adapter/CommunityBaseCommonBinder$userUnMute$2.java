...
public final class CommunityBaseCommonBinder$userUnMute$2 extends Lambda implements p<Throwable, APIStatusErrorException, Unit> {
    public final /* synthetic */ Context $context;
    public final /* synthetic */ CommunityBaseCommonBinder<ItemData, SubViewHolder> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CommunityBaseCommonBinder$userUnMute$2(CommunityBaseCommonBinder<ItemData, SubViewHolder> communityBaseCommonBinder, Context context) {
        super(2);
