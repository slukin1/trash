...
public final class CommunityBaseCommonBinder$onBindShareAction$1$1$upLoadCallback$1 extends Lambda implements l<Integer, Unit> {
    ...
    public CommunityBaseCommonBinder$onBindShareAction$1$1$upLoadCallback$1(CommunityFeedInfo.ListBean listBean, CommunityBaseCommonBinder.a aVar) {
        super(1);
        this.$item = listBean;
        this.$holder = aVar;
    }
