...
public final class SNSListItemView extends SNSStepView {
    public SNSListItemView(Context context) {
    ...
    public SNSListItemView(Context context, AttributeSet attributeSet, int i11) {
        this(context, attributeSet, i11, 0, 8, (r) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ SNSListItemView(Context context, AttributeSet attributeSet, int i11, int i12, int i13, r rVar) {
        this(context, (i13 & 2) != 0 ? null : attributeSet, (i13 & 4) != 0 ? R.attr.sns_ListItemViewStyle : i11, (i13 & 8) != 0 ? R.style.Widget_SNSListItemView : i12);
    }

    public SNSListItemView(Context context, AttributeSet attributeSet, int i11, int i12) {
        super(context, attributeSet, i11, i12, (SNSMetricElement) null);
        a aVar = a.f31095a;
        d a11 = aVar.a();
        if (a11 != null) {
            Integer a12 = aVar.a((View) this, SNSColorElement.CONTENT_STRONG);
            Integer a13 = aVar.a((View) this, SNSColorElement.CONTENT_NEUTRAL);
            if (a12 != null) {
                setTitleTextColor(ColorStateList.valueOf(a12.intValue()));
                setIconTintColor(ColorStateList.valueOf(a12.intValue()));
            }
            if (a13 != null) {
                setSubtitleTextColor(ColorStateList.valueOf(a13.intValue()));
            }
            Integer a14 = aVar.a((View) this, SNSColorElement.BACKGROUND_NEUTRAL);
            if (a14 != null) {
                setCardBackgroundColor(ColorStateList.valueOf(a14.intValue()));
            }
            Float a15 = aVar.a(a11, SNSMetricElement.CARD_CORNER_RADIUS);
            if (a15 != null) {
