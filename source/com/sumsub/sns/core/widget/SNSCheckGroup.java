...
public final class SNSCheckGroup extends LinearLayout implements a {
    ...
    public void addView(View view, int i11, ViewGroup.LayoutParams layoutParams) {
        ...
        d a12 = aVar.a();
        if ((view instanceof CheckBox) && a12 != null) {
            ...
            if (a13 != null && (a11 = aVar.a(a13, sNSColorElement, aVar.a((View) this))) != null) {
                ...
                iArr2[1] = intValue;
                ((CheckBox) view).setButtonTintList(new ColorStateList(iArr, iArr2));
            }
        }
    }
    ...
    public SNSCheckGroup(Context context, AttributeSet attributeSet, int i11) {
        this(context, attributeSet, i11, 0, 8, (r) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ SNSCheckGroup(Context context, AttributeSet attributeSet, int i11, int i12, int i13, r rVar) {
        this(context, (i13 & 2) != 0 ? null : attributeSet, (i13 & 4) != 0 ? R.attr.sns_CheckGroupStyle : i11, (i13 & 8) != 0 ? R.style.Widget_SNSCheckGroup : i12);
    }

    public SNSCheckGroup(Context context, AttributeSet attributeSet, int i11, int i12) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.SNSCheckGroup, i11, i12);
        ...
        if (a13 != null) {
            materialShapeDrawable.setFillColor(new ColorStateList(new int[][]{new int[]{R.attr.sns_stateInit}, new int[]{R.attr.sns_stateRejected}, new int[0]}, new int[]{0, a13.intValue(), 0}));
        }
