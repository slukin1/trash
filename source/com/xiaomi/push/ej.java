...
public enum ej {
    ...
    CONN_BOSH_ERR(20499),
    BIND_SUCCESS(CDNDownload.DEFAULT_TIMEOUT),
    ...
    CHANNEL_TIMER_DELAYED(BaseConstants.ERR_SVR_CONV_ACCOUNT_NOT_FOUND);
        ...
        switch (i11) {
            ...
            default:
                switch (i11) {
                    ...
                    case CDNDownload.DEFAULT_TIMEOUT:
                        return BIND_SUCCESS;
                    case 30199:
                        return BIND_TCP_ERR;
                    case 30399:
