...
public abstract class cj {
    ...
    public static class a extends ci {
        ...
        public String a(Context context, String str, List<au> list) {
            if (list == null) {
                return av.a(context, new URL(str));
            }
            Uri.Builder buildUpon = Uri.parse(str).buildUpon();
            for (au next : list) {
                buildUpon.appendQueryParameter(next.a(), next.b());
            }
            return av.a(context, new URL(buildUpon.toString()));
        }
    }

    public static String a(Context context, String str, List<au> list) {
    ...
    public static java.lang.String a(android.content.Context r20, java.lang.String r21, java.util.List<com.xiaomi.push.au> r22, com.xiaomi.push.ci r23, boolean r24) {
        /*
            r1 = r20
            r0 = r21
            r2 = r22
            r3 = r23
            boolean r4 = com.xiaomi.push.av.a((android.content.Context) r20)
            r5 = 0
            ...
            com.xiaomi.push.ch r6 = com.xiaomi.push.ch.a()     // Catch:{ MalformedURLException -> 0x00c3 }
            com.xiaomi.push.cd r6 = r6.a((java.lang.String) r0)     // Catch:{ MalformedURLException -> 0x00c3 }
            if (r6 == 0) goto L_0x0024
            java.util.ArrayList r4 = r6.a((java.lang.String) r0)     // Catch:{ MalformedURLException -> 0x00c3 }
        L_0x0024:
            r13 = r6
            goto L_0x0027
        L_0x0026:
        ...
        L_0x004c:
            ...
            boolean r0 = r3.a((android.content.Context) r1, (java.lang.String) r14, (java.util.List<com.xiaomi.push.au>) r15)     // Catch:{ IOException -> 0x00a4 }
            if (r0 != 0) goto L_0x0058
            goto L_0x00c2
        L_0x0058:
            java.lang.String r12 = r3.a((android.content.Context) r1, (java.lang.String) r14, (java.util.List<com.xiaomi.push.au>) r15)     // Catch:{ IOException -> 0x00a4 }
        ...
        L_0x00c7:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.cj.a(android.content.Context, java.lang.String, java.util.List, com.xiaomi.push.ci, boolean):java.lang.String");
    }

    private static int a(ci ciVar, String str, List<au> list, String str2) {
        if (ciVar.a() == 1) {
    ...
    public static int a(List<au> list) {
        int i11 = 0;
        for (au next : list) {
    ...
    public static int a(int i11, int i12) {
        return (((i12 + 243) / 1448) * 132) + 1080 + i11 + i12;
    }
