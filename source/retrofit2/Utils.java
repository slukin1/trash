...
final class Utils {
    ...
    public static Type getParameterLowerBound(int i11, ParameterizedType parameterizedType) {
    ...
    public static RuntimeException parameterError(Method method, Throwable th2, int i11, String str, Object... objArr) {
        return methodError(method, th2, str + " (parameter #" + (i11 + 1) + ")", objArr);
    }
    ...
    public static RuntimeException parameterError(Method method, int i11, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i11 + 1) + ")", objArr);
    }
}
