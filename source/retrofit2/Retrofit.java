...
public final class Retrofit {
    ...
    public Retrofit(Call.Factory factory, HttpUrl httpUrl, List<Converter.Factory> list, List<CallAdapter.Factory> list2, Executor executor, boolean z11) {
    ...
    public <T> Converter<T, RequestBody> nextRequestBodyConverter(Converter.Factory factory, Type type, Annotation[] annotationArr, Annotation[] annotationArr2) {
        ...
        for (int i11 = indexOf; i11 < size; i11++) {
            Converter<?, RequestBody> requestBodyConverter = this.converterFactories.get(i11).requestBodyConverter(type, annotationArr, annotationArr2, this);
    ...
    public <T> Converter<ResponseBody, T> nextResponseBodyConverter(Converter.Factory factory, Type type, Annotation[] annotationArr) {
        ...
        int size = this.converterFactories.size();
        for (int i11 = indexOf; i11 < size; i11++) {
            Converter<ResponseBody, ?> responseBodyConverter = this.converterFactories.get(i11).responseBodyConverter(type, annotationArr, this);
    ...
    public <T> Converter<T, String> stringConverter(Type type, Annotation[] annotationArr) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            Converter<?, String> stringConverter = this.converterFactories.get(i11).stringConverter(type, annotationArr, this);
