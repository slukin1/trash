...
class CellMarginDecorator extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(android.graphics.Rect r10, android.view.View r11, androidx.recyclerview.widget.RecyclerView r12, androidx.recyclerview.widget.RecyclerView.State r13) {
        ...
        L_0x0077:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: zendesk.support.request.CellMarginDecorator.getItemOffsets(android.graphics.Rect, android.view.View, androidx.recyclerview.widget.RecyclerView, androidx.recyclerview.widget.RecyclerView$State):void");
    }

    public CellMarginDecorator(ComponentRequestAdapter componentRequestAdapter, int i11, int i12) {
        this.dataSource = componentRequestAdapter;
        this.verticalMargin = i11;
        this.groupVerticalMargin = i12;
    }
}
