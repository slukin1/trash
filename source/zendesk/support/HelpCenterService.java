...
interface HelpCenterService {
    ...
    Call<Void> deleteVote(@Path("vote_id") Long l11);

    @POST("/api/v2/help_center/articles/{article_id}/down.json")
    Call<ArticleVoteResponse> downvoteArticle(@Path("article_id") Long l11, @Body String str);

    @GET("/hc/api/mobile/{locale}/articles/{article_id}.json?respect_sanitization_settings=true")
    Call<ArticleResponse> getArticle(@Path("locale") String str, @Path("article_id") Long l11, @Query("include") String str2);

    @GET("/api/v2/help_center/{locale}/sections/{id}/articles.json?respect_sanitization_settings=true")
    Call<ArticlesListResponse> getArticles(@Path("locale") String str, @Path("id") Long l11, @Query("label_names") String str2, @Query("include") String str3, @Query("per_page") int i11);

    @GET("/api/v2/help_center/{locale}/articles/{article_id}/attachments/{attachment_type}.json")
    Call<AttachmentResponse> getAttachments(@Path("locale") String str, @Path("article_id") Long l11, @Path("attachment_type") String str2);
    ...
    Call<CategoryResponse> getCategoryById(@Path("locale") String str, @Path("category_id") Long l11);

    @GET("/hc/api/mobile/{locale}/article_tree.json")
    Call<HelpResponse> getHelp(@Path("locale") String str, @Query("category_ids") String str2, @Query("section_ids") String str3, @Query("include") String str4, @Query("limit") int i11, @Query("article_labels") String str5, @Query("per_page") int i12, @Query("sort_by") String str6, @Query("sort_order") String str7);

    @GET("/api/v2/help_center/{locale}/sections/{section_id}.json")
    Call<SectionResponse> getSectionById(@Path("locale") String str, @Path("section_id") Long l11);

    @GET("/api/v2/help_center/{locale}/categories/{id}/sections.json")
    Call<SectionsResponse> getSections(@Path("locale") String str, @Path("id") Long l11, @Query("per_page") int i11);

    @GET("/api/mobile/help_center/search/deflect.json?respect_sanitization_settings=true")
    Call<SuggestedArticleResponse> getSuggestedArticles(@Query("query") String str, @Query("locale") String str2, @Query("label_names") String str3, @Query("category") Long l11, @Query("section") Long l12);
    ...
    Call<Void> submitRecordArticleView(@Path("article_id") Long l11, @Path("locale") String str, @Body RecordArticleViewRequest recordArticleViewRequest);

    @POST("/api/v2/help_center/articles/{article_id}/up.json")
    Call<ArticleVoteResponse> upvoteArticle(@Path("article_id") Long l11, @Body String str);
}
