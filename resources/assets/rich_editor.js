...
RE.setPlaceholder = function(placeholder, styleName) {
    RE.editor.setAttribute("placeholder", placeholder);
    RE.editor.setAttribute("class", styleName);
}
...
RE.insertImage = function(url, alt) {
    var html = '<img src="' + url + '" alt="' + alt + '" style="width:100%; height:auto; margin-top: 10px; margin-bottom: 10px" /><br><br>';
    RE.insertHTML(html);
}
...
RE.insertVideo = function(url, alt) {
    var html = '<video src="' + url + '" style="width:100%; height:auto" controls></video><br><br>';
    RE.insertHTML(html);
}
