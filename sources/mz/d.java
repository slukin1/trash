...
public final class d {
    ...
    public static final Map<String, String> f58288a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    public static final Map<String, String> f58289b = new HashMap();
    ...
    static {
        ...
        a("application/msword", TtmlNode.TEXT_EMPHASIS_MARK_DOT);
        ...
        a("audio/amr", "amr");
        a(MimeTypes.AUDIO_AMR_WB, "awb");
        a("audio/basic", "snd");
        a(MimeTypes.AUDIO_FLAC, "flac");
        a("application/x-flac", "flac");
        a("audio/imelody", "imy");
        a("audio/midi", CommunityConstants.REQUEST_KEY_MID);
        a("audio/midi", "midi");
        a("audio/midi", "ota");
        a("audio/midi", "kar");
        a("audio/midi", "rtttl");
        ...
        a("audio/mpeg", "m4a");
        a("audio/mpegurl", "m3u");
        a(MimeTypes.AUDIO_OGG, "oga");
        a(MimeTypes.AUDIO_OGG, "ogg");
        a(MimeTypes.AUDIO_OGG, "spx");
        a("audio/prs.sid", "sid");
        a("audio/x-aiff", "aif");
        a("audio/x-aiff", "aiff");
        a("audio/x-aiff", "aifc");
        a("audio/x-gsm", MTCommonConstants.Network.RADIO_3G);
        a(MimeTypes.AUDIO_MATROSKA, "mka");
        ...
        a("text/x-csh", "csh");
        a("text/x-csrc", "c");
        a("text/x-dsrc", GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG);
        a("text/x-haskell", "hs");
        a("text/x-java", u.f30502m);
        a("text/x-literate-haskell", "lhs");
        a("text/x-moc", "moc");
        a("text/x-pascal", TtmlNode.TAG_P);
        a("text/x-pascal", "pas");
        ...
        a(MimeTypes.VIDEO_MATROSKA, "mkv");
        a("video/x-mng", "mng");
        a("video/x-ms-asf", "asf");
        a("video/x-ms-asf", "asx");
        a("video/x-ms-wm", VulcanInfo.WM);
    ...
    public static void a(String str, String str2) {
        Map<String, String> map = f58288a;
        if (!map.containsKey(str)) {
            map.put(str, str2);
        }
        Map<String, String> map2 = f58289b;
    ...
    public static String b(String str) {
        ...
        return f58289b.get(str.toLowerCase(Locale.US));
    }
}
