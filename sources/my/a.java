...
public class a {
    ...
    public static class b {
        ...
        public static void a(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            ...
            L_0x030a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: my.a.b.a(android.graphics.Path, float[], char, char, float[]):void");
        }
        ...
        public static void d(b[] bVarArr, Path path) {
            ...
            for (int i11 = 0; i11 < bVarArr.length; i11++) {
                a(path, fArr, c11, bVarArr[i11].f37232a, bVarArr[i11].f37233b);
                c11 = bVarArr[i11].f37232a;
            }
        }
    }
    ...
    public static float[] b(float[] fArr, int i11, int i12) {
        if (i11 <= i12) {
    ...
    public static b[] c(String str) {
        ...
        while (i11 < str.length()) {
            int g11 = g(str, i11);
            String trim = str.substring(i12, g11).trim();
            if (trim.length() > 0) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void e(java.lang.String r8, int r9, my.a.C0509a r10) {
        /*
            r0 = 0
            r10.f37231b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: my.a.e(java.lang.String, int, my.a$a):void");
    }
    ...
    public static List<Path> h(float f11, float f12, List<Path> list, List<String> list2) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0048, code lost:
        if (r0 == 's') goto L_0x004b;
     */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x005a  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void i(float r18, float r19, char r20, float[] r21) {
        /*
            r0 = r20
            r1 = r21
            r5 = 84
        ...
        L_0x012d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: my.a.i(float, float, char, float[]):void");
    }

    public static void j(float f11, float f12, b[] bVarArr) {
        for (int i11 = 0; i11 < bVarArr.length; i11++) {
            i(f11, f12, bVarArr[i11].f37232a, bVarArr[i11].f37233b);
        }
    }
}
