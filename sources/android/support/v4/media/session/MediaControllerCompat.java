...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z11) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(11, Boolean.valueOf(z11), (Bundle) null);
                }
            }
            ...
            public void onRepeatModeChanged(int i11) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(9, Integer.valueOf(i11), (Bundle) null);
                }
            }
            ...
            public void onShuffleModeChanged(int i11) throws RemoteException {
                Callback callback = (Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(12, Integer.valueOf(i11), (Bundle) null);
                }
            }

            public void onShuffleModeChangedRemoved(boolean z11) throws RemoteException {
            }
    ...
    public static abstract class TransportControls {
        ...
        public abstract void skipToQueueItem(long j11);
    ...
    public static class TransportControlsBase extends TransportControls {
        ...
        public void fastForward() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in fastForward.", e11);
            }
        }
        ...
        public void pause() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in pause.", e11);
            }
        }
        ...
        public void play() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in play.", e11);
            }
        }
        ...
        public void playFromMediaId(String str, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in playFromMediaId.", e11);
            }
        }
        ...
        public void playFromSearch(String str, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in playFromSearch.", e11);
            }
        }
        ...
        public void playFromUri(Uri uri, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in playFromUri.", e11);
            }
        }
        ...
        public void prepare() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in prepare.", e11);
            }
        }
        ...
        public void prepareFromMediaId(String str, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in prepareFromMediaId.", e11);
            }
        }
        ...
        public void prepareFromSearch(String str, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in prepareFromSearch.", e11);
            }
        }
        ...
        public void prepareFromUri(Uri uri, Bundle bundle) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in prepareFromUri.", e11);
            }
        }
        ...
        public void rewind() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in rewind.", e11);
            }
        }

        public void seekTo(long j11) {
            try {
                this.mBinder.seekTo(j11);
            } catch (RemoteException e11) {
                Log.e(MediaControllerCompat.TAG, "Dead object in seekTo.", e11);
            }
        }
        ...
        public void setCaptioningEnabled(boolean z11) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in setCaptioningEnabled.", e11);
            }
        }
        ...
        public void setRating(RatingCompat ratingCompat) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in setRating.", e11);
            }
        }
        ...
        public void setRepeatMode(int i11) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in setRepeatMode.", e11);
            }
        }
        ...
        public void setShuffleMode(int i11) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in setShuffleMode.", e11);
            }
        }
        ...
        public void skipToNext() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in skipToNext.", e11);
            }
        }
        ...
        public void skipToPrevious() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in skipToPrevious.", e11);
            }
        }

        public void skipToQueueItem(long j11) {
            try {
                this.mBinder.skipToQueueItem(j11);
            } catch (RemoteException e11) {
                Log.e(MediaControllerCompat.TAG, "Dead object in skipToQueueItem.", e11);
            }
        }
        ...
        public void stop() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in stop.", e11);
            }
        }
        ...
        public void sendCustomAction(String str, Bundle bundle) {
            ...
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in sendCustomAction.", e11);
            }
        }
    ...
    public MediaControllerCompat(Context context, MediaSessionCompat mediaSessionCompat) {
        ...
        if (mediaSessionCompat != null) {
            ...
            try {
                ...
                Log.w(TAG, "Failed to create MediaControllerImpl.", e11);
            }
            this.mImpl = mediaControllerImplBase;
            return;
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        if (activity instanceof ComponentActivity) {
            ...
            try {
                ...
                Log.e(TAG, "Dead object in getMediaController.", e11);
                return null;
            }
        }
    }
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void seekTo(long j11) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, j11);
        }
        ...
        public void setCaptioningEnabled(boolean z11) {
            ...
            bundle.putBoolean(MediaSessionCompat.ACTION_ARGUMENT_CAPTIONING_ENABLED, z11);
        ...
        public void setRepeatMode(int i11) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_REPEAT_MODE, i11);
            sendCustomAction(MediaSessionCompat.ACTION_SET_REPEAT_MODE, bundle);
        }

        public void setShuffleMode(int i11) {
            Bundle bundle = new Bundle();
            bundle.putInt(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE, i11);
        ...
        public void skipToQueueItem(long j11) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, j11);
        }
    ...
    public static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in addQueueItem.", e11);
            }
        }

        public void adjustVolume(int i11, int i12) {
            try {
                this.mBinder.adjustVolume(i11, i12, (String) null);
            } catch (RemoteException e11) {
                Log.e(MediaControllerCompat.TAG, "Dead object in adjustVolume.", e11);
            }
        }
        ...
        public boolean dispatchMediaButtonEvent(KeyEvent keyEvent) {
            if (keyEvent != null) {
                try {
                    ...
                    Log.e(MediaControllerCompat.TAG, "Dead object in dispatchMediaButtonEvent.", e11);
                    return false;
                }
            } else {
        ...
        public Bundle getExtras() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getExtras.", e11);
                return null;
            }
        }
        ...
        public long getFlags() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getFlags.", e11);
                return 0;
            }
        }
        ...
        public MediaMetadataCompat getMetadata() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getMetadata.", e11);
                return null;
            }
        }
        ...
        public String getPackageName() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getPackageName.", e11);
                return null;
            }
        }
        ...
        public PlaybackInfo getPlaybackInfo() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getPlaybackInfo.", e11);
                return null;
            }
        }
        ...
        public PlaybackStateCompat getPlaybackState() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getPlaybackState.", e11);
                return null;
            }
        }
        ...
        public List<MediaSessionCompat.QueueItem> getQueue() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getQueue.", e11);
                return null;
            }
        }
        ...
        public CharSequence getQueueTitle() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getQueueTitle.", e11);
                return null;
            }
        }
        ...
        public int getRatingType() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getRatingType.", e11);
                return 0;
            }
        }
        ...
        public int getRepeatMode() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getRepeatMode.", e11);
                return -1;
            }
        }
        ...
        public PendingIntent getSessionActivity() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getSessionActivity.", e11);
                return null;
            }
        }
        ...
        public int getShuffleMode() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in getShuffleMode.", e11);
                return -1;
            }
        }
        ...
        public boolean isCaptioningEnabled() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in isCaptioningEnabled.", e11);
                return false;
            }
        }
        ...
        public void registerCallback(Callback callback, Handler handler) {
            if (callback != null) {
                try {
                    ...
                    Log.e(MediaControllerCompat.TAG, "Dead object in registerCallback.", e11);
                    callback.postToHandler(8, (Object) null, (Bundle) null);
                }
            } else {
        ...
        public void removeQueueItem(MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in removeQueueItem.", e11);
            }
        }
        ...
        public void sendCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in sendCommand.", e11);
            }
        }

        public void setVolumeTo(int i11, int i12) {
            try {
                this.mBinder.setVolumeTo(i11, i12, (String) null);
            } catch (RemoteException e11) {
                Log.e(MediaControllerCompat.TAG, "Dead object in setVolumeTo.", e11);
            }
        }
        ...
        public void unregisterCallback(Callback callback) {
            if (callback != null) {
                try {
                    ...
                    Log.e(MediaControllerCompat.TAG, "Dead object in unregisterCallback.", e11);
                }
            } else {
                throw new IllegalArgumentException("callback may not be null.");
            }
        ...
        public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int i11) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in addQueueItemAt.", e11);
            }
        }
    }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public void addQueueItem(MediaDescriptionCompat mediaDescriptionCompat, int i11) {
            if ((getFlags() & 4) != 0) {
                Bundle bundle = new Bundle();
                bundle.putParcelable(MediaControllerCompat.COMMAND_ARGUMENT_MEDIA_DESCRIPTION, mediaDescriptionCompat);
                bundle.putInt(MediaControllerCompat.COMMAND_ARGUMENT_INDEX, i11);
