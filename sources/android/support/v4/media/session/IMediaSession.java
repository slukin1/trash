...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public static class Proxy implements IMediaSession {
            ...
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i11) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void adjustVolume(int i11, int i12, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void removeQueueItemAt(int i11) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void setVolumeTo(int i11, int i12, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void skipToQueueItem(long j11) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i11) throws RemoteException;

    void adjustVolume(int i11, int i12, String str) throws RemoteException;
    ...
    void removeQueueItemAt(int i11) throws RemoteException;
    ...
    void setCaptioningEnabled(boolean z11) throws RemoteException;

    void setRepeatMode(int i11) throws RemoteException;

    void setShuffleMode(int i11) throws RemoteException;

    void setShuffleModeEnabledRemoved(boolean z11) throws RemoteException;

    void setVolumeTo(int i11, int i12, String str) throws RemoteException;

    void skipToQueueItem(long j11) throws RemoteException;
