...
public final class LocaleManager {
    ...
    private static final Collection<String> TRANSLATED_HELP_ASSET_LANGUAGES = Arrays.asList(new String[]{"de", "en", "es", "fa", "fr", "it", "ja", "ko", "nl", "pt", "ru", "uk", "zh-rCN", "zh"});
    ...
    static {
        ...
        hashMap.put(locale.getCountry(), DEFAULT_TLD);
        ...
        hashMap2.put(locale.getCountry(), DEFAULT_TLD);
    ...
    public static String getTranslatedAssetLanguage() {
        ...
        return TRANSLATED_HELP_ASSET_LANGUAGES.contains(systemLanguage) ? systemLanguage : "en";
    }
