...
public final class ExpandedProductResultParser extends ResultParser {
    private static String findAIvalue(int i11, String str) {
        if (str.charAt(i11) != '(') {
            return null;
        }
    ...
    private static String findValue(int i11, String str) {
        StringBuilder sb2 = new StringBuilder();
        String substring = str.substring(i11);
        for (int i12 = 0; i12 < substring.length(); i12++) {
            char charAt = substring.charAt(i12);
            if (charAt == '(') {
                if (findAIvalue(i12, substring) != null) {
                    break;
                }
                sb2.append('(');
            } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x020b, code lost:
        if (r1.equals(com.huobi.coupon.bean.CouponReturn.TYPE_EXPERIENCE) == false) goto L_0x004f;
     */
