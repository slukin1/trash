...
public final class EAN13Writer extends UPCEANWriter {
    ...
    public boolean[] encode(String str) {
        ...
        int i11 = EAN13Reader.FIRST_DIGIT_ENCODINGS[Character.digit(str.charAt(0), 10)];
        ...
        for (int i13 = 7; i13 <= 12; i13++) {
            appendPattern2 += OneDimensionalCodeWriter.appendPattern(zArr, appendPattern2, UPCEANReader.L_PATTERNS[Character.digit(str.charAt(i13), 10)], true);
        }
