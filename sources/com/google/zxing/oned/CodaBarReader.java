...
public final class CodaBarReader extends OneDReader {
    ...
    private void validatePattern(int i11) throws NotFoundException {
        ...
        for (int i18 = 0; i18 < 2; i18++) {
            fArr2[i18] = 0.0f;
            int i19 = i18 + 2;
            fArr2[i19] = ((((float) iArr[i18]) / ((float) iArr2[i18])) + (((float) iArr[i19]) / ((float) iArr2[i19]))) / MAX_ACCEPTABLE;
            fArr[i18] = fArr2[i19];
            fArr[i19] = ((((float) iArr[i19]) * MAX_ACCEPTABLE) + 1.5f) / ((float) iArr2[i19]);
        }
        loop3:
        while (true) {
            int i21 = CHARACTER_ENCODINGS[this.decodeRowResult.charAt(i12)];
            int i22 = 6;
            while (i22 >= 0) {
                int i23 = (i22 & 1) + ((i21 & 1) << 1);
                float f11 = (float) this.counters[i11 + i22];
