...
public final class ExecutorUtils {
    ...
    @SuppressLint({"ThreadPoolCreation"})
    private static void addDelayedShutdownHook(String str, ExecutorService executorService, long j11, TimeUnit timeUnit) {
        ...
        AnonymousClass2 r22 = new BackgroundPriorityRunnable() {
            public void onRun() {
                try {
                    ...
                    if (!executorService2.awaitTermination(j12, timeUnit2)) {
