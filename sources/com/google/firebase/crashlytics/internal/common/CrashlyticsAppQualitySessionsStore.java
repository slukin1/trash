...
class CrashlyticsAppQualitySessionsStore {
    ...
    private static final FilenameFilter AQS_SESSION_ID_FILE_FILTER = a.f67050b;
    private static final Comparator<File> FILE_RECENCY_COMPARATOR = b.f67051b;
    private String appQualitySessionId = null;
    private final FileStore fileStore;
    private String sessionId = null;

    public CrashlyticsAppQualitySessionsStore(FileStore fileStore2) {
    ...
    private static void persist(FileStore fileStore2, String str, String str2) {
        if (str != null && str2 != null) {
            try {
                ...
                Logger.getLogger().w("Failed to persist App Quality Sessions session id.", e11);
            }
        }
    }

    public static String readAqsSessionIdFile(FileStore fileStore2, String str) {
