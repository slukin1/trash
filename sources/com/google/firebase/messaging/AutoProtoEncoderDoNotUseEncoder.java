...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    public static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor COLLAPSEKEY_DESCRIPTOR = FieldDescriptor.builder(RemoteMessageConst.COLLAPSE_KEY).withProperty(AtProtobuf.builder().tag(7).build()).build();
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.builder(Constants.FLAG_PACKAGE_NAME).withProperty(AtProtobuf.builder().tag(6).build()).build();
