...
public interface ExecutorFactory {
    ...
    ScheduledExecutorService newScheduledThreadPool(int i11, ThreadPriority threadPriority);

    ScheduledExecutorService newScheduledThreadPool(int i11, ThreadFactory threadFactory, ThreadPriority threadPriority);
    ...
    ExecutorService newThreadPool(int i11, ThreadPriority threadPriority);

    ExecutorService newThreadPool(int i11, ThreadFactory threadFactory, ThreadPriority threadPriority);
