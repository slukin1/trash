...
class DisplayNotification {
    ...
    private void showNotification(CommonNotificationBuilder.DisplayNotificationInfo displayNotificationInfo) {
        ...
        int i11 = displayNotificationInfo.f67104id;
        Notification g11 = displayNotificationInfo.notificationBuilder.g();
        notificationManager.notify(str, i11, g11);
        PushAutoTrackHelper.onNotify(notificationManager, str, i11, g11);
    }
    ...
    private void waitForAndApplyImageDownload(NotificationCompat.e eVar, ImageDownload imageDownload) {
        if (imageDownload != null) {
            try {
                Bitmap bitmap = (Bitmap) Tasks.await(imageDownload.getTask(), 5, TimeUnit.SECONDS);
                eVar.J(bitmap);
                eVar.c0(new NotificationCompat.BigPictureStyle().A(bitmap).z((Bitmap) null));
