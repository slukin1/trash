...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext(Writer writer, Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder, boolean z11) {
    ...
    public JsonValueObjectEncoderContext doEncode(ObjectEncoder<Object> objectEncoder, Object obj, boolean z11) throws IOException {
        if (!z11) {
    ...
    public JsonValueObjectEncoderContext add(String str, double d11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(d11);
    }

    public JsonValueObjectEncoderContext add(String str, int i11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i11);
    }

    public JsonValueObjectEncoderContext add(String str, long j11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j11);
    }

    public JsonValueObjectEncoderContext add(String str, boolean z11) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(z11);
    }
    ...
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, float f11) throws IOException {
        return add(fieldDescriptor.getName(), (double) f11);
    }

    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, double d11) throws IOException {
        return add(fieldDescriptor.getName(), d11);
    }

    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, int i11) throws IOException {
        return add(fieldDescriptor.getName(), i11);
    }

    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, long j11) throws IOException {
        return add(fieldDescriptor.getName(), j11);
    }

    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, boolean z11) throws IOException {
        return add(fieldDescriptor.getName(), z11);
    }
    ...
    public JsonValueObjectEncoderContext add(float f11) throws IOException {
        maybeUnNest();
        this.jsonWriter.value((double) f11);
        return this;
    }

    public JsonValueObjectEncoderContext add(double d11) throws IOException {
        maybeUnNest();
        this.jsonWriter.value(d11);
        return this;
    }

    public JsonValueObjectEncoderContext add(int i11) throws IOException {
        maybeUnNest();
        this.jsonWriter.value((long) i11);
        return this;
    }

    public JsonValueObjectEncoderContext add(long j11) throws IOException {
        maybeUnNest();
        this.jsonWriter.value(j11);
        return this;
    }

    public JsonValueObjectEncoderContext add(boolean z11) throws IOException {
        maybeUnNest();
        this.jsonWriter.value(z11);
        return this;
    }
    ...
    public JsonValueObjectEncoderContext add(Object obj, boolean z11) throws IOException {
        Class<?> cls;
        int i11 = 0;
        if (z11 && cannotBeInline(obj)) {
            ...
            if (obj instanceof int[]) {
                ...
                while (i11 < length) {
                    this.jsonWriter.value((long) iArr[i11]);
                    i11++;
                }
                ...
                while (i11 < length3) {
                    this.jsonWriter.value(dArr[i11]);
                    i11++;
                }
                ...
                while (i11 < length4) {
                    this.jsonWriter.value(zArr[i11]);
                    i11++;
                }
            } else if (obj instanceof Number[]) {
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                ...
                try {
                    ...
                    throw new EncodingException(String.format("Only String keys are currently supported in maps, got %s of type %s instead.", new Object[]{key, key.getClass()}), e11);
                }
            }
            this.jsonWriter.endObject();
            return this;
            ...
            if (objectEncoder != null) {
                return doEncode(objectEncoder, obj, z11);
            }
            ...
            if (valueEncoder != null) {
                ...
                return doEncode(this.fallbackEncoder, obj, z11);
            } else {
