...
public final class RemoteSettings$clearCachedSettings$1 extends SuspendLambda implements p<h0, c<? super Unit>, Object> {
    public int label;
    ...
    public final Object invoke(h0 h0Var, c<? super Unit> cVar) {
        return ((RemoteSettings$clearCachedSettings$1) create(h0Var, cVar)).invokeSuspend(Unit.f56620a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i11 == 0) {
            ...
            this.label = 1;
            if (access$getSettingsCache$p.removeConfigs$com_google_firebase_firebase_sessions(this) == d11) {
                return d11;
            }
        } else if (i11 == 1) {
            k.b(obj);
