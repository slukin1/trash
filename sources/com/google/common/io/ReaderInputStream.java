...
final class ReaderInputStream extends InputStream {
    ...
    public ReaderInputStream(Reader reader2, Charset charset, int i11) {
        this(reader2, charset.newEncoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE), i11);
    }
    ...
    private int drain(byte[] bArr, int i11, int i12) {
    ...
    private void startDraining(boolean z11) {
        this.byteBuffer.flip();
        if (!z11 || this.byteBuffer.remaining() != 0) {
            this.draining = true;
        } else {
    ...
    public ReaderInputStream(Reader reader2, CharsetEncoder charsetEncoder, int i11) {
        boolean z11 = true;
        ...
        Preconditions.checkArgument(i11 <= 0 ? false : z11, "bufferSize must be positive: %s", i11);
