...
public final class NetworkBuilder<N, E> extends AbstractGraphBuilder<N> {
    ...
    public ElementOrder<? super E> edgeOrder = ElementOrder.insertion();
    public Optional<Integer> expectedEdgeCount = Optional.absent();

    private NetworkBuilder(boolean z11) {
        super(z11);
    }
    ...
    public NetworkBuilder<N, E> allowsParallelEdges(boolean z11) {
        this.allowsParallelEdges = z11;
        return this;
    }

    public NetworkBuilder<N, E> allowsSelfLoops(boolean z11) {
    ...
    public NetworkBuilder<N, E> expectedEdgeCount(int i11) {
        this.expectedEdgeCount = Optional.of(Integer.valueOf(Graphs.checkNonNegative(i11)));
        return this;
    }

    public NetworkBuilder<N, E> expectedNodeCount(int i11) {
