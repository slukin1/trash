...
final class TimeoutFuture<V> extends FluentFuture.TrustedFuture<V> {
        ...
        public void run() {
            ...
            if (timeoutFuture != null && (access$000 = timeoutFuture.delegateRef) != null) {
                ...
                try {
                    ...
                    timeoutFuture.setException(new TimeoutFutureException(str + l.f34627b + access$000));
    ...
    public static <V> ListenableFuture<V> create(ListenableFuture<V> listenableFuture, long j11, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        TimeoutFuture timeoutFuture = new TimeoutFuture(listenableFuture);
        Fire fire = new Fire(timeoutFuture);
        timeoutFuture.timer = scheduledExecutorService.schedule(fire, j11, timeUnit);
