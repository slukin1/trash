...
public final class ExecutionSequencer {
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> asyncCallable, final Executor executor) {
        ...
        AnonymousClass2 r02 = new AsyncCallable<T>() {
            public ListenableFuture<T> call() throws Exception {
        ...
        ListenableFuture submitAsync = Futures.submitAsync(r02, new Executor() {
        ...
        nonCancellationPropagating.addListener(r03, MoreExecutors.directExecutor());
        submitAsync.addListener(r03, MoreExecutors.directExecutor());
