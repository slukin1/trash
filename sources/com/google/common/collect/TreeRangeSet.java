...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> cut, boolean z11) {
            return subMap(Range.upTo(cut, BoundType.forBoolean(z11)));
        }

        public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> cut, boolean z11) {
            return subMap(Range.downTo(cut, BoundType.forBoolean(z11)));
        }

        public NavigableMap<Cut<C>, Range<C>> subMap(Cut<C> cut, boolean z11, Cut<C> cut2, boolean z12) {
            return subMap(Range.range(cut, BoundType.forBoolean(z11), cut2, BoundType.forBoolean(z12)));
        }
    }
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (!this.upperBoundWindow.hasLowerBound()) {
                ...
                if (lowerEntry == null) {
                    ...
                    it2 = this.rangesByLowerBound.tailMap(lowerEntry.getKey(), true).values().iterator();
                } else {
                    it2 = this.rangesByLowerBound.tailMap(this.upperBoundWindow.lowerEndpoint(), true).values().iterator();
                }
            }
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() {
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
    ...
    public static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final Iterator it2 = this.rangesByLowerBound.headMap(cut.endpoint(), cut.typeAsUpperBound() == BoundType.CLOSED).descendingMap().values().iterator();
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>() {
                public Map.Entry<Cut<C>, Range<C>> computeNext() {
                    if (!it2.hasNext()) {
                        return (Map.Entry) endOfData();
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (this.lowerBoundWindow.lowerBound.isLessThan(this.restriction.lowerBound)) {
                ...
                it2 = navigableMap.tailMap(endpoint, z11).values().iterator();
            }
