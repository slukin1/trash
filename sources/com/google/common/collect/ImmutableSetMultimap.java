...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public static final class Builder<K, V> extends ImmutableMultimap.Builder<K, V> {
        ...
        public Builder<K, V> putAll(K k11, V... vArr) {
            return putAll((Object) k11, (Iterable) Arrays.asList(vArr));
        }
    ...
    public static <K, V> ImmutableSetMultimap<K, V> fromMapEntries(Collection<? extends Map.Entry<? extends K, ? extends Collection<? extends V>>> collection, Comparator<? super V> comparator) {
        ...
        return new ImmutableSetMultimap<>(builder.build(), i11, comparator);
    }
    ...
    public ImmutableSet<V> get(K k11) {
        return (ImmutableSet) MoreObjects.firstNonNull((ImmutableSet) this.map.get(k11), this.emptySet);
    }
