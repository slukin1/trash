...
public final class Tables {
    ...
    public static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        public ImmutableCell(R r11, C c11, V v11) {
            this.rowKey = r11;
            this.columnKey = c11;
            this.value = v11;
        }
    ...
    public static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        public Map<R, V2> column(C c11) {
            return Maps.transformValues(this.fromTable.column(c11), this.function);
        }
        ...
        public V2 put(R r11, C c11, V2 v22) {
        ...
        public Map<C, V2> row(R r11) {
            return Maps.transformValues(this.fromTable.row(r11), this.function);
        }
    ...
    public static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        public Map<C, V> column(R r11) {
            return this.original.row(r11);
        }
        ...
        public V put(C c11, R r11, V v11) {
            return this.original.put(r11, c11, v11);
        }
        ...
        public Map<R, V> row(C c11) {
            return this.original.column(c11);
        }
    ...
    public static <R, C, V> Table.Cell<R, C, V> immutableCell(R r11, C c11, V v11) {
