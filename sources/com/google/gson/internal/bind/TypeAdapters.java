...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() {
        ...
        public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
            jsonWriter.value(bool == null ? OptionsBridge.NULL_VALUE : bool.toString());
        }
    };
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public void write(JsonWriter jsonWriter, T t11) throws IOException {
            jsonWriter.value(t11 == null ? null : this.constantToName.get(t11));
        }
    }
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public void write(JsonWriter jsonWriter, BitSet bitSet) throws IOException {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    jsonWriter.value(bitSet.get(i11) ? 1 : 0);
                }
                jsonWriter.endArray();
            }
        }.nullSafe();
        ...
        TypeAdapter<AtomicIntegerArray> nullSafe5 = new TypeAdapter<AtomicIntegerArray>() {
            ...
            public void write(JsonWriter jsonWriter, AtomicIntegerArray atomicIntegerArray) throws IOException {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    jsonWriter.value((long) atomicIntegerArray.get(i11));
                }
                jsonWriter.endArray();
            }
        }.nullSafe();
        ...
        AnonymousClass14 r06 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken peek = jsonReader.peek();
        ...
        NUMBER = r06;
        NUMBER_FACTORY = newFactory(Number.class, r06);
        AnonymousClass15 r07 = new TypeAdapter<Character>() {
        ...
        CHARACTER = r07;
        CHARACTER_FACTORY = newFactory(Character.TYPE, Character.class, r07);
        AnonymousClass16 r08 = new TypeAdapter<String>() {
        ...
        STRING = r08;
        STRING_FACTORY = newFactory(String.class, r08);
        AnonymousClass19 r09 = new TypeAdapter<StringBuilder>() {
        ...
        STRING_BUILDER = r09;
        STRING_BUILDER_FACTORY = newFactory(StringBuilder.class, r09);
        AnonymousClass20 r010 = new TypeAdapter<StringBuffer>() {
        ...
        STRING_BUFFER = r010;
        STRING_BUFFER_FACTORY = newFactory(StringBuffer.class, r010);
        AnonymousClass21 r011 = new TypeAdapter<URL>() {
            public URL read(JsonReader jsonReader) throws IOException {
                ...
                String nextString = jsonReader.nextString();
                if (OptionsBridge.NULL_VALUE.equals(nextString)) {
                    return null;
                }
        ...
        URL = r011;
        URL_FACTORY = newFactory(URL.class, r011);
        AnonymousClass22 r012 = new TypeAdapter<URI>() {
        ...
        URI = r012;
        URI_FACTORY = newFactory(URI.class, r012);
        AnonymousClass23 r013 = new TypeAdapter<InetAddress>() {
        ...
        INET_ADDRESS = r013;
        INET_ADDRESS_FACTORY = newTypeHierarchyFactory(InetAddress.class, r013);
        AnonymousClass24 r014 = new TypeAdapter<UUID>() {
        ...
        UUID = r014;
        UUID_FACTORY = newFactory(UUID.class, r014);
        ...
        AnonymousClass27 r015 = new TypeAdapter<Calendar>() {
        ...
        CALENDAR = r015;
        CALENDAR_FACTORY = newFactoryForMultipleTypes(Calendar.class, GregorianCalendar.class, r015);
        AnonymousClass28 r016 = new TypeAdapter<Locale>() {
        ...
        LOCALE = r016;
        LOCALE_FACTORY = newFactory(Locale.class, r016);
        AnonymousClass29 r017 = new TypeAdapter<JsonElement>() {
        ...
        JSON_ELEMENT = r017;
        JSON_ELEMENT_FACTORY = newTypeHierarchyFactory(JsonElement.class, r017);
    }
