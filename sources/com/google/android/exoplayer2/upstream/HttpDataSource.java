...
public interface HttpDataSource extends DataSource {
    public static final Predicate<String> REJECT_PAYWALL_TYPES = f.f66082b;
    ...
    public static final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        public InvalidResponseCodeException(int i11, Map<String, List<String>> map, DataSpec dataSpec) {
            this(i11, (String) null, map, dataSpec, Util.EMPTY_BYTE_ARRAY);
        }

        @Deprecated
        public InvalidResponseCodeException(int i11, String str, Map<String, List<String>> map, DataSpec dataSpec) {
            this(i11, str, map, dataSpec, Util.EMPTY_BYTE_ARRAY);
        }
