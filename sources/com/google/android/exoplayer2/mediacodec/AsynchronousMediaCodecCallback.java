...
final class AsynchronousMediaCodecCallback extends MediaCodec.Callback {
        ...
        if (!this.shutDown) {
            ...
            if (j11 <= 0) {
                ...
                try {
                    ...
                    setInternalException(e11);
                } catch (Exception e12) {
                    setInternalException(new IllegalStateException(e12));
                }
            }
        }
    }
    ...
    public int dequeueInputBufferIndex() {
        ...
        L_0x000c:
            ...
            com.google.android.exoplayer2.util.IntArrayQueue r1 = r3.availableInputBuffers     // Catch:{ all -> 0x0020 }
    ...
    public int dequeueOutputBufferIndex(android.media.MediaCodec.BufferInfo r10) {
        ...
        L_0x000c:
            ...
            com.google.android.exoplayer2.util.IntArrayQueue r1 = r9.availableOutputBuffers     // Catch:{ all -> 0x004a }
    ...
    public void flushAsync(Runnable runnable) {
        synchronized (this.lock) {
            ...
            ((Handler) Util.castNonNull(this.handler)).post(new e(this, runnable));
        }
    }
    ...
    public void onInputBufferAvailable(MediaCodec mediaCodec, int i11) {
        synchronized (this.lock) {
            this.availableInputBuffers.add(i11);
        }
    }
    ...
    public void onOutputBufferAvailable(MediaCodec mediaCodec, int i11, MediaCodec.BufferInfo bufferInfo) {
        synchronized (this.lock) {
            ...
            this.availableOutputBuffers.add(i11);
