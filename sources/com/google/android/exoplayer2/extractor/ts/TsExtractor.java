...
public final class TsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = e.f65907a;
                    ...
                    while (bytesLeft > 0) {
                        ...
                        if (!TsExtractor.this.trackIds.get(i14)) {
                            ...
                            if (TsExtractor.this.mode != 2 || readBits2 < this.trackIdToPidScratch.get(i14, 8192)) {
                                ...
                                this.trackIdToReaderScratch.put(i14, tsPayloadReader);
                            }
                        }
                        i11 = 3;
                        i13 = 4;
    ...
    public void seek(long j11, long j12) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if ((timestampAdjuster.getTimestampOffsetUs() == -9223372036854775807L) || !(timestampAdjuster.getTimestampOffsetUs() == 0 || timestampAdjuster.getFirstSampleTimestampUs() == j12)) {
