...
final class TsBinarySearchSeeker extends BinarySearchSeeker {
    ...
    public static final class TsPcrSeeker implements BinarySearchSeeker.TimestampSeeker {
        ...
        private BinarySearchSeeker.TimestampSearchResult searchForPcrValueInBuffer(ParsableByteArray parsableByteArray, long j11, long j12) {
            ...
            while (parsableByteArray.bytesLeft() >= 188 && (i11 = findSyncBytePosition + 188) <= limit) {
                ...
                if (readPcrFromPacket != -9223372036854775807L) {
                    ...
                    if (adjustTsTimestamp > j11) {
                        if (j16 == -9223372036854775807L) {
                            return BinarySearchSeeker.TimestampSearchResult.overestimatedResult(adjustTsTimestamp, j13);
                        }
                        return BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j13 + j15);
                    } else if (100000 + adjustTsTimestamp > j11) {
                        return BinarySearchSeeker.TimestampSearchResult.targetFoundResult(j13 + ((long) findSyncBytePosition));
                    } else {
                        j15 = (long) findSyncBytePosition;
            ...
            if (j16 != -9223372036854775807L) {
                return BinarySearchSeeker.TimestampSearchResult.underestimatedResult(j16, j13 + j14);
            }
