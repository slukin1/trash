...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public HlsMasterPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, Format format, List<Format> list7, boolean z11, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z11);
    ...
    private static <T> List<T> copyStreams(List<T> list, int i11, List<StreamKey> list2) {
        ...
        for (int i12 = 0; i12 < list.size(); i12++) {
            ...
            while (true) {
                ...
                if (streamKey.groupIndex == i11 && streamKey.trackIndex == i12) {
                    arrayList.add(t11);
                    break;
                }
                i13++;
