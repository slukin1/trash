...
public final class CCTDestination implements EncodedDestination {
    ...
    private static final Set<Encoding> SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Encoding[]{Encoding.of("proto"), Encoding.of(MTPushConstants.Analysis.KEY_JSON)})));
