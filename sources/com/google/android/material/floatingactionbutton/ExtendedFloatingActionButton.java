...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.b {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public ChangeSizeStrategy(AnimatorTracker animatorTracker, Size size2, boolean z11) {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("paddingStart")) {
                ...
                propertyValues3[0].setFloatValues(new float[]{(float) h0.L(ExtendedFloatingActionButton.this), (float) this.size.getPaddingStart()});
                currentMotionSpec.setPropertyValues("paddingStart", propertyValues3);
            }
            if (currentMotionSpec.hasPropertyValues("paddingEnd")) {
                PropertyValuesHolder[] propertyValues4 = currentMotionSpec.getPropertyValues("paddingEnd");
                propertyValues4[0].setFloatValues(new float[]{(float) h0.K(ExtendedFloatingActionButton.this), (float) this.size.getPaddingEnd()});
            ...
            if (currentMotionSpec.hasPropertyValues("labelOpacity")) {
                ...
                propertyValues5[0].setFloatValues(new float[]{f12, f11});
        ...
        public void performNow() {
            ...
            if (layoutParams != null) {
                layoutParams.width = this.size.getLayoutParams().width;
                layoutParams.height = this.size.getLayoutParams().height;
                h0.P0(ExtendedFloatingActionButton.this, this.size.getPaddingStart(), ExtendedFloatingActionButton.this.getPaddingTop(), this.size.getPaddingEnd(), ExtendedFloatingActionButton.this.getPaddingBottom());
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public void extendOrShow(ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            OnChangedCallback onChangedCallback = z11 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback;
            if (z11) {
    ...
    static {
        ...
        PADDING_START = new Property<View, Float>(cls, "paddingStart") {
            public Float get(View view) {
                return Float.valueOf((float) h0.L(view));
            }

            public void set(View view, Float f11) {
                h0.P0(view, f11.intValue(), view.getPaddingTop(), h0.K(view), view.getPaddingBottom());
            }
        };
        PADDING_END = new Property<View, Float>(cls, "paddingEnd") {
            public Float get(View view) {
                return Float.valueOf((float) h0.K(view));
            }

            public void set(View view, Float f11) {
                h0.P0(view, h0.L(view), view.getPaddingTop(), f11.intValue(), view.getPaddingBottom());
            }
        };
    }
    ...
    private boolean shouldAnimateVisibilityChange() {
        return (h0.a0(this) || (!isOrWillBeShown() && this.animateShowBeforeLayout)) && !isInEditMode();
    }
    ...
    public int getCollapsedSize() {
        ...
        return i11 < 0 ? (Math.min(h0.L(this), h0.K(this)) * 2) + getIconSize() : i11;
    }
    ...
    public void setPadding(int i11, int i12, int i13, int i14) {
        ...
        if (this.isExtended && !this.isTransforming) {
            this.extendedPaddingStart = h0.L(this);
            this.extendedPaddingEnd = h0.K(this);
        }
    }
    ...
    public ExtendedFloatingActionButton(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            r0.collapsedSize = r6
            int r6 = androidx.core.view.h0.L(r16)
            r0.extendedPaddingStart = r6
            int r6 = androidx.core.view.h0.K(r16)
