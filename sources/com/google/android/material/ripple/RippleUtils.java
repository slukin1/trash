...
public class RippleUtils {
    ...
    @TargetApi(21)
    private static int doubleAlpha(int i11) {
        return c.j(i11, Math.min(Color.alpha(i11) * 2, 255));
    }
    ...
    public static ColorStateList sanitizeRippleDrawableColor(ColorStateList colorStateList) {
        ...
        if (i11 >= 22 && i11 <= 27 && Color.alpha(colorStateList.getDefaultColor()) == 0 && Color.alpha(colorStateList.getColorForState(ENABLED_PRESSED_STATE_SET, 0)) != 0) {
