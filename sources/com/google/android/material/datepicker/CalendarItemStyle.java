...
final class CalendarItemStyle {
    ...
    private CalendarItemStyle(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int i11, ShapeAppearanceModel shapeAppearanceModel, Rect rect) {
        h.d(rect.left);
        h.d(rect.top);
        h.d(rect.right);
        h.d(rect.bottom);
    ...
    public static CalendarItemStyle create(Context context, int i11) {
        h.b(i11 != 0, "Cannot create a CalendarItemStyle with a styleResId of 0");
    ...
    public void styleItem(TextView textView) {
        ...
        h0.B0(textView, new InsetDrawable(rippleDrawable, rect.left, rect.top, rect.right, rect.bottom));
    }
}
