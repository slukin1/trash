...
public final class MaterialTextInputPicker<S> extends PickerFragment<S> {
    ...
    public static <T> MaterialTextInputPicker<T> newInstance(DateSelector<T> dateSelector2, int i11, CalendarConstraints calendarConstraints2) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return this.dateSelector.onCreateTextInputView(layoutInflater.cloneInContext(new ContextThemeWrapper(getContext(), this.themeResId)), viewGroup, bundle, this.calendarConstraints, new OnSelectionChangedListener<S>() {
            ...
            public void onSelectionChanged(S s11) {
                Iterator it2 = MaterialTextInputPicker.this.onSelectionChangedListeners.iterator();
                while (it2.hasNext()) {
                    ((OnSelectionChangedListener) it2.next()).onSelectionChanged(s11);
                }
            }
        });
    }
