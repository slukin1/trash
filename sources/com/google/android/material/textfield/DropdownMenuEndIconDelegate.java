...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public final TextInputLayout.AccessibilityDelegate accessibilityDelegate = new TextInputLayout.AccessibilityDelegate(this.textInputLayout) {
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (accessibilityNodeInfoCompat.X()) {
                accessibilityNodeInfoCompat.z0((CharSequence) null);
            }
        }
    ...
    private final TextInputLayout.OnEditTextAttachedListener dropdownMenuOnEditTextAttachedListener = new TextInputLayout.OnEditTextAttachedListener() {
        public void onEditTextAttached(TextInputLayout textInputLayout) {
            ...
            if (!DropdownMenuEndIconDelegate.isEditable(access$000)) {
                h0.I0(DropdownMenuEndIconDelegate.this.endIconView, 2);
            }
    ...
    public final View.OnFocusChangeListener onFocusChangeListener = new View.OnFocusChangeListener() {
        public void onFocusChange(View view, boolean z11) {
            DropdownMenuEndIconDelegate.this.textInputLayout.setEndIconActivated(z11);
            if (!z11) {
    ...
    private void addRippleEffectOnFilledLayout(AutoCompleteTextView autoCompleteTextView, int i11, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        int boxBackgroundColor = this.textInputLayout.getBoxBackgroundColor();
        int[] iArr2 = {MaterialColors.layer(i11, boxBackgroundColor, 0.1f), boxBackgroundColor};
        if (IS_LOLLIPOP) {
            h0.B0(autoCompleteTextView, new RippleDrawable(new ColorStateList(iArr, iArr2), materialShapeDrawable, materialShapeDrawable));
            return;
        }
        MaterialShapeDrawable materialShapeDrawable2 = new MaterialShapeDrawable(materialShapeDrawable.getShapeAppearanceModel());
        materialShapeDrawable2.setFillColor(new ColorStateList(iArr, iArr2));
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{materialShapeDrawable, materialShapeDrawable2});
        int L = h0.L(autoCompleteTextView);
        int paddingTop = autoCompleteTextView.getPaddingTop();
        int K = h0.K(autoCompleteTextView);
        int paddingBottom = autoCompleteTextView.getPaddingBottom();
        h0.B0(autoCompleteTextView, layerDrawable);
        h0.P0(autoCompleteTextView, L, paddingTop, K, paddingBottom);
    }

    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i11, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
    ...
    private ValueAnimator getAlphaAnimator(int i11, float... fArr) {
    ...
    private MaterialShapeDrawable getPopUpMaterialShapeDrawable(float f11, float f12, float f13, int i11) {
        ...
        MaterialShapeDrawable createWithElevationOverlay = MaterialShapeDrawable.createWithElevationOverlay(this.context, f13);
    ...
    /* access modifiers changed from: private */
    public void setEndIconChecked(boolean z11) {
        if (this.isEndIconChecked != z11) {
            this.isEndIconChecked = z11;
