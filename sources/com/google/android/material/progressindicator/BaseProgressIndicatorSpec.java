...
public abstract class BaseProgressIndicatorSpec {
    ...
    public BaseProgressIndicatorSpec(Context context, AttributeSet attributeSet, int i11, int i12) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.BaseProgressIndicator, i11, i12, new int[0]);
    ...
    private void loadIndicatorColors(Context context, TypedArray typedArray) {
        ...
        if (!typedArray.hasValue(i11)) {
            ...
            this.indicatorColors = new int[]{typedArray.getColor(i11, -1)};
        } else {
    ...
    private void loadTrackColor(Context context, TypedArray typedArray) {
        ...
        if (typedArray.hasValue(i11)) {
            this.trackColor = typedArray.getColor(i11, -1);
            return;
        }
        ...
        obtainStyledAttributes.recycle();
        this.trackColor = MaterialColors.compositeARGBWithAlpha(this.trackColor, (int) (f11 * 255.0f));
    }
