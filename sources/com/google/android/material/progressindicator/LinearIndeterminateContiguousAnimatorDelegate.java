...
final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    private static final Property<LinearIndeterminateContiguousAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<LinearIndeterminateContiguousAnimatorDelegate, Float>(Float.class, "animationFraction") {
        ...
        public void set(LinearIndeterminateContiguousAnimatorDelegate linearIndeterminateContiguousAnimatorDelegate, Float f11) {
            linearIndeterminateContiguousAnimatorDelegate.setAnimationFraction(f11.floatValue());
        }
    };
    ...
    private void updateSegmentPositions(int i11) {
        ...
        float fractionInRange = getFractionInRange(i11, 0, TOTAL_DURATION_IN_MS);
    ...
    public void setAnimationFraction(float f11) {
        ...
        updateSegmentPositions((int) (f11 * 333.0f));
