...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                Drawable r11 = a.r(getBackground().mutate());
                a.o(r11, colorStateList);
                a.p(r11, this.backgroundTintMode);
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i11)) {
                h0.F0(this, (float) obtainStyledAttributes.getDimensionPixelSize(i11, 0));
            }
            ...
            setFocusable(true);
            if (getBackground() == null) {
                h0.B0(this, createThemedBackground());
            }
        }
    }
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            h0.h0(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    h0.h0(BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    public BaseTransientBottomBar(Context context2, ViewGroup viewGroup, View view2, ContentViewCallback contentViewCallback2) {
        ...
        if (viewGroup == null) {
            ...
            h0.z0(snackbarBaseLayout, 1);
            h0.I0(snackbarBaseLayout, 1);
            h0.G0(snackbarBaseLayout, true);
            h0.O0(snackbarBaseLayout, new v() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    int unused = BaseTransientBottomBar.this.extraBottomMarginWindowInset = windowInsetsCompat.j();
                    int unused2 = BaseTransientBottomBar.this.extraLeftMarginWindowInset = windowInsetsCompat.k();
                    int unused3 = BaseTransientBottomBar.this.extraRightMarginWindowInset = windowInsetsCompat.l();
                    BaseTransientBottomBar.this.updateMargins();
                    return windowInsetsCompat;
                }
            });
            h0.x0(snackbarBaseLayout, new AccessibilityDelegateCompat() {
    ...
    public B setAnchorView(int i11) {
