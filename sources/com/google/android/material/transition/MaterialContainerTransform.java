...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i11, ShapeAppearanceModel shapeAppearanceModel) {
        if (i11 != -1) {
            transitionValues.f11866b = TransitionUtils.findDescendantOrAncestorById(transitionValues.f11866b, i11);
        } else if (view != null) {
            transitionValues.f11866b = view;
        } else {
            View view2 = transitionValues.f11866b;
            int i12 = R.id.mtrl_motion_snapshot_view;
            if (view2.getTag(i12) instanceof View) {
                transitionValues.f11866b.setTag(i12, (Object) null);
                transitionValues.f11866b = (View) transitionValues.f11866b.getTag(i12);
            }
        }
        View view3 = transitionValues.f11866b;
        if (h0.a0(view3) || view3.getWidth() != 0 || view3.getHeight() != 0) {
            ...
            transitionValues.f11865a.put(PROP_BOUNDS, relativeBounds);
            transitionValues.f11865a.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(view3, relativeBounds, shapeAppearanceModel));
        }
    }
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (!(transitionValues3 == null || transitionValues4 == null)) {
            RectF rectF = (RectF) transitionValues3.f11865a.get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) transitionValues3.f11865a.get(PROP_SHAPE_APPEARANCE);
            if (rectF == null || shapeAppearanceModel == null) {
                Log.w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                RectF rectF2 = (RectF) transitionValues4.f11865a.get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) transitionValues4.f11865a.get(PROP_SHAPE_APPEARANCE);
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View view3 = transitionValues3.f11866b;
                final View view4 = transitionValues4.f11866b;
