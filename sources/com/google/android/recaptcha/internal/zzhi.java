...
final class zzhi implements zzmd {
    ...
    public final void zzC(int i11, List list, boolean z11) throws IOException {
        ...
        if (z11) {
            ...
            for (int i14 = 0; i14 < list.size(); i14++) {
                ...
                i13 += zzhh.zzy((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzq(i13);
            while (i12 < list.size()) {
                zzhh zzhh = this.zza;
        ...
        while (i12 < list.size()) {
            ...
            zzhh2.zzp(i11, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i12++;
        }
    }
    ...
    public final void zzE(int i11, List list, boolean z11) throws IOException {
        ...
        if (z11) {
            ...
            for (int i14 = 0; i14 < list.size(); i14++) {
                ...
                i13 += zzhh.zzz((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzq(i13);
            while (i12 < list.size()) {
                zzhh zzhh = this.zza;
        ...
        while (i12 < list.size()) {
            ...
            zzhh2.zzr(i11, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i12++;
        }
    }
    ...
    public final void zzH(int i11, List list) throws IOException {
        ...
        if (list instanceof zzjm) {
            zzjm zzjm = (zzjm) list;
            while (i12 < list.size()) {
                Object zzf = zzjm.zzf(i12);
                if (zzf instanceof String) {
                    this.zza.zzm(i11, (String) zzf);
                } else {
                    this.zza.zze(i11, (zzgw) zzf);
                }
                i12++;
            }
            return;
    ...
    public final void zzJ(int i11, List list, boolean z11) throws IOException {
        ...
        if (z11) {
            ...
            int i13 = 0;
            for (int i14 = 0; i14 < list.size(); i14++) {
                i13 += zzhh.zzy(((Integer) list.get(i14)).intValue());
            }
            this.zza.zzq(i13);
            while (i12 < list.size()) {
    ...
    public final void zzL(int i11, List list, boolean z11) throws IOException {
        ...
        if (z11) {
            ...
            int i13 = 0;
            for (int i14 = 0; i14 < list.size(); i14++) {
                i13 += zzhh.zzz(((Long) list.get(i14)).longValue());
            }
            this.zza.zzq(i13);
            while (i12 < list.size()) {
    ...
    public final void zzd(int i11, zzgw zzgw) throws IOException {
        this.zza.zze(i11, zzgw);
    }

    public final void zze(int i11, List list) throws IOException {
        for (int i12 = 0; i12 < list.size(); i12++) {
            this.zza.zze(i11, (zzgw) list.get(i12));
        }
    }
    ...
    public final void zzj(int i11, List list, boolean z11) throws IOException {
        ...
        if (z11) {
            ...
            int i13 = 0;
            for (int i14 = 0; i14 < list.size(); i14++) {
                i13 += zzhh.zzu(((Integer) list.get(i14)).intValue());
            }
            this.zza.zzq(i13);
            while (i12 < list.size()) {
    ...
    public final void zzq(int i11, Object obj, zzkr zzkr) throws IOException {
        zzhh zzhh = this.zza;
        zzhh.zzo(i11, 3);
    ...
    public final void zzv(int i11, Object obj, zzkr zzkr) throws IOException {
        zzke zzke = (zzke) obj;
