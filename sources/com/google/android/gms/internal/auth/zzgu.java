...
class zzgu extends AbstractMap {
    ...
    public /* synthetic */ zzgu(int i11, zzgt zzgt) {
        this.zza = i11;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i11 <= size) {
            int i12 = (i11 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzgo) this.zzb.get(i12)).zza());
            if (compareTo2 < 0) {
                size = i12 - 1;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i11 = 0; i11 < zzb2; i11++) {
            if (!zzg(i11).equals(zzgu.zzg(i11))) {
                return false;
            }
        }
        if (zzb2 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i12 = this.zza;
        if (size == i12) {
            zzgo zzgo = (zzgo) this.zzb.remove(i12 - 1);
