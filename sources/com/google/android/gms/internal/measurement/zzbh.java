...
public final class zzbh extends zzaw {
    ...
    private static zzap zzc(zzbf zzbf, Iterator it2, zzap zzap) {
        if (it2 != null) {
            while (it2.hasNext()) {
                zzap zzc = zzbf.zza((zzap) it2.next()).zzc((zzae) zzap);
                ...
                case 29:
                    ...
                    if (zzb instanceof zzae) {
                        ...
                        while (zzg.zzb(zzap).zzg().booleanValue()) {
                            ...
                            zzg zza2 = zzg.zza();
                            for (int i12 = 0; i12 < zzae.zzc(); i12++) {
                                String zzi2 = zzae.zze(i12).zzi();
