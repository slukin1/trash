        ...
        if (ordinal == 3) {
            ...
            if (list.size() % 2 == 0) {
                ...
                while (i12 < list.size() - 1) {
                    zzap zzb3 = zzg.zzb((zzap) list.get(i12));
                    if (zzb3 instanceof zzat) {
                        zzg.zzf(zzb3.zzi(), zzg.zzb((zzap) list.get(i12 + 1)));
                        i12 += 2;
                    } else {
            ...
            zzap zzap = zzap.zzf;
            while (i11 < list.size()) {
                zzap = zzg.zzb((zzap) list.get(i11));
            ...
            if (ordinal != 18) {
                ...
                if (list.size() % 2 == 0) {
                    ...
                    while (i11 < list.size() - 1) {
                        zzap zzb12 = zzg.zzb((zzap) list.get(i11));
                        zzap zzb13 = zzg.zzb((zzap) list.get(i11 + 1));
