...
public final class zzeg {
    public static final zzef zzA = zza("measurement.upload.initial_upload_delay_time", 15000L, 15000L, zzbg.zza);
    public static final zzef zzB;
    public static final zzef zzC = zza("measurement.upload.retry_count", 6, 6, zzbj.zza);
    public static final zzef zzD = zza("measurement.upload.max_queue_time", 2419200000L, 2419200000L, zzbk.zza);
    public static final zzef zzE = zza("measurement.lifetimevalue.max_currency_tracked", 4, 4, zzbm.zza);
    public static final zzef zzF = zza("measurement.audience.filter_result_max_count", 200, 200, zzbn.zza);
    public static final zzef zzG = zza("measurement.upload.max_public_user_properties", 25, 25, (zzec) null);
    public static final zzef zzH = zza("measurement.upload.max_event_name_cardinality", 500, 500, (zzec) null);
    public static final zzef zzI = zza("measurement.upload.max_public_event_params", 25, 25, (zzec) null);
    public static final zzef zzJ = zza("measurement.service_client.idle_disconnect_millis", 5000L, 5000L, zzbo.zza);
    public static final zzef zzK;
    public static final zzef zzL = zza("measurement.test.string_flag", "---", "---", zzbq.zza);
    public static final zzef zzM = zza("measurement.test.long_flag", -1L, -1L, zzbr.zza);
    public static final zzef zzN = zza("measurement.test.int_flag", -2, -2, zzbt.zza);
    public static final zzef zzO;
    public static final zzef zzP = zza("measurement.experiment.max_ids", 50, 50, zzbv.zza);
    public static final zzef zzQ = zza("measurement.upload.max_item_scoped_custom_parameters", 27, 27, zzbw.zza);
    public static final zzef zzR = zza("measurement.max_bundles_per_iteration", 100, 100, zzby.zza);
    public static final zzef zzS;
    public static final zzef zzT = zza("measurement.redaction.app_instance_id.ttl", 7200000L, 7200000L, zzca.zza);
    ...
    public static final List zzaJ = Collections.synchronizedList(new ArrayList());
    ...
    public static final zzef zzaf;
    public static final zzef zzag;
    public static final zzef zzah = zza("measurement.service.storage_consent_support_version", 203600, 203600, zzcq.zza);
    public static final zzef zzai;
    ...
    public static final zzef zze = zza("measurement.config.url_scheme", Constants.SCHEME, Constants.SCHEME, zzcj.zza);
    ...
    public static final zzef zzk;
    public static final zzef zzl = zza("measurement.upload.max_error_events_per_day", 1000, 1000, zzcd.zza);
    public static final zzef zzm = zza("measurement.upload.max_public_events_per_day", 50000, 50000, zzco.zza);
    public static final zzef zzn = zza("measurement.upload.max_conversions_per_day", 10000, 10000, zzcz.zza);
    public static final zzef zzo = zza("measurement.upload.max_realtime_events_per_day", 10, 10, zzdk.zza);
    public static final zzef zzp;
    public static final zzef zzq = zza("measurement.upload.url", "https://app-measurement.com/a", "https://app-measurement.com/a", zzea.zza);
    public static final zzef zzr = zza("measurement.upload.backoff_period", 43200000L, 43200000L, zzeb.zza);
    public static final zzef zzs;
    public static final zzef zzt;
    public static final zzef zzu = zza("measurement.upload.realtime_upload_interval", 10000L, 10000L, zzba.zza);
    public static final zzef zzv = zza("measurement.upload.debug_upload_interval", 1000L, 1000L, zzbb.zza);
    public static final zzef zzw = zza("measurement.upload.minimum_delay", 500L, 500L, zzbc.zza);
    public static final zzef zzx = zza("measurement.alarm_manager.minimum_interval", 60000L, 60000L, zzbd.zza);
    public static final zzef zzy;
    public static final zzef zzz;

    static {
        Long valueOf = Long.valueOf(Period.MIN60_MILLS);
        zzb = zza("measurement.app_uninstalled_additional_ad_id_cache_time", valueOf, valueOf, zzaz.zza);
        Long valueOf2 = Long.valueOf(Period.DAY_MILLS);
        zzc = zza("measurement.monitoring.sample_period_millis", valueOf2, valueOf2, zzbl.zza);
        zzd = zza("measurement.config.cache_time", valueOf2, valueOf, zzbx.zza);
        Integer valueOf3 = Integer.valueOf(AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND);
        zzk = zza("measurement.upload.max_events_per_day", valueOf3, valueOf3, zzbs.zza);
        zzp = zza("measurement.store.max_stored_events_per_app", valueOf3, valueOf3, zzdv.zza);
        zzs = zza("measurement.upload.window_interval", valueOf, valueOf, zzax.zza);
        zzt = zza("measurement.upload.interval", valueOf, valueOf, zzay.zza);
        zzy = zza("measurement.upload.stale_data_deletion_interval", valueOf2, valueOf2, zzbe.zza);
        Long valueOf4 = Long.valueOf(Period.WEEK_MILLS);
        zzz = zza("measurement.upload.refresh_blacklisted_config_interval", valueOf4, valueOf4, zzbf.zza);
        Long valueOf5 = Long.valueOf(Period.MIN30_MILLS);
        zzB = zza("measurement.upload.retry_time", valueOf5, valueOf5, zzbi.zza);
        Boolean bool = Boolean.FALSE;
        zzK = zza("measurement.test.boolean_flag", bool, bool, zzbp.zza);
        Double valueOf6 = Double.valueOf(-3.0d);
        zzO = zza("measurement.test.double_flag", valueOf6, valueOf6, zzbu.zza);
        zzS = zza("measurement.sdk.attribution.cache.ttl", valueOf4, valueOf4, zzbz.zza);
        Boolean bool2 = Boolean.TRUE;
        zzU = zza("measurement.collection.log_event_and_bundle_v2", bool2, bool2, zzcb.zza);
        zzV = zza("measurement.quality.checksum", bool, bool, (zzec) null);
    ...
    public static zzef zza(String str, Object obj, Object obj2, zzec zzec) {
        zzef zzef = new zzef(str, obj, obj2, zzec, (zzee) null);
        zzaJ.add(zzef);
        return zzef;
    }
}
