...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public GoogleApi(Activity activity, Api<O> api, O o11, Settings settings) {
        this((Context) activity, activity, api, o11, settings);
    }

    private final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T zad(int i11, T t11) {
        t11.zak();
        this.zaa.zaw(this, i11, t11);
        return t11;
    }

    private final <TResult, A extends Api.AnyClient> Task<TResult> zae(int i11, TaskApiCall<A, TResult> taskApiCall) {
    ...
    public ClientSettings.Builder createClientSettingsBuilder() {
        ...
        if (!(o11 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o11).getGoogleSignInAccount()) == null) {
            O o12 = this.zae;
            account = o12 instanceof Api.ApiOptions.HasAccountOptions ? ((Api.ApiOptions.HasAccountOptions) o12).getAccount() : null;
        } else {
    ...
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(T t11, U u11) {
        ...
        return this.zaa.zaq(this, t11, u11, zad.zaa);
    }
    ...
    private GoogleApi(Context context, Activity activity, Api<O> api, O o11, Settings settings) {
        ...
        ApiKey<O> zaa2 = ApiKey.zaa(api, o11, str);
        this.zaf = zaa2;
