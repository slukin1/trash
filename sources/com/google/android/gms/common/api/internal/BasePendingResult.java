...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    private final R zaa() {
        ...
        return (Result) Preconditions.checkNotNull(r11);
    }
    ...
    private final void zab(R r11) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            arrayList.get(i11).onComplete(this.zak);
        }
        this.zag.clear();
    }
    ...
    public static class CallbackHandler<R extends Result> extends zaq {
        ...
        public final void zaa(ResultCallback<? super R> resultCallback, R r11) {
            int i11 = BasePendingResult.zad;
            sendMessage(obtainMessage(1, new Pair((ResultCallback) Preconditions.checkNotNull(resultCallback), r11)));
        }
