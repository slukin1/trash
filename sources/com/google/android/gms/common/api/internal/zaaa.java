...
final class zaaa implements zaca {
    ...
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaa, int i11, boolean z11) {
        zaaa.zab.zac(i11, z11);
        zaaa.zak = null;
        zaaa.zaj = null;
    }
    ...
    public final <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T zae(T t11) {
        if (!zaD(t11)) {
            ...
            t11.setFailedResult(new Status(4, (String) null, zaz()));
            return t11;
        } else {
            this.zae.zae(t11);
            return t11;
    ...
    public final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T zaf(T t11) {
        if (!zaD(t11)) {
            return this.zad.zaf(t11);
        }
        if (!zaC()) {
            return this.zae.zaf(t11);
        }
        t11.setFailedResult(new Status(4, (String) null, zaz()));
        return t11;
    }
