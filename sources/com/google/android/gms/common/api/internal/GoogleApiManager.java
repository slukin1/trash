...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final <T> void zaL(TaskCompletionSource<T> taskCompletionSource, int i11, GoogleApi googleApi) {
        zacd zaa2;
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i11) {
            ...
            case 2:
                ...
                Iterator<ApiKey<?>> it2 = zal2.zab().iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    } else {
            ...
            case 5:
                ...
                Iterator<zabq<?>> it3 = this.zap.values().iterator();
                while (true) {
                    if (it3.hasNext()) {
                        zabq next3 = it3.next();
                        if (next3.zab() == i12) {
                ...
                if (zabq != null) {
                    if (connectionResult.getErrorCode() != 13) {
                        ...
                        zabq.zaD(new Status(17, sb2.toString()));
                        break;
                    }
                } else {
    ...
    public final boolean zaG(ConnectionResult connectionResult, int i11) {
        return this.zal.zah(this.zak, connectionResult, i11);
    }
    ...
    public final <O extends Api.ApiOptions> Task<Boolean> zar(GoogleApi<O> googleApi, ListenerHolder.ListenerKey listenerKey, int i11) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        zaL(taskCompletionSource, i11, googleApi);
    ...
    public final void zay(MethodInvocation methodInvocation, int i11, long j11, int i12) {
        Handler handler = this.zat;
