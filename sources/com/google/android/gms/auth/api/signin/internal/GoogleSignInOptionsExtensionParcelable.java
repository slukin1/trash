...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.zaa = i11;
        this.zab = i12;
        this.zac = bundle;
    }
