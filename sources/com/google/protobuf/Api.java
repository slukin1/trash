...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        ...
        public Builder setMethods(int i11, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i11, (Method) builder.build());
            return this;
        }

        public Builder setMixins(int i11, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i11, (Mixin) builder.build());
            return this;
        }

        public Builder setOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i11, (Option) builder.build());
            return this;
        }
        ...
        public Builder addMethods(int i11, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i11, (Method) builder.build());
            return this;
        }

        public Builder addMixins(int i11, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i11, (Mixin) builder.build());
            return this;
        }

        public Builder addOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i11, (Option) builder.build());
            return this;
        }
    }
