...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private FieldSet<T> buildImpl(boolean z11) {
            ...
            if (this.hasNestedBuilders) {
                ...
                replaceBuilders(smallSortedMap, z11);
            }
        ...
        private static Object replaceBuilder(Object obj, boolean z11) {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z11) {
            for (int i11 = 0; i11 < smallSortedMap.getNumArrayEntries(); i11++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i11), z11);
            }
            for (Map.Entry<T, Object> replaceBuilders : smallSortedMap.getOverflowEntries()) {
                replaceBuilders(replaceBuilders, z11);
            }
        }
        ...
        public Object getField(T t11) {
            return replaceBuilders(t11, getFieldAllowBuilders(t11), true);
        }
        ...
        public Object getRepeatedField(T t11, int i11) {
            ...
            return replaceBuilder(getRepeatedFieldAllowBuilders(t11, i11), true);
        }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(Map.Entry<T, Object> entry, boolean z11) {
            entry.setValue(replaceBuilders((FieldDescriptorLite) entry.getKey(), entry.getValue(), z11));
        }

        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t11, Object obj, boolean z11) {
            if (obj == null || t11.getLiteJavaType() != WireFormat.JavaType.MESSAGE) {
                return obj;
            }
            if (!t11.isRepeated()) {
                return replaceBuilder(obj, z11);
            }
            if (obj instanceof List) {
                List list = (List) obj;
                for (int i11 = 0; i11 < list.size(); i11++) {
                    Object obj2 = list.get(i11);
                    Object replaceBuilder = replaceBuilder(obj2, z11);
