...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        public Builder setFields(int i11, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i11, (Field) builder.build());
            return this;
        }

        public Builder setOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i11, (Option) builder.build());
            return this;
        }
        ...
        public Builder addFields(int i11, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i11, (Field) builder.build());
            return this;
        }

        public Builder addOptions(int i11, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i11, (Option) builder.build());
            return this;
        }
    }
