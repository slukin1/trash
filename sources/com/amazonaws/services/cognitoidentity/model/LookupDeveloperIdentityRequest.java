...
public class LookupDeveloperIdentityRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public int hashCode() {
        ...
        int hashCode2 = (((hashCode + i11) * 31) + (getMaxResults() == null ? 0 : getMaxResults().hashCode())) * 31;
    ...
    public String toString() {
        ...
        if (getDeveloperUserIdentifier() != null) {
            sb2.append("DeveloperUserIdentifier: " + getDeveloperUserIdentifier() + Constants.ACCEPT_TIME_SEPARATOR_SP);
        }
