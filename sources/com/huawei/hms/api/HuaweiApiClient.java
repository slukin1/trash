...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f37772b = new ArrayList();

        /* renamed from: c  reason: collision with root package name */
        private final List<PermissionInfo> f37773c = new ArrayList();

        /* renamed from: d  reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f37774d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        private OnConnectionFailedListener f37775e;

        /* renamed from: f  reason: collision with root package name */
        private ConnectionCallbacks f37776f;

        /* renamed from: g  reason: collision with root package name */
        private int f37777g;

        /* renamed from: h  reason: collision with root package name */
        private Activity f37778h;

        public Builder(Context context) throws NullPointerException {
            Checker.checkNonNull(context, "context must not be null.");
            Context applicationContext = context.getApplicationContext();
            this.f37771a = applicationContext;
            this.f37777g = -1;
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i11, OnConnectionFailedListener onConnectionFailedListener) {
            if (i11 >= 0) {
                this.f37777g = i11;
                this.f37778h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
                return this;
            }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f37771a);
            huaweiApiClientImpl.setScopes(this.f37772b);
            huaweiApiClientImpl.setPermissionInfos(this.f37773c);
            huaweiApiClientImpl.setApiMap(this.f37774d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f37776f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f37775e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f37777g);
            if (this.f37777g >= 0) {
                a((HuaweiApiClient) huaweiApiClientImpl);
            }
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f37778h).startAutoMange(this.f37777g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o11, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f37774d.put(api, o11);
            if (api.getOptions() != null) {
                this.f37772b.addAll(api.getOptions().getScopeList(o11));
                this.f37773c.addAll(api.getOptions().getPermissionInfoList(o11));
            }
            this.f37772b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
