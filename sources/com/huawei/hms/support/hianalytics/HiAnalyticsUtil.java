...
public class HiAnalyticsUtil {
    ...
    private static final Object f38499a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static HiAnalyticsUtil f38500b;

    /* renamed from: c  reason: collision with root package name */
    private static HiAnalyticsUtils f38501c;

    private String a(Context context, String str) {
        String packageName = context.getPackageName();
        return "01|" + "" + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + packageName + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + Util.getAppId(context) + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + 61100302 + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + str;
    }

    public static HiAnalyticsUtil getInstance() {
        HiAnalyticsUtil hiAnalyticsUtil;
        synchronized (f38499a) {
            if (f38500b == null) {
                f38500b = new HiAnalyticsUtil();
                f38501c = HiAnalyticsUtils.getInstance();
            }
            hiAnalyticsUtil = f38500b;
        }
    ...
    public void onBuoyEvent(Context context, String str, String str2) {
        f38501c.onBuoyEvent(context, str, str2);
    }

    public void onEvent(Context context, String str, Map<String, String> map) {
        f38501c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f38501c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f38501c.onNewEvent(context, str, map);
    }
    ...
    public boolean hasError(Context context) {
        return f38501c.hasError(context);
    }
