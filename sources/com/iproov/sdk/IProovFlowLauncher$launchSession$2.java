...
public final class IProovFlowLauncher$launchSession$2 extends Lambda implements a<Cconst> {
    ...
    public IProovFlowLauncher$launchSession$2(IProovFlowLauncher iProovFlowLauncher, Context context, String str, String str2, Cextends extendsR) {
        super(0);
    ...
    public final Cconst invoke() {
        Cfor forR = new Cfor(this.this$0.getAppComponent(this.$context.getApplicationContext()), this.$streamingUrl, this.$token, this.$sessionOptions, this.this$0.internalOptions);
