...
public class ImageSelectMinimalistActivity extends BaseMinimalistLightActivity {
    ...
    public static final String TAG = "ImageSelectMinimalistActivity";
    ...
    public static class ImageGridAdapter extends RecyclerView.Adapter<ImageViewHolder> {
        ...
        private int indexOf(ImageBean imageBean) {
            ...
            for (int i11 = 0; i11 < this.data.size(); i11++) {
                if (TextUtils.equals(this.data.get(i11).thumbnailUri, imageBean.thumbnailUri)) {
                    return i11;
                }
            }
            return -1;
        ...
        public ImageBean getDataByPosition(int i11) {
            List<ImageBean> list = this.data;
            if (list != null) {
                return list.get(i11);
            }
        ...
        public void setSelected(ImageBean imageBean) {
            ...
            int indexOf = indexOf(imageBean);
            int indexOf2 = indexOf(this.selected);
            this.selected = imageBean;
            notifyItemChanged(indexOf, imageBean);
            notifyItemChanged(indexOf2, this.selected);
        }
        ...
        public void onBindViewHolder(ImageViewHolder imageViewHolder, int i11, List<Object> list) {
        ...
        if (imageBean != null) {
            ...
            a.y(this).h().M0(imageUri).G0(new e<File>() {
                public boolean onLoadFailed(GlideException glideException, Object obj, g<File> gVar, boolean z11) {
                    ...
                    String access$300 = ImageSelectMinimalistActivity.TAG;
                    Log.e(access$300, "DownloadUrl onLoadFailed e = " + glideException);
                    ToastUtil.toastShortMessage(ImageSelectMinimalistActivity.this.getResources().getString(R.string.setting_fail));
                    return false;
                }
                ...
                public boolean onResourceReady(File file, Object obj, g<File> gVar, DataSource dataSource, boolean z11) {
                    ...
                    ImageSelectMinimalistActivity.this.setResult(imageBean2);
                    ToastUtil.toastShortMessage(ImageSelectMinimalistActivity.this.getResources().getString(R.string.setting_success));
                    return false;
                }
            }).P0();
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.titleBarLayout.setOnRightClickListener(new View.OnClickListener() {
            @SensorsDataInstrumented
            public void onClick(View view) {
                if (ImageSelectMinimalistActivity.this.selected == null) {
                    SensorsDataAutoTrackHelper.trackViewOnClick(view);
                    return;
                }
                if (booleanExtra) {
                    ImageSelectMinimalistActivity.this.downloadUrl();
                } else {
                    Intent intent = new Intent();
                    intent.putExtra("data", ImageSelectMinimalistActivity.this.selected);
        ...
        this.gridAdapter.setOnItemClickListener(new OnItemClickListener() {
            public void onClick(ImageBean imageBean) {
                ImageBean unused = ImageSelectMinimalistActivity.this.selected = imageBean;
                ImageSelectMinimalistActivity.this.setSelectedStatus();
            }
        });
