...
public class OpenGlUtils {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f22240a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f22240a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f22240a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.tencent.liteav.videobase.utils.OpenGlUtils.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static FloatBuffer createTextureCoordsBuffer(k kVar, boolean z11, boolean z12) {
        float[] fArr = GLConstants.f22075e;
    ...
    public static void initTextureCoordsBuffer(float[] fArr, k kVar, boolean z11, boolean z12) {
        float[] fArr2 = GLConstants.f22075e;
        if (kVar != null) {
            int i11 = AnonymousClass1.f22240a[kVar.ordinal()];
            if (i11 == 1) {
                fArr2 = GLConstants.f22077g;
            } else if (i11 == 2) {
                fArr2 = GLConstants.f22078h;
            } else if (i11 == 3) {
                fArr2 = GLConstants.f22076f;
            }
        }
