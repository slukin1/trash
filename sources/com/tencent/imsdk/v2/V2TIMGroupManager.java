...
public abstract class V2TIMGroupManager {
    ...
    public abstract void decreaseGroupCounter(String str, String str2, long j11, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
    ...
    public abstract void getGroupMemberList(String str, int i11, long j11, V2TIMValueCallback<V2TIMGroupMemberInfoResult> v2TIMValueCallback);
    ...
    public abstract void increaseGroupCounter(String str, String str2, long j11, V2TIMValueCallback<Map<String, Long>> v2TIMValueCallback);
    ...
    public abstract void kickGroupMember(String str, List<String> list, String str2, int i11, V2TIMValueCallback<List<V2TIMGroupMemberOperationResult>> v2TIMValueCallback);
    ...
    public abstract void markGroupMemberList(String str, List<String> list, int i11, boolean z11, V2TIMCallback v2TIMCallback);

    public abstract void muteGroupMember(String str, String str2, int i11, V2TIMCallback v2TIMCallback);
    ...
    public abstract void setGroupMemberRole(String str, String str2, int i11, V2TIMCallback v2TIMCallback);
