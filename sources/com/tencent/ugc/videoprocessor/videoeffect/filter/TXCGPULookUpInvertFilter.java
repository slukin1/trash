...
public class TXCGPULookUpInvertFilter extends TXCGPULookUpFilter {
    ...
    private int mInvertLevelUniform = -1;

    public TXCGPULookUpInvertFilter(Bitmap bitmap) {
        super(TXCGPUImageFilter.NO_FILTER_VERTEX_SHADER, LookupInvert_Frag);
        this.m_bmp = bitmap;
    }
    ...
    public void setInvertLevel(float f11) {
        setFloatOnDraw(this.mInvertLevelUniform, f11);
    }
}
