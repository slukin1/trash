...
public class TPReportParams {
    ...
    public class BufferingOnceParams {
        ...
        public void paramsToJson(JSONObject jSONObject) {
            try {
                jSONObject.put(InnerShareParams.SCENCE, this.sceneInt);
                jSONObject.put("levent", this.lastEventInt);
                jSONObject.put(Constants.REASON, this.reasonInt);
                jSONObject.put(TUIConstants.TUIGroupNote.PLUGIN_GROUP_NOTE_FORMAT, this.formatInt);
                ...
                TPLogUtil.e(TPReportParams.TAG, (Throwable) e11);
            }
        }

        public void paramsToProperties(a aVar) {
            aVar.a(InnerShareParams.SCENCE, this.sceneInt);
            aVar.a("levent", this.lastEventInt);
            aVar.a(Constants.REASON, this.reasonInt);
            aVar.a(TUIConstants.TUIGroupNote.PLUGIN_GROUP_NOTE_FORMAT, this.formatInt);
    ...
    public class CommonParams {
        ...
        public void paramsToProperties(a aVar) {
            ...
            aVar.a(SymbolBean.ONLINE, this.onlineInt);
            aVar.a("p2p", this.p2pInt);
            aVar.a("sstrength", this.signalStrengthInt);
            aVar.a(OptionsBridge.NETWORK_KEY, this.networkTypeInt);
            aVar.a("speed", this.networkSpeedInt);
            aVar.a("device", this.deviceNameString);
            aVar.a(CommonCode.MapKey.HAS_RESOLUTION, this.deviceResolutionString);
            ...
            aVar.a(IBridgeMediaLoader.COLUMN_DURATION, this.mediaDurationFloat);
