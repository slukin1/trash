...
public class TPNativePlayerInitConfig {
    ...
    public void addQueueInt(int i11, int i12) {
        Vector vector = this.mQueueIntMap.get(Integer.valueOf(i11));
        if (vector == null) {
            vector = new Vector();
            this.mQueueIntMap.put(Integer.valueOf(i11), vector);
        }
        vector.add(Integer.valueOf(i12));
    }

    public void addQueueString(int i11, String str) {
        Vector vector = this.mQueueStringMap.get(Integer.valueOf(i11));
        if (vector == null) {
            vector = new Vector();
            this.mQueueStringMap.put(Integer.valueOf(i11), vector);
        }
        vector.add(str);
    }
    ...
    public void setBool(int i11, boolean z11) {
        this.mBoolMap.put(Integer.valueOf(i11), Boolean.valueOf(z11));
    }

    public void setFloat(int i11, float f11) {
        this.mFloatMap.put(Integer.valueOf(i11), Float.valueOf(f11));
    }

    public void setInt(int i11, int i12) {
        this.mIntMap.put(Integer.valueOf(i11), Integer.valueOf(i12));
    }

    public void setLong(int i11, long j11) {
        this.mLongMap.put(Integer.valueOf(i11), Long.valueOf(j11));
    }

    public void setObject(int i11, Object obj) {
        this.mObjectMap.put(Integer.valueOf(i11), obj);
    }

    public void setString(int i11, String str) {
        this.mStringMap.put(Integer.valueOf(i11), str);
    }
}
