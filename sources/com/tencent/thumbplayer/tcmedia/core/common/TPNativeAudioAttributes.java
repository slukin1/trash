...
public class TPNativeAudioAttributes {
    ...
    public static class Builder {
        ...
        public TPNativeAudioAttributes build() {
            ...
            int unused = tPNativeAudioAttributes.mContentType = this.mContentType;
            int unused2 = tPNativeAudioAttributes.mUsage = this.mUsage;
            int unused3 = tPNativeAudioAttributes.mFlags = this.mFlags;
            return tPNativeAudioAttributes;
        }

        public Builder setContentType(@TPNativeAudioAttributeContentType int i11) {
            if (!TPNativeAudioAttributes.mMapContentTypeToString.containsKey(Integer.valueOf(i11))) {
                i11 = 0;
            }
        ...
        public Builder setLegacyStreamType(@TPNativeAudioAttributeStreamType int i11) {
        ...
        public Builder setUsage(@TPNativeAudioAttributeUsage int i11) {
            if (!TPNativeAudioAttributes.mMapUsageToString.containsKey(Integer.valueOf(i11))) {
                i11 = 0;
            }
            this.mUsage = i11;
            return this;
    ...
    public static String contentTypeToString(@TPNativeAudioAttributeContentType int i11) {
    ...
    public static String usageToString(@TPNativeAudioAttributeUsage int i11) {
