...
public class ErrCode {
    public static final int CHECK_CLICK_RESULT_ERROR_CHECK_SUM_DECRYPT_FAILED = -1202;
    public static final int CHECK_CLICK_RESULT_ERROR_CHECK_SUM_INVALID_PUSH_TYPE = -1204;
    public static final int CHECK_CLICK_RESULT_ERROR_CHECK_SUM_MISMATCH = -1203;
    public static final int CHECK_CLICK_RESULT_ERROR_CHECK_SUM_NULL = -1201;
    public static final int CHECK_CLICK_RESULT_ERROR_OTHER = -1209;
