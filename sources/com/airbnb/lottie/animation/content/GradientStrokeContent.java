...
public class GradientStrokeContent extends BaseStrokeContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f11 = value.x;
        float f12 = value.y;
        RadialGradient radialGradient = new RadialGradient(f11, f12, (float) Math.hypot((double) (value2.x - f11), (double) (value2.y - f12)), applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
