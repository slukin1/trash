...
class GradientStrokeParser {
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.of(GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION, f.f34662a);
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of(TtmlNode.TAG_P, "k");
    private static final JsonReader.Options NAMES = JsonReader.Options.of("nm", g.f22793a, "o", "t", s.f70071a, "e", "w", "lc", "lj", "ml", "hd", GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG);
    ...
    public static GradientStroke parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (selectName != 0) {
                            ...
                            if (selectName != 1) {
                                ...
                                animatableGradientColorValue2 = AnimatableValueParser.parseGradientColor(jsonReader2, lottieComposition2, i11);
                            }
                        } else {
                            animatableGradientColorValue = animatableGradientColorValue2;
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals(GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG) || str2.equals(g.f22793a)) {
        ...
        return new GradientStroke(str, gradientType, animatableGradientColorValue2, animatableIntegerValue, animatablePointValue, animatablePointValue2, animatableFloatValue, lineCapType, lineJoinType, f11, arrayList, animatableFloatValue2, z11);
    }
}
