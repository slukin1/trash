...
class JsonUtils {
    ...
    private static PointF jsonObjectToPoint(JsonReader jsonReader, float f11) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (selectName == 0) {
                ...
                f13 = valueFromObject(jsonReader);
            }
        }
    ...
    public static PointF jsonToPoint(JsonReader jsonReader, float f11) throws IOException {
        int i11 = AnonymousClass1.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i11 == 1) {
    ...
    public static List<PointF> jsonToPoints(JsonReader jsonReader, float f11) throws IOException {
        ArrayList arrayList = new ArrayList();
        jsonReader.beginArray();
        while (jsonReader.peek() == JsonReader.Token.BEGIN_ARRAY) {
            jsonReader.beginArray();
            arrayList.add(jsonToPoint(jsonReader, f11));
            jsonReader.endArray();
        }
        jsonReader.endArray();
        return arrayList;
    ...
    public static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i11 = AnonymousClass1.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[peek.ordinal()];
        if (i11 == 1) {
