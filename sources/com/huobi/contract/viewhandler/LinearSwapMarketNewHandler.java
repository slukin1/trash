...
public class LinearSwapMarketNewHandler extends AbsMarketViewHandler<MarketLinearSwapPriceItem> {
    ...
    public void y(c cVar, int i11, MarketLinearSwapPriceItem marketLinearSwapPriceItem, ViewGroup viewGroup) {
        ...
        cVar2.itemView.setOnClickListener(new s(this, cVar2, marketLinearSwapPriceItem2, i11));
        cVar2.itemView.setOnLongClickListener(new t(marketLinearSwapPriceItem2, cVar2));
    }
