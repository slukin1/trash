...
public class ContractTriggerOrderRspInfo implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof ContractTriggerOrderRspInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ContractTriggerOrderRspInfo)) {
            return false;
        }
        ContractTriggerOrderRspInfo contractTriggerOrderRspInfo = (ContractTriggerOrderRspInfo) obj;
        if (!contractTriggerOrderRspInfo.canEqual(this)) {
            return false;
        }
        String symbol2 = getSymbol();
        String symbol3 = contractTriggerOrderRspInfo.getSymbol();
        if (symbol2 != null ? !symbol2.equals(symbol3) : symbol3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = contractTriggerOrderRspInfo.getContractCode();
        if (contractCode2 != null ? !contractCode2.equals(contractCode3) : contractCode3 != null) {
            return false;
        }
        String contractType2 = getContractType();
        String contractType3 = contractTriggerOrderRspInfo.getContractType();
        if (contractType2 != null ? !contractType2.equals(contractType3) : contractType3 != null) {
            return false;
        }
        String triggerType2 = getTriggerType();
        String triggerType3 = contractTriggerOrderRspInfo.getTriggerType();
        if (triggerType2 != null ? !triggerType2.equals(triggerType3) : triggerType3 != null) {
            return false;
        }
        String volume2 = getVolume();
        String volume3 = contractTriggerOrderRspInfo.getVolume();
        if (volume2 != null ? !volume2.equals(volume3) : volume3 != null) {
            return false;
        }
        if (getOrderType() != contractTriggerOrderRspInfo.getOrderType()) {
            return false;
        }
        String direction2 = getDirection();
        String direction3 = contractTriggerOrderRspInfo.getDirection();
        if (direction2 != null ? !direction2.equals(direction3) : direction3 != null) {
            return false;
        }
        String offset2 = getOffset();
        String offset3 = contractTriggerOrderRspInfo.getOffset();
        if (offset2 != null ? !offset2.equals(offset3) : offset3 != null) {
            return false;
        }
        if (getLeverRate() != contractTriggerOrderRspInfo.getLeverRate()) {
            return false;
        }
        String orderId2 = getOrderId();
        String orderId3 = contractTriggerOrderRspInfo.getOrderId();
        if (orderId2 != null ? !orderId2.equals(orderId3) : orderId3 != null) {
            return false;
        }
        if (getRelationOrderId() != contractTriggerOrderRspInfo.getRelationOrderId() || getStatus() != contractTriggerOrderRspInfo.getStatus()) {
            return false;
        }
        String orderSource2 = getOrderSource();
        String orderSource3 = contractTriggerOrderRspInfo.getOrderSource();
        if (orderSource2 != null ? !orderSource2.equals(orderSource3) : orderSource3 != null) {
            return false;
        }
        String triggerPrice2 = getTriggerPrice();
        String triggerPrice3 = contractTriggerOrderRspInfo.getTriggerPrice();
        if (triggerPrice2 != null ? !triggerPrice2.equals(triggerPrice3) : triggerPrice3 != null) {
            return false;
        }
        String triggeredPrice2 = getTriggeredPrice();
        String triggeredPrice3 = contractTriggerOrderRspInfo.getTriggeredPrice();
        if (triggeredPrice2 != null ? !triggeredPrice2.equals(triggeredPrice3) : triggeredPrice3 != null) {
            return false;
        }
        String orderPrice2 = getOrderPrice();
        String orderPrice3 = contractTriggerOrderRspInfo.getOrderPrice();
        if (orderPrice2 != null ? !orderPrice2.equals(orderPrice3) : orderPrice3 != null) {
            return false;
        }
        String orderPriceType2 = getOrderPriceType();
        String orderPriceType3 = contractTriggerOrderRspInfo.getOrderPriceType();
        if (orderPriceType2 != null ? !orderPriceType2.equals(orderPriceType3) : orderPriceType3 != null) {
            return false;
        }
        if (getCreatedAt() != contractTriggerOrderRspInfo.getCreatedAt() || getTriggeredAt() != contractTriggerOrderRspInfo.getTriggeredAt() || getOrderInsertAt() != contractTriggerOrderRspInfo.getOrderInsertAt() || getCanceledAt() != contractTriggerOrderRspInfo.getCanceledAt() || getFailCode() != contractTriggerOrderRspInfo.getFailCode()) {
            return false;
        }
        String failReason2 = getFailReason();
        String failReason3 = contractTriggerOrderRspInfo.getFailReason();
        if (failReason2 != null ? !failReason2.equals(failReason3) : failReason3 != null) {
            return false;
        }
        String tpslOrderType2 = getTpslOrderType();
        String tpslOrderType3 = contractTriggerOrderRspInfo.getTpslOrderType();
        ...
        String abailablePosition3 = contractTriggerOrderRspInfo.getAbailablePosition();
        ...
        String avgOpen3 = contractTriggerOrderRspInfo.getAvgOpen();
        if (avgOpen2 != null ? !avgOpen2.equals(avgOpen3) : avgOpen3 != null) {
            return false;
        }
        String lastPrice2 = getLastPrice();
        String lastPrice3 = contractTriggerOrderRspInfo.getLastPrice();
