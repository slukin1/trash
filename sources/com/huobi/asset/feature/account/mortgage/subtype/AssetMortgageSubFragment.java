...
public class AssetMortgageSubFragment extends EmptyMVPFragment {

    /* renamed from: l  reason: collision with root package name */
    public EasyRecyclerView<a> f42285l;

    /* renamed from: m  reason: collision with root package name */
    public LoadingViewData f42286m;
    ...
    public void Gh(List<PledgeBalance.CurrencyBalance> list, int i11) {
        ...
        LoadingViewData loadingViewData = this.f42286m;
        if (loadingViewData == null || this.f42285l == null) {
            k.c("l = :" + this.f42286m + " r = : " + this.f42285l);
            return;
        }
        if (!z11) {
            for (PledgeBalance.CurrencyBalance assetMortgageItemInfo : list) {
                arrayList.add(new AssetMortgageItemInfo(assetMortgageItemInfo, getString(R$string.n_total_asset_mortgage_number), MortgageType.mortgage));
            }
        } else if (i11 == 2) {
            loadingViewData.g(2);
            arrayList.add(this.f42286m);
        } else {
            loadingViewData.g(3);
            arrayList.add(this.f42286m);
        }
        this.f42285l.setData(arrayList);
    }
    ...
    public void initViews() {
        ...
        this.f42285l = easyRecyclerView;
        easyRecyclerView.setLayoutManager(new StableLinearLayoutManager(getActivity()));
        this.f42285l.addItemDecoration(new VerticalDividerItemDecoration(ContextCompat.getDrawable(getActivity(), R$color.baseColorPrimarySeparator), PixelUtils.a(0.5f), false, false));
        this.f42286m = new LoadingViewData(new b(this));
    }

    public View ph(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return LayoutInflater.from(getContext()).inflate(R$layout.fragment_asset_mortgage_subtype, viewGroup, false);
    }
}
