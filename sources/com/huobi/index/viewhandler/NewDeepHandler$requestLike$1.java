...
final class NewDeepHandler$requestLike$1 extends Lambda implements l<CommentPraiseBean, Unit> {
    public final /* synthetic */ p<Integer, Integer, Unit> $onUpdateUI;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NewDeepHandler$requestLike$1(p<? super Integer, ? super Integer, Unit> pVar) {
        super(1);
