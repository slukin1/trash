...
public class AssetCoinPAllTabChildFragment extends BaseAssetChildTabFragment {
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("coinPAllAssetList", new c(this));
        }
    }
    ...
    public void onResume() {
        ...
        a aVar = this.f42574e;
        if (!(aVar == null || aVar.a() == null)) {
            this.f42574e.a().I("assetThirdTypeEvent('7',true)");
        }
