...
public class AssetCoinMOwnTabChildFragment extends BaseAssetChildTabFragment {
    ...
    public String e9() {
        return "asset_tab_contract_position_u_item.xml";
    }
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("coinMOwnAssetList", new b(this));
        }
    }
    ...
    public void onResume() {
        ...
        a aVar = this.f42574e;
        if (!(aVar == null || aVar.a() == null)) {
            this.f42574e.a().I("assetThirdTypeEvent('11',false)");
        }
        BaseModuleConfig.a().w("app_assets_futures_CoinF_mv_exposure", (HashMap) null);
    }
    ...
    public String wa() {
        return "asset_tab_contract_position_u_expand_item.xml";
    }
}
