package com.huobi.asset2.index.tabfragment.options;
...
public class AssetOptionsTabChildFragment extends BaseAssetChildTabFragment {
    ...
    public String e9() {
        return "asset_tab_options_item.xml";
    }
    ...
    public void initViews() {
        ...
        if (aVar == null || aVar.a() == null) {
            ...
            this.f42574e.a().v("optionList", new ei.a(this));
        }
    }
    ...
    public View ve(Context context) {
        ...
        linearLayout.addView(this.f42574e.a().E("asset_tab_options_header_layout.xml", getContext(), false, (JSONObject) null));
        ...
        jSONObject.put("listTitleCenter", (Object) getResources().getString(R$string.n_trade_hold));
    ...
    public String wa() {
        return "asset_tab_options_expand_item.xml";
    }
}
