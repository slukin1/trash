...
public class TriangularIndicator extends View implements b {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(bitmap2, this.mAnchorX - ((float) (bitmap2.getWidth() / 2)), ((((float) getHeight()) - (-this.mYOffset)) - ((float) this.bitmap.getHeight())) + 1.0f, (Paint) null);
    }
