...
public class WithdrawRecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    private Drawable mDividerDrawable;
    private int mDividerSize;
    private int mSecondDividerSize;
    private Drawable mSecondDrawable;

    public WithdrawRecyclerViewItemDecoration(Context context, int i11, int i12, int i13, int i14) {
    ...
    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        if (childAdapterPosition != -1) {
            if (childAdapterPosition == 0 || childAdapterPosition == recyclerView.getLayoutManager().getItemCount() - 1) {
                ...
                rect.set(0, this.mDividerSize, 0, this.mSecondDividerSize);
            } else {
