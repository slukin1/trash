...
public final class SNSApplicantDataSubtitleView extends SNSApplicantDataBaseFieldView {
    ...
    public SNSApplicantDataSubtitleView(Context context) {
        super(context, (AttributeSet) null, 0, 0, 14, (r) null);
        String c11;
        removeAllViews();
        SNSSubtitle2TextView sNSSubtitle2TextView = new SNSSubtitle2TextView(context, (AttributeSet) null, 0, 0, 14, (r) null);
        ...
        sNSSubtitle2TextView.setLayoutParams(new ConstraintLayout.LayoutParams(-1, -2));
        addView(sNSSubtitle2TextView);
        onInitializationFinished();
        a aVar = a.f31095a;
        d a11 = aVar.a();
        if (a11 != null && (c11 = aVar.c(a11, SNSMetricElement.SECTION_HEADER_ALIGNMENT)) != null) {
            aVar.a((TextView) sNSSubtitle2TextView, c11);
        }
    }
    ...
    public void setOnLinkClicked(l<? super String, Unit> lVar) {
        SNSSubtitle2TextView sNSSubtitle2TextView = this.subtitleView;
        if (sNSSubtitle2TextView != null) {
            b.a((TextView) sNSSubtitle2TextView, lVar);
        }
