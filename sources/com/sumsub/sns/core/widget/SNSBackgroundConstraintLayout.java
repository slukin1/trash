...
public class SNSBackgroundConstraintLayout extends ConstraintLayout {
    public SNSBackgroundConstraintLayout(Context context) {
    ...
    public SNSBackgroundConstraintLayout(Context context, AttributeSet attributeSet, int i11) {
        this(context, attributeSet, i11, 0, 8, (r) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ SNSBackgroundConstraintLayout(Context context, AttributeSet attributeSet, int i11, int i12, int i13, r rVar) {
        this(context, (i13 & 2) != 0 ? null : attributeSet, (i13 & 4) != 0 ? R.attr.sns_BackgroundConstraintLayoutStyle : i11, (i13 & 8) != 0 ? R.style.Widget_SNSBackgroundView : i12);
    }

    public SNSBackgroundConstraintLayout(Context context, AttributeSet attributeSet, int i11, int i12) {
        super(context, attributeSet, i11);
        Integer a11;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.SNSBackgroundConstraintLayout, i11, i12);
        int i13 = R.styleable.SNSBackgroundConstraintLayout_android_background;
