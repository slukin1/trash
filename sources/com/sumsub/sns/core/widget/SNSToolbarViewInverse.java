...
public final class SNSToolbarViewInverse extends SNSToolbarView {
    public SNSToolbarViewInverse(Context context) {
    ...
    public SNSToolbarViewInverse(Context context, AttributeSet attributeSet, int i11) {
        this(context, attributeSet, i11, 0, 8, (r) null);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ SNSToolbarViewInverse(Context context, AttributeSet attributeSet, int i11, int i12, int i13, r rVar) {
        this(context, (i13 & 2) != 0 ? null : attributeSet, (i13 & 4) != 0 ? R.attr.sns_ToolbarViewStyle : i11, (i13 & 8) != 0 ? R.style.Widget_SNSToolbarView_Inverse : i12);
    }

    public SNSToolbarViewInverse(Context context, AttributeSet attributeSet, int i11, int i12) {
