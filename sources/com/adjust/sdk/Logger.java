...
public class Logger implements ILogger {
    ...
    public void setLogLevel(LogLevel logLevel2, boolean z11) {
        if (!this.logLevelLocked) {
            this.logLevel = logLevel2;
            this.isProductionEnvironment = z11;
        }
    }

    public void setLogLevelString(String str, boolean z11) {
        if (str != null) {
            try {
                setLogLevel(LogLevel.valueOf(str.toUpperCase(Locale.US)), z11);
