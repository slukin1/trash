...
public final class AdjustLinkResolution {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ URL f13893a;

        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ AdjustLinkResolutionCallback f13894b;

        public a(URL url, AdjustLinkResolutionCallback adjustLinkResolutionCallback) {
            this.f13893a = url;
            this.f13894b = adjustLinkResolutionCallback;
        }

        public final void run() {
            AdjustLinkResolution.requestAndResolve(this.f13893a, 0, this.f13894b);
        }
    }
    ...
    public static void requestAndResolve(java.net.URL r4, int r5, com.adjust.sdk.AdjustLinkResolution.AdjustLinkResolutionCallback r6) {
        /*
            ...
            r0 = 0
            java.net.URLConnection r1 = r4.openConnection()     // Catch:{ all -> 0x0024 }
            java.net.HttpURLConnection r1 = (java.net.HttpURLConnection) r1     // Catch:{ all -> 0x0024 }
            r2 = 0
            r1.setInstanceFollowRedirects(r2)     // Catch:{ all -> 0x0025 }
            r1.connect()     // Catch:{ all -> 0x0025 }
            java.lang.String r2 = "Location"
            java.lang.String r2 = r1.getHeaderField(r2)     // Catch:{ all -> 0x0025 }
            if (r2 == 0) goto L_0x0020
            java.net.URL r3 = new java.net.URL     // Catch:{ all -> 0x0025 }
