...
public class OAuthSigning {
    ...
    public String getAuthorizationHeader(String str, String str2, Map<String, String> map) {
        return this.oAuth1aHeaders.getAuthorizationHeader(this.authConfig, this.authToken, (String) null, str, str2, map);
    }

    public Map<String, String> getOAuthEchoHeaders(String str, String str2, Map<String, String> map) {
        return this.oAuth1aHeaders.getOAuthEchoHeaders(this.authConfig, this.authToken, (String) null, str, str2, map);
    }

    public Map<String, String> getOAuthEchoHeadersForVerifyCredentials() {
        return this.oAuth1aHeaders.getOAuthEchoHeaders(this.authConfig, this.authToken, (String) null, "GET", VERIFY_CREDENTIALS_URL, (Map<String, String>) null);
    }

    public OAuthSigning(TwitterAuthConfig twitterAuthConfig, TwitterAuthToken twitterAuthToken, OAuth1aHeaders oAuth1aHeaders2) {
        if (twitterAuthConfig == null) {
            ...
            this.oAuth1aHeaders = oAuth1aHeaders2;
        } else {
