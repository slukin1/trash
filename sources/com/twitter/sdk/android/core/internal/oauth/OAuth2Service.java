...
public class OAuth2Service extends OAuthService {
    public OAuth2Api api = ((OAuth2Api) getRetrofit().create(OAuth2Api.class));
    ...
    private String getAuthHeader() {
        ...
        ByteString encodeUtf8 = ByteString.encodeUtf8(UrlUtils.percentEncode(authConfig.getConsumerKey()) + ":" + UrlUtils.percentEncode(authConfig.getConsumerSecret()));
            ...
            public void success(Result<OAuth2Token> result) {
                ...
                OAuth2Service.this.requestGuestToken(new Callback<GuestTokenResponse>() {
                    ...
                    public void success(Result<GuestTokenResponse> result) {
                        callback.success(new Result(new GuestAuthToken(oAuth2Token.getTokenType(), oAuth2Token.getAccessToken(), ((GuestTokenResponse) result.data).guestToken), (Response) null));
                    }
                }, oAuth2Token);
            }
        });
