...
public class ZLog {
    ...
    public static boolean f63264a = true;

    /* renamed from: b  reason: collision with root package name */
    public static boolean f63265b = false;

    /* renamed from: c  reason: collision with root package name */
    public static boolean f63266c = true;
    ...
    public static java.lang.String a(java.lang.String r7, java.lang.String r8) {
        ...
        L_0x00b7:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bbc876219.lib.zlog.ZLog.a(java.lang.String, java.lang.String):java.lang.String");
    }
            ...
            if (i11 != 3) {
                if (i11 != 4) {
                    if (i11 != 5) {
                        if (i11 == 6) {
                            if (f63266c) {
                                Log.e(str3, a(str3, str2));
                            } else {
                                System.out.println(str3 + "\t" + a(str3, str2));
                            }
                        }
                    } else if (f63266c) {
                        Log.w(str3, a(str3, str2));
                    } else {
                        System.out.println(str3 + "\t" + a(str3, str2));
                    }
                } else if (f63266c) {
                    Log.i(str3, a(str3, str2));
                } else {
                    System.out.println(str3 + "\t" + a(str3, str2));
                }
            } else if (f63266c) {
                Log.d(str3, a(str3, str2));
            } else {
                System.out.println(str3 + "\t" + a(str3, str2));
            }
        } else if (f63266c) {
            Log.v(str3, a(str3, str2));
        } else {
            System.out.println(str3 + "\t" + a(str3, str2));
        }
        return i11;
