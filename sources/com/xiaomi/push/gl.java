...
public enum gl {
    ...
    OnetrackSwitch(140),
    NotificationGroupUpdateTimeSwitch(TPOptionalID.OPTION_ID_BEFORE_QUEUE_INT_SPECIAL_SEI_TYPES_CALLBACK),
    KASwitch(142),
    IntelligentHeartbeatForUnsupportWifiDigestBoolean(TPOptionalID.OPTION_ID_BEFORE_BOOL_ENABLE_ORIGINAL_VIDEO_INFO_CALLBACK_FROM_SURFACE_LISTENER),
