...
public class m {
    ...
    public static void c(android.content.Context r7, android.content.pm.PackageInfo r8) {
        ...
        L_0x0078:
            ...
            return
        L_0x007f:
            com.xiaomi.mipush.sdk.m$a r7 = new com.xiaomi.mipush.sdk.m$a
        ...
        L_0x0097:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.mipush.sdk.m.c(android.content.Context, android.content.pm.PackageInfo):void");
    }
        ...
        if (serviceInfoArr != null) {
            for (ServiceInfo serviceInfo : serviceInfoArr) {
                if (!TextUtils.isEmpty(serviceInfo.name) && hashMap2.containsKey(serviceInfo.name)) {
                    ...
                    boolean z11 = bVar.f2470a;
                    boolean z12 = bVar.f2471b;
                    String str = bVar.f51324b;
                    if (z11 != serviceInfo.enabled) {
                        throw new a(String.format("<service android:name=\"%1$s\" .../> in AndroidManifest had the wrong enabled attribute, which should be android:enabled=%2$b.", new Object[]{serviceInfo.name, Boolean.valueOf(z11)}));
                    } else if (z12 != serviceInfo.exported) {
                        throw new a(String.format("<service android:name=\"%1$s\" .../> in AndroidManifest had the wrong exported attribute, which should be android:exported=%2$b.", new Object[]{serviceInfo.name, Boolean.valueOf(z12)}));
    ...
    public static void c(android.content.Context r8) {
        /*
            ...
            java.lang.String r4 = com.xiaomi.push.service.an.f52501r
            r3.<init>(r4)
            r3.setPackage(r2)
            r4 = 1
            r5 = 0
            java.lang.Class r6 = com.xiaomi.push.s.a(r8, r0)     // Catch:{ ClassNotFoundException -> 0x0055 }
            android.content.pm.ActivityInfo r3 = a((android.content.pm.PackageManager) r1, (android.content.Intent) r3, (java.lang.Class<?>) r6)     // Catch:{ ClassNotFoundException -> 0x0055 }
            ...
            a((android.content.pm.ActivityInfo) r3, (java.lang.Boolean[]) r0)     // Catch:{ ClassNotFoundException -> 0x0055 }
            goto L_0x0059
        L_0x0035:
            com.xiaomi.mipush.sdk.m$a r3 = new com.xiaomi.mipush.sdk.m$a     // Catch:{ ClassNotFoundException -> 0x0055 }
        ...
        L_0x006e:
            ...
            java.lang.Class r6 = com.xiaomi.push.s.a(r8, r6)     // Catch:{ ClassNotFoundException -> 0x009a }
