...
public final class GroupShareActivity$initView$2 extends Lambda implements p<Throwable, APIStatusErrorException, Unit> {
    public final /* synthetic */ GroupShareActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GroupShareActivity$initView$2(GroupShareActivity groupShareActivity) {
        super(2);
