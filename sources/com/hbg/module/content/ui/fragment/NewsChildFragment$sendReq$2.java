...
public final class NewsChildFragment$sendReq$2 extends Lambda implements p<Throwable, APIStatusErrorException, Unit> {
    public final /* synthetic */ NewsChildFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NewsChildFragment$sendReq$2(NewsChildFragment newsChildFragment) {
        super(2);
