...
public final class CommunityChildFragment$initData$5 extends Lambda implements l<e, Unit> {
    public final /* synthetic */ CommunityChildFragment this$0;

    @d(c = "com.hbg.module.community.ui.CommunityChildFragment$initData$5$1", f = "CommunityChildFragment.kt", l = {266}, m = "invokeSuspend")
    /* renamed from: com.hbg.module.community.ui.CommunityChildFragment$initData$5$1  reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements p<h0, c<? super Unit>, Object> {
        public int label;

        public final c<Unit> create(Object obj, c<?> cVar) {
            return new AnonymousClass1(communityChildFragment, eVar, cVar);
        }
            ...
            if (i11 == 0) {
                ...
                AnonymousClass1 r12 = new p<h0, c<? super Unit>, Object>((c<? super AnonymousClass1>) null) {
                    ...
                    public final c<Unit> create(Object obj, c<?> cVar) {
                        ...
                        public CommunityChildFragment$initData$5(CommunityChildFragment communityChildFragment) {
                            super(1);
