...
public final class CommunityFeedItemBinder$onBindViewHolder$2 extends Lambda implements p<Integer, List<? extends CommunityFeedInfo.imgListBean>, Unit> {
    public final /* synthetic */ Context $context;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CommunityFeedItemBinder$onBindViewHolder$2(Context context) {
        super(2);
