...
final class CommonWidgetHelper$getPkData$2 extends Lambda implements p<Throwable, APIStatusErrorException, Unit> {
    public final /* synthetic */ b<CommonPkData> $callback;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CommonWidgetHelper$getPkData$2(b<CommonPkData> bVar) {
        super(2);
        this.$callback = bVar;
    }
