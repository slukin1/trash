...
public class SwapCurrentOrderInfo implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapCurrentOrderInfo;
    }
    ...
    public int hashCode() {
        ...
        Integer leverRate2 = getLeverRate();
        int hashCode9 = (((hashCode8 * 59) + (leverRate2 == null ? 43 : leverRate2.hashCode())) * 59) + getOrderType();
        String orderId2 = getOrderId();
        ...
        String realProfit2 = getRealProfit();
        int hashCode20 = (hashCode19 * 59) + (realProfit2 == null ? 43 : realProfit2.hashCode());
        String status2 = getStatus();
        int i12 = hashCode20 * 59;
        if (status2 != null) {
            i11 = status2.hashCode();
        }
        return ((i12 + i11) * 59) + getIsTpsl();
    }
    ...
    public String toString() {
        return "SwapCurrentOrderInfo(symbol=" + getSymbol() + ", contractType=" + getContractType() + ", contractCode=" + getContractCode() + ", volume=" + getVolume() + ", price=" + getPrice() + ", orderPriceType=" + getOrderPriceType() + ", direction=" + getDirection() + ", offset=" + getOffset() + ", leverRate=" + getLeverRate() + ", orderType=" + getOrderType() + ", orderId=" + getOrderId() + ", clientOrderId=" + getClientOrderId() + ", orderSource=" + getOrderSource() + ", createdAt=" + getCreatedAt() + ", tradeVolume=" + getTradeVolume() + ", tradeTurnover=" + getTradeTurnover() + ", fee=" + getFee() + ", tradeAvgPrice=" + getTradeAvgPrice() + ", marginFrozen=" + getMarginFrozen() + ", profit=" + getProfit() + ", realProfit=" + getRealProfit() + ", status=" + getStatus() + ", contractFace=" + getContractFace() + ", isTpsl=" + getIsTpsl() + ")";
    }
}
