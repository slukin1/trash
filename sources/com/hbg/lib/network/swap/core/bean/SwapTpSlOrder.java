...
public class SwapTpSlOrder implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SwapTpSlOrder;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String relationTpSlOrderId3 = swapTpSlOrder.getRelationTpSlOrderId();
        if (relationTpSlOrderId2 != null ? !relationTpSlOrderId2.equals(relationTpSlOrderId3) : relationTpSlOrderId3 != null) {
            return false;
        }
        if (getCanceledAt() != swapTpSlOrder.getCanceledAt() || getFailCode() != swapTpSlOrder.getFailCode()) {
            return false;
        }
        String failReason2 = getFailReason();
        String failReason3 = swapTpSlOrder.getFailReason();
        if (failReason2 != null ? !failReason2.equals(failReason3) : failReason3 != null) {
            return false;
        }
        String triggeredPrice2 = getTriggeredPrice();
        String triggeredPrice3 = swapTpSlOrder.getTriggeredPrice();
        ...
        String relationOrderId3 = swapTpSlOrder.getRelationOrderId();
        if (relationOrderId2 != null ? relationOrderId2.equals(relationOrderId3) : relationOrderId3 == null) {
            return getUpdateTime() == swapTpSlOrder.getUpdateTime() && getTriggeredAt() == swapTpSlOrder.getTriggeredAt();
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String contractCode2 = getContractCode();
        int hashCode2 = ((((((hashCode + 59) * 59) + (contractCode2 == null ? 43 : contractCode2.hashCode())) * 59) + getVolume()) * 59) + getOrderType();
        String leverRate2 = getLeverRate();
        int hashCode3 = (hashCode2 * 59) + (leverRate2 == null ? 43 : leverRate2.hashCode());
        String tpSlOrderType2 = getTpSlOrderType();
        int hashCode4 = (hashCode3 * 59) + (tpSlOrderType2 == null ? 43 : tpSlOrderType2.hashCode());
        String direction2 = getDirection();
        int hashCode5 = (hashCode4 * 59) + (direction2 == null ? 43 : direction2.hashCode());
        String orderId2 = getOrderId();
        int hashCode6 = (hashCode5 * 59) + (orderId2 == null ? 43 : orderId2.hashCode());
        String orderSource2 = getOrderSource();
        int hashCode7 = (hashCode6 * 59) + (orderSource2 == null ? 43 : orderSource2.hashCode());
        String triggerType2 = getTriggerType();
        int hashCode8 = (hashCode7 * 59) + (triggerType2 == null ? 43 : triggerType2.hashCode());
        String triggerPrice2 = getTriggerPrice();
        int hashCode9 = (hashCode8 * 59) + (triggerPrice2 == null ? 43 : triggerPrice2.hashCode());
        String orderPrice2 = getOrderPrice();
        int hashCode10 = (hashCode9 * 59) + (orderPrice2 == null ? 43 : orderPrice2.hashCode());
        long createdAt2 = getCreatedAt();
        int orderPriceType2 = (((((hashCode10 * 59) + ((int) (createdAt2 ^ (createdAt2 >>> 32)))) * 59) + getOrderPriceType()) * 59) + getStatus();
        String sourceOrderId2 = getSourceOrderId();
        int hashCode11 = (orderPriceType2 * 59) + (sourceOrderId2 == null ? 43 : sourceOrderId2.hashCode());
        String relationTpSlOrderId2 = getRelationTpSlOrderId();
        int hashCode12 = (hashCode11 * 59) + (relationTpSlOrderId2 == null ? 43 : relationTpSlOrderId2.hashCode());
        long canceledAt2 = getCanceledAt();
        int failCode2 = (((hashCode12 * 59) + ((int) (canceledAt2 ^ (canceledAt2 >>> 32)))) * 59) + getFailCode();
        String failReason2 = getFailReason();
        int hashCode13 = (failCode2 * 59) + (failReason2 == null ? 43 : failReason2.hashCode());
        String triggeredPrice2 = getTriggeredPrice();
