...
public class LinearSwapOpenRight implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof LinearSwapOpenRight;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LinearSwapOpenRight)) {
            return false;
        }
        LinearSwapOpenRight linearSwapOpenRight = (LinearSwapOpenRight) obj;
        if (!linearSwapOpenRight.canEqual(this)) {
            return false;
        }
        String kycCountryCode2 = getKycCountryCode();
        String kycCountryCode3 = linearSwapOpenRight.getKycCountryCode();
        if (kycCountryCode2 != null ? !kycCountryCode2.equals(kycCountryCode3) : kycCountryCode3 != null) {
            return false;
        }
        String contractCode2 = getContractCode();
        String contractCode3 = linearSwapOpenRight.getContractCode();
        if (contractCode2 != null ? contractCode2.equals(contractCode3) : contractCode3 == null) {
            return getRight() == linearSwapOpenRight.getRight() && getCloseRight() == linearSwapOpenRight.getCloseRight();
        }
        return false;
    }
    ...
    public String toString() {
        return "LinearSwapOpenRight(kycCountryCode=" + getKycCountryCode() + ", contractCode=" + getContractCode() + ", right=" + getRight() + ", closeRight=" + getCloseRight() + ")";
    }
}
