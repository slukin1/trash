...
public class LinearSwapTriggerOrderInfo implements Serializable {
    public static final String DELIVERY = "settlement";
    public static final String EXPLOSE = "risk";
    public static final String GE = "ge";
    public static final String GE_MARK = "ge_mark";
    public static final String LE = "le";
    public static final String LE_MARK = "le_mark";
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof LinearSwapTriggerOrderInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        String avgOpen3 = linearSwapTriggerOrderInfo.getAvgOpen();
        if (avgOpen2 != null ? !avgOpen2.equals(avgOpen3) : avgOpen3 != null) {
            return false;
        }
        String lastPrice2 = getLastPrice();
        String lastPrice3 = linearSwapTriggerOrderInfo.getLastPrice();
    ...
    public int hashCode() {
        ...
        String abailablePosition2 = getAbailablePosition();
        int hashCode17 = (hashCode16 * 59) + (abailablePosition2 == null ? 43 : abailablePosition2.hashCode());
        String avgOpen2 = getAvgOpen();
        int hashCode18 = (hashCode17 * 59) + (avgOpen2 == null ? 43 : avgOpen2.hashCode());
        String lastPrice2 = getLastPrice();
    ...
    public boolean isLe() {
        return "le".equalsIgnoreCase(this.triggerType);
    }

    public boolean isMarketPriceGe() {
        return GE_MARK.equalsIgnoreCase(this.triggerType);
    }

    public boolean isMarketPriceLe() {
        return LE_MARK.equalsIgnoreCase(this.triggerType);
    }
    ...
    public String toString() {
        return "LinearSwapTriggerOrderInfo(symbol=" + getSymbol() + ", contractCode=" + getContractCode() + ", contractType=" + getContractType() + ", triggerType=" + getTriggerType() + ", volume=" + getVolume() + ", orderType=" + getOrderType() + ", direction=" + getDirection() + ", offset=" + getOffset() + ", leverRate=" + getLeverRate() + ", orderId=" + getOrderId() + ", relationOrderId=" + getRelationOrderId() + ", status=" + getStatus() + ", orderSource=" + getOrderSource() + ", triggerPrice=" + getTriggerPrice() + ", triggeredPrice=" + getTriggeredPrice() + ", orderPrice=" + getOrderPrice() + ", orderPriceType=" + getOrderPriceType() + ", createdAt=" + getCreatedAt() + ", triggeredAt=" + getTriggeredAt() + ", orderInsertAt=" + getOrderInsertAt() + ", canceledAt=" + getCanceledAt() + ", failCode=" + getFailCode() + ", failReason=" + getFailReason() + ", contractFace=" + getContractFace() + ", tpslOrderType=" + getTpslOrderType() + ", marginMode=" + getMarginMode() + ", abailablePosition=" + getAbailablePosition() + ", avgOpen=" + getAvgOpen() + ", lastPrice=" + getLastPrice() + ")";
    }
}
