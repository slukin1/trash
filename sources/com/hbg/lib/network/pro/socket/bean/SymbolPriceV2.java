...
public class SymbolPriceV2 implements Serializable {
    ...
    public boolean canEqual(Object obj) {
        return obj instanceof SymbolPriceV2;
    }
    ...
    public String toString() {
        return "SymbolPriceV2(symbol=" + getSymbol() + ", open=" + getOpen() + ", close=" + getClose() + ", low=" + getLow() + ", high=" + getHigh() + ", amount=" + getAmount() + ", count=" + getCount() + ", vol=" + getVol() + ", rise=" + getRise() + ")";
    }
}
