...
public class SkiaImageDecoder implements c {
    ...
    public final Bitmap.Config f72148a;
    ...
    public android.graphics.Bitmap decode(android.content.Context r9, android.net.Uri r10) throws java.lang.Exception {
        /*
            ...
            r1.<init>()
            android.graphics.Bitmap$Config r2 = r8.f72148a
        ...
        L_0x00cb:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hbg.lib.widgets.photoviewer.SkiaImageDecoder.decode(android.content.Context, android.net.Uri):android.graphics.Bitmap");
    }
    ...
    public SkiaImageDecoder(Bitmap.Config config) {
        ...
        if (config != null) {
            ...
            this.f72148a = preferredBitmapConfig;
        } else {
            this.f72148a = Bitmap.Config.RGB_565;
        }
    }
}
