...
public class ViewIndexer {
            ...
            public void run() {
                ...
                if ((md5hash == null || !md5hash.equals(ViewIndexer.this.previousDigest)) && (buildAppIndexingRequest = ViewIndexer.buildAppIndexingRequest(str, currentAccessToken, FacebookSdk.getApplicationId(), Constants.APP_INDEXING)) != null) {
                    ...
                    try {
                        ...
                        Log.e(ViewIndexer.TAG, "Error decoding server response.", e11);
                    }
                }
            }
        });
    ...
    public void schedule() {
        final AnonymousClass1 r02 = new TimerTask() {
            ...
            public void run() {
                /*
                    r7 = this;
                    com.facebook.appevents.codeless.ViewIndexer r0 = com.facebook.appevents.codeless.ViewIndexer.this     // Catch:{ Exception -> 0x0094 }
                    ...
                    return
                L_0x000f:
                    java.lang.Class r1 = r0.getClass()     // Catch:{ Exception -> 0x0094 }
                    java.lang.String r1 = r1.getSimpleName()     // Catch:{ Exception -> 0x0094 }
                    android.view.Window r0 = r0.getWindow()     // Catch:{ Exception -> 0x0094 }
                    android.view.View r0 = r0.getDecorView()     // Catch:{ Exception -> 0x0094 }
                    android.view.View r0 = r0.getRootView()     // Catch:{ Exception -> 0x0094 }
                    boolean r2 = com.facebook.appevents.codeless.CodelessManager.getIsAppIndexingEnabled()     // Catch:{ Exception -> 0x0094 }
                ...
                L_0x0034:
                    ...
                    com.facebook.appevents.codeless.ViewIndexer r3 = com.facebook.appevents.codeless.ViewIndexer.this     // Catch:{ Exception -> 0x0094 }
                ...
                L_0x005f:
                    ...
                    r2.put(r4, r1)     // Catch:{ JSONException -> 0x0081 }
                    java.lang.String r1 = "screenshot"
                    r2.put(r1, r3)     // Catch:{ JSONException -> 0x0081 }
                    org.json.JSONArray r1 = new org.json.JSONArray     // Catch:{ JSONException -> 0x0081 }
                    r1.<init>()     // Catch:{ JSONException -> 0x0081 }
                    org.json.JSONObject r0 = com.facebook.appevents.codeless.internal.ViewHierarchy.getDictionaryOfView(r0)     // Catch:{ JSONException -> 0x0081 }
                    r1.put(r0)     // Catch:{ JSONException -> 0x0081 }
                    java.lang.String r0 = "view"
                    r2.put(r0, r1)     // Catch:{ JSONException -> 0x0081 }
                    goto L_0x008a
                L_0x0081:
                ...
                L_0x008a:
                    java.lang.String r0 = r2.toString()     // Catch:{ Exception -> 0x0094 }
                    com.facebook.appevents.codeless.ViewIndexer r1 = com.facebook.appevents.codeless.ViewIndexer.this     // Catch:{ Exception -> 0x0094 }
        ...
        FacebookSdk.getExecutor().execute(new Runnable() {
            public void run() {
                try {
                    ...
                    ViewIndexer.this.indexingTimer.scheduleAtFixedRate(r02, 0, 1000);
                } catch (Exception e11) {
                    Log.e(ViewIndexer.TAG, "Error scheduling indexing job", e11);
                }
            }
        });
    }
