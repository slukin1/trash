...
class AppEventsLoggerImpl {
    ...
    public static void augmentWebView(WebView webView, Context context) {
        ...
        if (Build.VERSION.SDK_INT < 17 || parseInt < 4 || (parseInt == 4 && i11 <= 1)) {
        ...
        getAnalyticsExecutor().execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    throw new FacebookException("Failed to construct request", (Throwable) e11);
                }
            }
        });
    }
    ...
    public void logSdkEvent(String str, Double d11, Bundle bundle) {
    ...
    public void logEvent(String str, double d11) {
    ...
    public void logPurchase(BigDecimal bigDecimal, Currency currency, Bundle bundle, boolean z11) {
        if (bigDecimal == null) {
    ...
    public void logEvent(String str, Double d11, Bundle bundle, boolean z11, UUID uuid) {
        if (str != null && !str.isEmpty()) {
            ...
            try {
                logEvent(new AppEvent(this.contextName, str, d11, bundle, z11, ActivityLifecycleTracker.isInBackground(), uuid), this.accessTokenAppId);
            } catch (JSONException e11) {
                Logger.log(LoggingBehavior.APP_EVENTS, "AppEvents", "JSON encoding for app event failed: '%s'", e11.toString());
            } catch (FacebookException e12) {
                Logger.log(LoggingBehavior.APP_EVENTS, "AppEvents", "Invalid app event: %s", e12.toString());
            }
        }
    }
