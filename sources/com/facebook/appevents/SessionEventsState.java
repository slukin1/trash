...
class SessionEventsState {
    ...
    public int populateRequest(GraphRequest graphRequest, Context context, boolean z11, boolean z12) {
        synchronized (this) {
            ...
            for (AppEvent next : this.inFlightEvents) {
                ...
                } else if (z11 || !next.getIsImplicit()) {
    ...
    private void populateRequest(GraphRequest graphRequest, Context context, int i11, JSONArray jSONArray, boolean z11) {
