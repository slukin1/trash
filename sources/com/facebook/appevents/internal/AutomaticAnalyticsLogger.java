...
public class AutomaticAnalyticsLogger {
    ...
    public static void logActivityTimeSpentEvent(String str, long j11) {
        Context applicationContext = FacebookSdk.getApplicationContext();
        String applicationId = FacebookSdk.getApplicationId();
        Validate.notNull(applicationContext, "context");
        ...
        if (queryAppSettings != null && queryAppSettings.getAutomaticLoggingEnabled() && j11 > 0) {
            ...
            internalAppEventsLogger2.logEvent(Constants.AA_TIME_SPENT_EVENT_NAME, (double) j11, bundle);
        }
    }

    public static void logPurchase(String str, String str2, boolean z11) {
        ...
        if (isImplicitPurchaseLoggingEnabled() && (purchaseLoggingParameters = getPurchaseLoggingParameters(str, str2)) != null) {
            boolean z12 = false;
            if (z11 && FetchedAppGateKeepersManager.getGateKeeperForKey(APP_EVENTS_IF_AUTO_LOG_SUBS, FacebookSdk.getApplicationId(), false)) {
                z12 = true;
            }
            if (z12) {
    ...
    private static PurchaseLoggingParameters getPurchaseLoggingParameters(String str, String str2, Map<String, String> map) {
        try {
            ...
            bundle.putCharSequence(Constants.IAP_PACKAGE_NAME, jSONObject.optString(Constants.FLAG_PACKAGE_NAME));
            ...
            Log.e(TAG, "Error parsing in-app subscription data.", e11);
            return null;
        }
    }
}
