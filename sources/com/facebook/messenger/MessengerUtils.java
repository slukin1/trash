...
public class MessengerUtils {
    ...
    public static void finishShareToMessenger(Activity activity, ShareToMessengerParams shareToMessengerParams) {
        ...
        if (categories == null) {
            ...
            if (categories.contains(ORCA_THREAD_CATEGORY_20150314)) {
                ...
                intent2.putExtra(EXTRA_THREAD_TOKEN_KEY, b11.getString(EXTRA_THREAD_TOKEN_KEY));
    ...
    private static Set<Integer> getAllAvailableProtocolVersions(Context context) {
        ...
        Cursor query = contentResolver.query(Uri.parse("content://com.facebook.orca.provider.MessengerPlatformProvider/versions"), new String[]{"version"}, (String) null, (String[]) null, (String) null);
        if (query != null) {
            try {
    ...
    public static MessengerThreadParams getMessengerThreadParamsForIntent(Intent intent) {
        ...
        Bundle b11 = AppLinks.b(intent);
        String string = b11.getString(EXTRA_THREAD_TOKEN_KEY);
        String string2 = b11.getString(EXTRA_METADATA);
        String string3 = b11.getString(EXTRA_PARTICIPANTS);
        boolean z11 = b11.getBoolean(EXTRA_IS_REPLY);
        boolean z12 = b11.getBoolean(EXTRA_IS_COMPOSE);
    ...
    public static void shareToMessenger(Activity activity, int i11, ShareToMessengerParams shareToMessengerParams) {
        if (!hasMessengerInstalled(activity)) {
            ...
            shareToMessenger20150314(activity, i11, shareToMessengerParams);
        } else {
            openMessengerInPlayStore(activity);
        }
    }

    private static void shareToMessenger20150314(Activity activity, int i11, ShareToMessengerParams shareToMessengerParams) {
        try {
