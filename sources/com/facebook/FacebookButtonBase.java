...
public abstract class FacebookButtonBase extends Button {
    ...
    public FacebookButtonBase(Context context, AttributeSet attributeSet, int i11, int i12, String str, String str2) {
    ...
    private void parseBackgroundAttributes(Context context, AttributeSet attributeSet, int i11, int i12) {
        if (!isInEditMode()) {
    ...
    private void parseCompoundDrawableAttributes(Context context, AttributeSet attributeSet, int i11, int i12) {
    ...
    private void parseContentAttributes(Context context, AttributeSet attributeSet, int i11, int i12) {
    ...
    private void parseTextAttributes(Context context, AttributeSet attributeSet, int i11, int i12) {
