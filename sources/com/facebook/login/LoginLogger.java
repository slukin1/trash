...
class LoginLogger {
    ...
    public void logStartLogin(LoginClient.Request request) {
        ...
        try {
            ...
            jSONObject.put("permissions", TextUtils.join(Constants.ACCEPT_TIME_SEPARATOR_SP, request.getPermissions()));
        ...
        this.logger.logEventImplicitly(EVENT_NAME_LOGIN_START, (Double) null, newAuthorizationLoggingBundle);
    }
