...
public class ImageDownloader {
    ...
    public static class CacheReadWorkItem implements Runnable {
        ...
        public CacheReadWorkItem(Context context2, RequestKey requestKey, boolean z11) {
    ...
    private static void enqueueCacheRead(ImageRequest imageRequest, RequestKey requestKey, boolean z11) {
        enqueueRequest(imageRequest, requestKey, cacheReadQueue, new CacheReadWorkItem(imageRequest.getContext(), requestKey, z11));
    }
    ...
    /* access modifiers changed from: private */
    public static void readFromCache(RequestKey requestKey, Context context, boolean z11) {
        InputStream inputStream;
        Uri redirectedUri;
        boolean z12 = false;
        if (!z11 || (redirectedUri = UrlRedirectCache.getRedirectedUri(requestKey.uri)) == null) {
            inputStream = null;
        } else {
        ...
        if (inputStream != null) {
            ...
            issueResponse(requestKey, (Exception) null, decodeStream, z12);
            return;
        }
