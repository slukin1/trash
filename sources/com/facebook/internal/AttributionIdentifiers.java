...
public class AttributionIdentifiers {
    ...
    public static com.facebook.internal.AttributionIdentifiers getAttributionIdentifiers(android.content.Context r12) {
        /*
            ...
            com.facebook.internal.AttributionIdentifiers r5 = recentlyFetchedIdentifiers     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            if (r5 == 0) goto L_0x002a
            long r5 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            com.facebook.internal.AttributionIdentifiers r7 = recentlyFetchedIdentifiers     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            long r8 = r7.fetchTime     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            long r5 = r5 - r8
        ...
        L_0x002a:
            ...
            boolean r5 = com.facebook.internal.FacebookSignatureValidator.validateSignature(r12, r5)     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            if (r5 == 0) goto L_0x0055
        ...
        L_0x0066:
            r6 = r4
        L_0x0067:
            java.lang.String r5 = getInstallerPackageName(r12)     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            if (r5 == 0) goto L_0x006f
            r3.androidInstallerPackage = r5     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
        L_0x006f:
            if (r6 != 0) goto L_0x0076
            com.facebook.internal.AttributionIdentifiers r12 = cacheAndReturnIdentifiers(r3)     // Catch:{ Exception -> 0x00db, all -> 0x00d9 }
            return r12
        L_0x0076:
        ...
        L_0x00db:
            ...
            r0 = r4
        L_0x00dd:
            java.lang.String r1 = TAG     // Catch:{ all -> 0x00fd }
            ...
            com.facebook.internal.Utility.logd((java.lang.String) r1, (java.lang.String) r12)     // Catch:{ all -> 0x00fd }
