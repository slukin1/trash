...
public class GraphResponse {
    ...
    public static List<GraphResponse> constructErrorResponses(List<GraphRequest> list, HttpURLConnection httpURLConnection, FacebookException facebookException) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            arrayList.add(new GraphResponse(list.get(i11), httpURLConnection, new FacebookRequestError(httpURLConnection, (Exception) facebookException)));
        }
        return arrayList;
    }
    ...
    public static List<GraphResponse> fromHttpConnection(HttpURLConnection httpURLConnection, GraphRequestBatch graphRequestBatch) {
        ...
        try {
            ...
            Logger.log(LoggingBehavior.REQUESTS, RESPONSE_LOG_TAG, "Response <Error>: %s", e11);
            return constructErrorResponses(graphRequestBatch, httpURLConnection, e11);
        } catch (Exception e12) {
            Logger.log(LoggingBehavior.REQUESTS, RESPONSE_LOG_TAG, "Response <Error>: %s", e12);
            return constructErrorResponses(graphRequestBatch, httpURLConnection, new FacebookException((Throwable) e12));
        } finally {
