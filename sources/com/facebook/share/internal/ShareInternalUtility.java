...
public final class ShareInternalUtility {
    ...
    private static AppCall getAppCallFromActivityResult(int i11, int i12, Intent intent) {
        UUID callIdFromIntent = NativeProtocol.getCallIdFromIntent(intent);
        if (callIdFromIntent == null) {
            return null;
        }
        return AppCall.finishPendingCall(callIdFromIntent, i11);
    }
    ...
    public static boolean handleActivityResult(int i11, int i12, Intent intent, ResultProcessor resultProcessor) {
        AppCall appCallFromActivityResult = getAppCallFromActivityResult(i11, i12, intent);
    ...
    public static void registerSharerCallback(final int i11, CallbackManager callbackManager, final FacebookCallback<Sharer.Result> facebookCallback) {
        if (callbackManager instanceof CallbackManagerImpl) {
            ((CallbackManagerImpl) callbackManager).registerCallback(i11, new CallbackManagerImpl.Callback() {
                public boolean onActivityResult(int i11, Intent intent) {
                    return ShareInternalUtility.handleActivityResult(i11, i11, intent, ShareInternalUtility.getShareResultProcessor(facebookCallback));
                }
            });
            return;
        }
    ...
    public static void registerStaticShareCallback(final int i11) {
        CallbackManagerImpl.registerStaticCallback(i11, new CallbackManagerImpl.Callback() {
            public boolean onActivityResult(int i11, Intent intent) {
                return ShareInternalUtility.handleActivityResult(i11, i11, intent, ShareInternalUtility.getShareResultProcessor((FacebookCallback<Sharer.Result>) null));
            }
        });
    }
    ...
    public static JSONObject toJSONObjectForCall(final UUID uuid, ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        ...
        JSONObject jSONObject = OpenGraphJSONUtility.toJSONObject(action, (OpenGraphJSONUtility.PhotoJSONProcessor) new OpenGraphJSONUtility.PhotoJSONProcessor() {
            public JSONObject toJSONObject(SharePhoto sharePhoto) {
                ...
                try {
                    ...
                    throw new FacebookException("Unable to attach images", (Throwable) e11);
                }
            }
        });
        NativeAppCallAttachmentStore.addAttachments(arrayList);
        ...
        if (shareOpenGraphContent.getPeopleIds() != null) {
            ...
            jSONObject.put(InnerShareParams.TAGS, new JSONArray(set));
        }
        return jSONObject;
    }
