...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = $SwitchMap$com$facebook$share$widget$ShareDialog$Mode     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = $SwitchMap$com$facebook$share$widget$ShareDialog$Mode     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    public class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, AnonymousClass1 r22) {
            this();
        }

        public boolean canShow(ShareContent shareContent, boolean z11) {
    ...
    public class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ FeedHandler(ShareDialog shareDialog, AnonymousClass1 r22) {
            this();
        }
    ...
    public class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ NativeHandler(ShareDialog shareDialog, AnonymousClass1 r22) {
            this();
        }
        ...
        public boolean canShow(ShareContent shareContent, boolean z11) {
            ...
            if (!z11) {
                z12 = shareContent.getShareHashtag() != null ? DialogPresenter.canPresentNativeDialogWithFeature(ShareDialogFeature.HASHTAG) : true;
                if ((shareContent instanceof ShareLinkContent) && !Utility.isNullOrEmpty(((ShareLinkContent) shareContent).getQuote())) {
                    z12 &= DialogPresenter.canPresentNativeDialogWithFeature(ShareDialogFeature.LINK_SHARE_QUOTES);
                }
            } else {
                z12 = true;
            }
            if (!z12 || !ShareDialog.canShowNative(shareContent.getClass())) {
                return false;
            }
            return true;
        }
    ...
    public class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, AnonymousClass1 r22) {
            this();
        }
    ...
    public class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        public /* synthetic */ WebShareHandler(ShareDialog shareDialog, AnonymousClass1 r22) {
            this();
        }
    ...
    public static boolean canShowWebCheck(ShareContent shareContent) {
        ...
        try {
            ...
            Utility.logd(TAG, "canShow returned false because the content of the Opem Graph object can't be shared via the web dialog", e11);
            return false;
        }
    }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i11 = AnonymousClass1.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
        String str2 = i11 != 1 ? i11 != 2 ? i11 != 3 ? str : AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_NATIVE : AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_WEB : AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_AUTOMATIC;
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ArrayList arrayList = new ArrayList();
        arrayList.add(new NativeHandler(this, (AnonymousClass1) null));
        arrayList.add(new FeedHandler(this, (AnonymousClass1) null));
        arrayList.add(new WebShareHandler(this, (AnonymousClass1) null));
        arrayList.add(new CameraEffectHandler(this, (AnonymousClass1) null));
        arrayList.add(new ShareStoryHandler(this, (AnonymousClass1) null));
        return arrayList;
    }
    ...
    public ShareDialog(android.app.Fragment fragment, int i11) {
        this(new FragmentWrapper(fragment), i11);
    }

    private ShareDialog(FragmentWrapper fragmentWrapper, int i11) {
