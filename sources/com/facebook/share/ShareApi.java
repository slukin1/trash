...
public final class ShareApi {
    ...
    private void addCommonParameters(Bundle bundle, ShareContent shareContent2) {
        ...
        if (!Utility.isNullOrEmpty(peopleIds)) {
            bundle.putString(InnerShareParams.TAGS, TextUtils.join(", ", peopleIds));
        }
    ...
    private Bundle getSharePhotoCommonParameters(SharePhoto sharePhoto, SharePhotoContent sharePhotoContent) throws JSONException {
        ...
        if (!parameters.containsKey(InnerShareParams.TAGS) && !Utility.isNullOrEmpty(sharePhotoContent.getPeopleIds())) {
            ...
            if (!Utility.isNullOrEmpty(peopleIds)) {
                ...
                parameters.putString(InnerShareParams.TAGS, jSONArray.toString());
            }
        }
    ...
    private static void putImageInBundleWithArrayFormat(Bundle bundle, int i11, JSONObject jSONObject) throws JSONException {
        Iterator<String> keys = jSONObject.keys();
        while (keys.hasNext()) {
            String next = keys.next();
            bundle.putString(String.format(Locale.ROOT, "image[%d][%s]", new Object[]{Integer.valueOf(i11), next}), jSONObject.get(next).toString());
        }
    }
    ...
    private void shareLinkContent(ShareLinkContent shareLinkContent, final FacebookCallback<Sharer.Result> facebookCallback) {
        AnonymousClass4 r52 = new GraphRequest.Callback() {
        ...
        new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath("feed"), bundle, HttpMethod.POST, r52).executeAsync();
    }
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent shareOpenGraphContent, final FacebookCallback<Sharer.Result> facebookCallback) {
        final AnonymousClass1 r42 = new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                String str;
                JSONObject jSONObject = graphResponse.getJSONObject();
                if (jSONObject == null) {
        ...
        stageOpenGraphAction(bundle, new CollectionMapper.OnMapperCompleteListener() {
            public void onComplete() {
                try {
                    ...
                    new GraphRequest(AccessToken.getCurrentAccessToken(), ShareApi.this.getGraphPath(URLEncoder.encode(action.getActionType(), "UTF-8")), bundle2, HttpMethod.POST, r42).executeAsync();
                } catch (UnsupportedEncodingException e11) {
                    ShareInternalUtility.invokeCallbackWithException(facebookCallback2, e11);
                }
            }
    ...
    private void sharePhotoContent(SharePhotoContent sharePhotoContent, FacebookCallback<Sharer.Result> facebookCallback) {
        ...
        AnonymousClass3 r12 = new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                JSONObject jSONObject = graphResponse.getJSONObject();
                if (jSONObject != null) {
        ...
        try {
            ...
            ShareInternalUtility.invokeCallbackWithException(facebookCallback2, e12);
        }
    }
            ...
            public Iterator<Integer> keyIterator() {
                ...
                return new Iterator<Integer>() {
                    ...
                    public Integer next() {
                        ...
                        mutable.value = Integer.valueOf(((Integer) t11).intValue() + 1);
                        return num;
                    }
                };
            }
    ...
    public void stageOpenGraphObject(final ShareOpenGraphObject shareOpenGraphObject, final CollectionMapper.OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        AnonymousClass9 r02 = new CollectionMapper.Collection<String>() {
            public Iterator<String> keyIterator() {
        ...
        final AnonymousClass10 r52 = new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
        ...
        stageCollectionValues(r02, new CollectionMapper.OnMapperCompleteListener() {
            public void onComplete() {
                ...
                try {
                    ...
                    new GraphRequest(currentAccessToken, shareApi.getGraphPath("objects/" + URLEncoder.encode(str, "UTF-8")), bundle, HttpMethod.POST, r52).executeAsync();
                } catch (UnsupportedEncodingException e11) {
                    String localizedMessage = e11.getLocalizedMessage();
                    if (localizedMessage == null) {
    ...
    public void stagePhoto(final SharePhoto sharePhoto, final CollectionMapper.OnMapValueCompleteListener onMapValueCompleteListener) {
        ...
        AnonymousClass12 r22 = new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                FacebookRequestError error = graphResponse.getError();
