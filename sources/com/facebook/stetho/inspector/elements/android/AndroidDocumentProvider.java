...
final class AndroidDocumentProvider extends ThreadBoundProxy implements DocumentProvider, AndroidDescriptorHost {
    ...
    public final class InspectModeHandler {
        ...
        public final class OverlayView extends DocumentHiddenView {
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                ...
                while (true) {
                    ...
                    Object elementToHighlightAtPosition = highlightableDescriptor2.getElementToHighlightAtPosition(parent, x11, y11, AndroidDocumentProvider.this.mHitRect);
                    x11 -= AndroidDocumentProvider.this.mHitRect.left;
                    y11 -= AndroidDocumentProvider.this.mHitRect.top;
        ...
        public void disable() {
            ...
            if (this.mOverlays != null) {
                for (int i11 = 0; i11 < this.mOverlays.size(); i11++) {
                    View view = this.mOverlays.get(i11);
    ...
    public AndroidDocumentProvider(Application application, List<DescriptorProvider> list, ThreadBound threadBound) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            list.get(i11).registerDescriptor(this.mDescriptorMap);
        }
    ...
    public void highlightElement(Object obj, int i11) {
        ...
        if (viewAndBoundsForHighlighting == null) {
            ...
            this.mHighlighter.setHighlightedView(viewAndBoundsForHighlighting, this.mHighlightingBoundsRect, i11);
        }
    }
