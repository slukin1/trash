            ...
            if (ScreencastDispatcher.this.mIsRunning && (tryGetTopActivity = ScreencastDispatcher.this.mActivityTracker.tryGetTopActivity()) != null) {
                ...
                try {
                    if (ScreencastDispatcher.this.mBitmap == null) {
                        ...
                        float min = Math.min(((float) ScreencastDispatcher.this.mRequest.maxWidth) / f11, ((float) ScreencastDispatcher.this.mRequest.maxHeight) / height);
                        int i11 = (int) (f11 * min);
                        int i12 = (int) (min * height);
                        Bitmap unused = ScreencastDispatcher.this.mBitmap = Bitmap.createBitmap(i11, i12, Bitmap.Config.RGB_565);
                        Canvas unused2 = ScreencastDispatcher.this.mCanvas = new Canvas(ScreencastDispatcher.this.mBitmap);
                        Matrix matrix = new Matrix();
                        ScreencastDispatcher.this.mTempSrc.set(0.0f, 0.0f, f11, height);
                        ScreencastDispatcher.this.mTempDst.set(0.0f, 0.0f, (float) i11, (float) i12);
