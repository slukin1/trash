...
public class LightHttpServer {
    ...
    public static class HttpMessageReader {
        ...
        public String readLine() throws IOException {
            while (true) {
                ...
                char c11 = (char) read;
                this.mNewLineDetector.accept(c11);
                int state = this.mNewLineDetector.state();
                if (state == 1) {
                    this.mBuffer.append(c11);
                } else if (state == 3) {
    ...
    private static void readHeaders(LightHttpMessage lightHttpMessage, HttpMessageReader httpMessageReader) throws IOException {
        while (true) {
            ...
            if (readLine == null) {
                ...
                String[] split = readLine.split(l.f34627b, 2);
                if (split.length == 2) {
                    String str = split[0];
                    String str2 = split[1];
    ...
    public static void writeResponseMessage(LightHttpResponse lightHttpResponse, HttpMessageWriter httpMessageWriter) throws IOException {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            httpMessageWriter.writeLine(lightHttpResponse.headerNames.get(i11) + l.f34627b + lightHttpResponse.headerValues.get(i11));
        }
    ...
    public static class HttpMessageWriter {
        private static final byte[] CRLF = LogUtils.NEW_LINE.getBytes();
        ...
        public void writeLine(String str) throws IOException {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                this.mOut.write(str.charAt(i11));
            }
