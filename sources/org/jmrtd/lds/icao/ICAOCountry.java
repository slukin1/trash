...
public class ICAOCountry extends Country {
    ...
    static {
        ...
        XIM = iCAOCountry16;
        ICAOCountry iCAOCountry17 = iCAOCountry14;
    ...
    public static Country getInstance(String str) {
        ...
        try {
            ...
            LOGGER.log(Level.FINE, "Unknown country", e11);
