...
class NewHope {
    ...
    public static void decodeA(short[] sArr, byte[] bArr, byte[] bArr2) {
        ...
        System.arraycopy(bArr2, Params.POLY_BYTES, bArr, 0, 32);
    }
    ...
    public static void decodeB(short[] sArr, short[] sArr2, byte[] bArr) {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            int i12 = i11 * 4;
            byte b11 = bArr[i11 + Params.POLY_BYTES] & 255;
            sArr2[i12 + 0] = (short) (b11 & 3);
            sArr2[i12 + 1] = (short) ((b11 >>> 2) & 3);
            sArr2[i12 + 2] = (short) ((b11 >>> 4) & 3);
            sArr2[i12 + 3] = (short) (b11 >>> 6);
        }
    }

    public static void encodeA(byte[] bArr, short[] sArr, byte[] bArr2) {
        Poly.toBytes(bArr, sArr);
        System.arraycopy(bArr2, 0, bArr, Params.POLY_BYTES, 32);
    }
    ...
    public static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            int i12 = i11 * 4;
            bArr[i11 + Params.POLY_BYTES] = (byte) ((sArr2[i12 + 3] << 6) | sArr2[i12] | (sArr2[i12 + 1] << 2) | (sArr2[i12 + 2] << 4));
        }
    }
