...
abstract class SPHINCSPlusEngine {
    ...
    public static class Sha256Engine extends SPHINCSPlusEngine {
        ...
        public Sha256Engine(boolean z11, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        public IndexedDigest H_msg(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
            ...
            byte[] bitmask = bitmask(Arrays.concatenate(bArr, bArr2, bArr5), new byte[(i11 + i15 + i16)]);
            byte[] bArr6 = new byte[8];
            System.arraycopy(bitmask, i11, bArr6, 8 - i16, i16);
            long bigEndianToLong = Pack.bigEndianToLong(bArr6, 0) & (-1 >>> (64 - i14));
            byte[] bArr7 = new byte[4];
            System.arraycopy(bitmask, i16 + i11, bArr7, 4 - i15, i15);
            return new IndexedDigest(bigEndianToLong, Pack.bigEndianToInt(bArr7, 0) & (-1 >>> (32 - i13)), Arrays.copyOfRange(bitmask, 0, i11));
        }
    ...
    public static class Shake256Engine extends SPHINCSPlusEngine {
        ...
        public IndexedDigest H_msg(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
            ...
            return new IndexedDigest(bigEndianToLong, Pack.bigEndianToInt(bArr7, 0) & (-1 >>> (32 - i13)), Arrays.copyOfRange(bArr5, 0, i11));
        }
    ...
    public static byte[] xor(byte[] bArr, byte[] bArr2) {
        ...
        for (int i11 = 0; i11 < bArr.length; i11++) {
            clone[i11] = (byte) (clone[i11] ^ bArr2[i11]);
        }
        return clone;
    }
