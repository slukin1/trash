...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f59535l == hSSPrivateKeyParameters.f59535l && this.isShard == hSSPrivateKeyParameters.isShard && this.indexLimit == hSSPrivateKeyParameters.indexLimit && this.index == hSSPrivateKeyParameters.index && this.keys.equals(hSSPrivateKeyParameters.keys)) {
    ...
    public HSSPrivateKeyParameters extractKeyShard(int i11) {
        ...
        synchronized (this) {
            ...
            if (getUsagesRemaining() >= j11) {
                ...
                makeCopy = makeCopy(new HSSPrivateKeyParameters(this.f59535l, arrayList, arrayList2, j12, j12 + j11, true));
                resetKeyToIndex();
            } else {
    ...
    public LMSContext generateLMSContext() {
        ...
        synchronized (this) {
            ...
            while (i12 < i11) {
                int i13 = i12 + 1;
                lMSSignedPubKeyArr[i12] = new LMSSignedPubKey(sig2.get(i12), keys2.get(i13).getPublicKey());
                i12 = i13;
            }
            incIndex();
        }
    ...
    public synchronized byte[] getEncoded() throws IOException {
        Composer bool;
        bool = Composer.compose().u32str(0).u32str(this.f59535l).u64str(this.index).u64str(this.indexLimit).bool(this.isShard);
    ...
    public synchronized HSSPublicKeyParameters getPublicKey() {
        return new HSSPublicKeyParameters(this.f59535l, getRootKey().getPublicKey());
    }
    ...
    public int hashCode() {
        ...
        long j12 = this.index;
        return (((((((((this.f59535l * 31) + (this.isShard ? 1 : 0)) * 31) + this.keys.hashCode()) * 31) + this.sig.hashCode()) * 31) + ((int) (j11 ^ (j11 >>> 32)))) * 31) + ((int) (j12 ^ (j12 >>> 32)));
    }
    ...
    public void replaceConsumedKey(int i11) {
        int i12 = i11 - 1;
        SeedDerive derivationFunction = this.keys.get(i12).getCurrentOTSKey().getDerivationFunction();
