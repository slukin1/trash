...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private static String createKey(String str, int i11, int i12, int i13, int i14, int i15) {
        ...
        return str + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i11 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i12 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i13 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i14 + Constants.ACCEPT_TIME_SEPARATOR_SERVER + i15;
    }
