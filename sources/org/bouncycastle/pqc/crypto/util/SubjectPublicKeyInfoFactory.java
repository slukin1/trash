    ...
    public static SubjectPublicKeyInfo createSubjectPublicKeyInfo(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        if (asymmetricKeyParameter instanceof QTESLAPublicKeyParameters) {
            ...
            if (asymmetricKeyParameter instanceof LMSPublicKeyParameters) {
                ...
                return new SubjectPublicKeyInfo(new AlgorithmIdentifier(Utils.sphincsPlusOidLookup(sPHINCSPlusPublicKeyParameters.getParameters())), (ASN1Encodable) new DEROctetString(sPHINCSPlusPublicKeyParameters.getEncoded()));
                ...
                return new SubjectPublicKeyInfo(new AlgorithmIdentifier(Utils.mcElieceOidLookup(cMCEPublicKeyParameters.getParameters())), (ASN1Encodable) new CMCEPublicKey(cMCEPublicKeyParameters.getEncoded()));
