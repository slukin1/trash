...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public LMSPrivateKey extractKeyShard(int i11) {
        ...
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey((LMSKeyParameters) ((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i11)) : new BCLMSPrivateKey((LMSKeyParameters) ((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(i11));
    }
