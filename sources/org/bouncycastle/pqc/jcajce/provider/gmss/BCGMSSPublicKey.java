...
public class BCGMSSPublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.gmssParameterSet.getHeightOfTrees().length; i11++) {
            str = str + "Layer " + i11 + " : " + this.gmssParameterSet.getHeightOfTrees()[i11] + " WinternitzParameter: " + this.gmssParameterSet.getWinternitzParameter()[i11] + " K: " + this.gmssParameterSet.getK()[i11] + "\n";
        }
        return str;
    }
}
