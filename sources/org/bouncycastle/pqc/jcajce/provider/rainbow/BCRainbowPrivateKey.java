...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    private short[] f59616b1;

    /* renamed from: b2  reason: collision with root package name */
    private short[] f59617b2;
    private Layer[] layers;

    /* renamed from: vi  reason: collision with root package name */
    private int[] f59618vi;
    ...
    public boolean equals(Object obj) {
        ...
        boolean z11 = ((((RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1())) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2())) && RainbowUtil.equals(this.f59616b1, bCRainbowPrivateKey.getB1())) && RainbowUtil.equals(this.f59617b2, bCRainbowPrivateKey.getB2())) && Arrays.equals(this.f59618vi, bCRainbowPrivateKey.getVi());
    ...
    public short[] getB1() {
        return this.f59616b1;
    }

    public short[] getB2() {
        return this.f59617b2;
    }
    ...
    public byte[] getEncoded() {
        /*
            ...
            short[][] r1 = r8.A1inv
            short[] r2 = r8.f59616b1
            short[][] r3 = r8.A2inv
            short[] r4 = r8.f59617b2
            int[] r5 = r8.f59618vi
    ...
    public int[] getVi() {
        return this.f59618vi;
    }

    public int hashCode() {
        int length = (((((((((this.layers.length * 37) + org.bouncycastle.util.Arrays.hashCode(this.A1inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f59616b1)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f59617b2)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f59618vi);
