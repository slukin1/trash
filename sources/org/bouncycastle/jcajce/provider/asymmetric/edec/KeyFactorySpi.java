...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (this.isXdh) {
            int i11 = this.specificBase;
            if ((i11 == 0 || i11 == 111) && algorithm2.equals((ASN1Primitive) EdECObjectIdentifiers.id_X448)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
            int i12 = this.specificBase;
            if ((i12 == 0 || i12 == 110) && algorithm2.equals((ASN1Primitive) EdECObjectIdentifiers.id_X25519)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
        } else {
            ...
            if (algorithm2.equals((ASN1Primitive) aSN1ObjectIdentifier) || algorithm2.equals((ASN1Primitive) EdECObjectIdentifiers.id_Ed25519)) {
                ...
                if ((i13 == 0 || i13 == 113) && algorithm2.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
                    return new BCEdDSAPrivateKey(privateKeyInfo);
                }
                int i14 = this.specificBase;
                if ((i14 == 0 || i14 == 112) && algorithm2.equals((ASN1Primitive) EdECObjectIdentifiers.id_Ed25519)) {
                    return new BCEdDSAPrivateKey(privateKeyInfo);
                }
            }
        }
