...
public class BCDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f59319y;

    public BCDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f59319y = bigInteger;
    ...
    public BCDHPublicKey(DHPublicKey dHPublicKey) {
        this.f59319y = dHPublicKey.getY();
        DHParameterSpec params = dHPublicKey.getParams();
        this.dhSpec = params;
        if (params instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, ((DHDomainParameterSpec) params).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
        }
    }

    public BCDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f59319y = dHPublicKeySpec.getY();
        ...
        if (dHParameterSpec instanceof DHDomainParameterSpec) {
            this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, ((DHDomainParameterSpec) dHParameterSpec).getDomainParameters());
        } else {
            this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, new DHParameters(dHPublicKeySpec.getP(), dHPublicKeySpec.getG()));
        }
    }
    ...
    public BCDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f59319y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.dhKeyAgreement) || isPKCSParam(instance)) {
                ...
                if (instance2.getL() != null) {
                    ...
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f59319y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG(), (BigInteger) null, this.dhSpec.getL()));
                } else {
                    this.dhSpec = new DHParameterSpec(instance2.getP(), instance2.getG());
                    dHPublicKeyParameters = new DHPublicKeyParameters(this.f59319y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
                }
                ...
                if (validationParams != null) {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, new DHParameters(instance3.getP(), instance3.getG(), instance3.getQ(), instance3.getJ(), new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue())));
                } else {
                    this.dhPublicKey = new DHPublicKeyParameters(this.f59319y, new DHParameters(instance3.getP(), instance3.getG(), instance3.getQ(), instance3.getJ(), (DHValidationParameters) null));
                }
    ...
    public BCDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f59319y = dHPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (!(dHParameterSpec instanceof DHDomainParameterSpec) || ((DHDomainParameterSpec) dHParameterSpec).getQ() == null) {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), (ASN1Encodable) new ASN1Integer(this.f59319y));
        }
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.dhpublicnumber, new DomainParameters(domainParameters.getP(), domainParameters.getG(), domainParameters.getQ(), domainParameters.getJ(), validationParams).toASN1Primitive()), (ASN1Encodable) new ASN1Integer(this.f59319y));
    }
    ...
    public String toString() {
        return DHUtil.publicKeyToString("DH", this.f59319y, new DHParameters(this.dhSpec.getP(), this.dhSpec.getG()));
    }
}
