...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        int bitLength = (this.f59321p.bitLength() + 7) / 8;
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof DHPrivateKey) {
            ...
            if (algorithmParameterSpec == null) {
                this.f59321p = dHPrivateKey.getParams().getP();
                this.f59320g = dHPrivateKey.getParams().getG();
            } else if (algorithmParameterSpec instanceof DHParameterSpec) {
                DHParameterSpec dHParameterSpec = (DHParameterSpec) algorithmParameterSpec;
                this.f59321p = dHParameterSpec.getP();
                this.f59320g = dHParameterSpec.getG();
    ...
    public Key engineDoPhase(Key key, boolean z11) throws InvalidKeyException, IllegalStateException {
        if (this.f59322x == null) {
            ...
            if (!dHPublicKey.getParams().getG().equals(this.f59320g) || !dHPublicKey.getParams().getP().equals(this.f59321p)) {
                throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
            }
            BigInteger y11 = dHPublicKey.getY();
            if (y11 != null && y11.compareTo(TWO) >= 0) {
                BigInteger bigInteger = this.f59321p;
                ...
                if (y11.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                    if (this.unifiedAgreement != null) {
                        ...
                        BigInteger modPow = y11.modPow(this.f59322x, this.f59321p);
