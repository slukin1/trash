...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (configurableProvider2.hasAlgorithm("MessageDigest", FileTool.HASH_TYPE_MD5)) {
                addDigestSignature(configurableProvider2, FileTool.HASH_TYPE_MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD5", PKCSObjectIdentifiers.md5WithRSAEncryption);
                addISO9796Signature(configurableProvider2, FileTool.HASH_TYPE_MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$MD5WithRSAEncryption");
            }
            if (configurableProvider2.hasAlgorithm("MessageDigest", FileTool.HASH_TYPE_SHA1)) {
                String str5 = str4;
                ...
                addPSSSignature(configurableProvider2, FileTool.HASH_TYPE_SHA1, str3, "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSA");
                addPSSSignature(configurableProvider2, FileTool.HASH_TYPE_SHA1, "SHAKE128", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSAandSHAKE128");
                addPSSSignature(configurableProvider2, FileTool.HASH_TYPE_SHA1, "SHAKE256", "org.bouncycastle.jcajce.provider.asymmetric.rsa.PSSSignatureSpi$SHA1withRSAandSHAKE256");
                addDigestSignature(configurableProvider2, FileTool.HASH_TYPE_SHA1, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$SHA1", PKCSObjectIdentifiers.sha1WithRSAEncryption);
                addISO9796Signature(configurableProvider2, FileTool.HASH_TYPE_SHA1, "org.bouncycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$SHA1WithRSAEncryption");
                ...
                addX931Signature(configurableProvider2, FileTool.HASH_TYPE_SHA1, "org.bouncycastle.jcajce.provider.asymmetric.rsa.X931SignatureSpi$SHA1WithRSAEncryption");
            }
