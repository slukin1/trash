    ...
    public static class CompositeKeyInfoConverter implements AsymmetricKeyInfoConverter {
        ...
        public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
            ...
            for (int i11 = 0; i11 != instance.size(); i11++) {
                PrivateKeyInfo instance2 = PrivateKeyInfo.getInstance(instance.getObjectAt(i11));
                privateKeyArr[i11] = this.provider.getKeyInfoConverter(instance2.getPrivateKeyAlgorithm().getAlgorithm()).generatePrivate(instance2);
            }
        ...
        public PublicKey generatePublic(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
            ...
            for (int i11 = 0; i11 != instance.size(); i11++) {
                SubjectPublicKeyInfo instance2 = SubjectPublicKeyInfo.getInstance(instance.getObjectAt(i11));
                publicKeyArr[i11] = this.provider.getKeyInfoConverter(instance2.getAlgorithm().getAlgorithm()).generatePublic(instance2);
            }
