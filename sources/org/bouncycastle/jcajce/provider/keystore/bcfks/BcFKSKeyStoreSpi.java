...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        public SharedKeyStoreSpi(JcaJceHelper jcaJceHelper) {
            ...
            try {
                ...
                this.seedKey = bArr;
                jcaJceHelper.createSecureRandom(MessengerShareContentUtility.PREVIEW_DEFAULT).nextBytes(bArr);
    ...
    private Cipher createCipher(String str, byte[] bArr) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, NoSuchProviderException {
        ...
        createCipher.init(1, new SecretKeySpec(bArr, b.f40261d));
        return createCipher;
    }
    ...
    private byte[] decryptData(String str, AlgorithmIdentifier algorithmIdentifier, char[] cArr, byte[] bArr) throws IOException {
        ...
        if (algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_PBES2)) {
            ...
            try {
                ...
                cipher.init(2, new SecretKeySpec(generateKey(keyDerivationFunc, str, cArr, 32), b.f40261d), algorithmParameters);
    ...
    private byte[] generateKey(KeyDerivationFunc keyDerivationFunc, String str, char[] cArr, int i11) throws IOException {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ...
            if (instance.getKeyLength() != null) {
                i11 = instance.getKeyLength().intValue();
            } else if (i11 == -1) {
                throw new IOException("no keyLength found in ScryptParams");
            }
            return SCrypt.generate(Arrays.concatenate(PKCS12PasswordToBytes, PKCS12PasswordToBytes2), instance.getSalt(), instance.getCostParameter().intValue(), instance.getBlockSize().intValue(), instance.getBlockSize().intValue(), i11);
            ...
            if (instance2.getKeyLength() != null) {
                i11 = instance2.getKeyLength().intValue();
            } else if (i11 == -1) {
    ...
    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(KeyDerivationFunc keyDerivationFunc, int i11) {
        ...
        if (equals) {
            ...
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, instance.getCostParameter(), instance.getBlockSize(), instance.getParallelizationParameter(), BigInteger.valueOf((long) i11)));
        }
        PBKDF2Params instance2 = PBKDF2Params.getInstance(parameters);
        byte[] bArr2 = new byte[instance2.getSalt().length];
        getDefaultSecureRandom().nextBytes(bArr2);
        return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr2, instance2.getIterationCount().intValue(), i11, instance2.getPrf()));
    }
                ...
                try {
                    ...
                    if (this.validator == null) {
                        ...
                        for (int i11 = 0; i11 != length; i11++) {
                            x509CertificateArr[i11] = (X509Certificate) createCertificateFactory.generateCertificate(new ByteArrayInputStream(certificates[i11].getEncoded()));
                        }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                if (upperCase.indexOf(b.f40261d) > -1) {
                    ...
                    if (aSN1ObjectIdentifier3 != null) {
                        ...
                        ASN1ObjectIdentifier aSN1ObjectIdentifier4 = map.get(upperCase + InstructionFileId.DOT + (encoded2.length * 8));
