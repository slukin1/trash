...
public class SHA1 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            addHMACAlgorithm(configurableProvider, FileTool.HASH_TYPE_SHA1, str + "$HashMac", str + "$KeyGenerator");
            addHMACAlias(configurableProvider, FileTool.HASH_TYPE_SHA1, PKCSObjectIdentifiers.id_hmacWithSHA1);
            addHMACAlias(configurableProvider, FileTool.HASH_TYPE_SHA1, IANAObjectIdentifiers.hmacSHA1);
