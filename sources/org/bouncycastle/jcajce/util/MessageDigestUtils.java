...
public class MessageDigestUtils {
    ...
    static {
        ...
        digestOidMap.put(PKCSObjectIdentifiers.md5, FileTool.HASH_TYPE_MD5);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier11 = MiscObjectIdentifiers.blake3_256;
        map10.put(aSN1ObjectIdentifier11, "BLAKE3-256");
        ...
        digestAlgIdMap.put("SHA-384", new AlgorithmIdentifier(aSN1ObjectIdentifier4));
        ...
        digestAlgIdMap.put("SHA3-512", new AlgorithmIdentifier(aSN1ObjectIdentifier10));
        digestAlgIdMap.put("BLAKE3-256", new AlgorithmIdentifier(aSN1ObjectIdentifier11));
    }
