...
public class PBMParameter extends ASN1Object {
    ...
    public PBMParameter(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, int i11, AlgorithmIdentifier algorithmIdentifier2) {
        this((ASN1OctetString) new DEROctetString(bArr), algorithmIdentifier, new ASN1Integer((long) i11), algorithmIdentifier2);
    }
