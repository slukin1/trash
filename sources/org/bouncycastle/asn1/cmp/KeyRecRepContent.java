...
public class KeyRecRepContent extends ASN1Object {
    ...
    public CMPCertificate[] getCaCerts() {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            cMPCertificateArr[i11] = CMPCertificate.getInstance(this.caCerts.getObjectAt(i11));
        }
    ...
    public CertifiedKeyPair[] getKeyPairHist() {
        ...
        for (int i11 = 0; i11 != size; i11++) {
            certifiedKeyPairArr[i11] = CertifiedKeyPair.getInstance(this.keyPairHist.getObjectAt(i11));
        }
