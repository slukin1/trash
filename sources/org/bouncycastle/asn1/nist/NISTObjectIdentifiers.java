...
public interface NISTObjectIdentifiers {
    ...
    static {
        ...
        id_sha512_224 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_sha512_256 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_sha3_224 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_sha3_256 = branch.branch("8");
        id_sha3_384 = branch.branch("9");
        id_sha3_512 = branch.branch(CouponReturn.TYPE_EXPERIENCE);
        id_shake128 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_shake256 = branch.branch("12");
        id_hmacWithSHA3_224 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        id_hmacWithSHA3_256 = branch.branch("14");
        id_hmacWithSHA3_384 = branch.branch("15");
        id_hmacWithSHA3_512 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
        ...
        id_aes128_wrap = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_aes128_GCM = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_aes128_CCM = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ...
        id_dsa_with_sha3_224 = branch3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_dsa_with_sha3_256 = branch3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_dsa_with_sha3_384 = branch3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_dsa_with_sha3_512 = branch3.branch("8");
        id_ecdsa_with_sha3_224 = branch3.branch("9");
        id_ecdsa_with_sha3_256 = branch3.branch(CouponReturn.TYPE_EXPERIENCE);
        id_ecdsa_with_sha3_384 = branch3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_ecdsa_with_sha3_512 = branch3.branch("12");
        id_rsassa_pkcs1_v1_5_with_sha3_224 = branch3.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
