...
public interface TeleTrusTObjectIdentifiers {
    ...
    static {
        ...
        brainpoolP224r1 = branch5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        brainpoolP224t1 = branch5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        brainpoolP256r1 = branch5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        brainpoolP256t1 = branch5.branch("8");
        brainpoolP320r1 = branch5.branch("9");
        brainpoolP320t1 = branch5.branch(CouponReturn.TYPE_EXPERIENCE);
        brainpoolP384r1 = branch5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        brainpoolP384t1 = branch5.branch("12");
        brainpoolP512r1 = branch5.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
