...
public class RC2CBCParameter extends ASN1Object {
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        ...
        this.f59058iv = (ASN1OctetString) aSN1Encodable;
    }
    ...
    public byte[] getIV() {
        return this.f59058iv.getOctets();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f59058iv);
