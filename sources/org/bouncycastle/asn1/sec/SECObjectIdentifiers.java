...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        sect113r2 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        secp112r1 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        secp112r2 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        secp160r1 = aSN1ObjectIdentifier.branch("8");
        secp160k1 = aSN1ObjectIdentifier.branch("9");
        secp256k1 = aSN1ObjectIdentifier.branch(CouponReturn.TYPE_EXPERIENCE);
        sect163r2 = aSN1ObjectIdentifier.branch("15");
        sect283k1 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_HUOBI_EARN);
        ...
        sect571r1 = aSN1ObjectIdentifier.branch(FinanceRecordItem.TYPE_FUTURE_LINEAR_SWAP_INNER);
