...
public class ResponseData extends ASN1Object {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        int i13 = i12 + 1;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(i12));
        int i14 = i13 + 1;
        this.responses = (ASN1Sequence) aSN1Sequence.getObjectAt(i13);
        if (aSN1Sequence.size() > i14) {
            this.responseExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i14), true);
        }
    }
