...
public class MetaData extends ASN1Object {
    ...
    private MetaData(ASN1Sequence aSN1Sequence) {
        ...
        if (i11 < aSN1Sequence.size() && (aSN1Sequence.getObjectAt(i11) instanceof ASN1IA5String)) {
            this.mediaType = ASN1IA5String.getInstance(aSN1Sequence.getObjectAt(i11));
            i11++;
        }
        if (i11 < aSN1Sequence.size()) {
            this.otherMetaData = Attributes.getInstance(aSN1Sequence.getObjectAt(i11));
        }
    }
