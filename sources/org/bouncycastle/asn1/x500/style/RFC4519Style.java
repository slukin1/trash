...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f59068c;

    /* renamed from: cn  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f59069cn;

    /* renamed from: dc  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f59070dc;
    ...
    public static final ASN1ObjectIdentifier f59071l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f59072o;

    /* renamed from: ou  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f59073ou;
    ...
    public static final ASN1ObjectIdentifier f59074sn;

    /* renamed from: st  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f59075st;
    ...
    static {
        ...
        hashtable.put(aSN1ObjectIdentifier41, TUIConstants.TUIChat.OWNER);
        Object obj = TUIConstants.TUIChat.OWNER;
        ...
        hashtable3.put(obj, aSN1ObjectIdentifier42);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals((ASN1Primitive) f59070dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals((ASN1Primitive) f59068c) || aSN1ObjectIdentifier.equals((ASN1Primitive) serialNumber) || aSN1ObjectIdentifier.equals((ASN1Primitive) dnQualifier) || aSN1ObjectIdentifier.equals((ASN1Primitive) telephoneNumber)) ? new DERPrintableString(str) : super.encodeStringValue(aSN1ObjectIdentifier, str);
    }
    ...
    public RDN[] fromString(String str) {
        ...
        for (int i11 = 0; i11 != rDNsFromString.length; i11++) {
            rdnArr[(length - i11) - 1] = rDNsFromString[i11];
        }
        return rdnArr;
    }
