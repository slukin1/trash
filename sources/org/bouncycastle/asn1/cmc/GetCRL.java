...
public class GetCRL extends ASN1Object {
    ...
    private GetCRL(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > i11 && (aSN1Sequence.getObjectAt(i11).toASN1Primitive() instanceof ASN1GeneralizedTime)) {
            this.time = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(i11));
            i11++;
        }
        if (aSN1Sequence.size() > i11 && (aSN1Sequence.getObjectAt(i11).toASN1Primitive() instanceof ASN1BitString)) {
            this.reasons = new ReasonFlags(ASN1BitString.getInstance(aSN1Sequence.getObjectAt(i11)));
        }
    }
