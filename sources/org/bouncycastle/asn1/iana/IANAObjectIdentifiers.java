...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        ASN1ObjectIdentifier branch = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        security = branch;
        SNMPv2 = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        mail = aSN1ObjectIdentifier.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        ASN1ObjectIdentifier branch2 = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        security_mechanisms = branch2;
        security_nametypes = branch.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        pkix = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
