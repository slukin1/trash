...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private int hashCollection(Collection collection) {
        ...
        for (Object next : collection) {
            i11 += next instanceof byte[] ? Arrays.hashCode((byte[]) next) : next.hashCode();
        }
        return i11;
    }
    ...
    private Set intersectOtherName(Set set, Set set2) {
        ...
        Iterator it2 = set2.iterator();
        while (it2.hasNext()) {
            OtherName instance = OtherName.getInstance(((GeneralSubtree) it2.next()).getBase().getName());
            if (set != null) {
    ...
    private boolean isUriConstrained(String str, String str2) {
        ...
        return !str2.startsWith(InstructionFileId.DOT) ? extractHostFromURL.equalsIgnoreCase(str2) : withinDomain(extractHostFromURL, str2);
    }
    ...
    private String stringifyIPCollection(Set set) {
        ...
        while (it2.hasNext()) {
            ...
            sb2.append(stringifyIP((byte[]) it2.next()));
        }
        sb2.append("]");
        return sb2.toString();
    }
    ...
    private static boolean withinDNSubtree(ASN1Sequence aSN1Sequence, ASN1Sequence aSN1Sequence2) {
        ...
        while (true) {
            if (i11 >= aSN1Sequence.size()) {
                i11 = i12;
                break;
            } else if (IETFUtils.rDNAreEqual(instance, RDN.getInstance(aSN1Sequence.getObjectAt(i11)))) {
                break;
            } else {
                i12 = i11;
                i11++;
        ...
        for (int i13 = 0; i13 < aSN1Sequence2.size(); i13++) {
            RDN instance2 = RDN.getInstance(aSN1Sequence2.getObjectAt(i13));
            RDN instance3 = RDN.getInstance(aSN1Sequence.getObjectAt(i11 + i13));
