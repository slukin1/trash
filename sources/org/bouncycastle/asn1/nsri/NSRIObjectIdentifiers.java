...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_aria128_ctr = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        id_aria192_ecb = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        id_aria192_cbc = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_SWAP);
        id_aria192_cfb = branch2.branch("8");
        id_aria192_ofb = branch2.branch("9");
        id_aria192_ctr = branch2.branch(CouponReturn.TYPE_EXPERIENCE);
        id_aria256_ecb = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        id_aria256_cbc = branch2.branch("12");
        id_aria256_cfb = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_WARRANT);
        ...
        id_aria256_ccm = branch2.branch(FinanceRecordItem.TYPE_FUTURE_LINEAR_SWAP_INNER);
