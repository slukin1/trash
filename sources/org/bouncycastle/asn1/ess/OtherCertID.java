...
public class OtherCertID extends ASN1Object {
    ...
    private OtherCertID(ASN1Sequence aSN1Sequence) {
        ...
        boolean z11 = aSN1Sequence.getObjectAt(0).toASN1Primitive() instanceof ASN1OctetString;
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(0);
        this.otherCertHash = z11 ? ASN1OctetString.getInstance(objectAt) : DigestInfo.getInstance(objectAt);
