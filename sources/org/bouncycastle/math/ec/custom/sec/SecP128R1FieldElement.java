...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP128R1FieldElement(BigInteger bigInteger) {
        ...
        this.f59412x = SecP128R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP128R1Field.add(this.f59412x, ((SecP128R1FieldElement) eCFieldElement).f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat128.create();
        SecP128R1Field.addOne(this.f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.inv(((SecP128R1FieldElement) eCFieldElement).f59412x, create);
        SecP128R1Field.multiply(create, this.f59412x, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat128.eq(this.f59412x, ((SecP128R1FieldElement) obj).f59412x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f59412x, 0, 4);
    }

    public ECFieldElement invert() {
        int[] create = Nat128.create();
        SecP128R1Field.inv(this.f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat128.isOne(this.f59412x);
    }

    public boolean isZero() {
        return Nat128.isZero(this.f59412x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.multiply(this.f59412x, ((SecP128R1FieldElement) eCFieldElement).f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat128.create();
        SecP128R1Field.negate(this.f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f59412x;
    ...
    public ECFieldElement square() {
        int[] create = Nat128.create();
        SecP128R1Field.square(this.f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.subtract(this.f59412x, ((SecP128R1FieldElement) eCFieldElement).f59412x, create);
        return new SecP128R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat128.getBit(this.f59412x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat128.toBigInteger(this.f59412x);
    }
}
