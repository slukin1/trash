...
public class SecP224R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f59402x;
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f59403y;
        ...
        SecP224R1FieldElement secP224R1FieldElement5 = (SecP224R1FieldElement) this.f59404zs[0];
        ...
        if (isOne) {
            iArr2 = secP224R1FieldElement3.f59425x;
            iArr = secP224R1FieldElement4.f59425x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement5.f59425x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement3.f59425x, create);
            SecP224R1Field.multiply(create2, secP224R1FieldElement5.f59425x, create2);
            SecP224R1Field.multiply(create2, secP224R1FieldElement4.f59425x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP224R1FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP224R1FieldElement.f59425x;
            iArr3 = secP224R1FieldElement2.f59425x;
        } else {
            SecP224R1Field.square(secP224R1FieldElement6.f59425x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement.f59425x, createExt);
            SecP224R1Field.multiply(create3, secP224R1FieldElement6.f59425x, create3);
            SecP224R1Field.multiply(create3, secP224R1FieldElement2.f59425x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP224R1Field.square(create, secP224R1FieldElement7.f59425x);
        int[] iArr5 = secP224R1FieldElement7.f59425x;
        ...
        SecP224R1Field.subtract(create2, secP224R1FieldElement7.f59425x, secP224R1FieldElement8.f59425x);
        SecP224R1Field.multiplyAddToExt(secP224R1FieldElement8.f59425x, create, createExt);
        SecP224R1Field.reduce(createExt, secP224R1FieldElement8.f59425x);
        SecP224R1FieldElement secP224R1FieldElement9 = new SecP224R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP224R1FieldElement9.f59425x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement5.f59425x, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP224R1FieldElement9.f59425x;
            SecP224R1Field.multiply(iArr7, secP224R1FieldElement6.f59425x, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP224R1Point(this.curve, this.f59402x, this.f59403y.negate(), this.f59404zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP224R1FieldElement secP224R1FieldElement = (SecP224R1FieldElement) this.f59403y;
        if (secP224R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP224R1FieldElement secP224R1FieldElement2 = (SecP224R1FieldElement) this.f59402x;
        SecP224R1FieldElement secP224R1FieldElement3 = (SecP224R1FieldElement) this.f59404zs[0];
        int[] create = Nat224.create();
        int[] create2 = Nat224.create();
        int[] create3 = Nat224.create();
        SecP224R1Field.square(secP224R1FieldElement.f59425x, create3);
        int[] create4 = Nat224.create();
        SecP224R1Field.square(create3, create4);
        boolean isOne = secP224R1FieldElement3.isOne();
        int[] iArr = secP224R1FieldElement3.f59425x;
        if (!isOne) {
            SecP224R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP224R1Field.subtract(secP224R1FieldElement2.f59425x, iArr, create);
        SecP224R1Field.add(secP224R1FieldElement2.f59425x, iArr, create2);
        ...
        SecP224R1Field.square(create2, secP224R1FieldElement4.f59425x);
        int[] iArr2 = secP224R1FieldElement4.f59425x;
        SecP224R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP224R1FieldElement4.f59425x;
        ...
        SecP224R1Field.subtract(create3, secP224R1FieldElement4.f59425x, secP224R1FieldElement5.f59425x);
        int[] iArr4 = secP224R1FieldElement5.f59425x;
        SecP224R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP224R1FieldElement5.f59425x;
        SecP224R1Field.subtract(iArr5, create, iArr5);
        SecP224R1FieldElement secP224R1FieldElement6 = new SecP224R1FieldElement(create2);
        SecP224R1Field.twice(secP224R1FieldElement.f59425x, secP224R1FieldElement6.f59425x);
        if (!isOne) {
            int[] iArr6 = secP224R1FieldElement6.f59425x;
            SecP224R1Field.multiply(iArr6, secP224R1FieldElement3.f59425x, iArr6);
        }
