...
public class SecP192R1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j14 = j12 + (4294967295L & ((long) iArr[2])) + 1;
        iArr[2] = (int) j14;
        if ((j14 >> 32) != 0) {
            Nat.incAt(6, iArr, 3);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j13 = (((long) iArr[10]) & 4294967295L) + j11;
        long j14 = (((long) iArr[11]) & 4294967295L) + j12;
        long j15 = j12;
        long j16 = (((long) iArr[0]) & 4294967295L) + j13 + 0;
        int i11 = (int) j16;
        long j17 = (j16 >> 32) + (((long) iArr[1]) & 4294967295L) + j14;
        iArr3[1] = (int) j17;
        long j18 = j13 + (((long) iArr[8]) & 4294967295L);
        long j19 = j14 + (((long) iArr[9]) & 4294967295L);
        long j21 = (j17 >> 32) + (((long) iArr[2]) & 4294967295L) + j18;
        long j22 = j21 & 4294967295L;
        long j23 = (j21 >> 32) + (((long) iArr[3]) & 4294967295L) + j19;
        iArr3[3] = (int) j23;
        long j24 = (j23 >> 32) + (((long) iArr[4]) & 4294967295L) + (j18 - j11);
        iArr3[4] = (int) j24;
        long j25 = (j24 >> 32) + (((long) iArr[5]) & 4294967295L) + (j19 - j15);
        iArr3[5] = (int) j25;
        long j26 = j25 >> 32;
        long j27 = j22 + j26;
        long j28 = j26 + (((long) i11) & 4294967295L);
        iArr3[0] = (int) j28;
        long j29 = j28 >> 32;
        if (j29 != 0) {
            long j30 = j29 + (4294967295L & ((long) iArr3[1]));
            iArr3[1] = (int) j30;
            j27 += j30 >> 32;
        }
        iArr3[2] = (int) j27;
        if (((j27 >> 32) != 0 && Nat.incAt(6, iArr3, 3) != 0) || (iArr3[5] == -1 && Nat192.gte(iArr3, P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void reduce32(int i11, int[] iArr) {
        ...
        if (i11 != 0) {
            ...
            long j16 = j14 + (4294967295L & ((long) iArr[2])) + j12;
            iArr[2] = (int) j16;
            j11 = j16 >> 32;
        } else {
            j11 = 0;
