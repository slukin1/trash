...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP224R1FieldElement(BigInteger bigInteger) {
        ...
        this.f59425x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.add(this.f59425x, ((SecP224R1FieldElement) eCFieldElement).f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224R1Field.addOne(this.f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) eCFieldElement).f59425x, create);
        SecP224R1Field.multiply(create, this.f59425x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat224.eq(this.f59425x, ((SecP224R1FieldElement) obj).f59425x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f59425x, 0, 7);
    }

    public ECFieldElement invert() {
        int[] create = Nat224.create();
        SecP224R1Field.inv(this.f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat224.isOne(this.f59425x);
    }

    public boolean isZero() {
        return Nat224.isZero(this.f59425x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.multiply(this.f59425x, ((SecP224R1FieldElement) eCFieldElement).f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224R1Field.negate(this.f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f59425x;
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224R1Field.square(this.f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.subtract(this.f59425x, ((SecP224R1FieldElement) eCFieldElement).f59425x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat224.getBit(this.f59425x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f59425x);
    }
}
