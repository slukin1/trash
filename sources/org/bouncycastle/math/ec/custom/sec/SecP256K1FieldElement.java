...
public class SecP256K1FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP256K1FieldElement(BigInteger bigInteger) {
        ...
        this.f59427x = SecP256K1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP256K1Field.add(this.f59427x, ((SecP256K1FieldElement) eCFieldElement).f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat256.create();
        SecP256K1Field.addOne(this.f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.inv(((SecP256K1FieldElement) eCFieldElement).f59427x, create);
        SecP256K1Field.multiply(create, this.f59427x, create);
        return new SecP256K1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat256.eq(this.f59427x, ((SecP256K1FieldElement) obj).f59427x);
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f59427x, 0, 8);
    }

    public ECFieldElement invert() {
        int[] create = Nat256.create();
        SecP256K1Field.inv(this.f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean isOne() {
        return Nat256.isOne(this.f59427x);
    }

    public boolean isZero() {
        return Nat256.isZero(this.f59427x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.multiply(this.f59427x, ((SecP256K1FieldElement) eCFieldElement).f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat256.create();
        SecP256K1Field.negate(this.f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f59427x;
    ...
    public ECFieldElement square() {
        int[] create = Nat256.create();
        SecP256K1Field.square(this.f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat256.create();
        SecP256K1Field.subtract(this.f59427x, ((SecP256K1FieldElement) eCFieldElement).f59427x, create);
        return new SecP256K1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat256.getBit(this.f59427x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat256.toBigInteger(this.f59427x);
    }
}
