...
public class SecP224R1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j15 = j12 + (4294967295L & ((long) iArr[3])) + 1;
        iArr[3] = (int) j15;
        if ((j15 >> 32) != 0) {
            Nat.incAt(7, iArr, 4);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j15 = ((((long) iArr[7]) & 4294967295L) + j12) - 1;
        long j16 = (((long) iArr[8]) & 4294967295L) + j13;
        long j17 = j13;
        long j18 = (((long) iArr[9]) & 4294967295L) + j14;
        long j19 = j14;
        long j21 = ((((long) iArr[0]) & 4294967295L) - j15) + 0;
        long j22 = j21 & 4294967295L;
        long j23 = j12;
        long j24 = (j21 >> 32) + ((((long) iArr[1]) & 4294967295L) - j16);
        iArr3[1] = (int) j24;
        long j25 = (j24 >> 32) + ((((long) iArr[2]) & 4294967295L) - j18);
        iArr3[2] = (int) j25;
        long j26 = (j25 >> 32) + (((((long) iArr[3]) & 4294967295L) + j15) - j11);
        long j27 = (j26 >> 32) + (((((long) iArr[4]) & 4294967295L) + j16) - j23);
        iArr3[4] = (int) j27;
        long j28 = (j27 >> 32) + (((((long) iArr[5]) & 4294967295L) + j18) - j17);
        iArr3[5] = (int) j28;
        long j29 = (j28 >> 32) + (((((long) iArr[6]) & 4294967295L) + j11) - j19);
        iArr3[6] = (int) j29;
        long j30 = (j29 >> 32) + 1;
        long j31 = (j26 & 4294967295L) + j30;
        long j32 = j22 - j30;
        iArr3[0] = (int) j32;
        long j33 = j32 >> 32;
        if (j33 != 0) {
            long j34 = j33 + (((long) iArr3[1]) & 4294967295L);
            iArr3[1] = (int) j34;
            long j35 = (j34 >> 32) + (4294967295L & ((long) iArr3[2]));
            iArr3[2] = (int) j35;
            j31 += j35 >> 32;
        }
        iArr3[3] = (int) j31;
        if (((j31 >> 32) != 0 && Nat.incAt(7, iArr3, 4) != 0) || (iArr3[6] == -1 && Nat224.gte(iArr3, P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void reduce32(int i11, int[] iArr) {
        ...
        if (i11 != 0) {
            ...
            long j17 = j14 + (4294967295L & ((long) iArr[3])) + j12;
            iArr[3] = (int) j17;
            j11 = j17 >> 32;
        } else {
            j11 = 0;
