...
public class SM2P256V1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j14 = j12 + ((((long) iArr[2]) & 4294967295L) - 1);
        iArr[2] = (int) j14;
        long j15 = (j14 >> 32) + (((long) iArr[3]) & 4294967295L) + 1;
        iArr[3] = (int) j15;
        long j16 = j15 >> 32;
        if (j16 != 0) {
            long j17 = j16 + (((long) iArr[4]) & 4294967295L);
            iArr[4] = (int) j17;
            long j18 = (j17 >> 32) + (((long) iArr[5]) & 4294967295L);
            iArr[5] = (int) j18;
            long j19 = (j18 >> 32) + (((long) iArr[6]) & 4294967295L);
            iArr[6] = (int) j19;
            j16 = j19 >> 32;
        }
        iArr[7] = (int) (j16 + (4294967295L & ((long) iArr[7])) + 1);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j12 = ((long) iArr[9]) & 4294967295L;
        long j13 = ((long) iArr[10]) & 4294967295L;
        long j14 = ((long) iArr[11]) & 4294967295L;
        long j15 = ((long) iArr[12]) & 4294967295L;
        long j16 = ((long) iArr[13]) & 4294967295L;
        long j17 = ((long) iArr[14]) & 4294967295L;
        ...
        long j25 = j15;
        long j26 = (((long) iArr[0]) & 4294967295L) + j24 + j16 + j17 + j18 + 0;
        iArr3[0] = (int) j26;
        long j27 = j14;
        long j28 = (j26 >> 32) + (((((long) iArr[1]) & 4294967295L) + j24) - j11) + j17 + j18;
        iArr3[1] = (int) j28;
        long j29 = (j28 >> 32) + ((((long) iArr[2]) & 4294967295L) - j23);
        iArr3[2] = (int) j29;
        long j30 = (j29 >> 32) + ((((((long) iArr[3]) & 4294967295L) + j24) - j12) - j13) + j16;
        iArr3[3] = (int) j30;
        long j31 = (j30 >> 32) + ((((((long) iArr[4]) & 4294967295L) + j24) - j19) - j11) + j17;
        iArr3[4] = (int) j31;
        long j32 = (j31 >> 32) + (((long) iArr[5]) & 4294967295L) + j22 + j13;
        iArr3[5] = (int) j32;
        long j33 = (j32 >> 32) + (((long) iArr[6]) & 4294967295L) + j27 + j17 + j18;
        iArr3[6] = (int) j33;
        long j34 = (j33 >> 32) + (4294967295L & ((long) iArr[7])) + j24 + j22 + j25;
        iArr3[7] = (int) j34;
        reduce32((int) (j34 >> 32), iArr3);
    }
    ...
    public static void reduce32(int i11, int[] iArr) {
        ...
        if (i11 != 0) {
            ...
            long j14 = j13 >> 32;
            if (j14 != 0) {
                long j15 = j14 + (((long) iArr[1]) & 4294967295L);
                iArr[1] = (int) j15;
                j14 = j15 >> 32;
            }
            long j16 = j14 + ((((long) iArr[2]) & 4294967295L) - j12);
            iArr[2] = (int) j16;
            long j17 = (j16 >> 32) + (((long) iArr[3]) & 4294967295L) + j12;
            iArr[3] = (int) j17;
            long j18 = j17 >> 32;
            if (j18 != 0) {
                long j19 = j18 + (((long) iArr[4]) & 4294967295L);
                iArr[4] = (int) j19;
                long j21 = (j19 >> 32) + (((long) iArr[5]) & 4294967295L);
                iArr[5] = (int) j21;
                long j22 = (j21 >> 32) + (((long) iArr[6]) & 4294967295L);
                iArr[6] = (int) j22;
                j18 = j22 >> 32;
            }
            long j23 = j18 + (4294967295L & ((long) iArr[7])) + j12;
            iArr[7] = (int) j23;
            j11 = j23 >> 32;
        } else {
            j11 = 0;
        }
        if (j11 != 0 || ((iArr[7] >>> 1) >= Integer.MAX_VALUE && Nat256.gte(iArr, P))) {
            addPInvTo(iArr);
        }
    }
