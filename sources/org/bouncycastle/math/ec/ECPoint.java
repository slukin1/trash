...
public abstract class ECPoint {
    ...
    public ECFieldElement f59402x;

    /* renamed from: y  reason: collision with root package name */
    public ECFieldElement f59403y;

    /* renamed from: zs  reason: collision with root package name */
    public ECFieldElement[] f59404zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement3 = this.f59402x;
            ECFieldElement a11 = curve.getA();
            ECFieldElement b11 = curve.getB();
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 6) {
                ECFieldElement eCFieldElement4 = this.f59404zs[0];
                boolean isOne = eCFieldElement4.isOne();
                if (eCFieldElement3.isZero()) {
                    ECFieldElement square = this.f59403y.square();
                    if (!isOne) {
                        b11 = b11.multiply(eCFieldElement4.square());
                    }
                    return square.equals(b11);
                }
                ECFieldElement eCFieldElement5 = this.f59403y;
                ECFieldElement square2 = eCFieldElement3.square();
                if (isOne) {
                    eCFieldElement2 = eCFieldElement5.square().add(eCFieldElement5).add(a11);
                    eCFieldElement = square2.square().add(b11);
                } else {
                    ECFieldElement square3 = eCFieldElement4.square();
                    ECFieldElement square4 = square3.square();
                    eCFieldElement2 = eCFieldElement5.add(eCFieldElement4).multiplyPlusProduct(eCFieldElement5, a11, square3);
                    eCFieldElement = square2.squarePlusProduct(b11, square4);
                }
                return eCFieldElement2.multiply(square2).equals(eCFieldElement);
            }
            ECFieldElement eCFieldElement6 = this.f59403y;
            ECFieldElement multiply = eCFieldElement6.add(eCFieldElement3).multiply(eCFieldElement6);
            if (coordinateSystem != 0) {
                if (coordinateSystem == 1) {
                    ECFieldElement eCFieldElement7 = this.f59404zs[0];
                    if (!eCFieldElement7.isOne()) {
                        ...
                        a11 = a11.multiply(eCFieldElement7);
            ...
            return multiply.equals(eCFieldElement3.add(a11).multiply(eCFieldElement3.square()).add(b11));
        }
        ...
        public AbstractF2m tau() {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement = this.f59402x;
            if (coordinateSystem != 0) {
                if (coordinateSystem != 1) {
                ...
                ECFieldElement eCFieldElement2 = this.f59403y;
                ECFieldElement eCFieldElement3 = this.f59404zs[0];
            ...
            createRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f59403y.square());
            return (AbstractF2m) createRawPoint;
        }
        ...
        public AbstractF2m tauPow(int i11) {
            ...
            if (coordinateSystem != 0) {
                ...
                ECFieldElement eCFieldElement2 = this.f59403y;
                ECFieldElement eCFieldElement3 = this.f59404zs[0];
                createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i11), eCFieldElement2.squarePow(i11), new ECFieldElement[]{eCFieldElement3.squarePow(i11)});
                return (AbstractF2m) createRawPoint;
            }
            createRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i11), this.f59403y.squarePow(i11));
            return (AbstractF2m) createRawPoint;
        }
    }
    ...
    public static abstract class AbstractFp extends ECPoint {
        ...
        public boolean satisfiesCurveEquation() {
            ...
            return square.equals(eCFieldElement.square().add(a11).multiply(eCFieldElement).add(b11));
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement7 = this.f59402x;
            ECFieldElement eCFieldElement8 = eCPoint2.f59402x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement9 = this.f59403y;
                ECFieldElement eCFieldElement10 = eCPoint2.f59403y;
                ...
                ECFieldElement eCFieldElement11 = this.f59403y;
                ECFieldElement eCFieldElement12 = this.f59404zs[0];
                ECFieldElement eCFieldElement13 = eCPoint2.f59403y;
                ECFieldElement eCFieldElement14 = eCPoint2.f59404zs[0];
                ...
                ECFieldElement eCFieldElement15 = this.f59403y;
                ECFieldElement eCFieldElement16 = this.f59404zs[0];
                ECFieldElement eCFieldElement17 = eCPoint2.f59403y;
                ECFieldElement eCFieldElement18 = eCPoint2.f59404zs[0];
        ...
        public ECPoint negate() {
            ...
            int curveCoordinateSystem = getCurveCoordinateSystem();
            if (curveCoordinateSystem == 0) {
                return new F2m(this.curve, eCFieldElement, this.f59403y.add(eCFieldElement));
                ...
                return new F2m(this.curve, eCFieldElement, this.f59403y.addOne());
            } else if (curveCoordinateSystem == 6) {
                ECFieldElement eCFieldElement4 = this.f59403y;
                ECFieldElement eCFieldElement5 = this.f59404zs[0];
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElement2 = this.f59402x;
            if (eCFieldElement2.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement add = this.f59403y.divide(eCFieldElement2).add(eCFieldElement2);
                ...
                ECFieldElement eCFieldElement3 = this.f59403y;
                ECFieldElement eCFieldElement4 = this.f59404zs[0];
                boolean isOne = eCFieldElement4.isOne();
                ...
                ECFieldElement eCFieldElement5 = this.f59403y;
                ECFieldElement eCFieldElement6 = this.f59404zs[0];
                ...
                ECFieldElement a11 = curve.getA();
                ECFieldElement multiply3 = isOne2 ? a11 : a11.multiply(square3);
                ...
                if (b11.bitLength() < (curve.getFieldSize() >> 1)) {
                    ...
                    eCFieldElement = square5.add(add5).add(square3).multiply(square5).add(b11.isOne() ? multiply3.add(square3).square() : multiply3.squarePlusProduct(b11, square3.square())).add(square4);
                    if (!a11.isZero()) {
                        if (!a11.isOne()) {
                            eCFieldElement = eCFieldElement.add(a11.addOne().multiply(multiply4));
                        }
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f59402x;
            ECFieldElement eCFieldElement3 = eCPoint.f59404zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f59403y;
            ECFieldElement eCFieldElement5 = this.f59404zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f59403y;
    ...
    public static class Fp extends AbstractFp {
        ...
        public org.bouncycastle.math.ec.ECPoint add(org.bouncycastle.math.ec.ECPoint r17) {
            ...
            L_0x0019:
                ...
                org.bouncycastle.math.ec.ECFieldElement r4 = r0.f59402x
                org.bouncycastle.math.ec.ECFieldElement r5 = r0.f59403y
                org.bouncycastle.math.ec.ECFieldElement r6 = r1.f59402x
                org.bouncycastle.math.ec.ECFieldElement r7 = r1.f59403y
            ...
            L_0x0036:
                ...
                throw r1
            L_0x003e:
                org.bouncycastle.math.ec.ECFieldElement[] r12 = r0.f59404zs
                r12 = r12[r9]
                org.bouncycastle.math.ec.ECFieldElement[] r1 = r1.f59404zs
                r1 = r1[r9]
            ...
            L_0x0142:
                r8 = r9
                org.bouncycastle.math.ec.ECFieldElement[] r3 = r0.f59404zs
                r3 = r3[r8]
                org.bouncycastle.math.ec.ECFieldElement[] r1 = r1.f59404zs
                r1 = r1[r8]
                boolean r8 = r3.isOne()
        ...
        public ECFieldElement getZCoord(int i11) {
            return (i11 == 1 && 4 == getCurveCoordinateSystem()) ? getJacobianModifiedW() : ECPoint.super.getZCoord(i11);
        }
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new Fp(curve, this.f59402x, this.f59403y.negate(), this.f59404zs) : new Fp(curve, this.f59402x, this.f59403y.negate());
        }
        ...
        public ECPoint threeTimes() {
            ...
            ECFieldElement eCFieldElement = this.f59403y;
            if (eCFieldElement.isZero()) {
                return this;
            }
            ECCurve curve = getCurve();
        ...
        public ECPoint timesPow2(int i11) {
            ...
            if (i12 < 0) {
                ...
                if (!fromBigInteger.isOne() && coordinateSystem != 0) {
                    ...
                    a11 = calculateJacobianModifiedW(fromBigInteger, eCFieldElement);
                }
                int i13 = 0;
                while (i13 < i12) {
                    if (eCFieldElement2.isZero()) {
                ...
                if (coordinateSystem == 0) {
                    ...
                    return new Fp(curve, eCFieldElement3, eCFieldElement2, new ECFieldElement[]{fromBigInteger, a11});
                } else {
                    throw new IllegalStateException("unsupported coordinate system");
                }
            }
        ...
        public ECPoint twice() {
            ...
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElement4 = this.f59402x;
            if (coordinateSystem == 0) {
                ...
                ECFieldElement a11 = curve.getA();
                if (!a11.isZero() && !isOne) {
                    a11 = a11.multiply(eCFieldElement5.square());
                }
                ECFieldElement add = a11.add(three(eCFieldElement4.square()));
                ...
                ECFieldElement negate = a12.negate();
        ...
        public Fp twiceJacobianModified(boolean z11) {
            ...
            ECFieldElement two4 = z11 ? two(two3.multiply(jacobianModifiedW)) : null;
            if (!eCFieldElement3.isOne()) {
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f59402x;
            ECFieldElement eCFieldElement3 = eCPoint.f59402x;
            ECFieldElement eCFieldElement4 = eCPoint.f59403y;
    ...
    public ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f59402x = eCFieldElement;
        this.f59403y = eCFieldElement2;
        this.f59404zs = eCFieldElementArr;
    }
    ...
    public int hashCode() {
        ...
        int i11 = curve2 == null ? 0 : ~curve2.hashCode();
        if (isInfinity()) {
            return i11;
        }
        ECPoint normalize = normalize();
    ...
    public boolean implIsValid(final boolean z11, final boolean z12) {
        ...
        return !((ValidityPrecompInfo) getCurve().precompute(this, ValidityPrecompInfo.PRECOMP_NAME, new PreCompCallback() {
    ...
    public boolean isInfinity() {
        if (!(this.f59402x == null || this.f59403y == null)) {
            ECFieldElement[] eCFieldElementArr = this.f59404zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f59404zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (ECFieldElement append : this.f59404zs) {
            stringBuffer.append(',');
