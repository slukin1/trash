...
public class MD4Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int i13 = this.H3;
        int i14 = this.H4;
        int rotateLeft = rotateLeft(i11 + F(i12, i13, i14) + this.X[0], 3);
        int rotateLeft2 = rotateLeft(i14 + F(rotateLeft, i12, i13) + this.X[1], 7);
        int rotateLeft3 = rotateLeft(i13 + F(rotateLeft2, rotateLeft, i12) + this.X[2], 11);
        int rotateLeft4 = rotateLeft(i12 + F(rotateLeft3, rotateLeft2, rotateLeft) + this.X[3], 19);
