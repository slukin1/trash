...
public class SHA512tDigest extends LongDigest {
    ...
    private static void longToBigEndian(long j11, byte[] bArr, int i11, int i12) {
        if (i12 > 0) {
            intToBigEndian((int) (j11 >>> 32), bArr, i11, i12);
            if (i12 > 4) {
                intToBigEndian((int) (j11 & 4294967295L), bArr, i11 + 4, i12 - 4);
            }
        }
    }
