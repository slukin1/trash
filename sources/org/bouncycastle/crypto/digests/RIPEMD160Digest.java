...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    public void processBlock() {
        ...
        int i14 = this.H3;
        int i15 = this.H4;
        int RL = RL(f1(i12, i13, i14) + i11 + this.X[0], 11) + i15;
        int RL2 = RL(i13, 10);
        int RL3 = RL(f1(RL, i12, RL2) + i15 + this.X[1], 14) + i14;
        int RL4 = RL(i12, 10);
        int RL5 = RL(f1(RL3, RL, RL4) + i14 + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i11 + f5(i12, i13, i14) + this.X[5] + 1352829926, 8) + i15;
        int RL34 = RL(i13, 10);
        int RL35 = RL(i15 + f5(RL33, i12, RL34) + this.X[14] + 1352829926, 9) + i14;
        int RL36 = RL(i12, 10);
        int RL37 = RL(i14 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
