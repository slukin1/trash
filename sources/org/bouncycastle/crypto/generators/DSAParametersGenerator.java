...
public class DSAParametersGenerator {
    ...
    private static BigInteger calculateGenerator_FIPS186_3_Verifiable(Digest digest2, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr, int i11) {
        BigInteger divide = bigInteger.subtract(ONE).divide(bigInteger2);
    ...
    private static void hash(Digest digest2, byte[] bArr, byte[] bArr2, int i11) {
        digest2.update(bArr, 0, bArr.length);
        digest2.doFinal(bArr2, i11);
    }
    ...
    public void init(DSAParameterGenerationParameters dSAParameterGenerationParameters) {
        ...
        } else if (l11 == 1024 && n11 != 160) {
            throw new IllegalArgumentException("N must be 160 for L = 1024");
        } else if (l11 == 2048 && n11 != 224 && n11 != 256) {
            throw new IllegalArgumentException("N must be 224 or 256 for L = 2048");
        } else if (l11 == 3072 && n11 != 256) {
            throw new IllegalArgumentException("N must be 256 for L = 3072");
        } else if (this.digest.getDigestSize() * 8 >= n11) {
            this.L = l11;
            this.N = n11;
