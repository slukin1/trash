...
public class JPAKEParticipant {
    ...
    private BigInteger f59099b;
    private final Digest digest;

    /* renamed from: g  reason: collision with root package name */
    private final BigInteger f59100g;
    ...
    private final BigInteger f59101p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q  reason: collision with root package name */
    private final BigInteger f59102q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1  reason: collision with root package name */
    private BigInteger f59103x1;

    /* renamed from: x2  reason: collision with root package name */
    private BigInteger f59104x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest2, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(cArr, MTCoreConstants.Register.KEY_PASSWORD);
        ...
        if (cArr.length != 0) {
            ...
            this.f59101p = jPAKEPrimeOrderGroup.getP();
            this.f59102q = jPAKEPrimeOrderGroup.getQ();
            this.f59100g = jPAKEPrimeOrderGroup.getG();
            this.digest = digest2;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i11 >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f59101p, this.f59102q, this.gx4, this.f59104x2, calculateS, this.f59099b);
            this.f59103x1 = null;
            this.f59104x2 = null;
            this.f59099b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            this.f59103x1 = JPAKEUtil.generateX1(this.f59102q, this.random);
            this.f59104x2 = JPAKEUtil.generateX2(this.f59102q, this.random);
            this.gx1 = JPAKEUtil.calculateGx(this.f59101p, this.f59100g, this.f59103x1);
            this.gx2 = JPAKEUtil.calculateGx(this.f59101p, this.f59100g, this.f59104x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f59101p, this.f59102q, this.f59100g, this.gx1, this.f59103x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f59101p, this.f59102q, this.f59100g, this.gx2, this.f59104x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i11 >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f59101p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f59102q, this.f59104x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f59101p, this.f59102q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f59101p, this.f59102q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        if (this.state < 20) {
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f59101p, this.f59102q, this.f59100g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
            JPAKEUtil.validateZeroKnowledgeProof(this.f59101p, this.f59102q, this.f59100g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
            this.state = 20;
            return;
        }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i11 >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f59101p, this.gx3, this.gx1, this.gx2);
            this.f59099b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f59101p, this.f59102q, calculateGA, this.f59099b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
