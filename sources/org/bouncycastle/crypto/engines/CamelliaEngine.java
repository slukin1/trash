...
public class CamelliaEngine implements BlockCipher, StatelessProcessing {
    ...
    private int[] f59161ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        camelliaF2(iArr, this.subkey, 28);
        camelliaF2(iArr, this.subkey, 32);
        camelliaFLs(iArr, this.f59161ke, 8);
    ...
    private void setKey(boolean z11, byte[] bArr) {
        ...
        if (this._keyIs128) {
            ...
            if (z11) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f59161ke, 4);
                ...
                roldq(15, iArr2, 0, this.f59161ke, 0);
            ...
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f59161ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f59161ke, 4);
        ...
        if (z11) {
            ...
            roldq(15, iArr, 0, this.f59161ke, 4);
            roldq(17, iArr, 0, this.subkey, 32);
            roldqo32(34, iArr, 0, this.subkey, 44);
            roldq(15, iArr, 4, this.subkey, 4);
            roldq(15, iArr, 4, this.f59161ke, 0);
