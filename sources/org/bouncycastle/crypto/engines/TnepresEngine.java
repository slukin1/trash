...
public final class TnepresEngine extends SerpentEngineBase {
    public void decryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        int i13 = i12;
        int[] iArr = new int[4];
        iArr[3] = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i11);
        iArr[2] = this.wKey[130] ^ Pack.bigEndianToInt(bArr3, i11 + 4);
        iArr[1] = this.wKey[129] ^ Pack.bigEndianToInt(bArr3, i11 + 8);
        iArr[0] = Pack.bigEndianToInt(bArr3, i11 + 12) ^ this.wKey[128];
        ib7(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        int i14 = iArr[0];
        int[] iArr2 = this.wKey;
        iArr[0] = i14 ^ iArr2[124];
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(iArr[3] ^ this.wKey[3], bArr4, i13);
        Pack.intToBigEndian(iArr[2] ^ this.wKey[2], bArr4, i13 + 4);
        Pack.intToBigEndian(iArr[1] ^ this.wKey[1], bArr4, i13 + 8);
        Pack.intToBigEndian(iArr[0] ^ this.wKey[0], bArr4, i13 + 12);
    }
    ...
    public void encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        int i13 = i12;
        int[] iArr = new int[4];
        iArr[3] = Pack.bigEndianToInt(bArr, i11);
        iArr[2] = Pack.bigEndianToInt(bArr3, i11 + 4);
        iArr[1] = Pack.bigEndianToInt(bArr3, i11 + 8);
        iArr[0] = Pack.bigEndianToInt(bArr3, i11 + 12);
        int[] iArr2 = this.wKey;
        sb0(iArr, iArr[0] ^ iArr2[0], iArr[1] ^ iArr2[1], iArr[2] ^ iArr2[2], iArr2[3] ^ iArr[3]);
        LT(iArr);
        int[] iArr3 = this.wKey;
        ...
        Pack.intToBigEndian(this.wKey[131] ^ iArr[3], bArr4, i13);
        Pack.intToBigEndian(this.wKey[130] ^ iArr[2], bArr4, i13 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ iArr[1], bArr4, i13 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ iArr[0], bArr4, i13 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        int i11 = 0;
        while (length > 0) {
            iArr[i11] = Pack.bigEndianToInt(bArr2, length);
            length -= 4;
            i11++;
        }
        if (length == 0) {
            int i12 = i11 + 1;
            iArr[i11] = Pack.bigEndianToInt(bArr2, 0);
            if (i12 < 8) {
                iArr[i12] = 1;
            }
            ...
            for (int i15 = 8; i15 < 132; i15++) {
                iArr2[i15] = SerpentEngineBase.rotateLeft(((((iArr2[i15 - 8] ^ iArr2[i15 - 5]) ^ iArr2[i15 - 3]) ^ iArr2[i15 - 1]) ^ SerpentEngineBase.PHI) ^ i15, 11);
            }
            int[] iArr3 = new int[4];
            int[] iArr4 = iArr3;
