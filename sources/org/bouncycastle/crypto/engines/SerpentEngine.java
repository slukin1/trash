...
public final class SerpentEngine extends SerpentEngineBase {
    public void decryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        byte[] bArr4 = bArr2;
        int i13 = i12;
        int[] iArr = {this.wKey[128] ^ Pack.littleEndianToInt(bArr, i11), this.wKey[129] ^ Pack.littleEndianToInt(bArr3, i11 + 4), this.wKey[130] ^ Pack.littleEndianToInt(bArr3, i11 + 8), Pack.littleEndianToInt(bArr3, i11 + 12) ^ this.wKey[131]};
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToLittleEndian(iArr[0] ^ this.wKey[0], bArr4, i13);
        Pack.intToLittleEndian(iArr[1] ^ this.wKey[1], bArr4, i13 + 4);
        Pack.intToLittleEndian(iArr[2] ^ this.wKey[2], bArr4, i13 + 8);
        Pack.intToLittleEndian(iArr[3] ^ this.wKey[3], bArr4, i13 + 12);
    }
    ...
    public void encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        byte[] bArr4 = bArr2;
        int i13 = i12;
        int[] iArr = {Pack.littleEndianToInt(bArr, i11), Pack.littleEndianToInt(bArr3, i11 + 4), Pack.littleEndianToInt(bArr3, i11 + 8), Pack.littleEndianToInt(bArr3, i11 + 12)};
        int[] iArr2 = this.wKey;
        ...
        Pack.intToLittleEndian(this.wKey[128] ^ iArr[0], bArr4, i13);
        Pack.intToLittleEndian(this.wKey[129] ^ iArr[1], bArr4, i13 + 4);
        Pack.intToLittleEndian(this.wKey[130] ^ iArr[2], bArr4, i13 + 8);
        Pack.intToLittleEndian(this.wKey[131] ^ iArr[3], bArr4, i13 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        while (true) {
            ...
            iArr[i12] = Pack.littleEndianToInt(bArr2, i11);
            i11 = i13;
            i12++;
        }
        if (i11 % 4 == 0) {
            ...
            for (int i17 = 8; i17 < 132; i17++) {
                iArr2[i17] = SerpentEngineBase.rotateLeft(((((iArr2[i17 - 8] ^ iArr2[i17 - 5]) ^ iArr2[i17 - 3]) ^ iArr2[i17 - 1]) ^ SerpentEngineBase.PHI) ^ i17, 11);
            }
            int[] iArr3 = new int[4];
            int[] iArr4 = iArr3;
