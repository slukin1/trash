...
class RFC3281CertPathUtilities {
    ...
    private static void checkCRL(DistributionPoint distributionPoint, X509AttributeCertificate x509AttributeCertificate, PKIXExtendedParameters pKIXExtendedParameters, Date date, Date date2, X509Certificate x509Certificate, CertStatus certStatus, ReasonsMask reasonsMask, List list, JcaJceHelper jcaJceHelper) throws AnnotatedException, RecoverableCertPathValidatorException {
        ...
        if (x509AttributeCertificate2.getExtensionValue(X509Extensions.NoRevAvail.getId()) == null) {
            if (date2.getTime() <= date.getTime()) {
                Iterator it3 = CertPathValidatorUtilities.getCompleteCRLs(new PKIXCertRevocationCheckerParameters(pKIXExtendedParameters, date2, (CertPath) null, -1, x509Certificate, (PublicKey) null), distributionPoint2, x509AttributeCertificate2, pKIXExtendedParameters2, date3).iterator();
                boolean z11 = false;
                e = null;
    ...
    public static CertPath processAttrCert1(X509AttributeCertificate x509AttributeCertificate, PKIXExtendedParameters pKIXExtendedParameters) throws CertPathValidatorException {
        ...
        if (x509AttributeCertificate.getHolder().getIssuer() != null) {
            ...
            int i12 = 0;
            while (i12 < issuer.length) {
                try {
                    if (issuer[i12] instanceof X500Principal) {
                        x509CertSelector.setIssuer(((X500Principal) issuer[i12]).getEncoded());
                    }
        ...
        if (x509AttributeCertificate.getHolder().getEntityNames() != null) {
            ...
            while (i11 < entityNames.length) {
                try {
                    if (entityNames[i11] instanceof X500Principal) {
                        x509CertStoreSelector.setIssuer(((X500Principal) entityNames[i11]).getEncoded());
                    }
                    ...
                    throw new ExtCertPathValidatorException("Unable to encode X500 principal.", e14);
                }
            }
            if (linkedHashSet.isEmpty()) {
