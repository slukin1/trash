...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private Certificate extractCert() throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException("cannot process signing cert: " + e11.getMessage(), e11, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    private static X509Certificate getSignerCert(BasicOCSPResponse basicOCSPResponse, X509Certificate x509Certificate, X509Certificate x509Certificate2, JcaJceHelper jcaJceHelper) throws NoSuchProviderException, NoSuchAlgorithmException {
        ...
        if (keyHash != null) {
            MessageDigest createMessageDigest = jcaJceHelper.createMessageDigest(FileTool.HASH_TYPE_SHA1);
    ...
    private static boolean responderMatches(ResponderID responderID, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws NoSuchProviderException, NoSuchAlgorithmException {
        byte[] keyHash = responderID.getKeyHash();
        if (keyHash != null) {
            return Arrays.areEqual(keyHash, calcKeyHash(jcaJceHelper.createMessageDigest(FileTool.HASH_TYPE_SHA1), x509Certificate.getPublicKey()));
        }
        X500NameStyle x500NameStyle = BCStrictStyle.INSTANCE;
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException("OCSP response failure: " + e13.getMessage(), e13, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
        }
    }
    ...
    public void check(java.security.cert.Certificate certificate) throws CertPathValidatorException {
        ...
        if (ocspResponder == null) {
            if (this.ocspURL != null) {
                try {
                    ...
                    throw new CertPathValidatorException("configuration error: " + e11.getMessage(), e11, this.parameters.getCertPath(), this.parameters.getIndex());
                }
            } else {
        ...
        if (ocspResponses.get(x509Certificate) != null || uri == null) {
            ...
            try {
                ...
                throw new CertPathValidatorException("unable to encode OCSP response", e12, this.parameters.getCertPath(), this.parameters.getIndex());
            }
        }
            ...
            if (instance == null) {
                ...
                if (instance2.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
                    try {
                        ...
                        if (z11 || validatedOcspResponse(instance3, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
                            ...
                            for (int i12 = 0; i12 != responses.size(); i12++) {
                                SingleResponse instance4 = SingleResponse.getInstance(responses.getObjectAt(i12));
                        ...
                        throw new CertPathValidatorException("unable to process OCSP response", e14, this.parameters.getCertPath(), this.parameters.getIndex());
                    }
                }
            } else {
