    ...
    public static OCSPResponse getOcspResponse(CertID certID, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, URI uri, X509Certificate x509Certificate, List<Extension> list, JcaJceHelper jcaJceHelper) throws CertPathValidatorException {
        ...
        if (!(map == null || (oCSPResponse = (OCSPResponse) map.get(certID2)) == null)) {
            ...
            for (int i11 = 0; i11 != responses.size(); i11++) {
                SingleResponse instance = SingleResponse.getInstance(responses.getObjectAt(i11));
        ...
        try {
            ...
            try {
                ...
                if (instance2.getResponseStatus().getIntValue() == 0) {
                    ...
                    if (instance3.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
                        try {
                            z11 = ProvOcspRevocationChecker.validatedOcspResponse(BasicOCSPResponse.getInstance(instance3.getResponse().getOctets()), pKIXCertRevocationCheckerParameters, bArr, x509Certificate, jcaJceHelper);
            ...
            MalformedURLException malformedURLException = e13;
