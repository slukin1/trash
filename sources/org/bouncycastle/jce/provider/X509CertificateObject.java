...
public class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    private void checkSignature(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (isAlgIdEqual(this.f59367c.getSignatureAlgorithm(), this.f59367c.getTBSCertificate().getSignature())) {
            X509SignatureUtil.setSignatureParameters(signature, this.f59367c.getSignatureAlgorithm().getParameters());
    ...
    private byte[] getExtensionBytes(String str) {
        Extension extension;
        Extensions extensions = this.f59367c.getTBSCertificate().getExtensions();
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            throw new CertificateExpiredException("certificate expired on " + this.f59367c.getEndDate().getTime());
        } else if (date.getTime() < getNotBefore().getTime()) {
            throw new CertificateNotYetValidException("certificate not valid till " + this.f59367c.getStartDate().getTime());
        }
    }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f59367c.getEncoded(ASN1Encoding.DER);
    ...
    public Principal getIssuerDN() {
        return new X509Principal(this.f59367c.getIssuer());
    }

    public boolean[] getIssuerUniqueID() {
        ASN1BitString issuerUniqueId = this.f59367c.getTBSCertificate().getIssuerUniqueId();
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f59367c.getIssuer().getEncoded());
    ...
    public Date getNotAfter() {
        return this.f59367c.getEndDate().getDate();
    }

    public Date getNotBefore() {
        return this.f59367c.getStartDate().getDate();
    }

    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f59367c.getSubjectPublicKeyInfo());
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f59367c.getSerialNumber().getValue();
    }
    ...
    public String getSigAlgOID() {
        return this.f59367c.getSignatureAlgorithm().getAlgorithm().getId();
    }

    public byte[] getSigAlgParams() {
        if (this.f59367c.getSignatureAlgorithm().getParameters() != null) {
            try {
                return this.f59367c.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded(ASN1Encoding.DER);
            } catch (IOException unused) {
            }
        }
        return null;
    ...
    public byte[] getSignature() {
        return this.f59367c.getSignature().getOctets();
    }
    ...
    public Principal getSubjectDN() {
        return new X509Principal(this.f59367c.getSubject());
    }

    public boolean[] getSubjectUniqueID() {
        ASN1BitString subjectUniqueId = this.f59367c.getTBSCertificate().getSubjectUniqueId();
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            return new X500Principal(this.f59367c.getSubject().getEncoded());
        } catch (IOException unused) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f59367c.getTBSCertificate().getEncoded(ASN1Encoding.DER);
        } catch (IOException e11) {
            throw new CertificateEncodingException(e11.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f59367c.getVersionNumber();
    }

    public boolean hasUnsupportedCriticalExtension() {
        Extensions extensions;
        if (getVersion() != 3 || (extensions = this.f59367c.getTBSCertificate().getExtensions()) == null) {
            return false;
        }
        Enumeration oids = extensions.oids();
        while (oids.hasMoreElements()) {
                ...
                if (extension.getExtnValue() != null) {
                    ...
                    try {
                        if (aSN1ObjectIdentifier.equals((ASN1Primitive) Extension.basicConstraints)) {
                            ...
                            verisignCzagExtension = new NetscapeCertType((ASN1BitString) (DERBitString) aSN1InputStream.readObject());
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String signatureName = X509SignatureUtil.getSignatureName(this.f59367c.getSignatureAlgorithm());
        try {
