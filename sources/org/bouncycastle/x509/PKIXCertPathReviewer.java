...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
    ...
    private void checkCriticalExtensions() {
        ...
        for (PKIXCertPathChecker init : certPathCheckers) {
            try {
                ...
                addError(e13.getErrorMessage(), e13.getIndex());
                return;
            }
        }
                ...
                try {
                    ...
                    if (aSN1Sequence2 != null) {
                        for (int i11 = 0; i11 < aSN1Sequence2.size(); i11++) {
                            instance = GeneralName.getInstance(aSN1Sequence2.getObjectAt(i11));
                            pKIXNameConstraintValidator.checkPermitted(instance);
                            pKIXNameConstraintValidator.checkExcluded(instance);
                        }
                    }
                } catch (AnnotatedException e11) {
                    throw new CertPathReviewerException(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.ncExtError"), e11, this.certPath, size);
                } catch (IOException e12) {
                    throw new CertPathReviewerException(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.ncSubjectNameError", new Object[]{new UntrustedInput(subjectPrincipal)}), e12, this.certPath, size);
                    ...
                    throw new CertPathReviewerException(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.excludedDN", new Object[]{new UntrustedInput(subjectPrincipal.getName())}), e14, this.certPath, size);
                } catch (AnnotatedException e15) {
                    throw new CertPathReviewerException(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.subjAltNameExtError"), e15, this.certPath, size);
                } catch (PKIXNameConstraintValidatorException e16) {
                    throw new CertPathReviewerException(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.notPermittedEmail", new Object[]{new UntrustedInput(instance)}), e16, this.certPath, size);
    ...
    private void checkPolicy() {
        ...
        L_0x0079:
            ...
            int r4 = r1.f59638n     // Catch:{ CertPathReviewerException -> 0x05f7 }
            int r4 = r4 - r12
        ...
        L_0x011e:
            ...
            int r0 = r1.f59638n     // Catch:{ CertPathReviewerException -> 0x05f7 }
    ...
    private boolean processQcStatements(X509Certificate x509Certificate, int i11) {
        ...
        try {
            ...
            for (int i13 = 0; i13 < aSN1Sequence.size(); i13++) {
                QCStatement instance = QCStatement.getInstance(aSN1Sequence.getObjectAt(i13));
                if (ETSIQCObjectIdentifiers.id_etsi_qcs_QcCompliance.equals((ASN1Primitive) instance.getStatementId())) {
                    ...
                    if (!RFC3739QCObjectIdentifiers.id_qcs_pkixQCSyntax_v1.equals((ASN1Primitive) instance.getStatementId())) {
                        if (ETSIQCObjectIdentifiers.id_etsi_qcs_QcSSCD.equals((ASN1Primitive) instance.getStatementId())) {
                            ...
                            addNotification(errorBundle, i12);
                        } else {
                            addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.QcUnknownStatement", new Object[]{instance.getStatementId(), new UntrustedInput(instance)}), i12);
                            z11 = true;
                        }
                    }
                }
                addNotification(errorBundle2, i12);
            }
            return true ^ z11;
        } catch (AnnotatedException unused) {
            addError(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.QcStatementExtError"), i12);
            return false;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:88:0x025d  */
    ...
    public void checkCRLs(java.security.cert.PKIXParameters r21, java.security.cert.X509Certificate r22, java.util.Date r23, java.security.cert.X509Certificate r24, java.security.PublicKey r25, java.util.Vector r26, int r27) throws org.bouncycastle.x509.CertPathReviewerException {
        /*
            ...
            r0.<init>()
            javax.security.auth.x500.X500Principal r11 = org.bouncycastle.x509.CertPathValidatorUtilities.getEncodedIssuerPrincipal(r22)     // Catch:{ IOException -> 0x041b }
            byte[] r11 = r11.getEncoded()     // Catch:{ IOException -> 0x041b }
            r0.addIssuerName(r11)     // Catch:{ IOException -> 0x041b }
        ...
        L_0x0115:
            ...
            java.lang.Object r0 = r13.next()     // Catch:{ CertPathReviewerException -> 0x01c6 }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ CertPathReviewerException -> 0x01c6 }
            java.security.cert.X509CRL r15 = r1.getCRL(r0)     // Catch:{ CertPathReviewerException -> 0x01c6 }
            if (r15 == 0) goto L_0x01b8
            javax.security.auth.x500.X500Principal r3 = r15.getIssuerX500Principal()     // Catch:{ CertPathReviewerException -> 0x01c6 }
            boolean r18 = r12.equals(r3)     // Catch:{ CertPathReviewerException -> 0x01c6 }
            if (r18 != 0) goto L_0x0167
            org.bouncycastle.i18n.ErrorBundle r15 = new org.bouncycastle.i18n.ErrorBundle     // Catch:{ CertPathReviewerException -> 0x01c6 }
            r18 = r11
            java.lang.String r11 = "CertPathReviewer.onlineCRLWrongCA"
            r26 = r13
            r19 = r14
            r13 = 3
            java.lang.Object[] r14 = new java.lang.Object[r13]     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.UntrustedInput r13 = new org.bouncycastle.i18n.filter.UntrustedInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            java.lang.String r3 = r3.getName()     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13.<init>(r3)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3 = 0
            r14[r3] = r13     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.UntrustedInput r3 = new org.bouncycastle.i18n.filter.UntrustedInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            java.lang.String r13 = r12.getName()     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3.<init>(r13)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13 = 1
            r14[r13] = r3     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.UntrustedUrlInput r3 = new org.bouncycastle.i18n.filter.UntrustedUrlInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3.<init>(r0)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13 = 2
            r14[r13] = r3     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r15.<init>((java.lang.String) r10, (java.lang.String) r11, (java.lang.Object[]) r14)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r1.addNotification(r15, r6)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            goto L_0x01be
        L_0x0165:
            r0 = move-exception
            goto L_0x01c9
        L_0x0167:
            ...
            r26 = r13
            r19 = r14
            java.util.Date r3 = r15.getThisUpdate()     // Catch:{ CertPathReviewerException -> 0x01b4 }
            java.util.Date r11 = r15.getNextUpdate()     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13 = 3
            java.lang.Object[] r14 = new java.lang.Object[r13]     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.TrustedInput r13 = new org.bouncycastle.i18n.filter.TrustedInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13.<init>(r3)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3 = 0
            r14[r3] = r13     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.TrustedInput r3 = new org.bouncycastle.i18n.filter.TrustedInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3.<init>(r11)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r13 = 1
            r14[r13] = r3     // Catch:{ CertPathReviewerException -> 0x01b4 }
            org.bouncycastle.i18n.filter.UntrustedUrlInput r3 = new org.bouncycastle.i18n.filter.UntrustedUrlInput     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r3.<init>(r0)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            ...
            boolean r0 = r4.before(r11)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            if (r0 == 0) goto L_0x0199
            goto L_0x01a4
        L_0x0199:
            org.bouncycastle.i18n.ErrorBundle r0 = new org.bouncycastle.i18n.ErrorBundle     // Catch:{ CertPathReviewerException -> 0x01b4 }
            java.lang.String r3 = "CertPathReviewer.onlineInvalidCRL"
            r0.<init>((java.lang.String) r10, (java.lang.String) r3, (java.lang.Object[]) r14)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            r1.addNotification(r0, r6)     // Catch:{ CertPathReviewerException -> 0x01b4 }
            goto L_0x01be
        L_0x01a4:
            org.bouncycastle.i18n.ErrorBundle r0 = new org.bouncycastle.i18n.ErrorBundle     // Catch:{ CertPathReviewerException -> 0x01b1 }
            java.lang.String r3 = "CertPathReviewer.onlineValidCRL"
            r0.<init>((java.lang.String) r10, (java.lang.String) r3, (java.lang.Object[]) r14)     // Catch:{ CertPathReviewerException -> 0x01b1 }
            r1.addNotification(r0, r6)     // Catch:{ CertPathReviewerException -> 0x01b1 }
            r11 = r15
            r0 = 1
            goto L_0x01e3
        L_0x01b1:
        ...
        L_0x0203:
            ...
            r11.verify(r5, r3)     // Catch:{ Exception -> 0x03f0 }
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = org.bouncycastle.asn1.x509.Extension.reasonCode     // Catch:{ AnnotatedException -> 0x0235 }
            java.lang.String r5 = r5.getId()     // Catch:{ AnnotatedException -> 0x0235 }
            org.bouncycastle.asn1.ASN1Primitive r5 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r3, r5)     // Catch:{ AnnotatedException -> 0x0235 }
            org.bouncycastle.asn1.ASN1Enumerated r5 = org.bouncycastle.asn1.ASN1Enumerated.getInstance(r5)     // Catch:{ AnnotatedException -> 0x0235 }
            if (r5 == 0) goto L_0x0243
        ...
        L_0x02c5:
            ...
            r5 = 1
        L_0x02c7:
            java.lang.String r4 = org.bouncycastle.x509.CertPathValidatorUtilities.ISSUING_DISTRIBUTION_POINT     // Catch:{ AnnotatedException -> 0x03e5 }
            org.bouncycastle.asn1.ASN1Primitive r4 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r11, r4)     // Catch:{ AnnotatedException -> 0x03e5 }
            java.lang.String r6 = org.bouncycastle.x509.CertPathValidatorUtilities.DELTA_CRL_INDICATOR     // Catch:{ AnnotatedException -> 0x03d8 }
            org.bouncycastle.asn1.ASN1Primitive r6 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r11, r6)     // Catch:{ AnnotatedException -> 0x03d8 }
            if (r6 == 0) goto L_0x036c
            org.bouncycastle.x509.X509CRLStoreSelector r12 = new org.bouncycastle.x509.X509CRLStoreSelector
            r12.<init>()
            javax.security.auth.x500.X500Principal r13 = org.bouncycastle.x509.CertPathValidatorUtilities.getIssuerPrincipal(r11)     // Catch:{ IOException -> 0x0360 }
            byte[] r13 = r13.getEncoded()     // Catch:{ IOException -> 0x0360 }
            r12.addIssuerName(r13)     // Catch:{ IOException -> 0x0360 }
            ...
            java.lang.String r6 = org.bouncycastle.x509.CertPathValidatorUtilities.CRL_NUMBER     // Catch:{ AnnotatedException -> 0x0352 }
            org.bouncycastle.asn1.ASN1Primitive r6 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r11, r6)     // Catch:{ AnnotatedException -> 0x0352 }
            org.bouncycastle.asn1.ASN1Integer r6 = (org.bouncycastle.asn1.ASN1Integer) r6     // Catch:{ AnnotatedException -> 0x0352 }
            java.math.BigInteger r6 = r6.getPositiveValue()     // Catch:{ AnnotatedException -> 0x0352 }
            r13 = 1
            java.math.BigInteger r9 = java.math.BigInteger.valueOf(r13)     // Catch:{ AnnotatedException -> 0x0352 }
            java.math.BigInteger r6 = r6.subtract(r9)     // Catch:{ AnnotatedException -> 0x0352 }
            r12.setMaxCRLNumber(r6)     // Catch:{ AnnotatedException -> 0x0352 }
            java.util.Set r2 = org.bouncycastle.x509.PKIXCRLUtil.findCRLs(r12, r2)     // Catch:{ AnnotatedException -> 0x0346 }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ AnnotatedException -> 0x0346 }
        L_0x030f:
            boolean r6 = r2.hasNext()
            if (r6 == 0) goto L_0x0335
            java.lang.Object r6 = r2.next()
            java.security.cert.X509CRL r6 = (java.security.cert.X509CRL) r6
            java.lang.String r8 = org.bouncycastle.x509.CertPathValidatorUtilities.ISSUING_DISTRIBUTION_POINT     // Catch:{ AnnotatedException -> 0x0329 }
            org.bouncycastle.asn1.ASN1Primitive r6 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r6, r8)     // Catch:{ AnnotatedException -> 0x0329 }
        ...
        L_0x036c:
            ...
            java.lang.String r3 = org.bouncycastle.x509.CertPathValidatorUtilities.BASIC_CONSTRAINTS     // Catch:{ AnnotatedException -> 0x03ca }
            r4 = r22
            org.bouncycastle.asn1.ASN1Primitive r3 = org.bouncycastle.x509.CertPathValidatorUtilities.getExtensionValue(r4, r3)     // Catch:{ AnnotatedException -> 0x03ca }
            org.bouncycastle.asn1.x509.BasicConstraints r3 = org.bouncycastle.asn1.x509.BasicConstraints.getInstance(r3)     // Catch:{ AnnotatedException -> 0x03ca }
    ...
    public void init(CertPath certPath2, PKIXParameters pKIXParameters) throws CertPathReviewerException {
        if (!this.initialized) {
            ...
            this.f59638n = certificates.size();
