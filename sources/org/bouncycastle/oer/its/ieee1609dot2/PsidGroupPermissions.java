...
public class PsidGroupPermissions extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setChainLengthRange(long j11) {
            this.chainLengthRange = new ASN1Integer(j11);
            return this;
        }
        ...
        public Builder setMinChainLength(long j11) {
            this.minChainLength = new ASN1Integer(j11);
            return this;
        }
    ...
    private PsidGroupPermissions(ASN1Sequence aSN1Sequence) {
        Class cls = ASN1Integer.class;
        if (aSN1Sequence.size() == 4) {
            this.subjectPermissions = SubjectPermissions.getInstance(aSN1Sequence.getObjectAt(0));
            this.minChainLength = (ASN1Integer) OEROptional.getInstance(aSN1Sequence.getObjectAt(1)).getObject(cls);
            this.chainLengthRange = (ASN1Integer) OEROptional.getInstance(aSN1Sequence.getObjectAt(2)).getObject(cls);
