...
public class EeRaCertRequest extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setAdditionalParams(AdditionalParams additionalParams2) {
            this.additionalParams = additionalParams2;
            return this;
        }
    ...
    public EeRaCertRequest(UINT8 uint8, Time32 time32, CertificateType certificateType, ToBeSignedCertificate toBeSignedCertificate, AdditionalParams additionalParams2) {
        this.version = uint8;
        this.generationTime = time32;
        this.type = certificateType;
        this.tbsCert = toBeSignedCertificate;
