...
public class AuthorizationValidationResponseCode extends ASN1Enumerated {
    ...
    public static final AuthorizationValidationResponseCode f59463ok = new AuthorizationValidationResponseCode(0);
    ...
    public AuthorizationValidationResponseCode(int i11) {
        super(i11);
        assertValues();
    }
