...
public class Ieee1609Dot2BaseTypes {
    ...
    static {
        ...
        OERDefinition.Builder typeName10 = OERDefinition.choice(typeName2.label("microseconds"), typeName2.label("milliseconds"), typeName2.label("seconds"), typeName2.label("minutes"), typeName2.label(PlaceFields.HOURS), typeName2.label("sixtyHours"), typeName2.label("years")).typeName("Duration");
        Duration = typeName10;
        ValidityPeriod = OERDefinition.seq(typeName9.label("start"), typeName10.label(IBridgeMediaLoader.COLUMN_DURATION)).typeName("ValidityPeriod");
        ...
        EciesP256EncryptedKey = OERDefinition.seq(typeName12.copy().label(f.f34662a), OERDefinition.octets(16).label("c"), OERDefinition.octets(16).label("t")).typeName("EciesP256EncryptedKey");
        ...
        OERDefinition.Builder typeName27 = OERDefinition.choice(typeName25.label("opaque"), OERDefinition.nullValue().label(TtmlNode.COMBINE_ALL), OERDefinition.extension(typeName26.label("bitmapSspRange"))).typeName("SspRange");
        SspRange = typeName27;
        ...
        OERDefinition.Builder typeName31 = OERDefinition.seq(typeName.label(TtmlNode.TAG_REGION), typeName5.label("subregions")).typeName("RegionAndSubregions");
        ...
        OERDefinition.Builder typeName33 = OERDefinition.seq(typeName29.label(UserDataStore.COUNTRY), typeName32.label("regionAndSubregions")).typeName("CountryAndSubregions");
        ...
        OERDefinition.Builder typeName44 = OERDefinition.seq(typeName41.label(TtmlNode.CENTER), typeName2.label("radius")).typeName("CircularRegion");
