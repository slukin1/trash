...
public interface BSIObjectIdentifiers {
    ...
    static {
        ...
        ecdsa_plain_SHA512 = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        ecdsa_plain_RIPEMD160 = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
        ecdsa_plain_SHA3_224 = branch2.branch("8");
        ecdsa_plain_SHA3_256 = branch2.branch("9");
        ecdsa_plain_SHA3_384 = branch2.branch(CouponReturn.TYPE_EXPERIENCE);
        ecdsa_plain_SHA3_512 = branch2.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_FUTURE_LINEAR_SWAP);
        ...
        ecka_eg_X963kdf_SHA512 = branch4.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_OTC);
        ecka_eg_X963kdf_RIPEMD160 = branch4.branch(BalanceProfitLossData.AccountBalance.DISTRIBUTION_TYPE_POOL);
