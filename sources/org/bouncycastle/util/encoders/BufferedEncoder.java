...
public class BufferedEncoder {
    ...
    public BufferedEncoder(Translator translator2, int i11) {
    ...
    public int processByte(byte b11, byte[] bArr, int i11) {
        ...
        int encode = this.translator.encode(bArr2, 0, bArr2.length, bArr, i11);
        this.bufOff = 0;
        return encode;
    }
    ...
    public int processBytes(byte[] bArr, int i11, int i12, byte[] bArr2, int i13) {
        if (i12 >= 0) {
            ...
            if (i12 > i15) {
                ...
                byte[] bArr4 = this.buf;
                int encode = translator2.encode(bArr4, 0, bArr4.length, bArr2, i13) + 0;
                this.bufOff = 0;
                int i17 = i12 - i15;
                int i18 = i11 + i15;
                int i19 = i13 + encode;
                int length2 = i17 - (i17 % this.buf.length);
                i16 = encode + this.translator.encode(bArr, i18, length2, bArr2, i19);
                i12 = i17 - length2;
                i11 = i18 + length2;
            }
            if (i12 != 0) {
