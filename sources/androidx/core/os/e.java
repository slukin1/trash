    ...
    public static final Bundle a(Pair<String, ? extends Object>... pairArr) {
        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (component2 == null) {
                ...
                if (i11 >= 18 && (component2 instanceof IBinder)) {
                    b.a(bundle, component1, (IBinder) component2);
                } else if (i11 >= 21 && (component2 instanceof Size)) {
                    c.a(bundle, component1, (Size) component2);
                } else if (i11 < 21 || !(component2 instanceof SizeF)) {
                    throw new IllegalArgumentException("Illegal value type " + component2.getClass().getCanonicalName() + " for key \"" + component1 + '\"');
                } else {
                    c.b(bundle, component1, (SizeF) component2);
                }
            }
        }
        return bundle;
