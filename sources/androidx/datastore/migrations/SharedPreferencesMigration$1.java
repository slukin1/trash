...
final class SharedPreferencesMigration$1 extends SuspendLambda implements p<Object, c<? super Boolean>, Object> {
    public int label;
    ...
    public final Object invoke(Object obj, c<? super Boolean> cVar) {
        return ((SharedPreferencesMigration$1) create(obj, cVar)).invokeSuspend(Unit.f56620a);
    }
