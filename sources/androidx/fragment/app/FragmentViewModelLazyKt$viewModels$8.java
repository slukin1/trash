...
public final class FragmentViewModelLazyKt$viewModels$8 extends Lambda implements a<ViewModelProvider.Factory> {
    public final /* synthetic */ i<q0> $owner$delegate;
    public final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FragmentViewModelLazyKt$viewModels$8(Fragment fragment, i<? extends q0> iVar) {
        super(0);
