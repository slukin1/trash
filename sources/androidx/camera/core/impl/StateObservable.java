...
public abstract class StateObservable<T> implements Observable<T> {
    ...
    public static abstract class ErrorWrapper {
        public static ErrorWrapper wrap(Throwable th2) {
    ...
    public StateObservable(Object obj, boolean z11) {
        if (z11) {
    ...
    public void updateState(T t11) {
        updateStateInternal(t11);
    }

    public void updateStateAsError(Throwable th2) {
