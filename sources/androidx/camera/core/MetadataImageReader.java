...
public class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    private void enqueueImageProxy(SettableImageProxy settableImageProxy) {
        ...
        if (executor != null) {
            executor.execute(new j0(this, onImageAvailableListener));
        } else {
    ...
    public void imageIncoming(androidx.camera.core.impl.ImageReaderProxy r7) {
        ...
        L_0x0025:
            r2 = 0
            androidx.camera.core.ImageProxy r2 = r7.acquireNextImage()     // Catch:{ IllegalStateException -> 0x0047 }
        ...
        L_0x0047:
            ...
            androidx.camera.core.Logger.d(r4, r5, r3)     // Catch:{ all -> 0x0045 }
        L_0x004f:
    ...
    public void setOnImageAvailableListener(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, Executor executor) {
        synchronized (this.mLock) {
            this.mListener = (ImageReaderProxy.OnImageAvailableListener) h.g(onImageAvailableListener);
            this.mExecutor = (Executor) h.g(executor);
    ...
    public MetadataImageReader(ImageReaderProxy imageReaderProxy) {
        ...
        this.mUnAcquiredAvailableImageCount = 0;
        this.mTransformedListener = new i0(this);
        this.mClosed = false;
