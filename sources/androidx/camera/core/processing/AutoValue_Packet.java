...
final class AutoValue_Packet<T> extends Packet<T> {
    ...
    public AutoValue_Packet(T t11, Exif exif2, int i11, Size size2, Rect rect, int i12, Matrix matrix, CameraCaptureResult cameraCaptureResult2) {
        ...
        Objects.requireNonNull(cameraCaptureResult2, "Null cameraCaptureResult");
