...
import com.huobi.kalle.exception.ConnectException;
import com.huobi.kalle.exception.ConnectTimeoutError;
import com.huobi.kalle.exception.HostError;
import com.huobi.kalle.exception.NetworkError;
import com.huobi.kalle.exception.ReadException;
import com.huobi.kalle.exception.ReadTimeoutError;
import com.huobi.kalle.exception.URLError;
import com.huobi.kalle.exception.WriteException;
...
public class d implements hm.d {

    /* renamed from: a  reason: collision with root package name */
    public final a f76215a = new a(Kalle.a().f());

    /* renamed from: b  reason: collision with root package name */
    public final b f76216b = Kalle.a().c();

    /* renamed from: c  reason: collision with root package name */
    public final e f76217c = Kalle.a().k();

    /* renamed from: d  reason: collision with root package name */
    public c f76218d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f76219e;
    ...
    public final c b(k kVar) throws ConnectException {
        if (this.f76217c.isAvailable()) {
            try {
                Headers c11 = kVar.c();
                URI uri = new URI(kVar.l().toString());
                List<String> d11 = this.f76215a.d(uri);
                if (d11 != null && !d11.isEmpty()) {
                    c11.k(HttpHeaders.COOKIE, d11);
                }
                c11.H("Host", uri.getHost());
                return this.f76216b.a(kVar);
    ...
    public final Response d(k kVar) throws ReadException {
        try {
            int c11 = this.f76218d.c();
            Headers c12 = c(this.f76218d.getHeaders());
            List<String> q11 = c12.q(HttpHeaders.SET_COOKIE);
            if (q11 != null && !q11.isEmpty()) {
                this.f76215a.b(URI.create(kVar.l().toString()), q11);
            }
            return Response.g().f(c11).g(c12).d(new f(c12.t(), this.f76218d.getInputStream())).e();
    ...
    public final void e(l lVar) throws WriteException {
        try {
            OutputStream outputStream = this.f76218d.getOutputStream();
