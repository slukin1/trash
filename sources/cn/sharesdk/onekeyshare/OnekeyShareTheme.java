...
public enum OnekeyShareTheme {
    ...
    private OnekeyShareTheme(int i11, OnekeyShareThemeImpl onekeyShareThemeImpl) {
        this.value = i11;
        this.impl = onekeyShareThemeImpl;
    }

    public static OnekeyShareTheme fromValue(int i11) {
        for (OnekeyShareTheme onekeyShareTheme : values()) {
            if (onekeyShareTheme.value == i11) {
