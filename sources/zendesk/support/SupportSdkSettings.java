...
public class SupportSdkSettings {
    ...
    public List<String> getContactZendeskTags() {
        SupportSettings supportSettings = this.mobileSettings;
        if ((supportSettings == null || supportSettings.getContactUs() == null || !a.i(this.mobileSettings.getContactUs().getTags())) ? false : true) {
    ...
    public String getReferrerUrl() {
        SupportSettings supportSettings = this.mobileSettings;
        return (supportSettings == null || !f.c(supportSettings.getReferrerUrl())) ? "https://www.zendesk.com/embeddables" : this.mobileSettings.getReferrerUrl();
    }

    public String getRequestSystemMessage() {
        SupportSettings supportSettings = this.mobileSettings;
        return (supportSettings == null || !f.c(supportSettings.getSystemMessage())) ? "" : this.mobileSettings.getSystemMessage();
    }
