...
public class Completable {
    public static final Completable COMPLETE = new Completable(new OnSubscribe() {
        public void call(CompletableSubscriber completableSubscriber) {
            completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
            completableSubscriber.onCompleted();
        }
    }, false);
    public static final Completable NEVER = new Completable(new OnSubscribe() {
        public void call(CompletableSubscriber completableSubscriber) {
            completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
        }
    }, false);
    ...
    public Completable(OnSubscribe onSubscribe2) {
    ...
    public static Completable amb(final Completable... completableArr) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                AnonymousClass1 r22 = new CompletableSubscriber() {
                ...
                while (i11 < length) {
                    ...
                    if (!compositeSubscription.isUnsubscribed()) {
                        if (completable == null) {
                            ...
                            completable.unsafeSubscribe((CompletableSubscriber) r22);
                            i11++;
                        } else {
                            return;
                        }
    ...
    public static void deliverUncaughtException(Throwable th2) {
    ...
    public static Completable fromObservable(final Observable<?> observable) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                AnonymousClass1 r02 = new Subscriber<Object>() {
                    public void onCompleted() {
                        completableSubscriber.onCompleted();
                    }
                ...
                completableSubscriber.onSubscribe(r02);
    ...
    public static Completable fromSingle(final Single<?> single) {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                AnonymousClass1 r02 = new SingleSubscriber<Object>() {
                    public void onError(Throwable th2) {
                        completableSubscriber.onError(th2);
                    }
    ...
    public static Completable merge0(Observable<? extends Completable> observable, int i11, boolean z11) {
        requireNonNull(observable);
        if (i11 >= 1) {
            return create(new CompletableOnSubscribeMerge(observable, i11, z11));
        }
    ...
    public static NullPointerException toNpe(Throwable th2) {
    ...
    public final <T> Observable<T> andThen(Observable<T> observable) {
        requireNonNull(observable);
        return observable.delaySubscription((Observable<U>) toObservable());
    }
        ...
        if (action1 != null) {
            return doOnLifecycle(Actions.empty(), new Action1<Throwable>() {
                public void call(Throwable th2) {
                    action1.call(Notification.createOnError(th2));
                }
            }, new Action0() {
                public void call() {
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
                    ...
                    public void onError(Throwable th2) {
                        try {
                            Completable completable = (Completable) func1.call(th2);
                            if (completable == null) {
                                completableSubscriber.onError(new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{th2, new NullPointerException("The completable returned is null")})));
                                return;
                            }
                            ...
                            completableSubscriber.onError(new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{th2, th3})));
                        }
                    }
    ...
    public final Subscription subscribe() {
        ...
        unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
            ...
            public void onError(Throwable th2) {
                RxJavaHooks.onError(th2);
                multipleAssignmentSubscription.unsubscribe();
                Completable.deliverUncaughtException(th2);
            }
    ...
    public final Completable timeout(long j11, TimeUnit timeUnit) {
        return timeout0(j11, timeUnit, Schedulers.computation(), (Completable) null);
    }

    public final Completable timeout0(long j11, TimeUnit timeUnit, Scheduler scheduler, Completable completable) {
        requireNonNull(timeUnit);
        requireNonNull(scheduler);
        return create(new CompletableOnSubscribeTimeout(this, j11, timeUnit, scheduler, completable));
    }
    ...
    public final <T> Single<T> toSingleDefault(final T t11) {
        requireNonNull(t11);
    ...
    public static Completable timer(final long j11, final TimeUnit timeUnit, final Scheduler scheduler) {
        requireNonNull(timeUnit);
        requireNonNull(scheduler);
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
    ...
    public static <R> Completable using(final Func0<R> func0, final Func1<? super R, ? extends Completable> func1, final Action1<? super R> action1, final boolean z11) {
        requireNonNull(func0);
        requireNonNull(func1);
        requireNonNull(action1);
        return create(new OnSubscribe() {
                    ...
                    try {
                        ...
                        if (completable == null) {
                            try {
                                ...
                                Exceptions.throwIfFatal(th2);
                                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
                                completableSubscriber.onError(new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{new NullPointerException("The completable supplied is null"), th2})));
                            }
                        } else {
                            final AtomicBoolean atomicBoolean = new AtomicBoolean();
                            completable.unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
                                ...
                                public Subscription f29195d;

                                public void dispose() {
                                    this.f29195d.unsubscribe();
                                    if (atomicBoolean.compareAndSet(false, true)) {
                                        try {
                                            action1.call(call);
                                        } catch (Throwable th2) {
                        ...
                        completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
                        completableSubscriber.onError(new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{th, th3})));
                    }
                } catch (Throwable th4) {
                    completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                Completable.this.unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
                    ...
                    public void onError(Throwable th2) {
                        boolean z11 = false;
                        try {
                            z11 = ((Boolean) func1.call(th2)).booleanValue();
                        } catch (Throwable th3) {
                            Exceptions.throwIfFatal(th3);
                            th2 = new CompositeException((Collection<? extends Throwable>) Arrays.asList(new Throwable[]{th2, th3}));
                        }
    ...
    public final Completable repeat(long j11) {
        return fromObservable(toObservable().repeat(j11));
    }
    ...
    public final Completable timeout(long j11, TimeUnit timeUnit, Completable completable) {
        requireNonNull(completable);
        return timeout0(j11, timeUnit, Schedulers.computation(), completable);
    }

    public Completable(OnSubscribe onSubscribe2, boolean z11) {
        this.onSubscribe = z11 ? RxJavaHooks.onCreate(onSubscribe2) : onSubscribe2;
    }

    public static Completable error(final Throwable th2) {
        requireNonNull(th2);
        return create(new OnSubscribe() {
            public void call(CompletableSubscriber completableSubscriber) {
                completableSubscriber.onSubscribe(Subscriptions.unsubscribed());
            ...
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                Completable.this.unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
                    public void onCompleted() {
                        ...
                        AnonymousClass1 r22 = new Action0() {
                            public void call() {
                                try {
                                    completableSubscriber.onCompleted();
                                } finally {
                        ...
                        AnonymousClass16 r32 = AnonymousClass16.this;
                        compositeSubscription.add(worker.schedule(r22, j12, timeUnit2));
                    }
                    ...
                    public void onError(final Throwable th2) {
                        if (z12) {
                            CompositeSubscription compositeSubscription = compositeSubscription;
                            Scheduler.Worker worker = createWorker;
                            AnonymousClass2 r22 = new Action0() {
                                public void call() {
                                    try {
                                        completableSubscriber.onError(th2);
                                    } finally {
                            ...
                            AnonymousClass16 r62 = AnonymousClass16.this;
                            compositeSubscription.add(worker.schedule(r22, j12, timeUnit2));
                            return;
                        }
                        completableSubscriber.onError(th2);
    ...
    public final Completable retry(long j11) {
        return fromObservable(toObservable().retry(j11));
    }
    ...
    public final Completable timeout(long j11, TimeUnit timeUnit, Scheduler scheduler) {
        return timeout0(j11, timeUnit, scheduler, (Completable) null);
    }
    ...
    public final Completable timeout(long j11, TimeUnit timeUnit, Scheduler scheduler, Completable completable) {
        requireNonNull(completable);
        return timeout0(j11, timeUnit, scheduler, completable);
    }

    public static Completable mergeDelayError(Observable<? extends Completable> observable, int i11) {
        return merge0(observable, i11, true);
    }
    ...
    public final Subscription subscribe(final Action0 action0, final Action1<? super Throwable> action1) {
        ...
        unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
            ...
            public void callOnError(Throwable th2) {
                try {
                    action1.call(th2);
                } catch (Throwable th3) {
                    multipleAssignmentSubscription.unsubscribe();
        ...
        return create(new OnSubscribe() {
            public void call(final CompletableSubscriber completableSubscriber) {
                ...
                try {
                    ...
                    final AtomicBoolean atomicBoolean = new AtomicBoolean();
                    AnonymousClass1 r32 = new CompletableSubscriber() {
                        public void onCompleted() {
                            if (atomicBoolean.compareAndSet(false, true)) {
                                compositeSubscription.unsubscribe();
                                completableSubscriber.onCompleted();
                            ...
                            if (!it2.hasNext()) {
                                ...
                                try {
                                    ...
                                    if (completable == null) {
                                        ...
                                        completable.unsafeSubscribe((CompletableSubscriber) r32);
                                        z11 = false;
                                    } else {
                                        return;
                                    }
    ...
    public final Throwable get(long j11, TimeUnit timeUnit) {
        requireNonNull(timeUnit);
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        final Throwable[] thArr = new Throwable[1];
        unsafeSubscribe((CompletableSubscriber) new CompletableSubscriber() {
    ...
    public static Completable concat(Observable<? extends Completable> observable, int i11) {
        requireNonNull(observable);
        if (i11 >= 1) {
            return create(new CompletableOnSubscribeConcat(observable, i11));
        }
        throw new IllegalArgumentException("prefetch > 0 required but it was " + i11);
    }

    public static Completable merge(Observable<? extends Completable> observable, int i11) {
        return merge0(observable, i11, false);
    }

    private <T> void unsafeSubscribe(final Subscriber<T> subscriber, boolean z11) {
