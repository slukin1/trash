...
public class SchedulerWhen extends Scheduler implements Subscription {
    public static final Subscription SUBSCRIBED = new Subscription() {
    ...
    public static class DelayedAction extends ScheduledAction {
        ...
        public DelayedAction(Action0 action0, long j11, TimeUnit timeUnit) {
            this.action = action0;
            this.delayTime = j11;
            this.unit = timeUnit;
        }
    ...
    public Scheduler.Worker createWorker() {
        ...
        AnonymousClass2 r32 = new Scheduler.Worker() {
            ...
            public Subscription schedule(Action0 action0, long j11, TimeUnit timeUnit) {
                DelayedAction delayedAction = new DelayedAction(action0, j11, timeUnit);
