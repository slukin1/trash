...
public final class ProducerObserverArbiter<T> implements Producer, Observer<T> {
    public static final Producer NULL_PRODUCER = new Producer() {
    ...
    public void emitLoop() {
        ...
        while (true) {
            synchronized (this) {
                ...
                z11 = true;
                if (i11 == 0 && producer == null && list == null && obj == null) {
                    this.emitting = false;
                    z12 = true;
                } else {
            ...
            if (!z12) {
                ...
                if (producer == null) {
                    ...
                    if (producer != null && i11 != 0) {
                        j13 = BackpressureUtils.addCap(j13, j11);
                    }
                    ...
                    if (j14 != 0) {
                        j13 = BackpressureUtils.addCap(j13, j14);
                    }
                }
                producer2 = producer;
