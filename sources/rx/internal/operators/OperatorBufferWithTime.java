...
public final class OperatorBufferWithTime<T> implements Observable.Operator<List<T>, T> {
    ...
    public final class ExactSubscriber extends Subscriber<T> {
        ...
        public void scheduleExact() {
            ...
            long j11 = operatorBufferWithTime.timespan;
            worker.schedulePeriodically(r12, j11, j11, operatorBufferWithTime.unit);
        }
    }
    ...
    public final class InexactSubscriber extends Subscriber<T> {
        ...
        public void scheduleChunk() {
            ...
            OperatorBufferWithTime operatorBufferWithTime = OperatorBufferWithTime.this;
            long j11 = operatorBufferWithTime.timeshift;
            worker.schedulePeriodically(r12, j11, j11, operatorBufferWithTime.unit);
        }
        ...
        public void startNewChunk() {
            ...
            synchronized (this) {
                if (!this.done) {
                    ...
                    OperatorBufferWithTime operatorBufferWithTime = OperatorBufferWithTime.this;
                    worker.schedule(r22, operatorBufferWithTime.timespan, operatorBufferWithTime.unit);
                }
            }
        }
    }

    public OperatorBufferWithTime(long j11, long j12, TimeUnit timeUnit, int i11, Scheduler scheduler2) {
        this.timespan = j11;
        this.timeshift = j12;
        this.unit = timeUnit;
        this.count = i11;
