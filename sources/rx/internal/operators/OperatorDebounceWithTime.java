...
public final class OperatorDebounceWithTime<T> implements Observable.Operator<T, T> {
    ...
    public static final class DebounceState<T> {
        ...
        public synchronized int next(T t11) {
            int i11;
            this.value = t11;
            this.hasValue = true;
            i11 = this.index + 1;
    ...
    public OperatorDebounceWithTime(long j11, TimeUnit timeUnit, Scheduler scheduler2) {
        this.timeout = j11;
        this.unit = timeUnit;
    ...
    public Subscriber<? super T> call(Subscriber<? super T> subscriber) {
        ...
        return new Subscriber<T>(subscriber) {
            ...
            public void onNext(T t11) {
                ...
                serialSubscription.set(worker.schedule(r22, operatorDebounceWithTime.timeout, operatorDebounceWithTime.unit));
            }
