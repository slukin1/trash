...
public class f implements a<InputStream> {
    ...
    public boolean a(java.io.InputStream r5, java.io.File r6, com.bumptech.glide.load.Options r7) {
        /*
            ...
            com.bumptech.glide.load.engine.bitmap_recycle.b r0 = r4.f66610a
        ...
        L_0x0042:
            com.bumptech.glide.load.engine.bitmap_recycle.b r5 = r4.f66610a
            r5.put(r0)
            return r1
        L_0x0048:
        ...
        L_0x004d:
            com.bumptech.glide.load.engine.bitmap_recycle.b r6 = r4.f66610a
            r6.put(r0)
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: s3.f.a(java.io.InputStream, java.io.File, com.bumptech.glide.load.Options):boolean");
    }
}
