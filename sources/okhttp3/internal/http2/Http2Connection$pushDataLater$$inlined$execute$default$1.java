...
public final class Http2Connection$pushDataLater$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$pushDataLater$$inlined$execute$default$1(String str, boolean z11, Http2Connection http2Connection, int i11, Buffer buffer, int i12, boolean z12) {
        super(str, z11);
        this.this$0 = http2Connection;
        this.$streamId$inlined = i11;
        this.$buffer$inlined = buffer;
        this.$byteCount$inlined = i12;
        this.$inFinished$inlined = z12;
    }
