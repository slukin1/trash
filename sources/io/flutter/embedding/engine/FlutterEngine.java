...
public class FlutterEngine {
    ...
    public FlutterEngine spawn(Context context, DartExecutor.DartEntrypoint dartEntrypoint, String str, List<String> list, PlatformViewsController platformViewsController2, boolean z11, boolean z12) {
    ...
    public FlutterEngine(Context context, String[] strArr, boolean z11) {
        this(context, (FlutterLoader) null, (FlutterJNI) null, strArr, z11);
    }

    public FlutterEngine(Context context, String[] strArr, boolean z11, boolean z12) {
    ...
    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, String[] strArr, boolean z11) {
        this(context, flutterLoader, flutterJNI2, new PlatformViewsController(), strArr, z11);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z11) {
        this(context, flutterLoader, flutterJNI2, platformViewsController2, strArr, z11, false);
    }

    public FlutterEngine(Context context, FlutterLoader flutterLoader, FlutterJNI flutterJNI2, PlatformViewsController platformViewsController2, String[] strArr, boolean z11, boolean z12) {
