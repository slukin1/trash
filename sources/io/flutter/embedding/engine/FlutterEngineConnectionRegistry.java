...
class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
        ...
        public boolean onActivityResult(int i11, int i12, Intent intent) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (((PluginRegistry.ActivityResultListener) it2.next()).onActivityResult(i11, i12, intent) || z11) {
                        z11 = true;
                    }
                }
            }
    ...
    public static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        public FlutterEngineServicePluginBinding(Service service2, Lifecycle lifecycle) {
    ...
    public void attachToService(Service service2, Lifecycle lifecycle, boolean z11) {
    ...
    public boolean onActivityResult(int i11, int i12, Intent intent) {
        if (isAttachedToActivity()) {
            ...
            try {
                return this.activityPluginBinding.onActivityResult(i11, i12, intent);
            } finally {
                TraceSection.end();
            }
        } else {
    ...
    public boolean onRequestPermissionsResult(int i11, String[] strArr, int[] iArr) {
        if (isAttachedToActivity()) {
            ...
            try {
                return this.activityPluginBinding.onRequestPermissionsResult(i11, strArr, iArr);
            } finally {
                TraceSection.end();
            }
        } else {
