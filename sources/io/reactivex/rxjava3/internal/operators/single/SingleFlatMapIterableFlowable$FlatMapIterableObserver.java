...
final class SingleFlatMapIterableFlowable$FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements m<T> {
    private static final long serialVersionUID = -8938804753851907758L;
    public volatile boolean cancelled;
    public final c<? super R> downstream;

    /* renamed from: it  reason: collision with root package name */
    public volatile Iterator<? extends R> f55602it;
    ...
    public void drain() {
        if (getAndIncrement() == 0) {
            ...
            Iterator<? extends R> it2 = this.f55602it;
