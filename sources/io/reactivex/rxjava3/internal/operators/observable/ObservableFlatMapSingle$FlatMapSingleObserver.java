...
final class ObservableFlatMapSingle$FlatMapSingleObserver<T, R> extends AtomicInteger implements k<T>, b {
    ...
    public final class InnerObserver extends AtomicReference<b> implements m<R>, b {
        ...
        public void onSuccess(R r11) {
            ObservableFlatMapSingle$FlatMapSingleObserver.this.innerSuccess(this, r11);
        }
    }

    public ObservableFlatMapSingle$FlatMapSingleObserver(k<? super R> kVar, h<? super T, ? extends o<? extends R>> hVar, boolean z11) {
    ...
    public void innerSuccess(ObservableFlatMapSingle$FlatMapSingleObserver<T, R>.InnerObserver innerObserver, R r11) {
        this.set.b(innerObserver);
        if (get() == 0) {
            boolean z11 = false;
