...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 extends SuspendLambda implements p<e<Object>, c<? super Unit>, Object> {
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(d[] dVarArr, c cVar, r rVar) {
        super(2, cVar);
        this.$flows = dVarArr;
    ...
    public final Object invoke(e<Object> eVar, c<? super Unit> cVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1) create(eVar, cVar)).invokeSuspend(Unit.f56620a);
    }
